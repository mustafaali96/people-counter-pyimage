...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CPack External Generator &mdash; CMake 3.16.1 Documentation</title>
...
<dd><p class="first">The <code class="docutils literal notranslate"><span class="pre">components</span></code> field is an object with component names as the keys and
objects describing the components as the values. The component objects have
the following fields:</p>
<dl class="last docutils">
<dt><code class="docutils literal notranslate"><span class="pre">name</span></code></dt>
<dd>The name of the component. This is always the same as the key in the
<code class="docutils literal notranslate"><span class="pre">components</span></code> object.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">displayName</span></code></dt>
<dd>The value of the <code class="docutils literal notranslate"><span class="pre">DISPLAY_NAME</span></code> field passed to
<span class="target" id="index-1-command:cpack_add_component"></span><a class="reference internal" href="../module/CPackComponent.html#command:cpack_add_component" title="cpack_add_component"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">cpack_add_component()</span></code></a>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">description</span></code></dt>
<dd>The value of the <code class="docutils literal notranslate"><span class="pre">DESCRIPTION</span></code> field passed to
<span class="target" id="index-2-command:cpack_add_component"></span><a class="reference internal" href="../module/CPackComponent.html#command:cpack_add_component" title="cpack_add_component"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">cpack_add_component()</span></code></a>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">isHidden</span></code></dt>
<dd>True if <code class="docutils literal notranslate"><span class="pre">HIDDEN</span></code> was passed to <span class="target" id="index-3-command:cpack_add_component"></span><a class="reference internal" href="../module/CPackComponent.html#command:cpack_add_component" title="cpack_add_component"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">cpack_add_component()</span></code></a>, false if
it was not.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">isRequired</span></code></dt>
<dd>True if <code class="docutils literal notranslate"><span class="pre">REQUIRED</span></code> was passed to <span class="target" id="index-4-command:cpack_add_component"></span><a class="reference internal" href="../module/CPackComponent.html#command:cpack_add_component" title="cpack_add_component"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">cpack_add_component()</span></code></a>, false if
it was not.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">isDisabledByDefault</span></code></dt>
<dd>True if <code class="docutils literal notranslate"><span class="pre">DISABLED</span></code> was passed to <span class="target" id="index-5-command:cpack_add_component"></span><a class="reference internal" href="../module/CPackComponent.html#command:cpack_add_component" title="cpack_add_component"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">cpack_add_component()</span></code></a>, false if
it was not.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">group</span></code></dt>
<dd>Only present if <code class="docutils literal notranslate"><span class="pre">GROUP</span></code> was passed to <span class="target" id="index-6-command:cpack_add_component"></span><a class="reference internal" href="../module/CPackComponent.html#command:cpack_add_component" title="cpack_add_component"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">cpack_add_component()</span></code></a>. If
so, this field is a string value containing the component’s group.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">dependencies</span></code></dt>
<dd>An array of components the component depends on. This contains the values
...
<code class="docutils literal notranslate"><span class="pre">DEPENDS</span></code> argument was passed, this is an empty list.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">installationTypes</span></code></dt>
<dd>An array of installation types the component is part of. This contains the
...
passed, this is an empty list.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">isDownloaded</span></code></dt>
<dd>True if <code class="docutils literal notranslate"><span class="pre">DOWNLOADED</span></code> was passed to <span class="target" id="index-9-command:cpack_add_component"></span><a class="reference internal" href="../module/CPackComponent.html#command:cpack_add_component" title="cpack_add_component"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">cpack_add_component()</span></code></a>, false
if it was not.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">archiveFile</span></code></dt>
<dd>The name of the archive file passed with the <code class="docutils literal notranslate"><span class="pre">ARCHIVE_FILE</span></code> argument to
...
this is an empty string.</dd>
</dl>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">componentGroups</span></code></dt>
<dd><p class="first">The <code class="docutils literal notranslate"><span class="pre">componentGroups</span></code> field is an object with component group names as the
keys and objects describing the component groups as the values. The component
group objects have the following fields:</p>
<dl class="last docutils">
<dt><code class="docutils literal notranslate"><span class="pre">name</span></code></dt>
<dd>The name of the component group. This is always the same as the key in the
<code class="docutils literal notranslate"><span class="pre">componentGroups</span></code> object.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">displayName</span></code></dt>
<dd>The value of the <code class="docutils literal notranslate"><span class="pre">DISPLAY_NAME</span></code> field passed to
...
<dt><code class="docutils literal notranslate"><span class="pre">parentGroup</span></code></dt>
<dd>Only present if <code class="docutils literal notranslate"><span class="pre">PARENT_GROUP</span></code> was passed to
<span class="target" id="index-3-command:cpack_add_component_group"></span><a class="reference internal" href="../module/CPackComponent.html#command:cpack_add_component_group" title="cpack_add_component_group"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">cpack_add_component_group()</span></code></a>. If so, this field is a string value
containing the component group’s parent group.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">isExpandedByDefault</span></code></dt>
<dd>True if <code class="docutils literal notranslate"><span class="pre">EXPANDED</span></code> was passed to <span class="target" id="index-4-command:cpack_add_component_group"></span><a class="reference internal" href="../module/CPackComponent.html#command:cpack_add_component_group" title="cpack_add_component_group"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">cpack_add_component_group()</span></code></a>,
false if it was not.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">isBold</span></code></dt>
<dd>True if <code class="docutils literal notranslate"><span class="pre">BOLD_TITLE</span></code> was passed to <span class="target" id="index-5-command:cpack_add_component_group"></span><a class="reference internal" href="../module/CPackComponent.html#command:cpack_add_component_group" title="cpack_add_component_group"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">cpack_add_component_group()</span></code></a>,
false if it was not.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">components</span></code></dt>
<dd>An array of names of components that are direct members of the group
...
subgroups are not included.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">subgroups</span></code></dt>
<dd>An array of names of component groups that are subgroups of the group
(groups that have this group as their <code class="docutils literal notranslate"><span class="pre">PARENT_GROUP</span></code>).</dd>
</dl>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">installationTypes</span></code></dt>
<dd><p class="first">The <code class="docutils literal notranslate"><span class="pre">installationTypes</span></code> field is an object with installation type names as
...
<dl class="last docutils">
<dt><code class="docutils literal notranslate"><span class="pre">name</span></code></dt>
<dd>The name of the installation type. This is always the same as the key in
the <code class="docutils literal notranslate"><span class="pre">installationTypes</span></code> object.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">displayName</span></code></dt>
<dd>The value of the <code class="docutils literal notranslate"><span class="pre">DISPLAY_NAME</span></code> field passed to
<span class="target" id="index-0-command:cpack_add_install_type"></span><a class="reference internal" href="../module/CPackComponent.html#command:cpack_add_install_type" title="cpack_add_install_type"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">cpack_add_install_type()</span></code></a>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">index</span></code></dt>
<dd>The integer index of the installation type in the list.</dd>
</dl>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">projects</span></code></dt>
<dd><p class="first">The <code class="docutils literal notranslate"><span class="pre">projects</span></code> field is an array of objects describing CMake projects which
...
<dl class="last docutils">
<dt><code class="docutils literal notranslate"><span class="pre">projectName</span></code></dt>
<dd>The project name passed to <span class="target" id="index-1-variable:CPACK_INSTALL_CMAKE_PROJECTS"></span><a class="reference internal" href="../module/CPack.html#variable:CPACK_INSTALL_CMAKE_PROJECTS" title="CPACK_INSTALL_CMAKE_PROJECTS"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_INSTALL_CMAKE_PROJECTS</span></code></a>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">component</span></code></dt>
<dd>The name of the component or component set which comprises the project.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">directory</span></code></dt>
<dd>The build directory of the CMake project. This is the directory which
contains the <code class="docutils literal notranslate"><span class="pre">cmake_install.cmake</span></code> script.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">subDirectory</span></code></dt>
<dd>The subdirectory to install the project into inside the CPack package.</dd>
</dl>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">packageName</span></code></dt>
<dd>The package name given in <span class="target" id="index-0-variable:CPACK_PACKAGE_NAME"></span><a class="reference internal" href="../module/CPack.html#variable:CPACK_PACKAGE_NAME" title="CPACK_PACKAGE_NAME"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_PACKAGE_NAME</span></code></a>. Only present if
this option is set.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">packageVersion</span></code></dt>
<dd>The package version given in <span class="target" id="index-0-variable:CPACK_PACKAGE_VERSION"></span><a class="reference internal" href="../module/CPack.html#variable:CPACK_PACKAGE_VERSION" title="CPACK_PACKAGE_VERSION"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_PACKAGE_VERSION</span></code></a>. Only present
if this option is set.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">packageDescriptionFile</span></code></dt>
<dd>The package description file given in
...
set.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">packageDescriptionSummary</span></code></dt>
<dd>The package description summary given in
...
set.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">buildConfig</span></code></dt>
<dd>The build configuration given to CPack with the <code class="docutils literal notranslate"><span class="pre">-C</span></code> option. Only present
if this option is set.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">defaultDirectoryPermissions</span></code></dt>
<dd>The default directory permissions given in
...
option is set.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">setDestdir</span></code></dt>
<dd>True if <span class="target" id="index-0-variable:CPACK_SET_DESTDIR"></span><a class="reference internal" href="../variable/CPACK_SET_DESTDIR.html#variable:CPACK_SET_DESTDIR" title="CPACK_SET_DESTDIR"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_SET_DESTDIR</span></code></a> is true, false if it is not.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">packagingInstallPrefix</span></code></dt>
<dd>The install prefix given in <span class="target" id="index-0-variable:CPACK_PACKAGING_INSTALL_PREFIX"></span><a class="reference internal" href="../variable/CPACK_PACKAGING_INSTALL_PREFIX.html#variable:CPACK_PACKAGING_INSTALL_PREFIX" title="CPACK_PACKAGING_INSTALL_PREFIX"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_PACKAGING_INSTALL_PREFIX</span></code></a>. Only
present if <span class="target" id="index-1-variable:CPACK_SET_DESTDIR"></span><a class="reference internal" href="../variable/CPACK_SET_DESTDIR.html#variable:CPACK_SET_DESTDIR" title="CPACK_SET_DESTDIR"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_SET_DESTDIR</span></code></a> is true.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">stripFiles</span></code></dt>
<dd>True if <span class="target" id="index-0-variable:CPACK_STRIP_FILES"></span><a class="reference internal" href="../module/CPack.html#variable:CPACK_STRIP_FILES" title="CPACK_STRIP_FILES"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_STRIP_FILES</span></code></a> is true, false if it is not.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">warnOnAbsoluteInstallDestination</span></code></dt>
<dd>True if <span class="target" id="index-0-variable:CPACK_WARN_ON_ABSOLUTE_INSTALL_DESTINATION"></span><a class="reference internal" href="../variable/CPACK_WARN_ON_ABSOLUTE_INSTALL_DESTINATION.html#variable:CPACK_WARN_ON_ABSOLUTE_INSTALL_DESTINATION" title="CPACK_WARN_ON_ABSOLUTE_INSTALL_DESTINATION"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_WARN_ON_ABSOLUTE_INSTALL_DESTINATION</span></code></a> is true, false
if it is not.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">errorOnAbsoluteInstallDestination</span></code></dt>
<dd>True if <span class="target" id="index-0-variable:CPACK_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION"></span><a class="reference internal" href="../variable/CPACK_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION.html#variable:CPACK_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION" title="CPACK_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION</span></code></a> is true,
false if it is not.</dd>
</dl>
</div>
</div>
...
<code class="descname">CPACK_EXTERNAL_REQUESTED_VERSIONS</code><a class="headerlink" href="#variable:CPACK_EXTERNAL_REQUESTED_VERSIONS" title="Permalink to this definition">¶</a></dt>
...
<code class="descname">CPACK_EXTERNAL_ENABLE_STAGING</code><a class="headerlink" href="#variable:CPACK_EXTERNAL_ENABLE_STAGING" title="Permalink to this definition">¶</a></dt>
...
<code class="descname">CPACK_EXTERNAL_PACKAGE_SCRIPT</code><a class="headerlink" href="#variable:CPACK_EXTERNAL_PACKAGE_SCRIPT" title="Permalink to this definition">¶</a></dt>
