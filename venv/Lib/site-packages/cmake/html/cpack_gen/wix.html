...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CPack WIX Generator &mdash; CMake 3.16.1 Documentation</title>
...
<p>If this variable is set to <code class="docutils literal notranslate"><span class="pre">.</span></code>, then application shortcuts will be
...
<ul class="simple">
<li><code class="docutils literal notranslate"><span class="pre">#PRODUCT</span></code> for the <code class="docutils literal notranslate"><span class="pre">&lt;Product&gt;</span></code> element.</li>
<li><code class="docutils literal notranslate"><span class="pre">#PRODUCTFEATURE</span></code> for the root <code class="docutils literal notranslate"><span class="pre">&lt;Feature&gt;</span></code> element.</li>
</ul>
...
<dd><p>Sets the name of the root install feature in the WIX installer. Same as
...
<dd><p>Sets the description of the root install feature in the WIX installer. Same as
...
<dd><p>If this variable is set to true, the default install location
...
<p class="last">It is therefore possible that the installer e.g. might try to install
...
<code class="descname">CPACK_WIX_ROOT_FOLDER_ID</code><a class="headerlink" href="#variable:CPACK_WIX_ROOT_FOLDER_ID" title="Permalink to this definition">¶</a></dt>
<dd><p>This variable allows specification of a custom root folder ID.
...
<code class="descname">CPACK_WIX_ROOT</code><a class="headerlink" href="#variable:CPACK_WIX_ROOT" title="Permalink to this definition">¶</a></dt>
