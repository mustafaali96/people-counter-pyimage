...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CPack Archive Generator &mdash; CMake 3.16.1 Documentation</title>
...
<p>Archive CPack generator that supports packaging of sources and binaries in
different formats:</p>
<blockquote>
<div><ul class="simple">
<li>7Z - 7zip - (.7z)</li>
...
<code class="descname">CPACK_ARCHIVE_FILE_NAME</code><a class="headerlink" href="#variable:CPACK_ARCHIVE_FILE_NAME" title="Permalink to this definition">¶</a></dt>
<dt id="variable:CPACK_ARCHIVE_&lt;component&gt;_FILE_NAME">
<code class="descname">CPACK_ARCHIVE_&lt;component&gt;_FILE_NAME</code><a class="headerlink" href="#variable:CPACK_ARCHIVE_<component>_FILE_NAME" title="Permalink to this definition">¶</a></dt>
<dd><p>Package file name without extension which is added automatically depending
on the archive format.</p>
<ul>
<li><p class="first">Mandatory : YES</p>
</li>
<li><dl class="first docutils">
<dt>Default <span class="classifier-delimiter">:</span> <span class="classifier"><code class="docutils literal notranslate"><span class="pre">&lt;CPACK_PACKAGE_FILE_NAME&gt;[-&lt;component&gt;].&lt;extension&gt;</span></code> with</span></dt>
<dd><p class="first last">spaces replaced by ‘-‘</p>
</dd>
</dl>
</li>
</ul>
...
<code class="descname">CPACK_ARCHIVE_COMPONENT_INSTALL</code><a class="headerlink" href="#variable:CPACK_ARCHIVE_COMPONENT_INSTALL" title="Permalink to this definition">¶</a></dt>
<dd><p>Enable component packaging for CPackArchive</p>
<ul class="simple">
<li>Mandatory : NO</li>
<li>Default   : OFF</li>
</ul>
