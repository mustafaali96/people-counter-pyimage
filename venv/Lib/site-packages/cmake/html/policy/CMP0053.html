...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMP0053 &mdash; CMake 3.16.1 Documentation</title>
...
<ul>
<li><p class="first">Expansion of <code class="docutils literal notranslate"><span class="pre">&#64;VAR&#64;</span></code> reference syntax defined by the
...
<li><p class="first">Literal <code class="docutils literal notranslate"><span class="pre">${VAR}</span></code> reference syntax may contain only
...
<li><p class="first">The setting of policy <span class="target" id="index-0-policy:CMP0010"></span><a class="reference internal" href="CMP0010.html#policy:CMP0010" title="CMP0010"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0010</span></code></a> is not considered,
...
<span class="target" id="index-1-manual:cmake-language(7)"></span><a class="reference internal" href="../manual/cmake-language.7.html#manual:cmake-language(7)" title="cmake-language(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake-language(7)</span></code></a> manual.</p>
</li>
</ul>
...
CMake version 3.16.1 warns when the policy is not set and uses
