...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>add_executable &mdash; CMake 3.16.1 Documentation</title>
...
here if they are added later using <span class="target" id="index-0-command:target_sources"></span><a class="reference internal" href="target_sources.html#command:target_sources" title="target_sources"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">target_sources()</span></code></a>.)  The
...
target property for details.</p>
<p>Source arguments to <code class="docutils literal notranslate"><span class="pre">add_executable</span></code> may use “generator expressions” with
...
<code class="docutils literal notranslate"><span class="pre">&lt;target&gt;</span></code> may not be a non-<code class="docutils literal notranslate"><span class="pre">GLOBAL</span></code>
<a class="reference internal" href="../manual/cmake-buildsystem.7.html#imported-targets"><span class="std std-ref">Imported Target</span></a> or an <code class="docutils literal notranslate"><span class="pre">ALIAS</span></code>.
<code class="docutils literal notranslate"><span class="pre">ALIAS</span></code> targets can be used as targets to read properties
