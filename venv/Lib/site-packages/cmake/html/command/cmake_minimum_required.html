...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>cmake_minimum_required &mdash; CMake 3.16.1 Documentation</title>
...
<code class="docutils literal notranslate"><span class="pre">major.minor[.patch[.tweak]]</span></code>, and the <code class="docutils literal notranslate"><span class="pre">...</span></code> is literal.</p>
...
The optional <code class="docutils literal notranslate"><span class="pre">&lt;max&gt;</span></code> version, if specified, must be at least the
<code class="docutils literal notranslate"><span class="pre">&lt;min&gt;</span></code> version and affects policy settings as described below.
