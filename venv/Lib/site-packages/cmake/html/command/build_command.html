...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>build_command &mdash; CMake 3.16.1 Documentation</title>
...
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>&lt;cmake&gt; --build . [--config &lt;config&gt;] [--target &lt;target&gt;...] [-- -i]
</pre></div>
</div>
...
tool, and <code class="docutils literal notranslate"><span class="pre">&lt;config&gt;</span></code> and <code class="docutils literal notranslate"><span class="pre">&lt;target&gt;</span></code> are the values provided to the
<code class="docutils literal notranslate"><span class="pre">CONFIGURATION</span></code> and <code class="docutils literal notranslate"><span class="pre">TARGET</span></code> options, if any.  The trailing <code class="docutils literal notranslate"><span class="pre">--</span> <span class="pre">-i</span></code>
option is added for <a class="reference internal" href="../manual/cmake-generators.7.html#makefile-generators"><span class="std std-ref">Makefile Generators</span></a> if policy <span class="target" id="index-0-policy:CMP0061"></span><a class="reference internal" href="../policy/CMP0061.html#policy:CMP0061" title="CMP0061"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0061</span></code></a>
