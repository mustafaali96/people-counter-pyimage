...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>file &mdash; CMake 3.16.1 Documentation</title>
...
Instead, use it in an <span class="target" id="index-0-command:install"></span><a class="reference internal" href="install.html#command:install" title="install"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">install(CODE)</span></code></a> or <span class="target" id="index-1-command:install"></span><a class="reference internal" href="install.html#command:install" title="install"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">install(SCRIPT)</span></code></a>
block. For example:</p>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">RESOLVED_DEPENDENCIES_VAR</span> <span class="pre">&lt;deps_var&gt;</span></code></dt>
<dd>Name of the variable in which to store the list of resolved dependencies.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">UNRESOLVED_DEPENDENCIES_VAR</span> <span class="pre">&lt;unresolved_deps_var&gt;</span></code></dt>
<dd>Name of the variable in which to store the list of unresolved dependencies.
If this variable is not specified, and there are any unresolved dependencies,
an error is issued.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">CONFLICTING_DEPENDENCIES_PREFIX</span> <span class="pre">&lt;conflicting_deps_prefix&gt;</span></code></dt>
<dd>Variable prefix in which to store conflicting dependency information.
...
<code class="docutils literal notranslate"><span class="pre">&lt;conflicting_deps_prefix&gt;_&lt;filename&gt;</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">EXECUTABLES</span> <span class="pre">&lt;executable_files&gt;</span></code></dt>
<dd>List of executable files to read for dependencies. These are executables that
...
will result in undefined behavior.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">LIBRARIES</span> <span class="pre">&lt;library_files&gt;</span></code></dt>
<dd>List of library files to read for dependencies. These are libraries that are
...
libraries, or executables here will result in undefined behavior.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">MODULES</span> <span class="pre">&lt;module_files&gt;</span></code></dt>
<dd>List of loadable module files to read for dependencies. These are modules
...
will result in undefined behavior.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">DIRECTORIES</span> <span class="pre">&lt;directories&gt;</span></code></dt>
<dd>List of additional directories to search for dependencies. On Linux
...
argument has no effect.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">BUNDLE_EXECUTABLE</span> <span class="pre">&lt;bundle_executable_file&gt;</span></code></dt>
<dd>Executable to treat as the “bundle executable” when resolving libraries. On
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">PRE_INCLUDE_REGEXES</span> <span class="pre">&lt;regexes&gt;</span></code></dt>
<dd>List of pre-include regexes through which to filter the names of
not-yet-resolved dependencies.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">PRE_EXCLUDE_REGEXES</span> <span class="pre">&lt;regexes&gt;</span></code></dt>
<dd>List of pre-exclude regexes through which to filter the names of
not-yet-resolved dependencies.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">POST_INCLUDE_REGEXES</span> <span class="pre">&lt;regexes&gt;</span></code></dt>
<dd>List of post-include regexes through which to filter the names of resolved
dependencies.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">POST_EXCLUDE_REGEXES</span> <span class="pre">&lt;regexes&gt;</span></code></dt>
<dd>List of post-exclude regexes through which to filter the names of resolved
dependencies.</dd>
</dl>
<p>These arguments can be used to blacklist unwanted system libraries when
resolving the dependencies, or to whitelist libraries from a specific
directory. The filtering works as follows:</p>
<ol class="arabic simple">
<li>If the not-yet-resolved dependency matches any of the
...
resolution proceeds to step 4.</li>
<li>If the not-yet-resolved dependency matches any of the
<code class="docutils literal notranslate"><span class="pre">PRE_EXCLUDE_REGEXES</span></code>, dependency resolution stops for that dependency.</li>
<li>Otherwise, dependency resolution proceeds.</li>
<li><code class="docutils literal notranslate"><span class="pre">file(GET_RUNTIME_DEPENDENCIES)</span></code> searches for the dependency according to
the linking rules of the platform (see below).</li>
<li>If the dependency is found, and its full path matches one of the
<code class="docutils literal notranslate"><span class="pre">POST_INCLUDE_REGEXES</span></code>, the full path is added to the resolved
...
that library’s own dependencies. Otherwise, resolution proceeds to step 6.</li>
<li>If the dependency is found, but its full path matches one of the
<code class="docutils literal notranslate"><span class="pre">POST_EXCLUDE_REGEXES</span></code>, it is not added to the resolved dependencies, and
dependency resolution stops for that dependency.</li>
<li>If the dependency is found, and its full path does not match either
<code class="docutils literal notranslate"><span class="pre">POST_INCLUDE_REGEXES</span></code> or <code class="docutils literal notranslate"><span class="pre">POST_EXCLUDE_REGEXES</span></code>, the full path is added
...
recursively resolves that library’s own dependencies.</li>
</ol>
...
<ol class="arabic simple">
<li>If the depending file does not have any <code class="docutils literal notranslate"><span class="pre">RUNPATH</span></code> entries, and the library
...
that order, the dependency is resolved to that file.</li>
<li>Otherwise, if the depending file has any <code class="docutils literal notranslate"><span class="pre">RUNPATH</span></code> entries, and the
library exists in one of those entries, the dependency is resolved to that
file.</li>
<li>Otherwise, if the library exists in one of the directories listed by
<code class="docutils literal notranslate"><span class="pre">ldconfig</span></code>, the dependency is resolved to that file.</li>
<li>Otherwise, if the library exists in one of the <code class="docutils literal notranslate"><span class="pre">DIRECTORIES</span></code> entries, the
...
which it pulls dependencies).</li>
<li>Otherwise, the dependency is unresolved.</li>
</ol>
<p>On Windows platforms, library resolution works as follows:</p>
<ol class="arabic">
<li><p class="first">The dependent DLL name is converted to lowercase. Windows DLL names are
...
<li><p class="first">(<strong>Not yet implemented</strong>) If the depending file is a Windows Store app, and
the dependency is listed as a dependency in the application’s package
manifest, the dependency is resolved to that file.</p>
</li>
<li><p class="first">Otherwise, if the library exists in the same directory as the depending
file, the dependency is resolved to that file.</p>
</li>
<li><p class="first">Otherwise, if the library exists in either the operating system’s
...
dependency is resolved to that file.</p>
</li>
<li><p class="first">Otherwise, if the library exists in one of the directories specified by
...
directories is a normal part of Windows library resolution.</p>
</li>
<li><p class="first">Otherwise, the dependency is unresolved.</p>
</li>
</ol>
<p>On Apple platforms, library resolution works as follows:</p>
<ol class="arabic simple">
<li>If the dependency starts with <code class="docutils literal notranslate"><span class="pre">&#64;executable_path/</span></code>, and an <code class="docutils literal notranslate"><span class="pre">EXECUTABLES</span></code>
...
existing file, the dependency is resolved to that file.</li>
<li>Otherwise, if the dependency starts with <code class="docutils literal notranslate"><span class="pre">&#64;executable_path/</span></code>, and there is
...
dependency is resolved to that file.</li>
<li>Otherwise, if the dependency starts with <code class="docutils literal notranslate"><span class="pre">&#64;loader_path/</span></code>, and replacing
...
existing file, the dependency is resolved to that file.</li>
<li>Otherwise, if the dependency starts with <code class="docutils literal notranslate"><span class="pre">&#64;rpath/</span></code>, and replacing
...
also have these items replaced with the appropriate path.</li>
<li>Otherwise, if the dependency is an absolute file that exists, the dependency
is resolved to that file.</li>
<li>Otherwise, the dependency is unresolved.</li>
</ol>
...
<code class="descname">CMAKE_GET_RUNTIME_DEPENDENCIES_PLATFORM</code><a class="headerlink" href="#variable:CMAKE_GET_RUNTIME_DEPENDENCIES_PLATFORM" title="Permalink to this definition">¶</a></dt>
...
<ul class="simple">
<li><code class="docutils literal notranslate"><span class="pre">linux+elf</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">windows+pe</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">macos+macho</span></code></li>
</ul>
...
<code class="descname">CMAKE_GET_RUNTIME_DEPENDENCIES_TOOL</code><a class="headerlink" href="#variable:CMAKE_GET_RUNTIME_DEPENDENCIES_TOOL" title="Permalink to this definition">¶</a></dt>
...
<thead valign="bottom">
<tr class="row-odd"><th class="head"><code class="docutils literal notranslate"><span class="pre">CMAKE_GET_RUNTIME_DEPENDENCIES_PLATFORM</span></code></th>
<th class="head"><code class="docutils literal notranslate"><span class="pre">CMAKE_GET_RUNTIME_DEPENDENCIES_TOOL</span></code></th>
</tr>
</thead>
<tbody valign="top">
<tr class="row-even"><td><code class="docutils literal notranslate"><span class="pre">linux+elf</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">objdump</span></code></td>
</tr>
<tr class="row-odd"><td><code class="docutils literal notranslate"><span class="pre">windows+pe</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">dumpbin</span></code></td>
</tr>
<tr class="row-even"><td><code class="docutils literal notranslate"><span class="pre">windows+pe</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">objdump</span></code></td>
</tr>
<tr class="row-odd"><td><code class="docutils literal notranslate"><span class="pre">macos+macho</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">otool</span></code></td>
</tr>
</tbody>
</table>
<p>If this variable is not specified, it is determined automatically by system
...
<code class="descname">CMAKE_GET_RUNTIME_DEPENDENCIES_COMMAND</code><a class="headerlink" href="#variable:CMAKE_GET_RUNTIME_DEPENDENCIES_COMMAND" title="Permalink to this definition">¶</a></dt>
...
<p>See the <span class="target" id="index-2-command:install"></span><a class="reference internal" href="install.html#command:install" title="install"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">install(DIRECTORY)</span></code></a> command for documentation of
...
Installation scripts generated by the <span class="target" id="index-3-command:install"></span><a class="reference internal" href="install.html#command:install" title="install"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">install()</span></code></a> command
