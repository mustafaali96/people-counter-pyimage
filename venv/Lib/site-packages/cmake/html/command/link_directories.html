...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>link_directories &mdash; CMake 3.16.1 Documentation</title>
...
The command will apply only to targets created after it is called.</p>
...
<p>Arguments to <code class="docutils literal notranslate"><span class="pre">link_directories</span></code> may use “generator expressions” with
...
<ul class="simple">
<li>Project generators like Xcode where the user can switch target
...
a universal binary).</li>
<li>Libraries may themselves have other private library dependencies
...
of things like <code class="docutils literal notranslate"><span class="pre">$ORIGIN</span></code>).</li>
</ul>
<p class="last">If a library search path must be provided, prefer to localize the effect
