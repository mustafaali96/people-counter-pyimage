...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>math &mdash; CMake 3.16.1 Documentation</title>
...
as in C code.</p>
<p>Hexadecimal numbers are recognized when prefixed with <code class="docutils literal notranslate"><span class="pre">0x</span></code>, as in C code.</p>
<p>The result is formatted according to the option <code class="docutils literal notranslate"><span class="pre">OUTPUT_FORMAT</span></code>,
where <code class="docutils literal notranslate"><span class="pre">&lt;format&gt;</span></code> is one of</p>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">HEXADECIMAL</span></code></dt>
<dd>Hexadecimal notation as in C code, i. e. starting with “0x”.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">DECIMAL</span></code></dt>
<dd>Decimal notation. Which is also used if no <code class="docutils literal notranslate"><span class="pre">OUTPUT_FORMAT</span></code> option
is specified.</dd>
</dl>
<p>For example</p>
