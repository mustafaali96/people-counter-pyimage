...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>list &mdash; CMake 3.16.1 Documentation</title>
...
<p class="last">A list in cmake is a <code class="docutils literal notranslate"><span class="pre">;</span></code> separated group of strings.  To create a
...
<div class="admonition note">
<p class="first admonition-title">Note</p>
<p class="last">When specifying index values, if <code class="docutils literal notranslate"><span class="pre">&lt;element</span> <span class="pre">index&gt;</span></code> is 0 or greater, it
...
<p>For more information on regular expressions see also the
<span class="target" id="index-1-command:string"></span><a class="reference internal" href="string.html#command:string" title="string"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">string()</span></code></a> command.</p>
...
<div class="admonition note">
<p class="first admonition-title">Note</p>
<p class="last">The <code class="docutils literal notranslate"><span class="pre">TRANSFORM</span></code> sub-command does not change the number of elements in the
...
of the list
(Same semantic as <code class="docutils literal notranslate"><span class="pre">REGEX</span> <span class="pre">REPLACE</span></code> from <span class="target" id="index-3-command:string"></span><a class="reference internal" href="string.html#command:string" title="string"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">string()</span></code></a> command).</p>
<blockquote>
...
Use the <code class="docutils literal notranslate"><span class="pre">COMPARE</span></code> keyword to select the comparison method for sorting.
The <code class="docutils literal notranslate"><span class="pre">&lt;compare&gt;</span></code> option should be one of:</p>
<ul class="simple">
<li><code class="docutils literal notranslate"><span class="pre">STRING</span></code>: Sorts a list of strings alphabetically.  This is the
default behavior if the <code class="docutils literal notranslate"><span class="pre">COMPARE</span></code> option is not given.</li>
<li><code class="docutils literal notranslate"><span class="pre">FILE_BASENAME</span></code>: Sorts a list of pathnames of files by their basenames.</li>
</ul>
...
<ul class="simple">
<li><code class="docutils literal notranslate"><span class="pre">SENSITIVE</span></code>: List items are sorted in a case-sensitive manner.  This is
the default behavior if the <code class="docutils literal notranslate"><span class="pre">CASE</span></code> option is not given.</li>
<li><code class="docutils literal notranslate"><span class="pre">INSENSITIVE</span></code>: List items are sorted case insensitively.  The order of
items which differ only by upper/lowercase is not specified.</li>
</ul>
...
<ul class="simple">
<li><code class="docutils literal notranslate"><span class="pre">ASCENDING</span></code>: Sorts the list in ascending order.  This is the default
behavior when the <code class="docutils literal notranslate"><span class="pre">ORDER</span></code> option is not given.</li>
<li><code class="docutils literal notranslate"><span class="pre">DESCENDING</span></code>: Sorts the list in descending order.</li>
</ul>
</div>
</div>
