...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>find_package &mdash; CMake 3.16.1 Documentation</title>
...
<ul class="simple">
<li><a class="reference internal" href="#find-package" id="id1">find_package</a><ul>
<li><a class="reference internal" href="#basic-signature-and-module-mode" id="id2">Basic Signature and Module Mode</a></li>
<li><a class="reference internal" href="#full-signature-and-config-mode" id="id3">Full Signature and Config Mode</a></li>
<li><a class="reference internal" href="#version-selection" id="id4">Version Selection</a></li>
<li><a class="reference internal" href="#search-procedure" id="id5">Search Procedure</a></li>
<li><a class="reference internal" href="#package-file-interface-variables" id="id6">Package File Interface Variables</a></li>
</ul>
</li>
</ul>
</div>
...
package.</p>
<p>The <code class="docutils literal notranslate"><span class="pre">[version]</span></code> argument requests a version with which the package found
should be compatible (format is <code class="docutils literal notranslate"><span class="pre">major[.minor[.patch[.tweak]]]</span></code>).  The
<code class="docutils literal notranslate"><span class="pre">EXACT</span></code> option requests that the version be matched exactly.  If no
<code class="docutils literal notranslate"><span class="pre">[version]</span></code> and/or component list is given to a recursive invocation
...
package-by-package basis (see the <a class="reference internal" href="#version-selection">Version Selection</a> section below).</p>
...
<p>If the <code class="docutils literal notranslate"><span class="pre">MODULE</span></code> option is not specfied in the above signature,
...
version (format is <code class="docutils literal notranslate"><span class="pre">major[.minor[.patch[.tweak]]]</span></code>).  If the <code class="docutils literal notranslate"><span class="pre">EXACT</span></code>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">PACKAGE_FIND_NAME</span></code></dt>
<dd>the <code class="docutils literal notranslate"><span class="pre">&lt;PackageName&gt;</span></code></dd>
<dt><code class="docutils literal notranslate"><span class="pre">PACKAGE_FIND_VERSION</span></code></dt>
<dd>full requested version string</dd>
<dt><code class="docutils literal notranslate"><span class="pre">PACKAGE_FIND_VERSION_MAJOR</span></code></dt>
<dd>major version if requested, else 0</dd>
<dt><code class="docutils literal notranslate"><span class="pre">PACKAGE_FIND_VERSION_MINOR</span></code></dt>
<dd>minor version if requested, else 0</dd>
<dt><code class="docutils literal notranslate"><span class="pre">PACKAGE_FIND_VERSION_PATCH</span></code></dt>
<dd>patch version if requested, else 0</dd>
<dt><code class="docutils literal notranslate"><span class="pre">PACKAGE_FIND_VERSION_TWEAK</span></code></dt>
<dd>tweak version if requested, else 0</dd>
<dt><code class="docutils literal notranslate"><span class="pre">PACKAGE_FIND_VERSION_COUNT</span></code></dt>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">PACKAGE_VERSION</span></code></dt>
<dd>full provided version string</dd>
<dt><code class="docutils literal notranslate"><span class="pre">PACKAGE_VERSION_EXACT</span></code></dt>
<dd>true if version is exact match</dd>
<dt><code class="docutils literal notranslate"><span class="pre">PACKAGE_VERSION_COMPATIBLE</span></code></dt>
<dd>true if version is compatible</dd>
<dt><code class="docutils literal notranslate"><span class="pre">PACKAGE_VERSION_UNSUITABLE</span></code></dt>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">&lt;PackageName&gt;_VERSION</span></code></dt>
<dd>full provided version string</dd>
<dt><code class="docutils literal notranslate"><span class="pre">&lt;PackageName&gt;_VERSION_MAJOR</span></code></dt>
<dd>major version if provided, else 0</dd>
<dt><code class="docutils literal notranslate"><span class="pre">&lt;PackageName&gt;_VERSION_MINOR</span></code></dt>
<dd>minor version if provided, else 0</dd>
<dt><code class="docutils literal notranslate"><span class="pre">&lt;PackageName&gt;_VERSION_PATCH</span></code></dt>
<dd>patch version if provided, else 0</dd>
<dt><code class="docutils literal notranslate"><span class="pre">&lt;PackageName&gt;_VERSION_TWEAK</span></code></dt>
<dd>tweak version if provided, else 0</dd>
<dt><code class="docutils literal notranslate"><span class="pre">&lt;PackageName&gt;_VERSION_COUNT</span></code></dt>
<dd>number of version components, 0 to 4</dd>
</dl>
...
that order).</p>
<ul class="simple">
<li>Paths with <code class="docutils literal notranslate"><span class="pre">lib64</span></code> are searched on 64 bit platforms if the
...
<li>Paths with <code class="docutils literal notranslate"><span class="pre">lib32</span></code> are searched on 32 bit platforms if the
...
<li>Paths with <code class="docutils literal notranslate"><span class="pre">libx32</span></code> are searched on platforms using the x32 ABI
...
<li>The <code class="docutils literal notranslate"><span class="pre">lib</span></code> path is always searched.</li>
</ul>
...
enabled.</p>
<ol class="arabic">
<li><p class="first">Search paths specified in the <span class="target" id="index-0-variable:&lt;PackageName&gt;_ROOT"></span><a class="reference internal" href="../variable/PackageName_ROOT.html#variable:&lt;PackageName&gt;_ROOT" title="&lt;PackageName&gt;_ROOT"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">&lt;PackageName&gt;_ROOT</span></code></a> CMake
...
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>CMAKE_PREFIX_PATH
...
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>&lt;PackageName&gt;_DIR
CMAKE_PREFIX_PATH
CMAKE_FRAMEWORK_PATH
CMAKE_APPBUNDLE_PATH
</pre></div>
...
<li><p class="first">Search paths specified by the <code class="docutils literal notranslate"><span class="pre">HINTS</span></code> option.  These should be paths
computed by system introspection, such as a hint provided by the
location of another item already found.  Hard-coded guesses should
be specified with the <code class="docutils literal notranslate"><span class="pre">PATHS</span></code> option.</p>
</li>
...
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>CMAKE_SYSTEM_PREFIX_PATH
...
<li><p class="first">Search paths specified by the <code class="docutils literal notranslate"><span class="pre">PATHS</span></code> option.  These are typically
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">CMAKE_FIND_ROOT_PATH_BOTH</span></code></dt>
<dd>Search in the order described above.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">NO_CMAKE_FIND_ROOT_PATH</span></code></dt>
<dd>Do not use the <span class="target" id="index-3-variable:CMAKE_FIND_ROOT_PATH"></span><a class="reference internal" href="../variable/CMAKE_FIND_ROOT_PATH.html#variable:CMAKE_FIND_ROOT_PATH" title="CMAKE_FIND_ROOT_PATH"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_FIND_ROOT_PATH</span></code></a> variable.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">ONLY_CMAKE_FIND_ROOT_PATH</span></code></dt>
<dd>Search only the re-rooted directories and directories below
<span class="target" id="index-1-variable:CMAKE_STAGING_PREFIX"></span><a class="reference internal" href="../variable/CMAKE_STAGING_PREFIX.html#variable:CMAKE_STAGING_PREFIX" title="CMAKE_STAGING_PREFIX"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_STAGING_PREFIX</span></code></a>.</dd>
</dl>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">CMAKE_FIND_PACKAGE_NAME</span></code></dt>
<dd>the <code class="docutils literal notranslate"><span class="pre">&lt;PackageName&gt;</span></code> which is searched for</dd>
<dt><code class="docutils literal notranslate"><span class="pre">&lt;PackageName&gt;_FIND_REQUIRED</span></code></dt>
<dd>true if <code class="docutils literal notranslate"><span class="pre">REQUIRED</span></code> option was given</dd>
<dt><code class="docutils literal notranslate"><span class="pre">&lt;PackageName&gt;_FIND_QUIETLY</span></code></dt>
<dd>true if <code class="docutils literal notranslate"><span class="pre">QUIET</span></code> option was given</dd>
<dt><code class="docutils literal notranslate"><span class="pre">&lt;PackageName&gt;_FIND_VERSION</span></code></dt>
<dd>full requested version string</dd>
<dt><code class="docutils literal notranslate"><span class="pre">&lt;PackageName&gt;_FIND_VERSION_MAJOR</span></code></dt>
<dd>major version if requested, else 0</dd>
<dt><code class="docutils literal notranslate"><span class="pre">&lt;PackageName&gt;_FIND_VERSION_MINOR</span></code></dt>
<dd>minor version if requested, else 0</dd>
<dt><code class="docutils literal notranslate"><span class="pre">&lt;PackageName&gt;_FIND_VERSION_PATCH</span></code></dt>
<dd>patch version if requested, else 0</dd>
<dt><code class="docutils literal notranslate"><span class="pre">&lt;PackageName&gt;_FIND_VERSION_TWEAK</span></code></dt>
<dd>tweak version if requested, else 0</dd>
<dt><code class="docutils literal notranslate"><span class="pre">&lt;PackageName&gt;_FIND_VERSION_COUNT</span></code></dt>
<dd>number of version components, 0 to 4</dd>
<dt><code class="docutils literal notranslate"><span class="pre">&lt;PackageName&gt;_FIND_VERSION_EXACT</span></code></dt>
<dd>true if <code class="docutils literal notranslate"><span class="pre">EXACT</span></code> option was given</dd>
<dt><code class="docutils literal notranslate"><span class="pre">&lt;PackageName&gt;_FIND_COMPONENTS</span></code></dt>
<dd>list of requested components</dd>
<dt><code class="docutils literal notranslate"><span class="pre">&lt;PackageName&gt;_FIND_REQUIRED_&lt;c&gt;</span></code></dt>
<dd>true if component <code class="docutils literal notranslate"><span class="pre">&lt;c&gt;</span></code> is required,
false if component <code class="docutils literal notranslate"><span class="pre">&lt;c&gt;</span></code> is optional</dd>
</dl>
