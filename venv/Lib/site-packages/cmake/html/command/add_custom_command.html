...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>add_custom_command &mdash; CMake 3.16.1 Documentation</title>
...
<dd>Append the <code class="docutils literal notranslate"><span class="pre">COMMAND</span></code> and <code class="docutils literal notranslate"><span class="pre">DEPENDS</span></code> option values to the custom
...
<p class="last">Explicit specification of byproducts is supported by the
...
prepended to the command before the location of the target executable.</li>
</ul>
...
<p class="last">Whenever a target is used as a command to execute or is mentioned in a
...
an <code class="docutils literal notranslate"><span class="pre">OUTPUT</span></code> of another custom command in the same directory
(<code class="docutils literal notranslate"><span class="pre">CMakeLists.txt</span></code> file) CMake automatically brings the other
...
If <code class="docutils literal notranslate"><span class="pre">DEPENDS</span></code> is not specified the command will run whenever
the <code class="docutils literal notranslate"><span class="pre">OUTPUT</span></code> is missing; if the command does not actually
create the <code class="docutils literal notranslate"><span class="pre">OUTPUT</span></code> then the rule will always run.
If <code class="docutils literal notranslate"><span class="pre">DEPENDS</span></code> specifies any target (created by the
...
recompiled.</p>
<p class="last">Arguments to <code class="docutils literal notranslate"><span class="pre">DEPENDS</span></code> may use
...
<dt><code class="docutils literal notranslate"><span class="pre">IMPLICIT_DEPENDS</span></code></dt>
...
an error by ninja at build time.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">MAIN_DEPENDENCY</span></code></dt>
...
gets silently overwritten by a custom command specification.</dd>
...
relative to the build tree directory corresponding to the
current source directory.
Each output file will be marked with the <span class="target" id="index-1-prop_sf:GENERATED"></span><a class="reference internal" href="../prop_sf/GENERATED.html#prop_sf:GENERATED" title="GENERATED"><code class="xref cmake cmake-prop_sf docutils literal notranslate"><span class="pre">GENERATED</span></code></a>
...
<dd><p class="first">Execute the command with the given current working directory.
If it is a relative path it will be interpreted relative to the
build tree directory corresponding to the current source directory.</p>
<p class="last">Arguments to <code class="docutils literal notranslate"><span class="pre">WORKING_DIRECTORY</span></code> may use
<span class="target" id="index-3-manual:cmake-generator-expressions(7)"></span><a class="reference internal" href="../manual/cmake-generator-expressions.7.html#manual:cmake-generator-expressions(7)" title="cmake-generator-expressions(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">generator</span> <span class="pre">expressions</span></code></a>.</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">DEPFILE</span></code></dt>
<dd>Specify a <code class="docutils literal notranslate"><span class="pre">.d</span></code> depfile for the <span class="target" id="index-3-generator:Ninja"></span><a class="reference internal" href="../generator/Ninja.html#generator:Ninja" title="Ninja"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Ninja</span></code></a> generator.
...
command itself.
Using <code class="docutils literal notranslate"><span class="pre">DEPFILE</span></code> with other generators than Ninja is an error.</dd>
</dl>
</div>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">PRE_BUILD</span></code></dt>
<dd>On <a class="reference internal" href="../manual/cmake-generators.7.html#visual-studio-generators"><span class="std std-ref">Visual Studio Generators</span></a>, run before any other rules are
executed within the target.
On other generators, run just before <code class="docutils literal notranslate"><span class="pre">PRE_LINK</span></code> commands.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">PRE_LINK</span></code></dt>
<dd>Run after sources have been compiled but before linking the binary
or running the librarian or archiver tool of a static library.
This is not defined for targets created by the
<span class="target" id="index-2-command:add_custom_target"></span><a class="reference internal" href="add_custom_target.html#command:add_custom_target" title="add_custom_target"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">add_custom_target()</span></code></a> command.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">POST_BUILD</span></code></dt>
...
<p class="last">This allows to add individual build events for every configuration.</p>
</div>
</div>
</div>
