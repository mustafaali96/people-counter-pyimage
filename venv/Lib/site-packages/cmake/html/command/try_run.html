...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>try_run &mdash; CMake 3.16.1 Documentation</title>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">&lt;runResultVar&gt;</span></code></dt>
<dd>Exit code if the executable were to be run on the target platform.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">&lt;runResultVar&gt;__TRYRUN_OUTPUT</span></code></dt>
