...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>Use_wxWindows &mdash; CMake 3.16.1 Documentation</title>
...
<p><span class="versionmodified">Deprecated since version 2.8.10: </span>Use <code class="docutils literal notranslate"><span class="pre">find_package(wxWidgets)</span></code> and <code class="docutils literal notranslate"><span class="pre">include(${wxWidgets_USE_FILE})</span></code> instead.</p>
</div>
