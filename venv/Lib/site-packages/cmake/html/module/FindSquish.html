...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FindSquish &mdash; CMake 3.16.1 Documentation</title>
...
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>squish_v4_add_test(cmakeTestName
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">cmakeTestName</span></code></dt>
<dd>this will be used as the first argument for add_test()</dd>
<dt><code class="docutils literal notranslate"><span class="pre">AUT</span> <span class="pre">targetName</span></code></dt>
<dd>the name of the cmake target which will be used as AUT, i.e. the
executable which will be tested.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">SUITE</span> <span class="pre">suiteName</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">TEST</span> <span class="pre">squishTestName</span></code></dt>
<dd>the name of the squish test, i.e. the name of the subdirectory
of the test inside the suite directory.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">SETTINGSGROUP</span> <span class="pre">group</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">PRE_COMMAND</span> <span class="pre">command</span></code></dt>
<dd>if specified, the given command will be executed before starting the squish test.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">POST_COMMAND</span> <span class="pre">command</span></code></dt>
...
testWrapper)</p>
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>This is deprecated. Use SQUISH_V3_ADD_TEST() if you are using Squish 3.x instead.
</pre></div>
</div>
</div>
