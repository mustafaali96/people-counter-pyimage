...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMakePackageConfigHelpers &mdash; CMake 3.16.1 Documentation</title>
...
<li>write a <code class="docutils literal notranslate"><span class="pre">FooConfig.cmake.in</span></code> file as you are used to</li>
<li>insert a line containing only the string <code class="docutils literal notranslate"><span class="pre">&#64;PACKAGE_INIT&#64;</span></code></li>
<li>instead of <code class="docutils literal notranslate"><span class="pre">set(FOO_DIR</span> <span class="pre">&quot;&#64;SOME_INSTALL_DIR&#64;&quot;)</span></code>, use
...
<code class="docutils literal notranslate"><span class="pre">&#64;PACKAGE_INIT&#64;</span></code> line)</li>
<li>instead of using the normal <span class="target" id="index-1-command:configure_file"></span><a class="reference internal" href="../command/configure_file.html#command:configure_file" title="configure_file"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">configure_file()</span></code></a>, use
<code class="docutils literal notranslate"><span class="pre">configure_package_config_file()</span></code></li>
</ol>
...
<p>If the <code class="docutils literal notranslate"><span class="pre">INSTALL_PREFIX</span></code> argument is passed, this is used as base path to
...
If <code class="docutils literal notranslate"><span class="pre">SameMinorVersion</span></code> is used, the behaviour is the same as
...
macro.</p>
<p>If <code class="docutils literal notranslate"><span class="pre">ARCH_INDEPENDENT</span></code> is given, the installed package version will be
...
<p class="last"><code class="docutils literal notranslate"><span class="pre">ARCH_INDEPENDENT</span></code> is intended for header-only libraries or similar
