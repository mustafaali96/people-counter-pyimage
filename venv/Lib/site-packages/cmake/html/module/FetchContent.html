...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FetchContent &mdash; CMake 3.16.1 Documentation</title>
...
related to them will be ignored.  In most cases, <code class="docutils literal notranslate"><span class="pre">&lt;contentOptions&gt;</span></code> will
...
calling <span class="target" id="index-0-command:fetchcontent_makeavailable"></span><a class="reference internal" href="#command:fetchcontent_makeavailable" title="fetchcontent_makeavailable"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">FetchContent_MakeAvailable()</span></code></a> for a simpler, more automated
...
<span class="target" id="index-1-command:fetchcontent_makeavailable"></span><a class="reference internal" href="#command:fetchcontent_makeavailable" title="fetchcontent_makeavailable"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">FetchContent_MakeAvailable()</span></code></a> instead (and should be preferred where
it meets the needs of the project).</p>
<dl class="command">
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">FETCHCONTENT_BASE_DIR</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">FETCHCONTENT_QUIET</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">FETCHCONTENT_FULLY_DISCONNECTED</span></code></dt>
...
the configure stage.  It is <code class="docutils literal notranslate"><span class="pre">OFF</span></code> by default.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">FETCHCONTENT_UPDATES_DISCONNECTED</span></code></dt>
...
<code class="docutils literal notranslate"><span class="pre">FETCHCONTENT_FULLY_DISCONNECTED</span></code>.  It is <code class="docutils literal notranslate"><span class="pre">OFF</span></code> by default.</dd>
</dl>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">FETCHCONTENT_SOURCE_DIR_&lt;ucName&gt;</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">FETCHCONTENT_UPDATES_DISCONNECTED_&lt;ucName&gt;</span></code></dt>
...
<code class="docutils literal notranslate"><span class="pre">&lt;name&gt;</span></code> are ignored.</li>
<li>No check is made for whether content for <code class="docutils literal notranslate"><span class="pre">&lt;name&gt;</span></code> has already been
populated.</li>
...
<li>The <code class="docutils literal notranslate"><span class="pre">FETCHCONTENT_FULLY_DISCONNECTED</span></code> and
<code class="docutils literal notranslate"><span class="pre">FETCHCONTENT_UPDATES_DISCONNECTED</span></code> cache variables are ignored.</li>
</ul>
...
<dd>The <code class="docutils literal notranslate"><span class="pre">QUIET</span></code> option can be given to hide the output associated with
...
<dt><code class="docutils literal notranslate"><span class="pre">SUBBUILD_DIR</span></code></dt>
<dd>The <code class="docutils literal notranslate"><span class="pre">SUBBUILD_DIR</span></code> argument can be provided to change the location of the
...
be interpreted as relative to <span class="target" id="index-0-variable:CMAKE_CURRENT_BINARY_DIR"></span><a class="reference internal" href="../variable/CMAKE_CURRENT_BINARY_DIR.html#variable:CMAKE_CURRENT_BINARY_DIR" title="CMAKE_CURRENT_BINARY_DIR"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_CURRENT_BINARY_DIR</span></code></a>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">SOURCE_DIR</span></code>, <code class="docutils literal notranslate"><span class="pre">BINARY_DIR</span></code></dt>
<dd>The <code class="docutils literal notranslate"><span class="pre">SOURCE_DIR</span></code> and <code class="docutils literal notranslate"><span class="pre">BINARY_DIR</span></code> arguments are supported by
...
<ul class="simple">
<li><code class="docutils literal notranslate"><span class="pre">CONFIGURE_COMMAND</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">BUILD_COMMAND</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">INSTALL_COMMAND</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">TEST_COMMAND</span></code></li>
</ul>
...
<code class="descname">FetchContent_MakeAvailable</code><a class="headerlink" href="#command:fetchcontent_makeavailable" title="Permalink to this definition">¶</a></dt>
...
that pattern is that it will only call <span class="target" id="index-3-command:add_subdirectory"></span><a class="reference internal" href="../command/add_subdirectory.html#command:add_subdirectory" title="add_subdirectory"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">add_subdirectory()</span></code></a> on the
...
<ul class="simple">
<li><code class="docutils literal notranslate"><span class="pre">projB</span></code> and <code class="docutils literal notranslate"><span class="pre">projC</span></code> define different content details for <code class="docutils literal notranslate"><span class="pre">projD</span></code>,
...
<li>In the <code class="docutils literal notranslate"><span class="pre">projA</span></code> call to <span class="target" id="index-2-command:fetchcontent_makeavailable"></span><a class="reference internal" href="#command:fetchcontent_makeavailable" title="fetchcontent_makeavailable"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">FetchContent_MakeAvailable()</span></code></a>, <code class="docutils literal notranslate"><span class="pre">projD</span></code>
...
control of how <code class="docutils literal notranslate"><span class="pre">projD</span></code> is populated.</li>
<li>While <code class="docutils literal notranslate"><span class="pre">projA</span></code> defines content details for <code class="docutils literal notranslate"><span class="pre">projE</span></code>, it does not need
...
project hierarchy unnecessarily.</li>
</ul>
