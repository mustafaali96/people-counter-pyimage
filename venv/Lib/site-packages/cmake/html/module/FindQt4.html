...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FindQt4 &mdash; CMake 3.16.1 Documentation</title>
...
<p class="last">When using <span class="target" id="index-1-prop_tgt:IMPORTED"></span><a class="reference internal" href="../prop_tgt/IMPORTED.html#prop_tgt:IMPORTED" title="IMPORTED"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">IMPORTED</span></code></a> targets, the qtmain.lib static library is
...
configuration.</p>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">Qt4::QtCore</span></code></dt>
<dd>The QtCore target</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Qt4::QtGui</span></code></dt>
<dd>The QtGui target</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Qt4::Qt3Support</span></code></dt>
<dd>The Qt3Support target</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Qt4::QtAssistant</span></code></dt>
<dd>The QtAssistant target</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Qt4::QtAssistantClient</span></code></dt>
<dd>The QtAssistantClient target</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Qt4::QAxContainer</span></code></dt>
<dd>The QAxContainer target (Windows only)</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Qt4::QAxServer</span></code></dt>
<dd>The QAxServer target (Windows only)</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Qt4::QtDBus</span></code></dt>
<dd>The QtDBus target</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Qt4::QtDeclarative</span></code></dt>
<dd>The QtDeclarative target</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Qt4::QtDesigner</span></code></dt>
<dd>The QtDesigner target</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Qt4::QtDesignerComponents</span></code></dt>
<dd>The QtDesignerComponents target</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Qt4::QtHelp</span></code></dt>
<dd>The QtHelp target</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Qt4::QtMotif</span></code></dt>
<dd>The QtMotif target</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Qt4::QtMultimedia</span></code></dt>
<dd>The QtMultimedia target</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Qt4::QtNetwork</span></code></dt>
<dd>The QtNetwork target</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Qt4::QtNsPLugin</span></code></dt>
<dd>The QtNsPLugin target</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Qt4::QtOpenGL</span></code></dt>
<dd>The QtOpenGL target</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Qt4::QtScript</span></code></dt>
<dd>The QtScript target</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Qt4::QtScriptTools</span></code></dt>
<dd>The QtScriptTools target</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Qt4::QtSql</span></code></dt>
<dd>The QtSql target</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Qt4::QtSvg</span></code></dt>
<dd>The QtSvg target</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Qt4::QtTest</span></code></dt>
<dd>The QtTest target</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Qt4::QtUiTools</span></code></dt>
<dd>The QtUiTools target</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Qt4::QtWebKit</span></code></dt>
<dd>The QtWebKit target</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Qt4::QtXml</span></code></dt>
<dd>The QtXml target</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Qt4::QtXmlPatterns</span></code></dt>
<dd>The QtXmlPatterns target</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Qt4::phonon</span></code></dt>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">Qt4_FOUND</span></code></dt>
<dd>If false, don’t try to use Qt 4.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">QT_FOUND</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">QT_VERSION_MAJOR</span></code></dt>
<dd>The major version of Qt found.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">QT_VERSION_MINOR</span></code></dt>
<dd>The minor version of Qt found.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">QT_VERSION_PATCH</span></code></dt>
