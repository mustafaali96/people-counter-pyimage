...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FindBISON &mdash; CMake 3.16.1 Documentation</title>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">BISON_EXECUTABLE</span></code></dt>
<dd>path to the <code class="docutils literal notranslate"><span class="pre">bison</span></code> program</dd>
<dt><code class="docutils literal notranslate"><span class="pre">BISON_VERSION</span></code></dt>
<dd>version of <code class="docutils literal notranslate"><span class="pre">bison</span></code></dd>
<dt><code class="docutils literal notranslate"><span class="pre">BISON_FOUND</span></code></dt>
...
<p>The options are:</p>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">COMPILE_FLAGS</span> <span class="pre">&lt;flags&gt;</span></code></dt>
<dd>Specify flags to be added to the <code class="docutils literal notranslate"><span class="pre">bison</span></code> command line.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">DEFINES_FILE</span> <span class="pre">&lt;file&gt;</span></code></dt>
<dd>Specify a non-default header <code class="docutils literal notranslate"><span class="pre">&lt;file&gt;</span></code> to be generated by <code class="docutils literal notranslate"><span class="pre">bison</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">VERBOSE</span> <span class="pre">[&lt;file&gt;]</span></code></dt>
<dd>Tell <code class="docutils literal notranslate"><span class="pre">bison</span></code> to write a report file of the grammar and parser.
If <code class="docutils literal notranslate"><span class="pre">&lt;file&gt;</span></code> is given, it specifies path the report file is copied to.
<code class="docutils literal notranslate"><span class="pre">[&lt;file&gt;]</span></code> is left for backward compatibility of this module.
Use <code class="docutils literal notranslate"><span class="pre">VERBOSE</span> <span class="pre">REPORT_FILE</span> <span class="pre">&lt;file&gt;</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">REPORT_FILE</span> <span class="pre">&lt;file&gt;</span></code></dt>
<dd>Specify a non-default report <code class="docutils literal notranslate"><span class="pre">&lt;file&gt;</span></code>, if generated.</dd>
</dl>
<p>The macro defines the following variables:</p>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">BISON_&lt;Name&gt;_DEFINED</span></code></dt>
<dd><code class="docutils literal notranslate"><span class="pre">True</span></code> is the macro ran successfully</dd>
<dt><code class="docutils literal notranslate"><span class="pre">BISON_&lt;Name&gt;_INPUT</span></code></dt>
<dd>The input source file, an alias for &lt;YaccInput&gt;</dd>
<dt><code class="docutils literal notranslate"><span class="pre">BISON_&lt;Name&gt;_OUTPUT_SOURCE</span></code></dt>
<dd>The source file generated by bison</dd>
<dt><code class="docutils literal notranslate"><span class="pre">BISON_&lt;Name&gt;_OUTPUT_HEADER</span></code></dt>
<dd>The header file generated by bison</dd>
<dt><code class="docutils literal notranslate"><span class="pre">BISON_&lt;Name&gt;_OUTPUTS</span></code></dt>
<dd>All files generated by bison including the source, the header and the report</dd>
<dt><code class="docutils literal notranslate"><span class="pre">BISON_&lt;Name&gt;_COMPILE_FLAGS</span></code></dt>
<dd>Options used in the <code class="docutils literal notranslate"><span class="pre">bison</span></code> command line</dd>
</dl>
<p>Example usage:</p>
