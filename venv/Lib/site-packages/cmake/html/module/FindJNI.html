...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FindJNI &mdash; CMake 3.16.1 Documentation</title>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">JNI_INCLUDE_DIRS</span></code></dt>
<dd>the include dirs to use</dd>
<dt><code class="docutils literal notranslate"><span class="pre">JNI_LIBRARIES</span></code></dt>
<dd>the libraries to use (JAWT and JVM)</dd>
<dt><code class="docutils literal notranslate"><span class="pre">JNI_FOUND</span></code></dt>
<dd>TRUE if JNI headers and libraries were found.</dd>
</dl>
</div>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">JAVA_AWT_LIBRARY</span></code></dt>
<dd>the path to the Java AWT Native Interface (JAWT) library</dd>
<dt><code class="docutils literal notranslate"><span class="pre">JAVA_JVM_LIBRARY</span></code></dt>
<dd>the path to the Java Virtual Machine (JVM) library</dd>
<dt><code class="docutils literal notranslate"><span class="pre">JAVA_INCLUDE_PATH</span></code></dt>
<dd>the include path to jni.h</dd>
<dt><code class="docutils literal notranslate"><span class="pre">JAVA_INCLUDE_PATH2</span></code></dt>
<dd>the include path to jni_md.h and jniport.h</dd>
<dt><code class="docutils literal notranslate"><span class="pre">JAVA_AWT_INCLUDE_PATH</span></code></dt>
<dd>the include path to jawt.h</dd>
</dl>
</div>
</div>
