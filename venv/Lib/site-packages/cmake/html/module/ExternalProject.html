...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>ExternalProject &mdash; CMake 3.16.1 Documentation</title>
...
<ul class="simple">
<li><a class="reference internal" href="#externalproject" id="id1">ExternalProject</a><ul>
<li><a class="reference internal" href="#external-project-definition" id="id2">External Project Definition</a></li>
<li><a class="reference internal" href="#obtaining-project-properties" id="id3">Obtaining Project Properties</a></li>
<li><a class="reference internal" href="#explicit-step-management" id="id4">Explicit Step Management</a></li>
...
<h2><a class="toc-backref" href="#id2">External Project Definition</a><a class="headerlink" href="#external-project-definition" title="Permalink to this headline">¶</a></h2>
<dl class="command">
...
<dd><p class="first">Most of the time, the default directory layout is sufficient. It is largely
...
external project.</p>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">PREFIX</span> <span class="pre">&lt;dir&gt;</span></code></dt>
<dd>Root directory for the external project. Unless otherwise noted below,
all other directories associated with the external project will be
created under here.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">TMP_DIR</span> <span class="pre">&lt;dir&gt;</span></code></dt>
<dd>Directory in which to store temporary files.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">STAMP_DIR</span> <span class="pre">&lt;dir&gt;</span></code></dt>
<dd>Directory in which to store the timestamps of each step. Log files from
individual steps are also created in here unless overridden by LOG_DIR
(see <em>Logging Options</em> below).</dd>
<dt><code class="docutils literal notranslate"><span class="pre">LOG_DIR</span> <span class="pre">&lt;dir&gt;</span></code></dt>
<dd>Directory in which to store the logs of each step.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">DOWNLOAD_DIR</span> <span class="pre">&lt;dir&gt;</span></code></dt>
<dd>Directory in which to store downloaded files before unpacking them. This
directory is only used by the URL download method, all other download
methods use <code class="docutils literal notranslate"><span class="pre">SOURCE_DIR</span></code> directly instead.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">SOURCE_DIR</span> <span class="pre">&lt;dir&gt;</span></code></dt>
<dd><p class="first">Source directory into which downloaded contents will be unpacked, or for
...
<p class="last">If a download method is specified, any existing contents of the source
...
<dt><code class="docutils literal notranslate"><span class="pre">BINARY_DIR</span> <span class="pre">&lt;dir&gt;</span></code></dt>
<dd>Specify the build directory location. This option is ignored if
<code class="docutils literal notranslate"><span class="pre">BUILD_IN_SOURCE</span></code> is enabled.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">INSTALL_DIR</span> <span class="pre">&lt;dir&gt;</span></code></dt>
<dd>Installation prefix to be placed in the <code class="docutils literal notranslate"><span class="pre">&lt;INSTALL_DIR&gt;</span></code> placeholder.
...
to the external project configuration step, e.g. using <code class="docutils literal notranslate"><span class="pre">&lt;INSTALL_DIR&gt;</span></code>.</dd>
</dl>
...
<p class="last">If no <code class="docutils literal notranslate"><span class="pre">PREFIX</span></code>, <code class="docutils literal notranslate"><span class="pre">EP_PREFIX</span></code>, or <code class="docutils literal notranslate"><span class="pre">EP_BASE</span></code> is specified, then the
...
<dd><p class="first">A download method can be omitted if the <code class="docutils literal notranslate"><span class="pre">SOURCE_DIR</span></code> option is used to
...
<dt><code class="docutils literal notranslate"><span class="pre">DOWNLOAD_COMMAND</span> <span class="pre">&lt;cmd&gt;...</span></code></dt>
<dd>Overrides the command used for the download step
...
the download step.</dd>
<dt><em>URL Download</em></dt>
<dd><dl class="first last docutils">
<dt><code class="docutils literal notranslate"><span class="pre">URL</span> <span class="pre">&lt;url1&gt;</span> <span class="pre">[&lt;url2&gt;...]</span></code></dt>
<dd>List of paths and/or URL(s) of the external project’s source. When more
...
based on the file extension.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">URL_HASH</span> <span class="pre">&lt;algo&gt;=&lt;hashValue&gt;</span></code></dt>
<dd>Hash of the archive file to be downloaded. The argument should be of
...
an earlier download that matches the specified hash.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">URL_MD5</span> <span class="pre">&lt;md5&gt;</span></code></dt>
<dd>Equivalent to <code class="docutils literal notranslate"><span class="pre">URL_HASH</span> <span class="pre">MD5=&lt;md5&gt;</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">DOWNLOAD_NAME</span> <span class="pre">&lt;fname&gt;</span></code></dt>
<dd>File name to use for the downloaded file. If not given, the end of the
...
of code internal to the <code class="docutils literal notranslate"><span class="pre">ExternalProject</span></code> module.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">DOWNLOAD_NO_EXTRACT</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>Allows the extraction part of the download step to be disabled by
...
<dt><code class="docutils literal notranslate"><span class="pre">DOWNLOAD_NO_PROGRESS</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>Can be used to disable logging the download progress. If this option is
not given, download progress messages will be logged.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">TIMEOUT</span> <span class="pre">&lt;seconds&gt;</span></code></dt>
<dd>Maximum time allowed for file download operations.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">HTTP_USERNAME</span> <span class="pre">&lt;username&gt;</span></code></dt>
<dd>Username for the download operation if authentication is required.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">HTTP_PASSWORD</span> <span class="pre">&lt;password&gt;</span></code></dt>
<dd>Password for the download operation if authentication is required.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">HTTP_HEADER</span> <span class="pre">&lt;header1&gt;</span> <span class="pre">[&lt;header2&gt;...]</span></code></dt>
<dd>Provides an arbitrary list of HTTP headers for the download operation.
This can be useful for accessing content in systems like AWS, etc.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">TLS_VERIFY</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>Specifies whether certificate verification should be performed for
https URLs. If this option is not provided, the default behavior is
determined by the <code class="docutils literal notranslate"><span class="pre">CMAKE_TLS_VERIFY</span></code> variable (see
...
<dd>Specify a custom certificate authority file to use if <code class="docutils literal notranslate"><span class="pre">TLS_VERIFY</span></code>
...
<span class="target" id="index-3-command:file"></span><a class="reference internal" href="../command/file.html#command:file" title="file"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">file(DOWNLOAD)</span></code></a>)</dd>
<dt><code class="docutils literal notranslate"><span class="pre">NETRC</span> <span class="pre">&lt;level&gt;</span></code></dt>
<dd><p class="first">Specify whether the <code class="docutils literal notranslate"><span class="pre">.netrc</span></code> file is to be used for operation.
...
<dd>The <code class="docutils literal notranslate"><span class="pre">.netrc</span></code> file is ignored.
This is the default.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">OPTIONAL</span></code></dt>
<dd>The <code class="docutils literal notranslate"><span class="pre">.netrc</span></code> file is optional, and information in the URL
is preferred.  The file will be scanned to find which ever
information is not specified in the URL.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">REQUIRED</span></code></dt>
<dd>The <code class="docutils literal notranslate"><span class="pre">.netrc</span></code> file is required, and information in the URL
is ignored.</dd>
</dl>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">NETRC_FILE</span> <span class="pre">&lt;file&gt;</span></code></dt>
<dd>Specify an alternative <code class="docutils literal notranslate"><span class="pre">.netrc</span></code> file to the one in your home directory
...
be used instead (see <span class="target" id="index-5-command:file"></span><a class="reference internal" href="../command/file.html#command:file" title="file"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">file(DOWNLOAD)</span></code></a>)</dd>
</dl>
</dd>
<dt><em>Git</em></dt>
<dd><p class="first">NOTE: A git version of 1.6.5 or later is required if this download method
is used.</p>
<dl class="last docutils">
<dt><code class="docutils literal notranslate"><span class="pre">GIT_REPOSITORY</span> <span class="pre">&lt;url&gt;</span></code></dt>
<dd>URL of the git repository. Any URL understood by the <code class="docutils literal notranslate"><span class="pre">git</span></code> command
may be used.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">GIT_TAG</span> <span class="pre">&lt;tag&gt;</span></code></dt>
<dd><p class="first">Git branch name, tag or commit hash. Note that branch names and tags
...
<ul class="simple">
<li>If the local clone already has the commit corresponding to the hash,
...
external projects are being used.</li>
<li>Using a specific git hash ensures that the main project’s own history
...
traceability and repeatability.</li>
</ul>
<p class="last">If <code class="docutils literal notranslate"><span class="pre">GIT_SHALLOW</span></code> is enabled then <code class="docutils literal notranslate"><span class="pre">GIT_TAG</span></code> works only with
branch names and tags.  A commit hash is not allowed.</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">GIT_REMOTE_NAME</span> <span class="pre">&lt;name&gt;</span></code></dt>
<dd>The optional name of the remote. If this option is not specified, it
defaults to <code class="docutils literal notranslate"><span class="pre">origin</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">GIT_SUBMODULES</span> <span class="pre">&lt;module&gt;...</span></code></dt>
<dd>Specific git submodules that should also be updated. If this option is
not provided, all git submodules will be updated. When <span class="target" id="index-0-policy:CMP0097"></span><a class="reference internal" href="../policy/CMP0097.html#policy:CMP0097" title="CMP0097"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0097</span></code></a>
is set to <code class="docutils literal notranslate"><span class="pre">NEW</span></code> if this value is set to an empty string then no submodules
are initialized or updated.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">GIT_SHALLOW</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>When this option is enabled, the <code class="docutils literal notranslate"><span class="pre">git</span> <span class="pre">clone</span></code> operation will be given
...
denoted by the <code class="docutils literal notranslate"><span class="pre">GIT_TAG</span></code> option.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">GIT_PROGRESS</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>When enabled, this option instructs the <code class="docutils literal notranslate"><span class="pre">git</span> <span class="pre">clone</span></code> operation to
...
overly noisy if lots of external projects are used.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">GIT_CONFIG</span> <span class="pre">&lt;option1&gt;</span> <span class="pre">[&lt;option2&gt;...]</span></code></dt>
<dd>Specify a list of config options to pass to <code class="docutils literal notranslate"><span class="pre">git</span> <span class="pre">clone</span></code>. Each option
...
form <code class="docutils literal notranslate"><span class="pre">key=value</span></code>.</dd>
</dl>
</dd>
<dt><em>Subversion</em></dt>
<dd><dl class="first last docutils">
<dt><code class="docutils literal notranslate"><span class="pre">SVN_REPOSITORY</span> <span class="pre">&lt;url&gt;</span></code></dt>
<dd>URL of the Subversion repository.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">SVN_REVISION</span> <span class="pre">-r&lt;rev&gt;</span></code></dt>
<dd>Revision to checkout from the Subversion repository.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">SVN_USERNAME</span> <span class="pre">&lt;username&gt;</span></code></dt>
<dd>Username for the Subversion checkout and update.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">SVN_PASSWORD</span> <span class="pre">&lt;password&gt;</span></code></dt>
<dd>Password for the Subversion checkout and update.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">SVN_TRUST_CERT</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>Specifies whether to trust the Subversion server site certificate. If
...
checkout and update commands.</dd>
</dl>
</dd>
<dt><em>Mercurial</em></dt>
<dd><dl class="first last docutils">
<dt><code class="docutils literal notranslate"><span class="pre">HG_REPOSITORY</span> <span class="pre">&lt;url&gt;</span></code></dt>
<dd>URL of the mercurial repository.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">HG_TAG</span> <span class="pre">&lt;tag&gt;</span></code></dt>
<dd>Mercurial branch name, tag or commit id.</dd>
</dl>
</dd>
<dt><em>CVS</em></dt>
<dd><dl class="first last docutils">
<dt><code class="docutils literal notranslate"><span class="pre">CVS_REPOSITORY</span> <span class="pre">&lt;cvsroot&gt;</span></code></dt>
<dd>CVSROOT of the CVS repository.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">CVS_MODULE</span> <span class="pre">&lt;mod&gt;</span></code></dt>
<dd>Module to checkout from the CVS repository.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">CVS_TAG</span> <span class="pre">&lt;tag&gt;</span></code></dt>
<dd>Tag to checkout from the CVS repository.</dd>
</dl>
</dd>
</dl>
</dd>
<dt><strong>Update/Patch Step Options:</strong></dt>
<dd><p class="first">Whenever CMake is re-run, by default the external project’s sources will be
...
<dl class="last docutils">
<dt><code class="docutils literal notranslate"><span class="pre">UPDATE_COMMAND</span> <span class="pre">&lt;cmd&gt;...</span></code></dt>
<dd>Overrides the download method’s update step with a custom command.
The command may use
<span class="target" id="index-1-manual:cmake-generator-expressions(7)"></span><a class="reference internal" href="../manual/cmake-generator-expressions.7.html#manual:cmake-generator-expressions(7)" title="cmake-generator-expressions(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">generator</span> <span class="pre">expressions</span></code></a>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">UPDATE_DISCONNECTED</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd><p class="first">When enabled, this option causes the update step to be skipped. It does
...
<p class="last">When this option is present, it is generally advisable to make the value
...
<dt><code class="docutils literal notranslate"><span class="pre">PATCH_COMMAND</span> <span class="pre">&lt;cmd&gt;...</span></code></dt>
<dd>Specifies a custom command to patch the sources after an update. By
...
called again after updating to the new tag.</dd>
</dl>
</dd>
<dt><strong>Configure Step Options:</strong></dt>
<dd><p class="first">The configure step is run after the download and update steps. By default,
the external project is assumed to be a CMake project, but this can be
overridden if required.</p>
<dl class="last docutils">
<dt><code class="docutils literal notranslate"><span class="pre">CONFIGURE_COMMAND</span> <span class="pre">&lt;cmd&gt;...</span></code></dt>
<dd>The default configure command runs CMake with options based on the main
project. For non-CMake external projects, the <code class="docutils literal notranslate"><span class="pre">CONFIGURE_COMMAND</span></code>
...
option with an empty string as the command to execute.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">CMAKE_COMMAND</span> <span class="pre">/.../cmake</span></code></dt>
<dd>Specify an alternative cmake executable for the configure step (use an
...
specified with <code class="docutils literal notranslate"><span class="pre">CONFIGURE_COMMAND</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">CMAKE_GENERATOR</span> <span class="pre">&lt;gen&gt;</span></code></dt>
<dd>Override the CMake generator used for the configure step. Without this
...
<code class="docutils literal notranslate"><span class="pre">CONFIGURE_COMMAND</span></code> option.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">CMAKE_GENERATOR_PLATFORM</span> <span class="pre">&lt;platform&gt;</span></code></dt>
<dd>Pass a generator-specific platform name to the CMake command (see
...
option without the <code class="docutils literal notranslate"><span class="pre">CMAKE_GENERATOR</span></code> option.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">CMAKE_GENERATOR_TOOLSET</span> <span class="pre">&lt;toolset&gt;</span></code></dt>
<dd>Pass a generator-specific toolset name to the CMake command (see
...
option without the <code class="docutils literal notranslate"><span class="pre">CMAKE_GENERATOR</span></code> option.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">CMAKE_GENERATOR_INSTANCE</span> <span class="pre">&lt;instance&gt;</span></code></dt>
<dd>Pass a generator-specific instance selection to the CMake command (see
...
option without the <code class="docutils literal notranslate"><span class="pre">CMAKE_GENERATOR</span></code> option.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">CMAKE_ARGS</span> <span class="pre">&lt;arg&gt;...</span></code></dt>
<dd>The specified arguments are passed to the <code class="docutils literal notranslate"><span class="pre">cmake</span></code> command line. They
...
<span class="target" id="index-0-manual:cmake(1)"></span><a class="reference internal" href="../manual/cmake.1.html#manual:cmake(1)" title="cmake(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">CMake</span> <span class="pre">Options</span></code></a>). In addition, arguments may use
<span class="target" id="index-3-manual:cmake-generator-expressions(7)"></span><a class="reference internal" href="../manual/cmake-generator-expressions.7.html#manual:cmake-generator-expressions(7)" title="cmake-generator-expressions(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">generator</span> <span class="pre">expressions</span></code></a>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">CMAKE_CACHE_ARGS</span> <span class="pre">&lt;arg&gt;...</span></code></dt>
<dd>This is an alternate way of specifying cache variables where command line
...
using the <span class="target" id="index-1-manual:cmake(1)"></span><a class="reference internal" href="../manual/cmake.1.html#manual:cmake(1)" title="cmake(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake</span> <span class="pre">-C</span></code></a> command line option. Arguments
may use <span class="target" id="index-4-manual:cmake-generator-expressions(7)"></span><a class="reference internal" href="../manual/cmake-generator-expressions.7.html#manual:cmake-generator-expressions(7)" title="cmake-generator-expressions(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">generator</span> <span class="pre">expressions</span></code></a>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">CMAKE_CACHE_DEFAULT_ARGS</span> <span class="pre">&lt;arg&gt;...</span></code></dt>
<dd><p class="first">This is the same as the <code class="docutils literal notranslate"><span class="pre">CMAKE_CACHE_ARGS</span></code> option except the <code class="docutils literal notranslate"><span class="pre">set()</span></code>
...
<p class="last">If the CMake generator is the <code class="docutils literal notranslate"><span class="pre">Green</span> <span class="pre">Hills</span> <span class="pre">MULTI</span></code> and not overridden then
...
<dt><code class="docutils literal notranslate"><span class="pre">SOURCE_SUBDIR</span> <span class="pre">&lt;dir&gt;</span></code></dt>
<dd>When no <code class="docutils literal notranslate"><span class="pre">CONFIGURE_COMMAND</span></code> option is specified, the configure step
...
<code class="docutils literal notranslate"><span class="pre">SOURCE_DIR</span></code>.  When <code class="docutils literal notranslate"><span class="pre">BUILD_IN_SOURCE</span> <span class="pre">1</span></code> is specified, the
<code class="docutils literal notranslate"><span class="pre">BUILD_COMMAND</span></code> is used to point to an alternative directory within the
source tree.</dd>
</dl>
</dd>
<dt><strong>Build Step Options:</strong></dt>
<dd><p class="first">If the configure step assumed the external project uses CMake as its build
...
required.</p>
<dl class="last docutils">
<dt><code class="docutils literal notranslate"><span class="pre">BUILD_COMMAND</span> <span class="pre">&lt;cmd&gt;...</span></code></dt>
<dd>Overrides the default build command
...
nothing.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">BUILD_IN_SOURCE</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>When this option is enabled, the build will be done directly within the
...
option should not be specified if building in-source.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">BUILD_ALWAYS</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>Enabling this option forces the build step to always be run. This can be
...
developers might modify the sources in <code class="docutils literal notranslate"><span class="pre">SOURCE_DIR</span></code>).</dd>
<dt><code class="docutils literal notranslate"><span class="pre">BUILD_BYPRODUCTS</span> <span class="pre">&lt;file&gt;...</span></code></dt>
<dd>Specifies files that will be generated by the build command but which
...
<dl class="last docutils">
<dt><code class="docutils literal notranslate"><span class="pre">INSTALL_COMMAND</span> <span class="pre">&lt;cmd&gt;...</span></code></dt>
<dd>The external project’s own install step is invoked as part of the main
...
<dd><p class="first">The test step is only defined if at least one of the following <code class="docutils literal notranslate"><span class="pre">TEST_...</span></code>
options are provided.</p>
<dl class="last docutils">
<dt><code class="docutils literal notranslate"><span class="pre">TEST_COMMAND</span> <span class="pre">&lt;cmd&gt;...</span></code></dt>
<dd>Overrides the default test command
...
test step target is not needed.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">TEST_BEFORE_INSTALL</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>When this option is enabled, the test step will be executed before the
install step. The default behavior is for the test step to run after the
install step.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">TEST_AFTER_INSTALL</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>This option is mainly useful as a way to indicate that the test step is
...
<code class="docutils literal notranslate"><span class="pre">TEST_AFTER_INSTALL</span></code> are enabled, the latter is silently ignored.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">TEST_EXCLUDE_FROM_MAIN</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>If enabled, the main build’s default ALL target will not depend on the
test step. This can be a useful way of ensuring the test step is defined
but only gets invoked when manually requested.</dd>
</dl>
</dd>
<dt><strong>Output Logging Options:</strong></dt>
<dd><p class="first">Each of the following <code class="docutils literal notranslate"><span class="pre">LOG_...</span></code> options can be used to wrap the relevant
...
<dl class="last docutils">
<dt><code class="docutils literal notranslate"><span class="pre">LOG_DOWNLOAD</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>When enabled, the output of the download step is logged to files.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">LOG_UPDATE</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>When enabled, the output of the update step is logged to files.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">LOG_PATCH</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>When enabled, the output of the patch step is logged to files.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">LOG_CONFIGURE</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>When enabled, the output of the configure step is logged to files.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">LOG_BUILD</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>When enabled, the output of the build step is logged to files.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">LOG_INSTALL</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>When enabled, the output of the install step is logged to files.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">LOG_TEST</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>When enabled, the output of the test step is logged to files.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">LOG_MERGED_STDOUTERR</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>When enabled, stdout and stderr will be merged for any step whose
output is being logged to files.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">LOG_OUTPUT_ON_FAILURE</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>This option only has an effect if at least one of the other <code class="docutils literal notranslate"><span class="pre">LOG_&lt;step&gt;</span></code>
...
<dd><p class="first">Steps can be given direct access to the terminal in some cases. Giving a
...
<dl class="last docutils">
<dt><code class="docutils literal notranslate"><span class="pre">USES_TERMINAL_DOWNLOAD</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>Give the download step access to the terminal.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">USES_TERMINAL_UPDATE</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>Give the update step access to the terminal.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">USES_TERMINAL_CONFIGURE</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>Give the configure step access to the terminal.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">USES_TERMINAL_BUILD</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>Give the build step access to the terminal.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">USES_TERMINAL_INSTALL</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>Give the install step access to the terminal.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">USES_TERMINAL_TEST</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>Give the test step access to the terminal.</dd>
</dl>
</dd>
<dt><strong>Target Options:</strong></dt>
<dd><dl class="first last docutils">
<dt><code class="docutils literal notranslate"><span class="pre">DEPENDS</span> <span class="pre">&lt;targets&gt;...</span></code></dt>
<dd>Specify other targets on which the external project depends. The other
...
not make any of the steps dependent on <code class="docutils literal notranslate"><span class="pre">&lt;targets&gt;</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">EXCLUDE_FROM_ALL</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>When enabled, this option excludes the external project from the default
ALL target of the main build.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">STEP_TARGETS</span> <span class="pre">&lt;step-target&gt;...</span></code></dt>
<dd>Generate custom targets for the specified steps. This is required if the
...
See <span class="target" id="index-0-command:externalproject_add_step"></span><a class="reference internal" href="#command:externalproject_add_step" title="externalproject_add_step"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">ExternalProject_Add_Step()</span></code></a> below for further discussion of
the effects of this option.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">INDEPENDENT_STEP_TARGETS</span> <span class="pre">&lt;step-target&gt;...</span></code></dt>
<dd>Generate custom targets for the specified steps and prevent these targets
...
<span class="target" id="index-1-command:externalproject_add_step"></span><a class="reference internal" href="#command:externalproject_add_step" title="externalproject_add_step"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">ExternalProject_Add_Step()</span></code></a> below for further discussion of the
effects of this option.</dd>
</dl>
</dd>
<dt><strong>Miscellaneous Options:</strong></dt>
<dd><dl class="first last docutils">
<dt><code class="docutils literal notranslate"><span class="pre">LIST_SEPARATOR</span> <span class="pre">&lt;sep&gt;</span></code></dt>
<dd>For any of the various <code class="docutils literal notranslate"><span class="pre">..._COMMAND</span></code> options, replace <code class="docutils literal notranslate"><span class="pre">;</span></code> with
...
<dt><code class="docutils literal notranslate"><span class="pre">COMMAND</span> <span class="pre">&lt;cmd&gt;...</span></code></dt>
<dd><p class="first">Any of the other <code class="docutils literal notranslate"><span class="pre">..._COMMAND</span></code> options can have additional commands
...
<div class="last highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">ExternalProject_Add(</span><span class="nb">example</span><span class="w"></span>
...
<h2><a class="toc-backref" href="#id3">Obtaining Project Properties</a><a class="headerlink" href="#obtaining-project-properties" title="Permalink to this headline">¶</a></h2>
<dl class="command">
...
<h2><a class="toc-backref" href="#id4">Explicit Step Management</a><a class="headerlink" href="#explicit-step-management" title="Permalink to this headline">¶</a></h2>
...
the pre-defined steps (<code class="docutils literal notranslate"><span class="pre">mkdir</span></code>, <code class="docutils literal notranslate"><span class="pre">download</span></code>, <code class="docutils literal notranslate"><span class="pre">update</span></code>, <code class="docutils literal notranslate"><span class="pre">skip-update</span></code>,
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">COMMAND</span> <span class="pre">&lt;cmd&gt;...</span></code></dt>
<dd>The command line to be executed by this custom step
(<span class="target" id="index-9-manual:cmake-generator-expressions(7)"></span><a class="reference internal" href="../manual/cmake-generator-expressions.7.html#manual:cmake-generator-expressions(7)" title="cmake-generator-expressions(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">generator</span> <span class="pre">expressions</span></code></a> are
supported). This option can be repeated multiple times to specify multiple
commands to be executed in order.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">COMMENT</span> <span class="pre">&quot;&lt;text&gt;...&quot;</span></code></dt>
<dd>Text to be printed when the custom step executes.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">DEPENDEES</span> <span class="pre">&lt;step&gt;...</span></code></dt>
<dd>Other steps (custom or pre-defined) on which this step depends.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">DEPENDERS</span> <span class="pre">&lt;step&gt;...</span></code></dt>
<dd>Other steps (custom or pre-defined) that depend on this new custom step.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">DEPENDS</span> <span class="pre">&lt;file&gt;...</span></code></dt>
<dd>Files on which this custom step depends.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">BYPRODUCTS</span> <span class="pre">&lt;file&gt;...</span></code></dt>
<dd>Files that will be generated by this custom step but which might or might
...
<span class="target" id="index-1-command:add_custom_command"></span><a class="reference internal" href="../command/add_custom_command.html#command:add_custom_command" title="add_custom_command"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">add_custom_command()</span></code></a> used to implement the custom step internally.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">ALWAYS</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>When enabled, this option specifies that the custom step should always be
run (i.e. that it is always considered out of date).</dd>
<dt><code class="docutils literal notranslate"><span class="pre">EXCLUDE_FROM_MAIN</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>When enabled, this option specifies that the external project’s main target
does not depend on the custom step.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">WORKING_DIRECTORY</span> <span class="pre">&lt;dir&gt;</span></code></dt>
<dd>Specifies the working directory to set before running the custom step’s
...
<code class="docutils literal notranslate"><span class="pre">ExternalProject_Add_Step()</span></code> was called.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">LOG</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>If set, this causes the output from the custom step to be captured to files
in the external project’s <code class="docutils literal notranslate"><span class="pre">LOG_DIR</span></code> if supplied or <code class="docutils literal notranslate"><span class="pre">STAMP_DIR</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">USES_TERMINAL</span> <span class="pre">&lt;bool&gt;</span></code></dt>
<dd>If enabled, this gives the custom step direct access to the terminal if
possible.</dd>
</dl>
...
<span class="target" id="index-2-command:externalproject_add"></span><a class="reference internal" href="#command:externalproject_add" title="externalproject_add"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">ExternalProject_Add()</span></code></a>.</p>
</dd></dl>
...
<p>If the <code class="docutils literal notranslate"><span class="pre">NO_DEPENDS</span></code> option is specified, the step target will not depend on
the dependencies of the external project (i.e. on any dependencies of the
<code class="docutils literal notranslate"><span class="pre">&lt;name&gt;</span></code> custom target created by <span class="target" id="index-3-command:externalproject_add"></span><a class="reference internal" href="#command:externalproject_add" title="externalproject_add"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">ExternalProject_Add()</span></code></a>). This is
...
and installed.</p>
<p>Internally, <span class="target" id="index-4-command:externalproject_add"></span><a class="reference internal" href="#command:externalproject_add" title="externalproject_add"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">ExternalProject_Add()</span></code></a> calls
<span class="target" id="index-3-command:externalproject_add_step"></span><a class="reference internal" href="#command:externalproject_add_step" title="externalproject_add_step"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">ExternalProject_Add_Step()</span></code></a> to create each step. If any
<code class="docutils literal notranslate"><span class="pre">STEP_TARGETS</span></code> or <code class="docutils literal notranslate"><span class="pre">INDEPENDENT_STEP_TARGETS</span></code> were specified, then
<code class="docutils literal notranslate"><span class="pre">ExternalProject_Add_StepTargets()</span></code> will also be called after
<span class="target" id="index-4-command:externalproject_add_step"></span><a class="reference internal" href="#command:externalproject_add_step" title="externalproject_add_step"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">ExternalProject_Add_Step()</span></code></a>. <code class="docutils literal notranslate"><span class="pre">INDEPENDENT_STEP_TARGETS</span></code> have the
<code class="docutils literal notranslate"><span class="pre">NO_DEPENDS</span></code> option set, whereas <code class="docutils literal notranslate"><span class="pre">STEP_TARGETS</span></code> do not. Other than that,
the two options result in <code class="docutils literal notranslate"><span class="pre">ExternalProject_Add_StepTargets()</span></code> being called
in the same way. Even if a step is not mentioned in either of those two
options, <code class="docutils literal notranslate"><span class="pre">ExternalProject_Add_StepTargets()</span></code> can still be called later to
manually define a target for the step.</p>
<p>The <code class="docutils literal notranslate"><span class="pre">STEP_TARGETS</span></code> and <code class="docutils literal notranslate"><span class="pre">INDEPENDENT_STEP_TARGETS</span></code> options for
<span class="target" id="index-5-command:externalproject_add"></span><a class="reference internal" href="#command:externalproject_add" title="externalproject_add"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">ExternalProject_Add()</span></code></a> are generally the easiest way to ensure
targets are created for specific steps of interest. For custom steps,
<code class="docutils literal notranslate"><span class="pre">ExternalProject_Add_StepTargets()</span></code> must be called explicitly if a target
should also be created for that custom step. An alternative to these two
options is to populate the <code class="docutils literal notranslate"><span class="pre">EP_STEP_TARGETS</span></code> and
<code class="docutils literal notranslate"><span class="pre">EP_INDEPENDENT_STEP_TARGETS</span></code> directory properties. These act as defaults
for the step target options and can save having to repeatedly specify the
same set of step targets when multiple external projects are being defined.</p>
</dd></dl>
...
<dd><p>The <code class="docutils literal notranslate"><span class="pre">ExternalProject_Add_StepDependencies()</span></code> function can be used to add
...
before creating the external projects with <span class="target" id="index-6-command:externalproject_add"></span><a class="reference internal" href="#command:externalproject_add" title="externalproject_add"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">ExternalProject_Add()</span></code></a>:</p>
