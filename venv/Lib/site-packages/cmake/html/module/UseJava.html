...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>UseJava &mdash; CMake 3.16.1 Documentation</title>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">INSTALL_FILES</span></code></dt>
<dd>The files which should be installed.  This is used by <code class="docutils literal notranslate"><span class="pre">install_jar()</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">JNI_SYMLINK</span></code></dt>
<dd>The JNI symlink which should be installed.  This is used by
<code class="docutils literal notranslate"><span class="pre">install_jni_symlink()</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">JAR_FILE</span></code></dt>
<dd>The location of the jar file so that you can include it.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">CLASSDIR</span></code></dt>
<dd>The directory where the class files can be found.  For example to use them
with <code class="docutils literal notranslate"><span class="pre">javah</span></code>.</dd>
</dl>
...
<p><span class="versionmodified">Deprecated since version 3.11.</span></p>
</div>
<div class="admonition note">
<p class="first admonition-title">Note</p>
<p class="last">This command will no longer be supported starting with version 10 of the JDK
...
<dd>Specifies various paths to look up classes. Here .class files, jar files or
targets created by command add_jar can be used.</dd>
...
<dd>Concatenates the resulting header files for all the classes listed by option
<code class="docutils literal notranslate"><span class="pre">CLASSES</span></code> into <code class="docutils literal notranslate"><span class="pre">&lt;path&gt;</span></code>.  Same behavior as option <code class="docutils literal notranslate"><span class="pre">-o</span></code> of javah tool.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">OUTPUT_DIR</span> <span class="pre">&lt;path&gt;</span></code></dt>
<dd>Sets the directory where the header files will be generated.  Same behavior
as option <code class="docutils literal notranslate"><span class="pre">-d</span></code> of javah tool.  If not specified,
<span class="target" id="index-0-variable:CMAKE_CURRENT_BINARY_DIR"></span><a class="reference internal" href="../variable/CMAKE_CURRENT_BINARY_DIR.html#variable:CMAKE_CURRENT_BINARY_DIR" title="CMAKE_CURRENT_BINARY_DIR"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_CURRENT_BINARY_DIR</span></code></a> is used as the output directory.</dd>
</dl>
</div>
</div>
