...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMakeFindDependencyMacro &mdash; CMake 3.16.1 Documentation</title>
...
<code class="descname">find_dependency</code><a class="headerlink" href="#command:find_dependency" title="Permalink to this definition">¶</a></dt>
...
<p class="last">The call to <span class="target" id="index-1-command:return"></span><a class="reference internal" href="../command/return.html#command:return" title="return"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">return()</span></code></a> makes this macro unsuitable to call
