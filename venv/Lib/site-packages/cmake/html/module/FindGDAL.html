...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FindGDAL &mdash; CMake 3.16.1 Documentation</title>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">GDAL_FOUND</span></code></dt>
<dd>True if GDAL is found.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">GDAL_INCLUDE_DIRS</span></code></dt>
<dd>Include directories for GDAL headers.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">GDAL_LIBRARIES</span></code></dt>
<dd>Libraries to link to GDAL.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">GDAL_VERSION</span></code></dt>
<dd>The version of GDAL found.</dd>
</dl>
</div>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">GDAL_LIBRARY</span></code></dt>
<dd>The libgdal library file.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">GDAL_INCLUDE_DIR</span></code></dt>
<dd>The directory containing <code class="docutils literal notranslate"><span class="pre">gdal.h</span></code>.</dd>
</dl>
</div>
