...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CheckFortranSourceRuns &mdash; CMake 3.16.1 Documentation</title>
...
<code class="descname">check_fortran_source_runs</code><a class="headerlink" href="#command:check_fortran_source_runs" title="Permalink to this definition">¶</a></dt>
...
command (see <span class="target" id="index-1-command:try_run"></span><a class="reference internal" href="../command/try_run.html#command:try_run" title="try_run"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">try_run()</span></code></a> for further details).</dd>
