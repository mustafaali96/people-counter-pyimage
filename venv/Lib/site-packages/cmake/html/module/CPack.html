...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CPack &mdash; CMake 3.16.1 Documentation</title>
...
<ul class="simple">
<li><span class="target" id="index-2-manual:cpack(1)"></span><a class="reference internal" href="../manual/cpack.1.html#manual:cpack(1)" title="cpack(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cpack</span></code></a> runs</li>
<li>it includes <code class="docutils literal notranslate"><span class="pre">CPackConfig.cmake</span></code></li>
<li>it iterates over the generators given by the <code class="docutils literal notranslate"><span class="pre">-G</span></code> command line option,
...
<li>sets <span class="target" id="index-4-variable:CPACK_GENERATOR"></span><a class="reference internal" href="#variable:CPACK_GENERATOR" title="CPACK_GENERATOR"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_GENERATOR</span></code></a> to the one currently being iterated</li>
...
<code class="descname">CPACK_PACKAGE_DESCRIPTION</code><a class="headerlink" href="#variable:CPACK_PACKAGE_DESCRIPTION" title="Permalink to this definition">¶</a></dt>
...
<code class="descname">CPACK_PACKAGE_HOMEPAGE_URL</code><a class="headerlink" href="#variable:CPACK_PACKAGE_HOMEPAGE_URL" title="Permalink to this definition">¶</a></dt>
...
<code class="descname">CPACK_INSTALL_SCRIPTS</code><a class="headerlink" href="#variable:CPACK_INSTALL_SCRIPTS" title="Permalink to this definition">¶</a></dt>
