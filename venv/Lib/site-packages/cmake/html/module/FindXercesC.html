...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FindXercesC &mdash; CMake 3.16.1 Documentation</title>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">XercesC::XercesC</span></code></dt>
<dd>The Xerces-C++ <code class="docutils literal notranslate"><span class="pre">xerces-c</span></code> library, if found.</dd>
</dl>
</div>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">XercesC_FOUND</span></code></dt>
<dd>true if the Xerces headers and libraries were found</dd>
<dt><code class="docutils literal notranslate"><span class="pre">XercesC_VERSION</span></code></dt>
<dd>Xerces release version</dd>
<dt><code class="docutils literal notranslate"><span class="pre">XercesC_INCLUDE_DIRS</span></code></dt>
<dd>the directory containing the Xerces headers</dd>
<dt><code class="docutils literal notranslate"><span class="pre">XercesC_LIBRARIES</span></code></dt>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">XercesC_INCLUDE_DIR</span></code></dt>
<dd>the directory containing the Xerces headers</dd>
<dt><code class="docutils literal notranslate"><span class="pre">XercesC_LIBRARY</span></code></dt>
