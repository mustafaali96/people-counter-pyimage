...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FindKDE3 &mdash; CMake 3.16.1 Documentation</title>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">KDE3_DEFINITIONS</span></code></dt>
<dd>compiler definitions required for compiling KDE software</dd>
<dt><code class="docutils literal notranslate"><span class="pre">KDE3_INCLUDE_DIR</span></code></dt>
<dd>the KDE include directory</dd>
<dt><code class="docutils literal notranslate"><span class="pre">KDE3_INCLUDE_DIRS</span></code></dt>
<dd>the KDE and the Qt include directory, for use with include_directories()</dd>
<dt><code class="docutils literal notranslate"><span class="pre">KDE3_LIB_DIR</span></code></dt>
<dd>the directory where the KDE libraries are installed, for use with link_directories()</dd>
<dt><code class="docutils literal notranslate"><span class="pre">QT_AND_KDECORE_LIBS</span></code></dt>
<dd>this contains both the Qt and the kdecore library</dd>
<dt><code class="docutils literal notranslate"><span class="pre">KDE3_DCOPIDL_EXECUTABLE</span></code></dt>
<dd>the dcopidl executable</dd>
<dt><code class="docutils literal notranslate"><span class="pre">KDE3_DCOPIDL2CPP_EXECUTABLE</span></code></dt>
<dd>the dcopidl2cpp executable</dd>
<dt><code class="docutils literal notranslate"><span class="pre">KDE3_KCFGC_EXECUTABLE</span></code></dt>
<dd>the kconfig_compiler executable</dd>
<dt><code class="docutils literal notranslate"><span class="pre">KDE3_FOUND</span></code></dt>
<dd>set to TRUE if all of the above has been found</dd>
</dl>
<p>The following user adjustable options are provided:</p>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">KDE3_BUILD_TESTS</span></code></dt>
