...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FindOpenSceneGraph &mdash; CMake 3.16.1 Documentation</title>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">&lt;MODULE&gt;_DIR</span></code></dt>
<dd>(where <code class="docutils literal notranslate"><span class="pre">MODULE</span></code> is of the form “OSGVOLUME” and there is
a <span class="target" id="index-0-module:FindosgVolume"></span><a class="reference internal" href="FindosgVolume.html#module:FindosgVolume" title="FindosgVolume"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindosgVolume</span></code></a>.cmake` file)</dd>
<dt><code class="docutils literal notranslate"><span class="pre">OSG_DIR</span></code></dt>
<dd></dd>
<dt><code class="docutils literal notranslate"><span class="pre">OSGDIR</span></code></dt>
<dd></dd>
<dt><code class="docutils literal notranslate"><span class="pre">OSG_ROOT</span></code></dt>
<dd></dd>
</dl>
