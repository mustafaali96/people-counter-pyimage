...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>GNUInstallDirs &mdash; CMake 3.16.1 Documentation</title>
...
<blockquote>
<div>The absolute path generated from the corresponding <code class="docutils literal notranslate"><span class="pre">CMAKE_INSTALL_&lt;dir&gt;</span></code>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">BINDIR</span></code></dt>
<dd>user executables (<code class="docutils literal notranslate"><span class="pre">bin</span></code>)</dd>
<dt><code class="docutils literal notranslate"><span class="pre">SBINDIR</span></code></dt>
<dd>system admin executables (<code class="docutils literal notranslate"><span class="pre">sbin</span></code>)</dd>
<dt><code class="docutils literal notranslate"><span class="pre">LIBEXECDIR</span></code></dt>
<dd>program executables (<code class="docutils literal notranslate"><span class="pre">libexec</span></code>)</dd>
<dt><code class="docutils literal notranslate"><span class="pre">SYSCONFDIR</span></code></dt>
<dd>read-only single-machine data (<code class="docutils literal notranslate"><span class="pre">etc</span></code>)</dd>
<dt><code class="docutils literal notranslate"><span class="pre">SHAREDSTATEDIR</span></code></dt>
<dd>modifiable architecture-independent data (<code class="docutils literal notranslate"><span class="pre">com</span></code>)</dd>
<dt><code class="docutils literal notranslate"><span class="pre">LOCALSTATEDIR</span></code></dt>
<dd>modifiable single-machine data (<code class="docutils literal notranslate"><span class="pre">var</span></code>)</dd>
<dt><code class="docutils literal notranslate"><span class="pre">RUNSTATEDIR</span></code></dt>
<dd>run-time variable data (<code class="docutils literal notranslate"><span class="pre">LOCALSTATEDIR/run</span></code>)</dd>
<dt><code class="docutils literal notranslate"><span class="pre">LIBDIR</span></code></dt>
<dd>object code libraries (<code class="docutils literal notranslate"><span class="pre">lib</span></code> or <code class="docutils literal notranslate"><span class="pre">lib64</span></code>
or <code class="docutils literal notranslate"><span class="pre">lib/&lt;multiarch-tuple&gt;</span></code> on Debian)</dd>
<dt><code class="docutils literal notranslate"><span class="pre">INCLUDEDIR</span></code></dt>
<dd>C header files (<code class="docutils literal notranslate"><span class="pre">include</span></code>)</dd>
<dt><code class="docutils literal notranslate"><span class="pre">OLDINCLUDEDIR</span></code></dt>
<dd>C header files for non-gcc (<code class="docutils literal notranslate"><span class="pre">/usr/include</span></code>)</dd>
<dt><code class="docutils literal notranslate"><span class="pre">DATAROOTDIR</span></code></dt>
<dd>read-only architecture-independent data root (<code class="docutils literal notranslate"><span class="pre">share</span></code>)</dd>
<dt><code class="docutils literal notranslate"><span class="pre">DATADIR</span></code></dt>
<dd>read-only architecture-independent data (<code class="docutils literal notranslate"><span class="pre">DATAROOTDIR</span></code>)</dd>
<dt><code class="docutils literal notranslate"><span class="pre">INFODIR</span></code></dt>
<dd>info documentation (<code class="docutils literal notranslate"><span class="pre">DATAROOTDIR/info</span></code>)</dd>
<dt><code class="docutils literal notranslate"><span class="pre">LOCALEDIR</span></code></dt>
<dd>locale-dependent data (<code class="docutils literal notranslate"><span class="pre">DATAROOTDIR/locale</span></code>)</dd>
<dt><code class="docutils literal notranslate"><span class="pre">MANDIR</span></code></dt>
<dd>man documentation (<code class="docutils literal notranslate"><span class="pre">DATAROOTDIR/man</span></code>)</dd>
<dt><code class="docutils literal notranslate"><span class="pre">DOCDIR</span></code></dt>
<dd>documentation root (<code class="docutils literal notranslate"><span class="pre">DATAROOTDIR/doc/PROJECT_NAME</span></code>)</dd>
</dl>
...
and <code class="docutils literal notranslate"><span class="pre">/usr</span></code> will be a symbolic link to <code class="docutils literal notranslate"><span class="pre">/</span></code>.</div></blockquote>
</div></blockquote>
<p><code class="docutils literal notranslate"><span class="pre">/usr</span></code></p>
<blockquote>
<div>For <code class="docutils literal notranslate"><span class="pre">&lt;dir&gt;</span></code> equal to <code class="docutils literal notranslate"><span class="pre">SYSCONFDIR</span></code>, <code class="docutils literal notranslate"><span class="pre">LOCALSTATEDIR</span></code> or
...
This is required by the <a class="reference external" href="https://www.gnu.org/prep/standards/html_node/Directory-Variables.html">GNU Coding Standards</a>.</div></blockquote>
...
This is defined by the <a class="reference external" href="https://refspecs.linuxfoundation.org/FHS_3.0/fhs/index.html">Filesystem Hierarchy Standard</a>.</div></blockquote>
</div>
...
<dd><div class="highlight-none notranslate"><div class="highlight"><pre><span></span>GNUInstallDirs_get_absolute_install_dir(absvar var)
</pre></div>
</div>
