...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FindEnvModules &mdash; CMake 3.16.1 Documentation</title>
...
<p class="last">The loaded environment will not survive past the end of the calling process.
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">EnvModules_FOUND</span></code></dt>
<dd>True if a compatible environment modules framework was found.</dd>
</dl>
</div>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">EnvModules_COMMAND</span></code></dt>
<dd>The low level module command to use.  Currently supported
implementations are the Lua based Lmod and TCL based EnvironmentModules.</dd>
</dl>
</div>
<div class="section" id="environment-variables">
<h2>Environment Variables<a class="headerlink" href="#environment-variables" title="Permalink to this headline">¶</a></h2>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">ENV{MODULESHOME}</span></code></dt>
<dd>Usually set by the module environment implementation, used as a hint to
locate the module command to execute.</dd>
</dl>
</div>
...
<code class="descname">env_module</code><a class="headerlink" href="#command:env_module" title="Permalink to this definition">¶</a></dt>
...
<p>The options are:</p>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">cmd</span> <span class="pre">arg1</span> <span class="pre">...</span> <span class="pre">argN</span></code></dt>
<dd>The module sub-command and arguments to execute as if they were
passed directly to the module command in your shell environment.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">OUTPUT_VARIABLE</span> <span class="pre">&lt;out-var&gt;</span></code></dt>
<dd>The standard output from executing the module command.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">RESULT_VARIABLE</span> <span class="pre">&lt;ret-var&gt;</span></code></dt>
<dd>The return code from executing the module command.</dd>
</dl>
</dd></dl>

<dl class="command">
<dt id="command:env_module_swap">
<code class="descname">env_module_swap</code><a class="headerlink" href="#command:env_module_swap" title="Permalink to this definition">¶</a></dt>
...
<code class="descname">env_module_list</code><a class="headerlink" href="#command:env_module_list" title="Permalink to this definition">¶</a></dt>
...
<code class="descname">env_module_avail</code><a class="headerlink" href="#command:env_module_avail" title="Permalink to this definition">¶</a></dt>
