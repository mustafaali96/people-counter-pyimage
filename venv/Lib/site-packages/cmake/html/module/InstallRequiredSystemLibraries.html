...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>InstallRequiredSystemLibraries &mdash; CMake 3.16.1 Documentation</title>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">CMAKE_INSTALL_SYSTEM_RUNTIME_LIBS</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">CMAKE_INSTALL_SYSTEM_RUNTIME_LIBS_SKIP</span></code></dt>
<dd>Set to TRUE to skip calling the <span class="target" id="index-0-command:install"></span><a class="reference internal" href="../command/install.html#command:install" title="install"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">install(PROGRAMS)</span></code></a> command to
allow the includer to specify its own install rule, using the value of
<code class="docutils literal notranslate"><span class="pre">CMAKE_INSTALL_SYSTEM_RUNTIME_LIBS</span></code> to get the list of libraries.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">CMAKE_INSTALL_DEBUG_LIBRARIES</span></code></dt>
<dd>Set to TRUE to install the debug runtime libraries when available
with MSVC tools.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">CMAKE_INSTALL_DEBUG_LIBRARIES_ONLY</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">CMAKE_INSTALL_UCRT_LIBRARIES</span></code></dt>
<dd><p class="first">Set to TRUE to install the Windows Universal CRT libraries for
app-local deployment (e.g. to Windows XP).  This is meaningful
only with MSVC from Visual Studio 2015 or higher.</p>
<p class="last">One may set a <code class="docutils literal notranslate"><span class="pre">CMAKE_WINDOWS_KITS_10_DIR</span></code> <em>environment variable</em>
to an absolute path to tell CMake to look for Windows 10 SDKs in
a custom location.  The specified directory is expected to contain
<code class="docutils literal notranslate"><span class="pre">Redist/ucrt/DLLs/*</span></code> directories.</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">CMAKE_INSTALL_MFC_LIBRARIES</span></code></dt>
<dd>Set to TRUE to install the MSVC MFC runtime libraries.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">CMAKE_INSTALL_OPENMP_LIBRARIES</span></code></dt>
<dd>Set to TRUE to install the MSVC OpenMP runtime libraries</dd>
<dt><code class="docutils literal notranslate"><span class="pre">CMAKE_INSTALL_SYSTEM_RUNTIME_DESTINATION</span></code></dt>
...
and <code class="docutils literal notranslate"><span class="pre">lib</span></code> elsewhere.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">CMAKE_INSTALL_SYSTEM_RUNTIME_LIBS_NO_WARNINGS</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">CMAKE_INSTALL_SYSTEM_RUNTIME_COMPONENT</span></code></dt>
