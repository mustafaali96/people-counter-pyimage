...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FortranCInterface &mdash; CMake 3.16.1 Documentation</title>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">FortranCInterface_GLOBAL_FOUND</span></code></dt>
<dd>Global subroutines and functions.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">FortranCInterface_MODULE_FOUND</span></code></dt>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">FortranCInterface_GLOBAL_PREFIX</span></code></dt>
<dd>Prefix for a global symbol without an underscore.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">FortranCInterface_GLOBAL_SUFFIX</span></code></dt>
<dd>Suffix for a global symbol without an underscore.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">FortranCInterface_GLOBAL_CASE</span></code></dt>
<dd>The case for a global symbol without an underscore,
either <code class="docutils literal notranslate"><span class="pre">UPPER</span></code> or <code class="docutils literal notranslate"><span class="pre">LOWER</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">FortranCInterface_GLOBAL__PREFIX</span></code></dt>
<dd>Prefix for a global symbol with an underscore.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">FortranCInterface_GLOBAL__SUFFIX</span></code></dt>
<dd>Suffix for a global symbol with an underscore.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">FortranCInterface_GLOBAL__CASE</span></code></dt>
<dd>The case for a global symbol with an underscore,
either <code class="docutils literal notranslate"><span class="pre">UPPER</span></code> or <code class="docutils literal notranslate"><span class="pre">LOWER</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">FortranCInterface_MODULE_PREFIX</span></code></dt>
<dd>Prefix for a module symbol without an underscore.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">FortranCInterface_MODULE_MIDDLE</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">FortranCInterface_MODULE_SUFFIX</span></code></dt>
<dd>Suffix for a module symbol without an underscore.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">FortranCInterface_MODULE_CASE</span></code></dt>
<dd>The case for a module symbol without an underscore,
either <code class="docutils literal notranslate"><span class="pre">UPPER</span></code> or <code class="docutils literal notranslate"><span class="pre">LOWER</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">FortranCInterface_MODULE__PREFIX</span></code></dt>
<dd>Prefix for a module symbol with an underscore.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">FortranCInterface_MODULE__MIDDLE</span></code></dt>
<dd>Middle of a module symbol with an underscore that appears
between the name of the module and the name of the symbol.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">FortranCInterface_MODULE__SUFFIX</span></code></dt>
<dd>Suffix for a module symbol with an underscore.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">FortranCInterface_MODULE__CASE</span></code></dt>
...
<ul class="simple">
<li>Global symbols without ‘_’: <code class="docutils literal notranslate"><span class="pre">call</span> <span class="pre">mysub()</span></code></li>
<li>Global symbols with ‘_’   : <code class="docutils literal notranslate"><span class="pre">call</span> <span class="pre">my_sub()</span></code></li>
<li>Module symbols without ‘_’: <code class="docutils literal notranslate"><span class="pre">use</span> <span class="pre">mymod;</span> <span class="pre">call</span> <span class="pre">mysub()</span></code></li>
<li>Module symbols with ‘_’   : <code class="docutils literal notranslate"><span class="pre">use</span> <span class="pre">mymod;</span> <span class="pre">call</span> <span class="pre">my_sub()</span></code></li>
</ul>
...
<p>The options are:</p>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">MACRO_NAMESPACE</span></code></dt>
<dd>Replace the default <code class="docutils literal notranslate"><span class="pre">FortranCInterface_</span></code> prefix with a given
namespace <code class="docutils literal notranslate"><span class="pre">&lt;macro-ns&gt;</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">SYMBOLS</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">SYMBOL_NAMESPACE</span></code></dt>
<dd>Prefix all preprocessor definitions generated by the <code class="docutils literal notranslate"><span class="pre">SYMBOLS</span></code>
option with a given namespace <code class="docutils literal notranslate"><span class="pre">&lt;ns&gt;</span></code>.</dd>
</dl>
</dd></dl>
