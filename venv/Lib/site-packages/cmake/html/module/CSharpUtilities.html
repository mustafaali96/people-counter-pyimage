...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CSharpUtilities &mdash; CMake 3.16.1 Documentation</title>
...
<ul class="simple">
<li><span class="target" id="index-0-command:csharp_set_windows_forms_properties"></span><a class="reference internal" href="#command:csharp_set_windows_forms_properties" title="csharp_set_windows_forms_properties"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">csharp_set_windows_forms_properties()</span></code></a></li>
<li><span class="target" id="index-0-command:csharp_set_designer_cs_properties"></span><a class="reference internal" href="#command:csharp_set_designer_cs_properties" title="csharp_set_designer_cs_properties"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">csharp_set_designer_cs_properties()</span></code></a></li>
<li><span class="target" id="index-0-command:csharp_set_xaml_cs_properties"></span><a class="reference internal" href="#command:csharp_set_xaml_cs_properties" title="csharp_set_xaml_cs_properties"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">csharp_set_xaml_cs_properties()</span></code></a></li>
</ul>
<p><strong>Helper functions</strong></p>
<ul class="simple">
<li><span class="target" id="index-0-command:csharp_get_filename_keys"></span><a class="reference internal" href="#command:csharp_get_filename_keys" title="csharp_get_filename_keys"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">csharp_get_filename_keys()</span></code></a></li>
<li><span class="target" id="index-0-command:csharp_get_filename_key_base"></span><a class="reference internal" href="#command:csharp_get_filename_key_base" title="csharp_get_filename_key_base"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">csharp_get_filename_key_base()</span></code></a></li>
<li><span class="target" id="index-0-command:csharp_get_dependentupon_name"></span><a class="reference internal" href="#command:csharp_get_dependentupon_name" title="csharp_get_dependentupon_name"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">csharp_get_dependentupon_name()</span></code></a></li>
</ul>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">&lt;fileN&gt;</span></code></dt>
...
<code class="docutils literal notranslate"><span class="pre">.Designer.cs</span></code> extensions).</dd>
</dl>
...
<code class="docutils literal notranslate"><span class="pre">.resx</span></code>, <code class="docutils literal notranslate"><span class="pre">.settings</span></code> and <code class="docutils literal notranslate"><span class="pre">.Designer.cs</span></code> extensions).</dd>
</dl>
...
<p class="last">Because the source file properties of the <code class="docutils literal notranslate"><span class="pre">.Designer.cs</span></code> file are set according
...
<code class="docutils literal notranslate"><span class="pre">.xaml</span></code>, and <code class="docutils literal notranslate"><span class="pre">.xaml.cs</span></code> extensions).</dd>
</dl>
<p>In the list of all given files for all files ending with
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">OUT</span></code></dt>
<dd>Name of the variable in which the list of keys is stored</dd>
<dt><code class="docutils literal notranslate"><span class="pre">&lt;fileN&gt;</span></code></dt>
<dd>filename(s) as given to to CSharp target using <span class="target" id="index-0-command:add_library"></span><a class="reference internal" href="../command/add_library.html#command:add_library" title="add_library"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">add_library()</span></code></a>
or <span class="target" id="index-0-command:add_executable"></span><a class="reference internal" href="../command/add_executable.html#command:add_executable" title="add_executable"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">add_executable()</span></code></a></dd>
</dl>
...
<dd>Name of the variable with the computed “base” of <code class="docutils literal notranslate"><span class="pre">KEY</span></code>.</dd>
...
<dd>Filename to convert to <code class="docutils literal notranslate"><span class="pre">&lt;DependentUpon&gt;</span></code> value</dd>
</dl>
