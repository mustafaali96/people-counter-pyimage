...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FindEXPAT &mdash; CMake 3.16.1 Documentation</title>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">EXPAT::EXPAT</span></code></dt>
<dd>The Expat <code class="docutils literal notranslate"><span class="pre">expat</span></code> library, if found.</dd>
</dl>
</div>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">EXPAT_INCLUDE_DIRS</span></code></dt>
<dd>where to find expat.h, etc.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">EXPAT_LIBRARIES</span></code></dt>
<dd>the libraries to link against to use Expat.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">EXPAT_FOUND</span></code></dt>
<dd>true if the Expat headers and libraries were found.</dd>
</dl>
</div>
</div>
