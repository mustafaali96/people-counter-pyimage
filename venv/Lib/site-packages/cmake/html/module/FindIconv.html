...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FindIconv &mdash; CMake 3.16.1 Documentation</title>
...
<code class="descname">Iconv_FOUND</code><a class="headerlink" href="#variable:Iconv_FOUND" title="Permalink to this definition">¶</a></dt>
<dd><p>Variable indicating if the iconv support was found.</p>
</dd></dl>

<dl class="variable">
<dt id="variable:Iconv_INCLUDE_DIRS">
<code class="descname">Iconv_INCLUDE_DIRS</code><a class="headerlink" href="#variable:Iconv_INCLUDE_DIRS" title="Permalink to this definition">¶</a></dt>
<dd><p>The directories containing the iconv headers.</p>
</dd></dl>

<dl class="variable">
<dt id="variable:Iconv_LIBRARIES">
<code class="descname">Iconv_LIBRARIES</code><a class="headerlink" href="#variable:Iconv_LIBRARIES" title="Permalink to this definition">¶</a></dt>
<dd><p>The iconv libraries to be linked.</p>
</dd></dl>

<dl class="variable">
<dt id="variable:Iconv_IS_BUILT_IN">
<code class="descname">Iconv_IS_BUILT_IN</code><a class="headerlink" href="#variable:Iconv_IS_BUILT_IN" title="Permalink to this definition">¶</a></dt>
...
<code class="descname">Iconv::Iconv</code><a class="headerlink" href="#variable:Iconv::Iconv" title="Permalink to this definition">¶</a></dt>
...
<code class="descname">Iconv_INCLUDE_DIR</code><a class="headerlink" href="#variable:Iconv_INCLUDE_DIR" title="Permalink to this definition">¶</a></dt>
<dd><p>The directory containing the iconv headers.</p>
</dd></dl>

<dl class="variable">
<dt id="variable:Iconv_LIBRARY">
<code class="descname">Iconv_LIBRARY</code><a class="headerlink" href="#variable:Iconv_LIBRARY" title="Permalink to this definition">¶</a></dt>
<dd><p>The iconv library (if not implicitly given in the C library).</p>
</dd></dl>

<div class="admonition note">
<p class="first admonition-title">Note</p>
<p class="last">On POSIX platforms, iconv might be part of the C library and the cache
