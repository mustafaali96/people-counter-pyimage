...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>GetPrerequisites &mdash; CMake 3.16.1 Documentation</title>
...
<p><span class="versionmodified">Deprecated since version 3.16: </span>Use <span class="target" id="index-0-command:file"></span><a class="reference internal" href="../command/file.html#command:file" title="file"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">file(GET_RUNTIME_DEPENDENCIES)</span></code></a> instead.</p>
</div>
...
locations, /usr/lib…</p>
<p>The variable GET_PREREQUISITES_VERBOSE can be set to true to enable verbose
output.</p>
