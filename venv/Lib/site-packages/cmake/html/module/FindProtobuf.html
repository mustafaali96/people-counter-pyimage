...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FindProtobuf &mdash; CMake 3.16.1 Documentation</title>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">Protobuf_SRC_ROOT_FOLDER</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">Protobuf_IMPORT_DIRS</span></code></dt>
<dd>List of additional directories to be searched for
imported .proto files.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Protobuf_DEBUG</span></code></dt>
<dd>Show debug messages.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Protobuf_USE_STATIC_LIBS</span></code></dt>
<dd>Set to ON to force the use of the static libraries.
Default is OFF.</dd>
</dl>
<p>Defines the following variables:</p>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">Protobuf_FOUND</span></code></dt>
<dd>Found the Google Protocol Buffers library
(libprotobuf &amp; header files)</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Protobuf_VERSION</span></code></dt>
<dd>Version of package found.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Protobuf_INCLUDE_DIRS</span></code></dt>
<dd>Include directories for Google Protocol Buffers</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Protobuf_LIBRARIES</span></code></dt>
<dd>The protobuf libraries</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Protobuf_PROTOC_LIBRARIES</span></code></dt>
<dd>The protoc libraries</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Protobuf_LITE_LIBRARIES</span></code></dt>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">protobuf::libprotobuf</span></code></dt>
<dd>The protobuf library.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">protobuf::libprotobuf-lite</span></code></dt>
<dd>The protobuf lite library.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">protobuf::libprotoc</span></code></dt>
<dd>The protoc library.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">protobuf::protoc</span></code></dt>
<dd>The protoc compiler.</dd>
</dl>
<p>The following cache variables are also available to set or use:</p>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">Protobuf_LIBRARY</span></code></dt>
<dd>The protobuf library</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Protobuf_PROTOC_LIBRARY</span></code></dt>
<dd>The protoc library</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Protobuf_INCLUDE_DIR</span></code></dt>
<dd>The include directory for protocol buffers</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Protobuf_PROTOC_EXECUTABLE</span></code></dt>
<dd>The protoc compiler</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Protobuf_LIBRARY_DEBUG</span></code></dt>
<dd>The protobuf library (debug)</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Protobuf_PROTOC_LIBRARY_DEBUG</span></code></dt>
<dd>The protoc library (debug)</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Protobuf_LITE_LIBRARY</span></code></dt>
<dd>The protobuf lite library</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Protobuf_LITE_LIBRARY_DEBUG</span></code></dt>
...
<p class="last">The <code class="docutils literal notranslate"><span class="pre">protobuf_generate_cpp</span></code> and <code class="docutils literal notranslate"><span class="pre">protobuf_generate_python</span></code>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">SRCS</span></code></dt>
<dd>Variable to define with autogenerated source files</dd>
<dt><code class="docutils literal notranslate"><span class="pre">HDRS</span></code></dt>
<dd>Variable to define with autogenerated header files</dd>
<dt><code class="docutils literal notranslate"><span class="pre">DESCRIPTORS</span></code></dt>
<dd>Variable to define with autogenerated descriptor files, if requested.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">EXPORT_MACRO</span></code></dt>
<dd>is a macro which should expand to <code class="docutils literal notranslate"><span class="pre">__declspec(dllexport)</span></code> or
<code class="docutils literal notranslate"><span class="pre">__declspec(dllimport)</span></code> depending on what is being compiled.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">ARGN</span></code></dt>
<dd><code class="docutils literal notranslate"><span class="pre">.proto</span></code> files</dd>
</dl>
</dd></dl>
...
<dd><p>Add custom commands to process <code class="docutils literal notranslate"><span class="pre">.proto</span></code> files to Python:</p>
...
<dt><code class="docutils literal notranslate"><span class="pre">ARGN</span></code></dt>
<dd><code class="docutils literal notranslate"><span class="pre">.proto</span></code> filess</dd>
</dl>
</dd></dl>
