...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FindMatlab &mdash; CMake 3.16.1 Documentation</title>
...
can also be used:</p>
<ul class="simple">
<li>to run specific commands in Matlab in case Matlab is available</li>
<li>for declaring Matlab unit test</li>
<li>to retrieve various information from Matlab (mex extensions, versions and
release queries, …)</li>
</ul>
<p>The module supports the following components:</p>
<ul class="simple">
<li><code class="docutils literal notranslate"><span class="pre">ENG_LIBRARY</span></code> and <code class="docutils literal notranslate"><span class="pre">MAT_LIBRARY</span></code>: respectively the <code class="docutils literal notranslate"><span class="pre">ENG</span></code> and <code class="docutils literal notranslate"><span class="pre">MAT</span></code>
libraries of Matlab</li>
<li><code class="docutils literal notranslate"><span class="pre">MAIN_PROGRAM</span></code> the Matlab binary program. Note that this component is not
available on the MCR version, and will yield an error if the MCR is found
instead of the regular Matlab installation.</li>
<li><code class="docutils literal notranslate"><span class="pre">MEX_COMPILER</span></code> the MEX compiler.</li>
<li><code class="docutils literal notranslate"><span class="pre">MCC_COMPILER</span></code> the MCC compiler, included with the Matlab Compiler add-on.</li>
<li><code class="docutils literal notranslate"><span class="pre">SIMULINK</span></code> the Simulink environment.</li>
</ul>
...
specific:</p>
<ul class="simple">
<li>Windows: The installed versions of Matlab/MCR are retrieved from the
Windows registry</li>
<li>OS X: The installed versions of Matlab/MCR are given by the MATLAB
...
found, it falls back to the one that might be accessible from the <code class="docutils literal notranslate"><span class="pre">PATH</span></code>.</li>
<li>Unix: The desired Matlab should be accessible from the <code class="docutils literal notranslate"><span class="pre">PATH</span></code>. This does
...
behaviour:</p>
<dl class="docutils">
<dt><span class="target" id="index-2-variable:Matlab_ROOT_DIR"></span><a class="reference internal" href="#variable:Matlab_ROOT_DIR" title="Matlab_ROOT_DIR"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">Matlab_ROOT_DIR</span></code></a></dt>
<dd>the root of the Matlab installation.</dd>
<dt><span class="target" id="index-1-variable:MATLAB_FIND_DEBUG"></span><a class="reference internal" href="#variable:MATLAB_FIND_DEBUG" title="MATLAB_FIND_DEBUG"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">MATLAB_FIND_DEBUG</span></code></a></dt>
<dd>outputs debug information</dd>
<dt><span class="target" id="index-1-variable:MATLAB_ADDITIONAL_VERSIONS"></span><a class="reference internal" href="#variable:MATLAB_ADDITIONAL_VERSIONS" title="MATLAB_ADDITIONAL_VERSIONS"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">MATLAB_ADDITIONAL_VERSIONS</span></code></a></dt>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">Matlab_FOUND</span></code></dt>
<dd><code class="docutils literal notranslate"><span class="pre">TRUE</span></code> if the Matlab installation is found, <code class="docutils literal notranslate"><span class="pre">FALSE</span></code>
otherwise. All variable below are defined if Matlab is found.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Matlab_ROOT_DIR</span></code></dt>
<dd>the final root of the Matlab installation determined by the FindMatlab
module.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Matlab_MAIN_PROGRAM</span></code></dt>
<dd>the Matlab binary program. Available only if the component <code class="docutils literal notranslate"><span class="pre">MAIN_PROGRAM</span></code>
is given in the <span class="target" id="index-2-command:find_package"></span><a class="reference internal" href="../command/find_package.html#command:find_package" title="find_package"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">find_package()</span></code></a> directive.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Matlab_INCLUDE_DIRS</span></code></dt>
<dd>the path of the Matlab libraries headers</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Matlab_MEX_LIBRARY</span></code></dt>
<dd>library for mex, always available.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Matlab_MX_LIBRARY</span></code></dt>
<dd>mx library of Matlab (arrays), always available.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Matlab_ENG_LIBRARY</span></code></dt>
<dd>Matlab engine library. Available only if the component <code class="docutils literal notranslate"><span class="pre">ENG_LIBRARY</span></code>
is requested.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Matlab_MAT_LIBRARY</span></code></dt>
<dd>Matlab matrix library. Available only if the component <code class="docutils literal notranslate"><span class="pre">MAT_LIBRARY</span></code>
is requested.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Matlab_ENGINE_LIBRARY</span></code></dt>
<dd>Matlab C++ engine library, always available for R2018a and newer.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Matlab_DATAARRAY_LIBRARY</span></code></dt>
<dd>Matlab C++ data array library, always available for R2018a and newer.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Matlab_LIBRARIES</span></code></dt>
<dd>the whole set of libraries of Matlab</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Matlab_MEX_COMPILER</span></code></dt>
<dd>the mex compiler of Matlab. Currently not used.
Available only if the component <code class="docutils literal notranslate"><span class="pre">MEX_COMPILER</span></code> is requested.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Matlab_MCC_COMPILER</span></code></dt>
<dd>the mcc compiler of Matlab. Included with the Matlab Compiler add-on.
Available only if the component <code class="docutils literal notranslate"><span class="pre">MCC_COMPILER</span></code> is requested.</dd>
</dl>
</div>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">Matlab_MEX_EXTENSION</span></code></dt>
...
<dl class="docutils">
<dt><span class="target" id="index-0-command:matlab_add_mex"></span><a class="reference internal" href="#command:matlab_add_mex" title="matlab_add_mex"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">matlab_add_mex()</span></code></a></dt>
<dd>adds a target compiling a MEX file.</dd>
<dt><span class="target" id="index-1-command:matlab_add_unit_test"></span><a class="reference internal" href="#command:matlab_add_unit_test" title="matlab_add_unit_test"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">matlab_add_unit_test()</span></code></a></dt>
...
<dt><span class="target" id="index-0-command:matlab_get_mex_suffix"></span><a class="reference internal" href="#command:matlab_get_mex_suffix" title="matlab_get_mex_suffix"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">matlab_get_mex_suffix()</span></code></a></dt>
<dd>returns the suffix to be used for the mex files
(platform/architecture dependent)</dd>
<dt><span class="target" id="index-0-command:matlab_get_version_from_matlab_run"></span><a class="reference internal" href="#command:matlab_get_version_from_matlab_run" title="matlab_get_version_from_matlab_run"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">matlab_get_version_from_matlab_run()</span></code></a></dt>
<dd>returns the version of Matlab/MCR, given the full directory of the Matlab/MCR
installation path.</dd>
</dl>
</div>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">matlab_versions</span></code></dt>
<dd>the versions of each of the Matlab or MCR installations</dd>
<dt><code class="docutils literal notranslate"><span class="pre">matlab_roots</span></code></dt>
<dd>the location of each of the Matlab or MCR installations</dd>
</dl>
</dd></dl>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">matlab_root</span></code></dt>
<dd>the root of the Matlab/MCR installation</dd>
<dt><code class="docutils literal notranslate"><span class="pre">mex_suffix</span></code></dt>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">matlab_binary_path</span></code></dt>
<dd>the location of the <cite>matlab</cite> binary executable</dd>
<dt><code class="docutils literal notranslate"><span class="pre">matlab_list_versions</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">UNITTEST_FILE</span></code></dt>
<dd>the matlab unittest file. Its path will be automatically
added to the Matlab path.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">CUSTOM_TEST_COMMAND</span></code></dt>
...
where <code class="docutils literal notranslate"><span class="pre">matlab_file_name</span></code> is the <code class="docutils literal notranslate"><span class="pre">UNITTEST_FILE</span></code> without the extension.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">UNITTEST_PRECOMMAND</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">ADDITIONAL_PATH</span></code></dt>
<dd>a list of paths to add to the Matlab path prior to
running the unit test.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">MATLAB_ADDITIONAL_STARTUP_OPTIONS</span></code></dt>
<dd>a list of additional option in order
to run Matlab from the command line.
<code class="docutils literal notranslate"><span class="pre">-nosplash</span> <span class="pre">-nodesktop</span> <span class="pre">-nodisplay</span></code> are always added.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">TEST_ARGS</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">NO_UNITTEST_FRAMEWORK</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">LINK_TO</span></code></dt>
<dd>a list of additional link dependencies.  The target links to <code class="docutils literal notranslate"><span class="pre">libmex</span></code>
and <code class="docutils literal notranslate"><span class="pre">libmx</span></code> by default.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">OUTPUT_NAME</span></code></dt>
<dd>if given, overrides the default name. The default name is
the name of the target without any prefix and
with <code class="docutils literal notranslate"><span class="pre">Matlab_MEX_EXTENSION</span></code> suffix.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">DOCUMENTATION</span></code></dt>
<dd>if given, the file <code class="docutils literal notranslate"><span class="pre">file.txt</span></code> will be considered as
...
<dt><code class="docutils literal notranslate"><span class="pre">R2017b</span></code> or <code class="docutils literal notranslate"><span class="pre">R2018a</span></code> may be given to specify the version of the C API</dt>
<dd>to use: <code class="docutils literal notranslate"><span class="pre">R2017b</span></code> specifies the traditional (separate complex) C API,
...
to R2018a. Defaults to <code class="docutils literal notranslate"><span class="pre">R2017b</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">MODULE</span></code> or <code class="docutils literal notranslate"><span class="pre">SHARED</span></code> may be given to specify the type of library to be</dt>
<dd>created. <code class="docutils literal notranslate"><span class="pre">EXECUTABLE</span></code> may be given to create an executable instead of
a library. If no type is given explicitly, the type is <code class="docutils literal notranslate"><span class="pre">SHARED</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">EXCLUDE_FROM_ALL</span></code></dt>
<dd>This option has the same meaning as for <span class="target" id="index-0-prop_tgt:EXCLUDE_FROM_ALL"></span><a class="reference internal" href="../prop_tgt/EXCLUDE_FROM_ALL.html#prop_tgt:EXCLUDE_FROM_ALL" title="EXCLUDE_FROM_ALL"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">EXCLUDE_FROM_ALL</span></code></a> and
