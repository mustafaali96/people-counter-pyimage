...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FindOpenGL &mdash; CMake 3.16.1 Documentation</title>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">OpenGL::GL</span></code></dt>
<dd>Defined to the platform-specific OpenGL libraries if the system has OpenGL.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">OpenGL::OpenGL</span></code></dt>
<dd>Defined to libOpenGL if the system is GLVND-based.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">OpenGL::GLU</span></code></dt>
<dd>Defined if the system has OpenGL Utility Library (GLU).</dd>
<dt><code class="docutils literal notranslate"><span class="pre">OpenGL::GLX</span></code></dt>
<dd>Defined if the system has OpenGL Extension to the X Window System (GLX).</dd>
<dt><code class="docutils literal notranslate"><span class="pre">OpenGL::EGL</span></code></dt>
<dd>Defined if the system has EGL.</dd>
</dl>
</div>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">OPENGL_FOUND</span></code></dt>
<dd>True, if the system has OpenGL and all components are found.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">OPENGL_XMESA_FOUND</span></code></dt>
<dd>True, if the system has XMESA.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">OPENGL_GLU_FOUND</span></code></dt>
<dd>True, if the system has GLU.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">OpenGL_OpenGL_FOUND</span></code></dt>
<dd>True, if the system has an OpenGL library.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">OpenGL_GLX_FOUND</span></code></dt>
<dd>True, if the system has GLX.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">OpenGL_EGL_FOUND</span></code></dt>
<dd>True, if the system has EGL.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">OPENGL_INCLUDE_DIR</span></code></dt>
<dd>Path to the OpenGL include directory.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">OPENGL_EGL_INCLUDE_DIRS</span></code></dt>
<dd>Path to the EGL include directory.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">OPENGL_LIBRARIES</span></code></dt>
<dd>Paths to the OpenGL library, windowing system libraries, and GLU libraries.
On Linux, this assumes GLX and is never correct for EGL-based targets.
Clients are encouraged to use the <code class="docutils literal notranslate"><span class="pre">OpenGL::*</span></code> import targets instead.</dd>
</dl>
</div>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">OPENGL_egl_LIBRARY</span></code></dt>
<dd>Path to the EGL library.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">OPENGL_glu_LIBRARY</span></code></dt>
<dd>Path to the GLU library.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">OPENGL_glx_LIBRARY</span></code></dt>
<dd>Path to the GLVND ‘GLX’ library.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">OPENGL_opengl_LIBRARY</span></code></dt>
<dd>Path to the GLVND ‘OpenGL’ library</dd>
<dt><code class="docutils literal notranslate"><span class="pre">OPENGL_gl_LIBRARY</span></code></dt>
<dd>Path to the OpenGL library.  New code should prefer the <code class="docutils literal notranslate"><span class="pre">OpenGL::*</span></code> import
targets.</dd>
</dl>
</div>
<div class="section" id="linux-specific">
<h2>Linux-specific<a class="headerlink" href="#linux-specific" title="Permalink to this headline">¶</a></h2>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">GLVND</span></code></dt>
<dd>If the GLVND OpenGL and GLX libraries are available, prefer them.
This forces <code class="docutils literal notranslate"><span class="pre">OPENGL_gl_LIBRARY</span></code> to be empty.
This is the default if components were requested (since components
correspond to GLVND libraries) or if policy <span class="target" id="index-0-policy:CMP0072"></span><a class="reference internal" href="../policy/CMP0072.html#policy:CMP0072" title="CMP0072"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0072</span></code></a> is
set to <code class="docutils literal notranslate"><span class="pre">NEW</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">LEGACY</span></code></dt>
<dd>Prefer to use the legacy libGL library, if available.
This is the default if no components were requested and
policy <span class="target" id="index-1-policy:CMP0072"></span><a class="reference internal" href="../policy/CMP0072.html#policy:CMP0072" title="CMP0072"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0072</span></code></a> is not set to <code class="docutils literal notranslate"><span class="pre">NEW</span></code>.</dd>
</dl>
