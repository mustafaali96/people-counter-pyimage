...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FindPostgreSQL &mdash; CMake 3.16.1 Documentation</title>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">PostgreSQL_FOUND</span></code></dt>
<dd>True if PostgreSQL is found.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">PostgreSQL_LIBRARIES</span></code></dt>
<dd>the PostgreSQL libraries needed for linking</dd>
<dt><code class="docutils literal notranslate"><span class="pre">PostgreSQL_INCLUDE_DIRS</span></code></dt>
<dd>the directories of the PostgreSQL headers</dd>
<dt><code class="docutils literal notranslate"><span class="pre">PostgreSQL_LIBRARY_DIRS</span></code></dt>
<dd>the link directories for PostgreSQL libraries</dd>
<dt><code class="docutils literal notranslate"><span class="pre">PostgreSQL_VERSION_STRING</span></code></dt>
<dd>the version of PostgreSQL found</dd>
</dl>
</div>
</div>
