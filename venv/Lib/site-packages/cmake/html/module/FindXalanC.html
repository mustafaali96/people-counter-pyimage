...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FindXalanC &mdash; CMake 3.16.1 Documentation</title>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">XalanC::XalanC</span></code></dt>
<dd>The Xalan-C++ <code class="docutils literal notranslate"><span class="pre">xalan-c</span></code> library, if found.</dd>
</dl>
</div>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">XalanC_FOUND</span></code></dt>
<dd>true if the Xalan headers and libraries were found</dd>
<dt><code class="docutils literal notranslate"><span class="pre">XalanC_VERSION</span></code></dt>
<dd>Xalan release version</dd>
<dt><code class="docutils literal notranslate"><span class="pre">XalanC_INCLUDE_DIRS</span></code></dt>
<dd>the directory containing the Xalan headers; note
<code class="docutils literal notranslate"><span class="pre">XercesC_INCLUDE_DIRS</span></code> is also required</dd>
<dt><code class="docutils literal notranslate"><span class="pre">XalanC_LIBRARIES</span></code></dt>
<dd>Xalan libraries to be linked; note <code class="docutils literal notranslate"><span class="pre">XercesC_LIBRARIES</span></code> is also
required</dd>
</dl>
</div>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">XalanC_INCLUDE_DIR</span></code></dt>
<dd>the directory containing the Xalan headers</dd>
<dt><code class="docutils literal notranslate"><span class="pre">XalanC_LIBRARY</span></code></dt>
