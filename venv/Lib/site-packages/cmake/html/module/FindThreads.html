...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FindThreads &mdash; CMake 3.16.1 Documentation</title>
...
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>CMAKE_THREAD_LIBS_INIT     - the thread library
...
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>Threads::Threads
</pre></div>
</div>
<p>If the use of the -pthread compiler and linker flag is preferred then the
caller can set</p>
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>THREADS_PREFER_PTHREAD_FLAG
</pre></div>
</div>
<p>The compiler flag can only be used with the imported
