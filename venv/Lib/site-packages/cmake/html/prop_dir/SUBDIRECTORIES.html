...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>SUBDIRECTORIES &mdash; CMake 3.16.1 Documentation</title>
...
<p class="last">The <span class="target" id="index-1-command:subdirs"></span><a class="reference internal" href="../command/subdirs.html#command:subdirs" title="subdirs"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">subdirs()</span></code></a> command does not process its arguments until
