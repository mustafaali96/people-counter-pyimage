...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMake 3.5 Release Notes &mdash; CMake 3.16.1 Documentation</title>
...
<ul class="simple">
<li>The <span class="target" id="index-0-manual:cmake-gui(1)"></span><a class="reference internal" href="../manual/cmake-gui.1.html#manual:cmake-gui(1)" title="cmake-gui(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake-gui(1)</span></code></a> gained options to control warnings about
deprecated functionality.</li>
<li>The <span class="target" id="index-1-manual:cmake-gui(1)"></span><a class="reference internal" href="../manual/cmake-gui.1.html#manual:cmake-gui(1)" title="cmake-gui(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake-gui(1)</span></code></a> learned an option to set the toolset
to be used with VS IDE and Xcode generators, much like the
existing <code class="docutils literal notranslate"><span class="pre">-T</span></code> option to <span class="target" id="index-0-manual:cmake(1)"></span><a class="reference internal" href="../manual/cmake.1.html#manual:cmake(1)" title="cmake(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake(1)</span></code></a>.</li>
<li>The <span class="target" id="index-2-manual:cmake-gui(1)"></span><a class="reference internal" href="../manual/cmake-gui.1.html#manual:cmake-gui(1)" title="cmake-gui(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake-gui(1)</span></code></a> gained a Regular Expression Explorer which
may be used to create and evaluate regular expressions in real-time.
The explorer window is available via the <code class="docutils literal notranslate"><span class="pre">Tools</span></code> menu.</li>
</ul>
</div>
...
<ul class="simple">
<li>The <code class="docutils literal notranslate"><span class="pre">-Wdev</span></code> and <code class="docutils literal notranslate"><span class="pre">-Wno-dev</span></code> <span class="target" id="index-1-manual:cmake(1)"></span><a class="reference internal" href="../manual/cmake.1.html#manual:cmake(1)" title="cmake(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake(1)</span></code></a> options now also enable
...
<li>The <span class="target" id="index-0-command:install"></span><a class="reference internal" href="../command/install.html#command:install" title="install"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">install(DIRECTORY)</span></code></a> command learned to support
...
option to control the <code class="docutils literal notranslate"><span class="pre">git</span> <span class="pre">clone</span> <span class="pre">--origin</span></code> value.</li>
<li>The <span class="target" id="index-0-module:FindBoost"></span><a class="reference internal" href="../module/FindBoost.html#module:FindBoost" title="FindBoost"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindBoost</span></code></a> module now provides imported targets
such as <code class="docutils literal notranslate"><span class="pre">Boost::boost</span></code> and <code class="docutils literal notranslate"><span class="pre">Boost::filesystem</span></code>.</li>
...
to be generated.</li>
<li>The <span class="target" id="index-0-module:FindGTest"></span><a class="reference internal" href="../module/FindGTest.html#module:FindGTest" title="FindGTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindGTest</span></code></a> module now provides imported targets.</li>
...
a new <code class="docutils literal notranslate"><span class="pre">GTK2_TARGETS</span></code> variable containing all the targets imported.</li>
<li>The <span class="target" id="index-0-module:FindOpenMP"></span><a class="reference internal" href="../module/FindOpenMP.html#module:FindOpenMP" title="FindOpenMP"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindOpenMP</span></code></a> module learned to support Clang.</li>
<li>The <span class="target" id="index-0-module:FindOpenSSL"></span><a class="reference internal" href="../module/FindOpenSSL.html#module:FindOpenSSL" title="FindOpenSSL"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindOpenSSL</span></code></a> module gained a new
...
<li>The <span class="target" id="index-0-module:FindPNG"></span><a class="reference internal" href="../module/FindPNG.html#module:FindPNG" title="FindPNG"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindPNG</span></code></a> module now provides imported targets.</li>
<li>The <span class="target" id="index-0-module:FindTIFF"></span><a class="reference internal" href="../module/FindTIFF.html#module:FindTIFF" title="FindTIFF"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindTIFF</span></code></a> module now provides imported targets.</li>
<li>A <span class="target" id="index-0-module:FindXalanC"></span><a class="reference internal" href="../module/FindXalanC.html#module:FindXalanC" title="FindXalanC"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindXalanC</span></code></a> module was introduced to find the
Apache Xalan-C++ XSL transform processing library.</li>
<li>The <span class="target" id="index-0-module:FindXercesC"></span><a class="reference internal" href="../module/FindXercesC.html#module:FindXercesC" title="FindXercesC"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindXercesC</span></code></a> module now provides imported targets.</li>
</ul>
</div>
...
<ul class="simple">
<li>Support was added for the ARM Compiler (arm.com) with compiler id <code class="docutils literal notranslate"><span class="pre">ARMCC</span></code>.</li>
...
<li>The <span class="target" id="index-1-cpack_gen:CPack DragNDrop Generator"></span><a class="reference internal" href="../cpack_gen/dmg.html#cpack_gen:CPack DragNDrop Generator" title="CPack DragNDrop Generator"><code class="xref cmake cmake-cpack_gen docutils literal notranslate"><span class="pre">CPack</span> <span class="pre">DragNDrop</span> <span class="pre">Generator</span></code></a> learned to add
...
<span class="target" id="index-0-variable:CPACK_DMG_SLA_DIR"></span><a class="reference internal" href="../cpack_gen/dmg.html#variable:CPACK_DMG_SLA_DIR" title="CPACK_DMG_SLA_DIR"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_DMG_SLA_DIR</span></code></a> variables for details.</li>
...
<li>The <span class="target" id="index-0-generator:Xcode"></span><a class="reference internal" href="../generator/Xcode.html#generator:Xcode" title="Xcode"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Xcode</span></code></a> generator was fixed to escape backslashes in
...
<code class="docutils literal notranslate"><span class="pre">/debug:fastlink</span></code> linker flag to the <code class="docutils literal notranslate"><span class="pre">.vcxproj</span></code> file property.</li>
...
<li>The precompiled Windows binary provided on <code class="docutils literal notranslate"><span class="pre">cmake.org</span></code> is now a
