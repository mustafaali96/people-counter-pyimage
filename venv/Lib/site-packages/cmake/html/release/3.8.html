...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMake 3.8 Release Notes &mdash; CMake 3.16.1 Documentation</title>
...
<ul>
<li><p class="first">CMake learned to support <code class="docutils literal notranslate"><span class="pre">CSharp</span></code> (C#) as a first-class language that
...
<ul class="simple">
<li>CMake learned to support <code class="docutils literal notranslate"><span class="pre">CUDA</span></code> as a first-class language that can be
enabled via the <span class="target" id="index-1-command:project"></span><a class="reference internal" href="../command/project.html#command:project" title="project"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">project()</span></code></a> and <span class="target" id="index-1-command:enable_language"></span><a class="reference internal" href="../command/enable_language.html#command:enable_language" title="enable_language"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">enable_language()</span></code></a> commands.</li>
<li><code class="docutils literal notranslate"><span class="pre">CUDA</span></code> is currently supported by the <a class="reference internal" href="../manual/cmake-generators.7.html#makefile-generators"><span class="std std-ref">Makefile Generators</span></a>
...
<li>The NVIDIA CUDA Toolkit compiler (<code class="docutils literal notranslate"><span class="pre">nvcc</span></code>) is supported.</li>
</ul>
</div>
...
<ul class="simple">
<li>A new minimal platform file for <code class="docutils literal notranslate"><span class="pre">Fuchsia</span></code> was added.</li>
</ul>
</div>
...
<ul class="simple">
<li>The <span class="target" id="index-0-generator:CodeBlocks"></span><a class="reference internal" href="../generator/CodeBlocks.html#generator:CodeBlocks" title="CodeBlocks"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">CodeBlocks</span></code></a> extra generator may now be used to
generate with <span class="target" id="index-0-generator:NMake Makefiles JOM"></span><a class="reference internal" href="../generator/NMake Makefiles JOM.html#generator:NMake Makefiles JOM" title="NMake Makefiles JOM"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">NMake</span> <span class="pre">Makefiles</span> <span class="pre">JOM</span></code></a>.</li>
...
<li>The <span class="target" id="index-0-command:math"></span><a class="reference internal" href="../command/math.html#command:math" title="math"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">math(EXPR)</span></code></a> command gained support for unary
<code class="docutils literal notranslate"><span class="pre">+</span></code> and <code class="docutils literal notranslate"><span class="pre">-</span></code> operators.</li>
...
as a way to encode plain <code class="docutils literal notranslate"><span class="pre">%</span></code>.</li>
<li>The <span class="target" id="index-1-command:string"></span><a class="reference internal" href="../command/string.html#command:string" title="string"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">string(TIMESTAMP)</span></code></a> command will now honor the
...
<li>The <span class="target" id="index-1-command:try_compile"></span><a class="reference internal" href="../command/try_compile.html#command:try_compile" title="try_compile"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">try_compile()</span></code></a> command source file signature now honors
...
See policy <span class="target" id="index-0-policy:CMP0067"></span><a class="reference internal" href="../policy/CMP0067.html#policy:CMP0067" title="CMP0067"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0067</span></code></a>.</li>
</ul>
</div>
...
environment variables in the generated <code class="docutils literal notranslate"><span class="pre">.sublime-project</span></code>.</li>
...
variable for the <code class="docutils literal notranslate"><span class="pre">INSTALL</span></code> target.</li>
</ul>
</div>
...
<ul class="simple">
<li>A <span class="target" id="index-0-prop_tgt:BUILD_RPATH"></span><a class="reference internal" href="../prop_tgt/BUILD_RPATH.html#prop_tgt:BUILD_RPATH" title="BUILD_RPATH"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">BUILD_RPATH</span></code></a> target property and corresponding
...
<li>The <span class="target" id="index-0-prop_tgt:FRAMEWORK"></span><a class="reference internal" href="../prop_tgt/FRAMEWORK.html#prop_tgt:FRAMEWORK" title="FRAMEWORK"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">FRAMEWORK</span></code></a> target property may now also be applied to
...
<li>A <span class="target" id="index-0-prop_tgt:&lt;LANG&gt;_CPPLINT"></span><a class="reference internal" href="../prop_tgt/LANG_CPPLINT.html#prop_tgt:&lt;LANG&gt;_CPPLINT" title="&lt;LANG&gt;_CPPLINT"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">&lt;LANG&gt;_CPPLINT</span></code></a> target property and supporting
...
<code class="docutils literal notranslate"><span class="pre">CXX</span></code> languages.</li>
...
the <span class="target" id="index-0-command:add_dependencies"></span><a class="reference internal" href="../command/add_dependencies.html#command:add_dependencies" title="add_dependencies"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">add_dependencies()</span></code></a> command.</li>
...
custom MSBuild user <code class="docutils literal notranslate"><span class="pre">.props</span></code> file.</li>
...
with multiple SDKs like <code class="docutils literal notranslate"><span class="pre">macosx</span></code> and <code class="docutils literal notranslate"><span class="pre">iphoneos</span></code> in parallel.</li>
...
<li>The <span class="target" id="index-0-module:ExternalData"></span><a class="reference internal" href="../module/ExternalData.html#module:ExternalData" title="ExternalData"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">ExternalData</span></code></a> module learned to support multiple
...
to pass <code class="docutils literal notranslate"><span class="pre">--config</span></code> options to Git when cloning repositories.</li>
...
<li>The <span class="target" id="index-0-module:FindOpenGL"></span><a class="reference internal" href="../module/FindOpenGL.html#module:FindOpenGL" title="FindOpenGL"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindOpenGL</span></code></a> module now provides imported targets
<code class="docutils literal notranslate"><span class="pre">OpenGL::GL</span></code> and <code class="docutils literal notranslate"><span class="pre">OpenGL::GLU</span></code> when the libraries are found.</li>
...
to give more flexibility over the old <code class="docutils literal notranslate"><span class="pre">swig_add_module</span></code> command.</li>
...
file location (<code class="docutils literal notranslate"><span class="pre">swig</span> <span class="pre">-o</span></code>).</li>
...
independently from <code class="docutils literal notranslate"><span class="pre">AddressSanitizer</span></code>.</li>
...
to honor the <code class="docutils literal notranslate"><span class="pre">RETRY_COUNT</span></code>, <code class="docutils literal notranslate"><span class="pre">RETRY_DELAY</span></code>, and <code class="docutils literal notranslate"><span class="pre">QUIET</span></code> options.</li>
</ul>
</div>
...
command gained a new <code class="docutils literal notranslate"><span class="pre">DEPENDENCIES</span></code> alias for <code class="docutils literal notranslate"><span class="pre">DEPENDS</span></code> option.</li>
...
Please use new <code class="docutils literal notranslate"><span class="pre">SORTING_PRIORITY</span></code> option instead.</li>
...
are ignored and a developer warning is printed out.</li>
...
<li>The <span class="target" id="index-2-cpack_gen:CPack RPM Generator"></span><a class="reference internal" href="../cpack_gen/rpm.html#cpack_gen:CPack RPM Generator" title="CPack RPM Generator"><code class="xref cmake cmake-cpack_gen docutils literal notranslate"><span class="pre">CPack</span> <span class="pre">RPM</span> <span class="pre">Generator</span></code></a> learned to generate a single
...
<li>A new generator expression <code class="docutils literal notranslate"><span class="pre">$&lt;IF:cond,true-value,false-value&gt;</span></code> was added.
...
the false-value if the condition is <code class="docutils literal notranslate"><span class="pre">0</span></code>.</li>
</ul>
</div>
</div>
...
deprecated in favor of <code class="docutils literal notranslate"><span class="pre">swig_add_library</span></code>.</li>
</ul>
</div>
...
silently ignored.</li>
<li>The <span class="target" id="index-3-command:ctest_memcheck"></span><a class="reference internal" href="../command/ctest_memcheck.html#command:ctest_memcheck" title="ctest_memcheck"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">ctest_memcheck()</span></code></a> command no longer automatically adds
...
unless <code class="docutils literal notranslate"><span class="pre">leak_check=0</span></code>.</li>
...
<span class="target" id="index-1-prop_tgt:INCLUDE_DIRECTORIES"></span><a class="reference internal" href="../prop_tgt/INCLUDE_DIRECTORIES.html#prop_tgt:INCLUDE_DIRECTORIES" title="INCLUDE_DIRECTORIES"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">INCLUDE_DIRECTORIES</span></code></a>.</li>
...
enabled.</li>
<li>The <span class="target" id="index-2-command:try_compile"></span><a class="reference internal" href="../command/try_compile.html#command:try_compile" title="try_compile"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">try_compile()</span></code></a> command source file signature now
...
<li>The precompiled Windows binary MSI package provided on <code class="docutils literal notranslate"><span class="pre">cmake.org</span></code> now
records the installation directory in the Windows Registry under the key
<code class="docutils literal notranslate"><span class="pre">HKLM\Software\Kitware\CMake</span></code> with a value named <code class="docutils literal notranslate"><span class="pre">InstallDir</span></code>.</li>
</ul>
</div>
</div>
