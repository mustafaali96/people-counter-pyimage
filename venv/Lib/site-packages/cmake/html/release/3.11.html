...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMake 3.11 Release Notes &mdash; CMake 3.16.1 Documentation</title>
...
<ul class="simple">
<li><a class="reference internal" href="#cmake-3-11-release-notes" id="id4">CMake 3.11 Release Notes</a><ul>
<li><a class="reference internal" href="#new-features" id="id5">New Features</a><ul>
<li><a class="reference internal" href="#platforms" id="id6">Platforms</a></li>
...
<li><a class="reference internal" href="#autogen" id="id12">Autogen</a></li>
...
<li><a class="reference internal" href="#updates" id="id18">Updates</a><ul>
<li><a class="reference internal" href="#id1" id="id19">3.11.1</a></li>
<li><a class="reference internal" href="#id2" id="id20">3.11.2</a></li>
<li><a class="reference internal" href="#id3" id="id21">3.11.3</a></li>
</ul>
</li>
</ul>
</li>
...
<ul class="simple">
<li>TI C/C++ compilers are now supported by the <span class="target" id="index-0-generator:Ninja"></span><a class="reference internal" href="../generator/Ninja.html#generator:Ninja" title="Ninja"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Ninja</span></code></a> generator.</li>
</ul>
</div>
...
<ul class="simple">
<li>The <span class="target" id="index-0-generator:CodeBlocks"></span><a class="reference internal" href="../generator/CodeBlocks.html#generator:CodeBlocks" title="CodeBlocks"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">CodeBlocks</span></code></a> extra generator learned to check a
...
compiler identification value to place in the project file.</li>
...
<span class="target" id="index-0-prop_tgt:&lt;LANG&gt;_COMPILER_LAUNCHER"></span><a class="reference internal" href="../prop_tgt/LANG_COMPILER_LAUNCHER.html#prop_tgt:&lt;LANG&gt;_COMPILER_LAUNCHER" title="&lt;LANG&gt;_COMPILER_LAUNCHER"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">&lt;LANG&gt;_COMPILER_LAUNCHER</span></code></a> target property for details.</li>
<li><a class="reference internal" href="../manual/cmake-generators.7.html#visual-studio-generators"><span class="std std-ref">Visual Studio Generators</span></a> learned to support the <code class="docutils literal notranslate"><span class="pre">COMPILE_LANGUAGE</span></code>
...
<code class="docutils literal notranslate"><span class="pre">.netrc</span></code> file.</li>
...
<a class="reference internal" href="../manual/cmake-buildsystem.7.html#imported-targets"><span class="std std-ref">Imported Targets</span></a>.</li>
...
<a class="reference internal" href="../manual/cmake-buildsystem.7.html#imported-targets"><span class="std std-ref">Imported Targets</span></a>.</li>
<li>The <span class="target" id="index-1-command:target_sources"></span><a class="reference internal" href="../command/target_sources.html#command:target_sources" title="target_sources"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">target_sources()</span></code></a> command learned to set the
...
<ul class="simple">
<li>A <span class="target" id="index-0-variable:CMAKE_GENERATOR_INSTANCE"></span><a class="reference internal" href="../variable/CMAKE_GENERATOR_INSTANCE.html#variable:CMAKE_GENERATOR_INSTANCE" title="CMAKE_GENERATOR_INSTANCE"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_GENERATOR_INSTANCE</span></code></a> variable was introduced
...
selected instance of Visual Studio persistently.</li>
<li>A <span class="target" id="index-0-variable:CMAKE_INSTALL_DEFAULT_DIRECTORY_PERMISSIONS"></span><a class="reference internal" href="../variable/CMAKE_INSTALL_DEFAULT_DIRECTORY_PERMISSIONS.html#variable:CMAKE_INSTALL_DEFAULT_DIRECTORY_PERMISSIONS" title="CMAKE_INSTALL_DEFAULT_DIRECTORY_PERMISSIONS"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_INSTALL_DEFAULT_DIRECTORY_PERMISSIONS</span></code></a> variable was added
...
<li>A <span class="target" id="index-0-variable:CMAKE_JOB_POOLS"></span><a class="reference internal" href="../variable/CMAKE_JOB_POOLS.html#variable:CMAKE_JOB_POOLS" title="CMAKE_JOB_POOLS"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_JOB_POOLS</span></code></a> variable was added specify a value to use for
...
the <span class="target" id="index-0-module:ExternalProject"></span><a class="reference internal" href="../module/ExternalProject.html#module:ExternalProject" title="ExternalProject"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">ExternalProject</span></code></a> module.</li>
<li>A <span class="target" id="index-0-variable:CMAKE_CUDA_SEPARABLE_COMPILATION"></span><a class="reference internal" href="../variable/CMAKE_CUDA_SEPARABLE_COMPILATION.html#variable:CMAKE_CUDA_SEPARABLE_COMPILATION" title="CMAKE_CUDA_SEPARABLE_COMPILATION"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_CUDA_SEPARABLE_COMPILATION</span></code></a> variable was added to
...
on targets when they are created.</li>
</ul>
</div>
...
<li>A <span class="target" id="index-0-prop_sf:COMPILE_OPTIONS"></span><a class="reference internal" href="../prop_sf/COMPILE_OPTIONS.html#prop_sf:COMPILE_OPTIONS" title="COMPILE_OPTIONS"><code class="xref cmake cmake-prop_sf docutils literal notranslate"><span class="pre">COMPILE_OPTIONS</span></code></a> source file property was added to manage list
of options to pass to the compiler.</li>
<li>An <span class="target" id="index-0-prop_tgt:IMPORTED_GLOBAL"></span><a class="reference internal" href="../prop_tgt/IMPORTED_GLOBAL.html#prop_tgt:IMPORTED_GLOBAL" title="IMPORTED_GLOBAL"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">IMPORTED_GLOBAL</span></code></a> target property was added to indicate
...
to be globally visible by setting this property to <code class="docutils literal notranslate"><span class="pre">TRUE</span></code>.</li>
<li>An <span class="target" id="index-0-prop_sf:INCLUDE_DIRECTORIES"></span><a class="reference internal" href="../prop_sf/INCLUDE_DIRECTORIES.html#prop_sf:INCLUDE_DIRECTORIES" title="INCLUDE_DIRECTORIES"><code class="xref cmake cmake-prop_sf docutils literal notranslate"><span class="pre">INCLUDE_DIRECTORIES</span></code></a> source file property was added to specify
list of preprocessor include file search directories.</li>
<li>Source file properties <span class="target" id="index-0-prop_sf:VS_SHADER_DISABLE_OPTIMIZATIONS"></span><a class="reference internal" href="../prop_sf/VS_SHADER_DISABLE_OPTIMIZATIONS.html#prop_sf:VS_SHADER_DISABLE_OPTIMIZATIONS" title="VS_SHADER_DISABLE_OPTIMIZATIONS"><code class="xref cmake cmake-prop_sf docutils literal notranslate"><span class="pre">VS_SHADER_DISABLE_OPTIMIZATIONS</span></code></a> and
...
details of <code class="docutils literal notranslate"><span class="pre">.hlsl</span></code> sources with <a class="reference internal" href="../manual/cmake-generators.7.html#visual-studio-generators"><span class="std std-ref">Visual Studio Generators</span></a>.</li>
</ul>
</div>
...
<code class="docutils literal notranslate"><span class="pre">C</span></code> or <code class="docutils literal notranslate"><span class="pre">CXX</span></code> compiler.</li>
...
<code class="docutils literal notranslate"><span class="pre">SameMinorVersion</span></code> mode for the <code class="docutils literal notranslate"><span class="pre">COMPATIBILITY</span></code> argument.</li>
...
in comments, commands, working directory and byproducts.</li>
...
options to specify use of a <code class="docutils literal notranslate"><span class="pre">.netrc</span></code> file.</li>
<li>A new <span class="target" id="index-0-module:FetchContent"></span><a class="reference internal" href="../module/FetchContent.html#module:FetchContent" title="FetchContent"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FetchContent</span></code></a> module was added which supports populating
...
throughout the whole project tree.</li>
...
<a class="reference external" href="https://github.com/flame">FLAME</a> <code class="docutils literal notranslate"><span class="pre">blis</span></code> and <code class="docutils literal notranslate"><span class="pre">libflame</span></code>.</li>
...
output <code class="docutils literal notranslate"><span class="pre">Doxyfile</span></code>.</li>
<li>A <span class="target" id="index-0-module:FindIconv"></span><a class="reference internal" href="../module/FindIconv.html#module:FindIconv" title="FindIconv"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindIconv</span></code></a> module was added to locate iconv support.</li>
...
generated export header’s include guard.</li>
...
to removal of the <code class="docutils literal notranslate"><span class="pre">javah</span></code> tool by <a class="reference external" href="http://openjdk.java.net/jeps/313">JEP 313</a>.</li>
</ul>
</div>
...
is derived from the number of CPUs on the host.</li>
</ul>
</div>
...
<ul class="simple">
<li>The <span class="target" id="index-0-command:ctest_start"></span><a class="reference internal" href="../command/ctest_start.html#command:ctest_start" title="ctest_start"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">ctest_start()</span></code></a> command no longer sets
...
global scope still prevents the script from being re-run at the end.</li>
</ul>
</div>
...
<ul class="simple">
<li><span class="target" id="index-0-manual:cpack(1)"></span><a class="reference internal" href="../manual/cpack.1.html#manual:cpack(1)" title="cpack(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cpack(1)</span></code></a> gained <code class="docutils literal notranslate"><span class="pre">--trace</span></code> and <code class="docutils literal notranslate"><span class="pre">--trace-expand</span></code> options.</li>
...
if the target directory should not be deleted when uninstalling.</li>
...
See <span class="target" id="index-0-variable:CPACK_RPM_INSTALL_WITH_EXEC"></span><a class="reference internal" href="../cpack_gen/rpm.html#variable:CPACK_RPM_INSTALL_WITH_EXEC" title="CPACK_RPM_INSTALL_WITH_EXEC"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_RPM_INSTALL_WITH_EXEC</span></code></a> variable.</li>
<li>A <span class="target" id="index-0-variable:CPACK_INSTALL_DEFAULT_DIRECTORY_PERMISSIONS"></span><a class="reference internal" href="../variable/CPACK_INSTALL_DEFAULT_DIRECTORY_PERMISSIONS.html#variable:CPACK_INSTALL_DEFAULT_DIRECTORY_PERMISSIONS" title="CPACK_INSTALL_DEFAULT_DIRECTORY_PERMISSIONS"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_INSTALL_DEFAULT_DIRECTORY_PERMISSIONS</span></code></a> variable was added
...
installation (e.g. <code class="docutils literal notranslate"><span class="pre">make</span> <span class="pre">install</span></code>).</li>
</ul>
</div>
<div class="section" id="other">
<h3><a class="toc-backref" href="#id15">Other</a><a class="headerlink" href="#other" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
<li><a class="reference internal" href="../manual/cmake-buildsystem.7.html#alias-targets"><span class="std std-ref">Alias Targets</span></a> may now alias <a class="reference internal" href="../manual/cmake-buildsystem.7.html#imported-targets"><span class="std std-ref">Imported Targets</span></a> that are
created with the <code class="docutils literal notranslate"><span class="pre">GLOBAL</span></code> option to <span class="target" id="index-2-command:add_library"></span><a class="reference internal" href="../command/add_library.html#command:add_library" title="add_library"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">add_library()</span></code></a>.</li>
<li><a class="reference internal" href="../manual/cmake-buildsystem.7.html#interface-libraries"><span class="std std-ref">Interface Libraries</span></a> may now have custom properties set on them if
...
<code class="docutils literal notranslate"><span class="pre">INTERFACE</span></code> libraries, but it also blocked usage of custom properties.</li>
...
<ul class="simple">
<li>An explicit deprecation diagnostic was added for policies <code class="docutils literal notranslate"><span class="pre">CMP0037</span></code>
...
NEW behaviors.</li>
<li>The <code class="docutils literal notranslate"><span class="pre">KDevelop3</span></code> generator has been removed.</li>
</ul>
</div>
...
<ul class="simple">
<li>Policy <span class="target" id="index-0-policy:CMP0037"></span><a class="reference internal" href="../policy/CMP0037.html#policy:CMP0037" title="CMP0037"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0037</span></code></a> no longer reserves target names associated
...
the corresponding feature is enabled.</li>
<li>The <span class="target" id="index-0-module:FindOpenGL"></span><a class="reference internal" href="../module/FindOpenGL.html#module:FindOpenGL" title="FindOpenGL"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindOpenGL</span></code></a> module now prefers GLVND libraries if available.
See policy <span class="target" id="index-0-policy:CMP0072"></span><a class="reference internal" href="../policy/CMP0072.html#policy:CMP0072" title="CMP0072"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0072</span></code></a>.</li>
<li>The minimum deployment target set in the
...
iOS version.</li>
<li>The <span class="target" id="index-1-generator:Xcode"></span><a class="reference internal" href="../generator/Xcode.html#generator:Xcode" title="Xcode"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Xcode</span></code></a> generator behavior of generating one project
...
large projects and to work-around a bug in the <code class="docutils literal notranslate"><span class="pre">ZERO_CHECK</span></code> logic.</li>
<li>Since the <code class="docutils literal notranslate"><span class="pre">CMakeCache.txt</span></code> format does not support newlines in values,
...
message is displayed to the user on the console.</li>
</ul>
</div>
...
with a policy for compatibility.</li>
</ul>
</div>
<div class="section" id="id2">
<h3><a class="toc-backref" href="#id20">3.11.2</a><a class="headerlink" href="#id2" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
<li>Calling <span class="target" id="index-3-command:add_library"></span><a class="reference internal" href="../command/add_library.html#command:add_library" title="add_library"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">add_library()</span></code></a> to create an alias of an imported
...
imported targets to be aliased.</li>
...
account for policy <span class="target" id="index-0-policy:CMP0071"></span><a class="reference internal" href="../policy/CMP0071.html#policy:CMP0071" title="CMP0071"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0071</span></code></a>.</li>
</ul>
</div>
<div class="section" id="id3">
<h3><a class="toc-backref" href="#id21">3.11.3</a><a class="headerlink" href="#id3" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
<li>CMake 3.11.0 introduced support for resolving symbolic links on
Windows in code paths that typically do so on UNIX.  This has been
reverted due to breakage on <code class="docutils literal notranslate"><span class="pre">subst</span></code> drives.</li>
</ul>
</div>
</div>
</div>
