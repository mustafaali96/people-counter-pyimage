...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMake 3.1 Release Notes &mdash; CMake 3.16.1 Documentation</title>
...
implementation.  See policy <span class="target" id="index-0-policy:CMP0053"></span><a class="reference internal" href="../policy/CMP0053.html#policy:CMP0053" title="CMP0053"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0053</span></code></a>.</li>
<li>The <span class="target" id="index-0-command:if"></span><a class="reference internal" href="../command/if.html#command:if" title="if"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">if()</span></code></a> command no longer automatically dereferences
variables named in quoted or bracket arguments.  See policy
<span class="target" id="index-0-policy:CMP0054"></span><a class="reference internal" href="../policy/CMP0054.html#policy:CMP0054" title="CMP0054"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0054</span></code></a>.</li>
</ul>
</div>
...
<span class="target" id="index-0-manual:cmake-generator-expressions(7)"></span><a class="reference internal" href="../manual/cmake-generator-expressions.7.html#manual:cmake-generator-expressions(7)" title="cmake-generator-expressions(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake-generator-expressions(7)</span></code></a> in arguments to <code class="docutils literal notranslate"><span class="pre">DEPENDS</span></code>.</li>
<li>The <span class="target" id="index-0-command:export"></span><a class="reference internal" href="../command/export.html#command:export" title="export"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">export(PACKAGE)</span></code></a> command learned to check the
...
option to enable extraction of <code class="docutils literal notranslate"><span class="pre">UTF-8</span></code> strings.</li>
<li>The <span class="target" id="index-0-command:find_package"></span><a class="reference internal" href="../command/find_package.html#command:find_package" title="find_package"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">find_package()</span></code></a> command learned to check the
...
which removes
<span class="target" id="index-1-manual:cmake-generator-expressions(7)"></span><a class="reference internal" href="../manual/cmake-generator-expressions.7.html#manual:cmake-generator-expressions(7)" title="cmake-generator-expressions(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">generator</span> <span class="pre">expression</span></code></a>.</li>
...
<span class="target" id="index-0-prop_tgt:SOURCES"></span><a class="reference internal" href="../prop_tgt/SOURCES.html#prop_tgt:SOURCES" title="SOURCES"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">SOURCES</span></code></a> target property.</li>
</ul>
</div>
...
with the <code class="docutils literal notranslate"><span class="pre">-A</span></code> option, e.g. <code class="docutils literal notranslate"><span class="pre">-G</span> <span class="pre">&quot;Visual</span> <span class="pre">Studio</span> <span class="pre">12</span> <span class="pre">2013&quot;</span> <span class="pre">-A</span> <span class="pre">x64</span></code>.</li>
...
features.</li>
<li>New <span class="target" id="index-0-prop_tgt:COMPILE_PDB_NAME"></span><a class="reference internal" href="../prop_tgt/COMPILE_PDB_NAME.html#prop_tgt:COMPILE_PDB_NAME" title="COMPILE_PDB_NAME"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">COMPILE_PDB_NAME</span></code></a> and
...
file location (<code class="docutils literal notranslate"><span class="pre">link</span> <span class="pre">/pdb</span></code>).</li>
...
<li>The <span class="target" id="index-1-prop_tgt:SOURCES"></span><a class="reference internal" href="../prop_tgt/SOURCES.html#prop_tgt:SOURCES" title="SOURCES"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">SOURCES</span></code></a> target property now contains
...
policy <span class="target" id="index-0-policy:CMP0051"></span><a class="reference internal" href="../policy/CMP0051.html#policy:CMP0051" title="CMP0051"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0051</span></code></a> is <code class="docutils literal notranslate"><span class="pre">NEW</span></code>.</li>
<li>The <span class="target" id="index-2-prop_tgt:SOURCES"></span><a class="reference internal" href="../prop_tgt/SOURCES.html#prop_tgt:SOURCES" title="SOURCES"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">SOURCES</span></code></a> target property now generally supports
...
<span class="target" id="index-0-command:add_executable"></span><a class="reference internal" href="../command/add_executable.html#command:add_executable" title="add_executable"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">add_executable()</span></code></a> commands.</li>
<li>It is now possible to write and append to the <span class="target" id="index-3-prop_tgt:SOURCES"></span><a class="reference internal" href="../prop_tgt/SOURCES.html#prop_tgt:SOURCES" title="SOURCES"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">SOURCES</span></code></a> target
...
<li>The <span class="target" id="index-0-generator:Xcode"></span><a class="reference internal" href="../generator/Xcode.html#generator:Xcode" title="Xcode"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Xcode</span></code></a> generator learned to check source
...
provide a <code class="docutils literal notranslate"><span class="pre">CHECK_Fortran_SOURCE_COMPILES</span></code> macro.</li>
...
source tarballs with <code class="docutils literal notranslate"><span class="pre">.7z</span></code>, <code class="docutils literal notranslate"><span class="pre">.tar.xz</span></code>, and <code class="docutils literal notranslate"><span class="pre">.txz</span></code> extensions.</li>
...
<li>The <span class="target" id="index-0-module:FindGLEW"></span><a class="reference internal" href="../module/FindGLEW.html#module:FindGLEW" title="FindGLEW"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindGLEW</span></code></a> module now provides imported targets.</li>
<li>The <span class="target" id="index-0-module:FindGLUT"></span><a class="reference internal" href="../module/FindGLUT.html#module:FindGLUT" title="FindGLUT"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindGLUT</span></code></a> module now provides imported targets.</li>
...
help run <code class="docutils literal notranslate"><span class="pre">hg</span></code> to extract information about a Mercurial work copy.</li>
<li>The <span class="target" id="index-0-module:FindOpenCL"></span><a class="reference internal" href="../module/FindOpenCL.html#module:FindOpenCL" title="FindOpenCL"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindOpenCL</span></code></a> module was introduced.</li>
<li>The <span class="target" id="index-0-module:FindOpenMP"></span><a class="reference internal" href="../module/FindOpenMP.html#module:FindOpenMP" title="FindOpenMP"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindOpenMP</span></code></a> module learned to support Fortran.</li>
...
environment variable value as the <code class="docutils literal notranslate"><span class="pre">pkg-config</span></code> executable, if set.</li>
<li>The <span class="target" id="index-0-module:FindXercesC"></span><a class="reference internal" href="../module/FindXercesC.html#module:FindXercesC" title="FindXercesC"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindXercesC</span></code></a> module was introduced.</li>
<li>The <span class="target" id="index-0-module:FindZLIB"></span><a class="reference internal" href="../module/FindZLIB.html#module:FindZLIB" title="FindZLIB"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindZLIB</span></code></a> module now provides imported targets.</li>
...
<li>The <span class="target" id="index-0-module:UseSWIG"></span><a class="reference internal" href="../module/UseSWIG.html#module:UseSWIG" title="UseSWIG"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">UseSWIG</span></code></a> module learned to detect the module name
...
the <code class="docutils literal notranslate"><span class="pre">SWIG_MODULE_NAME</span></code> source file property explicitly.</li>
...
<ul class="simple">
<li>New <code class="docutils literal notranslate"><span class="pre">COMPILE_FEATURES</span></code>
...
<code class="docutils literal notranslate"><span class="pre">CTEST_COVERAGE_EXTRA_FLAGS</span></code> to set <code class="docutils literal notranslate"><span class="pre">CoverageExtraFlags</span></code>.</li>
<li>The <span class="target" id="index-1-command:ctest_coverage"></span><a class="reference internal" href="../command/ctest_coverage.html#command:ctest_coverage" title="ctest_coverage"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">ctest_coverage()</span></code></a> command learned to support
Intel coverage files with the <code class="docutils literal notranslate"><span class="pre">codecov</span></code> tool.</li>
...
<ul class="simple">
<li>The <span class="target" id="index-3-manual:cmake(1)"></span><a class="reference internal" href="../manual/cmake.1.html#manual:cmake(1)" title="cmake(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake(1)</span></code></a> <code class="docutils literal notranslate"><span class="pre">-E</span></code> option learned a new <code class="docutils literal notranslate"><span class="pre">env</span></code> command.</li>
...
of a normal library (e.g. <code class="docutils literal notranslate"><span class="pre">.dat</span></code> is okay but not <code class="docutils literal notranslate"><span class="pre">.def</span></code>).</li>
<li>Visual Studio generators for VS 8 and later learned to support
the <code class="docutils literal notranslate"><span class="pre">ASM_MASM</span></code> language.</li>
<li>The Visual Studio generators learned to treat <code class="docutils literal notranslate"><span class="pre">.hlsl</span></code> source
...
<ul class="simple">
<li>Policy <span class="target" id="index-0-policy:CMP0052"></span><a class="reference internal" href="../policy/CMP0052.html#policy:CMP0052" title="CMP0052"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0052</span></code></a> introduced to control directories in the
...
<li><p class="first">Prior to CMake 3.1 the Makefile generators did not escape <code class="docutils literal notranslate"><span class="pre">#</span></code>
...
<code class="docutils literal notranslate"><span class="pre">UNKNOWN_READ_ACCESS</span></code>.</p>
</li>
...
<li><p class="first">The <span class="target" id="index-0-module:FindITK"></span><a class="reference internal" href="../module/FindITK.html#module:FindITK" title="FindITK"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindITK</span></code></a> module has been removed altogether.
...
<li><p class="first">The <span class="target" id="index-0-module:FindVTK"></span><a class="reference internal" href="../module/FindVTK.html#module:FindVTK" title="FindVTK"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindVTK</span></code></a> module has been removed altogether.
...
<ul class="simple">
<li>The <span class="target" id="index-0-manual:cmake-gui(1)"></span><a class="reference internal" href="../manual/cmake-gui.1.html#manual:cmake-gui(1)" title="cmake-gui(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake-gui(1)</span></code></a> learned to capture output from child
...
by 11.</li>
<li>The <code class="docutils literal notranslate"><span class="pre">cmake-mode.el</span></code> major Emacs editing mode no longer
