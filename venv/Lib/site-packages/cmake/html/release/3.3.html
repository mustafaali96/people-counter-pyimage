...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMake 3.3 Release Notes &mdash; CMake 3.16.1 Documentation</title>
...
<ul class="simple">
<li>The <a class="reference internal" href="../manual/cmake-generators.7.html#makefile-generators"><span class="std std-ref">Makefile Generators</span></a> now add <code class="docutils literal notranslate"><span class="pre">.DELETE_ON_ERROR</span></code> to the
...
<li>The <a class="reference internal" href="../manual/cmake-generators.7.html#visual-studio-generators"><span class="std std-ref">Visual Studio Generators</span></a> learned to support <code class="docutils literal notranslate"><span class="pre">.xaml</span></code>
source files and automatically associate them with corresponding
<code class="docutils literal notranslate"><span class="pre">.h</span></code> and <code class="docutils literal notranslate"><span class="pre">.cpp</span></code> sources.</li>
...
the same file for <code class="docutils literal notranslate"><span class="pre">OUTPUT_FILE</span></code> and <code class="docutils literal notranslate"><span class="pre">ERROR_FILE</span></code>.</li>
...
target property.</li>
<li>The <span class="target" id="index-1-command:install"></span><a class="reference internal" href="../command/install.html#command:install" title="install"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">install(TARGETS)</span></code></a> command learned to support
generator expressions in the <code class="docutils literal notranslate"><span class="pre">DESTINATION</span></code> value.</li>
</ul>
</div>
...
solution (<code class="docutils literal notranslate"><span class="pre">.sln</span></code>) file.</li>
</ul>
</div>
...
policy <span class="target" id="index-0-policy:CMP0063"></span><a class="reference internal" href="../policy/CMP0063.html#policy:CMP0063" title="CMP0063"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0063</span></code></a>.</li>
...
<span class="target" id="index-0-module:CheckCCompilerFlag"></span><a class="reference internal" href="../module/CheckCCompilerFlag.html#module:CheckCCompilerFlag" title="CheckCCompilerFlag"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CheckCCompilerFlag</span></code></a> module already does for <code class="docutils literal notranslate"><span class="pre">C</span></code>.</li>
<li>The <span class="target" id="index-0-module:ExternalData"></span><a class="reference internal" href="../module/ExternalData.html#module:ExternalData" title="ExternalData"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">ExternalData</span></code></a> module learned a new
...
to be matched.</li>
<li>The <span class="target" id="index-2-module:ExternalData"></span><a class="reference internal" href="../module/ExternalData.html#module:ExternalData" title="ExternalData"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">ExternalData</span></code></a> module learned a new URL template
...
like <code class="docutils literal notranslate"><span class="pre">&lt;BINARY_DIR&gt;</span></code> in the <code class="docutils literal notranslate"><span class="pre">BYPRODUCTS</span></code> of each step.</li>
...
when using <code class="docutils literal notranslate"><span class="pre">LOG_*</span></code> options and in CMake initial cache options.</li>
<li>The <span class="target" id="index-0-module:FindBoost"></span><a class="reference internal" href="../module/FindBoost.html#module:FindBoost" title="FindBoost"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindBoost</span></code></a> module now tracks the directories containing
libraries separately for RELEASE and DEBUG configurations.</li>
<li>The <span class="target" id="index-0-module:FindCUDA"></span><a class="reference internal" href="../module/FindCUDA.html#module:FindCUDA" title="FindCUDA"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindCUDA</span></code></a> module now defaults to using the static
...
this behavior.</li>
<li>The <span class="target" id="index-0-module:FindMatlab"></span><a class="reference internal" href="../module/FindMatlab.html#module:FindMatlab" title="FindMatlab"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindMatlab</span></code></a> module was completely rewritten.  It learned
...
<ul class="simple">
<li>A new <code class="docutils literal notranslate"><span class="pre">COMPILE_LANGUAGE</span></code> generator expression was introduced to
...
<span class="target" id="index-0-command:ctest_coverage"></span><a class="reference internal" href="../command/ctest_coverage.html#command:ctest_coverage" title="ctest_coverage"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">ctest_coverage()</span></code></a> command.</li>
</ul>
</div>
...
Qt Framework Installer 2.0 tools.</li>
...
variable to specify per-component use of <code class="docutils literal notranslate"><span class="pre">dpkg-shlibdeps</span></code>.</li>
...
<code class="docutils literal notranslate"><span class="pre">rpmbuild</span></code> versions.</li>
...
provides convenience functions to handle <span class="target" id="index-0-prop_tgt:XCTEST"></span><a class="reference internal" href="../prop_tgt/XCTEST.html#prop_tgt:XCTEST" title="XCTEST"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">XCTEST</span></code></a> bundles.</li>
</ul>
</div>
</div>
...
<ul>
<li><p class="first">On OS X the <span class="target" id="index-0-manual:cmake-gui(1)"></span><a class="reference internal" href="../manual/cmake-gui.1.html#manual:cmake-gui(1)" title="cmake-gui(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake-gui(1)</span></code></a> no longer has the
...
See policy <span class="target" id="index-0-policy:CMP0061"></span><a class="reference internal" href="../policy/CMP0061.html#policy:CMP0061" title="CMP0061"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0061</span></code></a>.</p>
</li>
...
<span class="target" id="index-0-policy:CMP0059"></span><a class="reference internal" href="../policy/CMP0059.html#policy:CMP0059" title="CMP0059"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0059</span></code></a>.</p>
</li>
<li><p class="first">With Visual Studio 7, 8, and 9 generators the value of the <code class="docutils literal notranslate"><span class="pre">$(OutDir)</span></code>
placeholder no longer evaluates to the configuration name.  Projects
should use <code class="docutils literal notranslate"><span class="pre">$(ConfigurationName)</span></code> for that instead.</p>
</li>
...
command is no longer allowed.  See policy <span class="target" id="index-0-policy:CMP0062"></span><a class="reference internal" href="../policy/CMP0062.html#policy:CMP0062" title="CMP0062"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0062</span></code></a> for details.</p>
</li>
</ul>
</div>
...
<ul class="simple">
<li>The <span class="target" id="index-1-generator:Ninja"></span><a class="reference internal" href="../generator/Ninja.html#generator:Ninja" title="Ninja"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Ninja</span></code></a> generator now requires that calls to the
...
than the inputs).  See policy <span class="target" id="index-0-policy:CMP0058"></span><a class="reference internal" href="../policy/CMP0058.html#policy:CMP0058" title="CMP0058"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0058</span></code></a>.</li>
...
See policy <span class="target" id="index-0-policy:CMP0060"></span><a class="reference internal" href="../policy/CMP0060.html#policy:CMP0060" title="CMP0060"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0060</span></code></a>.</li>
</ul>
</div>
</div>
