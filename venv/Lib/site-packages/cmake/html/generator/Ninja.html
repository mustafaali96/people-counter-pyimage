...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>Ninja &mdash; CMake 3.16.1 Documentation</title>
...
are generated:</p>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">sub/dir/all</span></code></dt>
<dd>Depends on all targets required by the subdirectory.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">sub/dir/install</span></code></dt>
<dd>Runs the install step in the subdirectory, if any.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">sub/dir/install/strip</span></code></dt>
<dd><p class="first">Runs the install step in the subdirectory followed by a <code class="docutils literal notranslate"><span class="pre">CMAKE_STRIP</span></code> command,
if any.</p>
<p class="last">The <code class="docutils literal notranslate"><span class="pre">CMAKE_STRIP</span></code> variable will contain the platform’s <code class="docutils literal notranslate"><span class="pre">strip</span></code> utility, which
removes symbols information from generated binaries.</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">sub/dir/test</span></code></dt>
<dd>Runs the test step in the subdirectory, if any.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">sub/dir/package</span></code></dt>
