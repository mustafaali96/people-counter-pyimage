...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FIXTURES_REQUIRED &mdash; CMake 3.16.1 Documentation</title>
...
<ul class="simple">
<li>Two fixtures are defined: <code class="docutils literal notranslate"><span class="pre">DB</span></code> and <code class="docutils literal notranslate"><span class="pre">Foo</span></code>. Tests can require a single
...
fixtures like <code class="docutils literal notranslate"><span class="pre">dbWithFoo</span></code> does.</li>
<li>A <code class="docutils literal notranslate"><span class="pre">DEPENDS</span></code> relationship is set up to ensure <code class="docutils literal notranslate"><span class="pre">setupUsers</span></code> happens after
...
automatically.</li>
<li>No explicit <code class="docutils literal notranslate"><span class="pre">DEPENDS</span></code> relationships were needed to make the setup tests run
before or the cleanup tests run after the regular tests.</li>
<li>The <code class="docutils literal notranslate"><span class="pre">Foo</span></code> fixture has no setup tests defined, only a single cleanup test.</li>
<li><code class="docutils literal notranslate"><span class="pre">testsDone</span></code> is a cleanup test for both the <code class="docutils literal notranslate"><span class="pre">DB</span></code> and <code class="docutils literal notranslate"><span class="pre">Foo</span></code> fixtures.
