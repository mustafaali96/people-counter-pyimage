...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>cmake-compile-features(7) &mdash; CMake 3.16.1 Documentation</title>
...
<div class="highlight-c++ notranslate"><div class="highlight"><pre><span></span><span class="cp">#include</span> <span class="cpf">&quot;foo_compiler_detection.h&quot;</span><span class="cp"></span>
...
<ul class="simple">
<li><code class="docutils literal notranslate"><span class="pre">AppleClang</span></code>: Apple Clang for Xcode versions 4.4+.</li>
<li><code class="docutils literal notranslate"><span class="pre">Clang</span></code>: Clang compiler versions 2.9+.</li>
<li><code class="docutils literal notranslate"><span class="pre">GNU</span></code>: GNU compiler versions 4.4+.</li>
<li><code class="docutils literal notranslate"><span class="pre">MSVC</span></code>: Microsoft Visual Studio versions 2010+.</li>
<li><code class="docutils literal notranslate"><span class="pre">SunPro</span></code>: Oracle SolarisStudio versions 12.4+.</li>
<li><code class="docutils literal notranslate"><span class="pre">Intel</span></code>: Intel compiler versions 12.1+.</li>
</ul>
...
<li><code class="docutils literal notranslate"><span class="pre">GNU</span></code>: GNU compiler versions 3.4+</li>
</ul>
...
versions specified for each:</p>
<ul class="simple">
<li><code class="docutils literal notranslate"><span class="pre">Cray</span></code>: Cray Compiler Environment version 8.1+.</li>
<li><code class="docutils literal notranslate"><span class="pre">PGI</span></code>: PGI version 12.10+.</li>
<li><code class="docutils literal notranslate"><span class="pre">XL</span></code>: IBM XL version 10.1+.</li>
</ul>
...
versions specified for each:</p>
<ul class="simple">
<li>all compilers and versions listed above with only meta-features for C++.</li>
<li><code class="docutils literal notranslate"><span class="pre">TI</span></code>: Texas Instruments compiler.</li>
</ul>
<p>CMake is currently aware of the <span class="target" id="index-0-prop_tgt:CUDA_STANDARD"></span><a class="reference internal" href="../prop_tgt/CUDA_STANDARD.html#prop_tgt:CUDA_STANDARD" title="CUDA_STANDARD"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">CUDA</span> <span class="pre">standards</span></code></a>
from the following <span class="target" id="index-4-variable:CMAKE_&lt;LANG&gt;_COMPILER_ID"></span><a class="reference internal" href="../variable/CMAKE_LANG_COMPILER_ID.html#variable:CMAKE_&lt;LANG&gt;_COMPILER_ID" title="CMAKE_&lt;LANG&gt;_COMPILER_ID"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">compiler</span> <span class="pre">ids</span></code></a> as of the
versions specified for each:</p>
<ul class="simple">
<li><code class="docutils literal notranslate"><span class="pre">NVIDIA</span></code>: NVIDIA nvcc compiler 7.5+.</li>
</ul>
</div>
</div>
