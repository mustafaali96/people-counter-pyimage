...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>ctest(1) &mdash; CMake 3.16.1 Documentation</title>
  ...
  <li>
    <a href="../index.html">3.16.1 Documentation</a> &#187;
  </li>
...
<h1><a class="toc-backref" href="#id13">ctest(1)</a><a class="headerlink" href="#ctest-1" title="Permalink to this headline">¶</a></h1>
<div class="contents topic" id="contents">
<p class="topic-title first">Contents</p>
<ul class="simple">
<li><a class="reference internal" href="#ctest-1" id="id13">ctest(1)</a><ul>
<li><a class="reference internal" href="#synopsis" id="id14">Synopsis</a></li>
...
<li><a class="reference internal" href="#label-and-subproject-summary" id="id17">Label and Subproject Summary</a></li>
<li><a class="reference internal" href="#build-and-test-mode" id="id18">Build and Test Mode</a></li>
<li><a class="reference internal" href="#dashboard-client" id="id19">Dashboard Client</a><ul>
<li><a class="reference internal" href="#dashboard-client-steps" id="id20">Dashboard Client Steps</a></li>
<li><a class="reference internal" href="#dashboard-client-modes" id="id21">Dashboard Client Modes</a></li>
<li><a class="reference internal" href="#dashboard-client-via-ctest-command-line" id="id22">Dashboard Client via CTest Command-Line</a></li>
<li><a class="reference internal" href="#dashboard-client-via-ctest-script" id="id23">Dashboard Client via CTest Script</a></li>
</ul>
</li>
<li><a class="reference internal" href="#dashboard-client-configuration" id="id24">Dashboard Client Configuration</a><ul>
<li><a class="reference internal" href="#ctest-start-step" id="id25">CTest Start Step</a></li>
<li><a class="reference internal" href="#ctest-update-step" id="id26">CTest Update Step</a></li>
<li><a class="reference internal" href="#ctest-configure-step" id="id27">CTest Configure Step</a></li>
<li><a class="reference internal" href="#ctest-build-step" id="id28">CTest Build Step</a></li>
<li><a class="reference internal" href="#ctest-test-step" id="id29">CTest Test Step</a></li>
<li><a class="reference internal" href="#ctest-coverage-step" id="id30">CTest Coverage Step</a></li>
<li><a class="reference internal" href="#ctest-memcheck-step" id="id31">CTest MemCheck Step</a></li>
<li><a class="reference internal" href="#ctest-submit-step" id="id32">CTest Submit Step</a></li>
</ul>
</li>
<li><a class="reference internal" href="#show-as-json-object-model" id="id33">Show as JSON Object Model</a></li>
<li><a class="reference internal" href="#resource-allocation" id="id34">Resource Allocation</a><ul>
<li><a class="reference internal" href="#resource-specification-file" id="id35">Resource Specification File</a></li>
<li><a class="reference internal" href="#resource-groups-property" id="id36"><code class="docutils literal notranslate"><span class="pre">RESOURCE_GROUPS</span></code> Property</a></li>
<li><a class="reference internal" href="#environment-variables" id="id37">Environment Variables</a></li>
</ul>
</li>
<li><a class="reference internal" href="#see-also" id="id38">See Also</a></li>
</ul>
</li>
</ul>
</div>
<div class="section" id="synopsis">
<h2><a class="toc-backref" href="#id14">Synopsis</a><a class="headerlink" href="#synopsis" title="Permalink to this headline">¶</a></h2>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">-C</span> <span class="pre">&lt;cfg&gt;,</span> <span class="pre">--build-config</span> <span class="pre">&lt;cfg&gt;</span></code></dt>
...
<dd><p class="first">Enable short progress output from tests.</p>
...
<p class="last">This option can also be enabled by setting the environment variable
...
<dt><code class="docutils literal notranslate"><span class="pre">-V,--verbose</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">-VV,--extra-verbose</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">--output-on-failure</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">-j</span> <span class="pre">&lt;jobs&gt;,</span> <span class="pre">--parallel</span> <span class="pre">&lt;jobs&gt;</span></code></dt>
...
<p class="last">See <a class="reference internal" href="#label-and-subproject-summary">Label and Subproject Summary</a>.</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">--resource-spec-file</span> <span class="pre">&lt;file&gt;</span></code></dt>
<dd><p class="first">Run CTest with <a class="reference internal" href="#ctest-resource-allocation"><span class="std std-ref">resource allocation</span></a> enabled,
using the
...
<p class="last">When <code class="docutils literal notranslate"><span class="pre">ctest</span></code> is run as a <a class="reference internal" href="#dashboard-client">Dashboard Client</a> this sets the
...
<dt><code class="docutils literal notranslate"><span class="pre">--test-load</span> <span class="pre">&lt;level&gt;</span></code></dt>
<dd><p class="first">While running tests in parallel (e.g. with <code class="docutils literal notranslate"><span class="pre">-j</span></code>), try not to start
...
<dt><code class="docutils literal notranslate"><span class="pre">-Q,--quiet</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">-O</span> <span class="pre">&lt;file&gt;,</span> <span class="pre">--output-log</span> <span class="pre">&lt;file&gt;</span></code></dt>
<dd><p class="first">Output to log file.</p>
<p class="last">This option tells CTest to write all its output to a <code class="docutils literal notranslate"><span class="pre">&lt;file&gt;</span></code> log file.</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">-N,--show-only[=&lt;format&gt;]</span></code></dt>
...
<dd>Human-friendly output.  This is not guaranteed to be stable.
This is the default.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">json-v1</span></code></dt>
<dd>Dump the test information in JSON format.
See <a class="reference internal" href="#show-as-json-object-model">Show as JSON Object Model</a>.</dd>
</dl>
</div></blockquote>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">-L</span> <span class="pre">&lt;regex&gt;,</span> <span class="pre">--label-regex</span> <span class="pre">&lt;regex&gt;</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">-R</span> <span class="pre">&lt;regex&gt;,</span> <span class="pre">--tests-regex</span> <span class="pre">&lt;regex&gt;</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">-E</span> <span class="pre">&lt;regex&gt;,</span> <span class="pre">--exclude-regex</span> <span class="pre">&lt;regex&gt;</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">-LE</span> <span class="pre">&lt;regex&gt;,</span> <span class="pre">--label-exclude</span> <span class="pre">&lt;regex&gt;</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">-FA</span> <span class="pre">&lt;regex&gt;,</span> <span class="pre">--fixture-exclude-any</span> <span class="pre">&lt;regex&gt;</span></code></dt>
<dd><p class="first">Exclude fixtures matching <code class="docutils literal notranslate"><span class="pre">&lt;regex&gt;</span></code> from automatically adding any tests to
the test set.</p>
<p class="last">If a test in the set of tests to be executed requires a particular fixture,
...
<dt><code class="docutils literal notranslate"><span class="pre">-FS</span> <span class="pre">&lt;regex&gt;,</span> <span class="pre">--fixture-exclude-setup</span> <span class="pre">&lt;regex&gt;</span></code></dt>
<dd>Same as <code class="docutils literal notranslate"><span class="pre">-FA</span></code> except only matching setup tests are excluded.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">-FC</span> <span class="pre">&lt;regex&gt;,</span> <span class="pre">--fixture-exclude-cleanup</span> <span class="pre">&lt;regex&gt;</span></code></dt>
<dd>Same as <code class="docutils literal notranslate"><span class="pre">-FA</span></code> except only matching cleanup tests are excluded.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">-D</span> <span class="pre">&lt;dashboard&gt;,</span> <span class="pre">--dashboard</span> <span class="pre">&lt;dashboard&gt;</span></code></dt>
...
<p class="last">See <a class="reference internal" href="#dashboard-client">Dashboard Client</a>.</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">-D</span> <span class="pre">&lt;var&gt;:&lt;type&gt;=&lt;value&gt;</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">-M</span> <span class="pre">&lt;model&gt;,</span> <span class="pre">--test-model</span> <span class="pre">&lt;model&gt;</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">-T</span> <span class="pre">&lt;action&gt;,</span> <span class="pre">--test-action</span> <span class="pre">&lt;action&gt;</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">-S</span> <span class="pre">&lt;script&gt;,</span> <span class="pre">--script</span> <span class="pre">&lt;script&gt;</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">-SP</span> <span class="pre">&lt;script&gt;,</span> <span class="pre">--script-new-process</span> <span class="pre">&lt;script&gt;</span></code></dt>
<dd><p class="first">Execute a dashboard for a configuration.</p>
...
<dt><code class="docutils literal notranslate"><span class="pre">-I</span> <span class="pre">[Start,End,Stride,test#,test#|Test</span> <span class="pre">file],</span> <span class="pre">--tests-information</span></code></dt>
<dd><p class="first">Run a specific number of tests by number.</p>
<p class="last">This option causes CTest to run tests starting at number <code class="docutils literal notranslate"><span class="pre">Start</span></code>,
...
<dt><code class="docutils literal notranslate"><span class="pre">-U,</span> <span class="pre">--union</span></code></dt>
<dd><p class="first">Take the Union of <code class="docutils literal notranslate"><span class="pre">-I</span></code> and <code class="docutils literal notranslate"><span class="pre">-R</span></code>.</p>
<p class="last">When both <code class="docutils literal notranslate"><span class="pre">-R</span></code> and <code class="docutils literal notranslate"><span class="pre">-I</span></code> are specified by default the intersection of
...
<dt><code class="docutils literal notranslate"><span class="pre">--rerun-failed</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">--repeat-until-fail</span> <span class="pre">&lt;n&gt;</span></code></dt>
<dd><p class="first">Require each test to run <code class="docutils literal notranslate"><span class="pre">&lt;n&gt;</span></code> times without failing in order to pass.</p>
<p class="last">This is useful in finding sporadic failures in test cases.</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">--max-width</span> <span class="pre">&lt;width&gt;</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">--interactive-debug-mode</span> <span class="pre">[0|1]</span></code></dt>
<dd><p class="first">Set the interactive mode to <code class="docutils literal notranslate"><span class="pre">0</span></code> or <code class="docutils literal notranslate"><span class="pre">1</span></code>.</p>
<p class="last">This option causes CTest to run tests in either an interactive mode
or a non-interactive mode.  On Windows this means that in
non-interactive mode, all system debug pop up windows are blocked.
In dashboard mode (<code class="docutils literal notranslate"><span class="pre">Experimental</span></code>, <code class="docutils literal notranslate"><span class="pre">Nightly</span></code>, <code class="docutils literal notranslate"><span class="pre">Continuous</span></code>), the default
is non-interactive.  When just running tests not for a dashboard the
default is to allow popups and interactive debugging.</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">--no-label-summary</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">--no-subproject-summary</span></code></dt>
<dd><p class="first">Disable timing summary information for subprojects.</p>
<p>This option tells CTest not to print summary information for each
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">--test-output-size-passed</span> <span class="pre">&lt;size&gt;</span></code></dt>
<dd>Limit the output for passed tests to <code class="docutils literal notranslate"><span class="pre">&lt;size&gt;</span></code> bytes.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">--test-output-size-failed</span> <span class="pre">&lt;size&gt;</span></code></dt>
<dd>Limit the output for failed tests to <code class="docutils literal notranslate"><span class="pre">&lt;size&gt;</span></code> bytes.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">--overwrite</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">--force-new-ctest-process</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">--schedule-random</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">--submit-index</span></code></dt>
...
<dd><p class="first">Set the default test timeout.</p>
<p class="last">This option effectively sets a timeout on all tests that do not
...
<dt><code class="docutils literal notranslate"><span class="pre">--stop-time</span> <span class="pre">&lt;time&gt;</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">--print-labels</span></code></dt>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">--help,-help,-usage,-h,-H,/?</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">--version,-version,/V</span> <span class="pre">[&lt;f&gt;]</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">--help-full</span> <span class="pre">[&lt;f&gt;]</span></code></dt>
<dd><p class="first">Print all help manuals and exit.</p>
<p class="last">All manuals are printed in a human-readable text format.
The help is printed to a named &lt;f&gt;ile if given.</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">--help-manual</span> <span class="pre">&lt;man&gt;</span> <span class="pre">[&lt;f&gt;]</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">--help-manual-list</span> <span class="pre">[&lt;f&gt;]</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">--help-command</span> <span class="pre">&lt;cmd&gt;</span> <span class="pre">[&lt;f&gt;]</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">--help-command-list</span> <span class="pre">[&lt;f&gt;]</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">--help-commands</span> <span class="pre">[&lt;f&gt;]</span></code></dt>
<dd><p class="first">Print cmake-commands manual and exit.</p>
<p class="last">The <span class="target" id="index-1-manual:cmake-commands(7)"></span><a class="reference internal" href="cmake-commands.7.html#manual:cmake-commands(7)" title="cmake-commands(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake-commands(7)</span></code></a> manual is printed in a
human-readable text format.
The help is printed to a named &lt;f&gt;ile if given.</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">--help-module</span> <span class="pre">&lt;mod&gt;</span> <span class="pre">[&lt;f&gt;]</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">--help-module-list</span> <span class="pre">[&lt;f&gt;]</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">--help-modules</span> <span class="pre">[&lt;f&gt;]</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">--help-policy</span> <span class="pre">&lt;cmp&gt;</span> <span class="pre">[&lt;f&gt;]</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">--help-policy-list</span> <span class="pre">[&lt;f&gt;]</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">--help-policies</span> <span class="pre">[&lt;f&gt;]</span></code></dt>
<dd><p class="first">Print cmake-policies manual and exit.</p>
<p class="last">The <span class="target" id="index-1-manual:cmake-policies(7)"></span><a class="reference internal" href="cmake-policies.7.html#manual:cmake-policies(7)" title="cmake-policies(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake-policies(7)</span></code></a> manual is printed in a
human-readable text format.
The help is printed to a named &lt;f&gt;ile if given.</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">--help-property</span> <span class="pre">&lt;prop&gt;</span> <span class="pre">[&lt;f&gt;]</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">--help-property-list</span> <span class="pre">[&lt;f&gt;]</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">--help-properties</span> <span class="pre">[&lt;f&gt;]</span></code></dt>
<dd><p class="first">Print cmake-properties manual and exit.</p>
<p class="last">The <span class="target" id="index-1-manual:cmake-properties(7)"></span><a class="reference internal" href="cmake-properties.7.html#manual:cmake-properties(7)" title="cmake-properties(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake-properties(7)</span></code></a> manual is printed in a
human-readable text format.
The help is printed to a named &lt;f&gt;ile if given.</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">--help-variable</span> <span class="pre">&lt;var&gt;</span> <span class="pre">[&lt;f&gt;]</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">--help-variable-list</span> <span class="pre">[&lt;f&gt;]</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">--help-variables</span> <span class="pre">[&lt;f&gt;]</span></code></dt>
<dd><p class="first">Print cmake-variables manual and exit.</p>
<p class="last">The <span class="target" id="index-1-manual:cmake-variables(7)"></span><a class="reference internal" href="cmake-variables.7.html#manual:cmake-variables(7)" title="cmake-variables(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake-variables(7)</span></code></a> manual is printed in a
human-readable text format.
The help is printed to a named &lt;f&gt;ile if given.</p>
</dd>
</dl>
...
<span id="id1"></span><h2><a class="toc-backref" href="#id17">Label and Subproject Summary</a><a class="headerlink" href="#label-and-subproject-summary" title="Permalink to this headline">¶</a></h2>
...
<p>where:</p>
<ul class="simple">
<li><code class="docutils literal notranslate"><span class="pre">raw_test_time[j,i]</span></code>: Wall-clock time for the <code class="docutils literal notranslate"><span class="pre">i</span></code> test
for the <code class="docutils literal notranslate"><span class="pre">j</span></code> label or subproject</li>
<li><code class="docutils literal notranslate"><span class="pre">num_processors[j,i]</span></code>: Value of the CTest <span class="target" id="index-2-prop_test:PROCESSORS"></span><a class="reference internal" href="../prop_test/PROCESSORS.html#prop_test:PROCESSORS" title="PROCESSORS"><code class="xref cmake cmake-prop_test docutils literal notranslate"><span class="pre">PROCESSORS</span></code></a> property
for the <code class="docutils literal notranslate"><span class="pre">i</span></code> test for the <code class="docutils literal notranslate"><span class="pre">j</span></code> label or subproject</li>
<li><code class="docutils literal notranslate"><span class="pre">num_tests[j]</span></code>: Number of tests associated with the <code class="docutils literal notranslate"><span class="pre">j</span></code> label or subproject</li>
<li><code class="docutils literal notranslate"><span class="pre">total</span></code>: Total number of labels or subprojects that have at least one test run</li>
</ul>
...
<span id="id2"></span><h2><a class="toc-backref" href="#id18">Build and Test Mode</a><a class="headerlink" href="#build-and-test-mode" title="Permalink to this headline">¶</a></h2>
...
this mode include:</p>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">--build-target</span></code></dt>
<dd><p class="first">Specify a specific target to build.</p>
<p class="last">If left out the <code class="docutils literal notranslate"><span class="pre">all</span></code> target is built.</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">--build-nocmake</span></code></dt>
<dd><p class="first">Run the build without running cmake first.</p>
<p class="last">Skip the cmake step.</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">--build-run-dir</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">--build-two-config</span></code></dt>
<dd>Run CMake twice.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">--build-exe-dir</span></code></dt>
<dd>Specify the directory for the executable.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">--build-generator</span></code></dt>
<dd>Specify the generator to use. See the <span class="target" id="index-0-manual:cmake-generators(7)"></span><a class="reference internal" href="cmake-generators.7.html#manual:cmake-generators(7)" title="cmake-generators(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake-generators(7)</span></code></a> manual.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">--build-generator-platform</span></code></dt>
<dd>Specify the generator-specific platform.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">--build-generator-toolset</span></code></dt>
<dd>Specify the generator-specific toolset.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">--build-project</span></code></dt>
<dd>Specify the name of the project to build.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">--build-makeprogram</span></code></dt>
<dd>Specify the explicit make program to be used by CMake when configuring and
building the project. Only applicable for Make and Ninja based generators.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">--build-noclean</span></code></dt>
<dd>Skip the make clean step.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">--build-config-sample</span></code></dt>
<dd>A sample executable to use to determine the configuration that
should be used.  e.g.  <code class="docutils literal notranslate"><span class="pre">Debug</span></code>, <code class="docutils literal notranslate"><span class="pre">Release</span></code> etc.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">--build-options</span></code></dt>
<dd>Additional options for configuring the build (i.e. for CMake, not for
...
line, with the possible exception of <code class="docutils literal notranslate"><span class="pre">--test-command</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">--test-command</span></code></dt>
<dd>The command to run as the test step with the <code class="docutils literal notranslate"><span class="pre">--build-and-test</span></code> option.
All arguments following this keyword will be assumed to be part of the
test command line, so it must be the last option given.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">--test-timeout</span></code></dt>
<dd>The time limit in seconds</dd>
</dl>
</div>
<div class="section" id="dashboard-client">
<span id="id3"></span><h2><a class="toc-backref" href="#id19">Dashboard Client</a><a class="headerlink" href="#dashboard-client" title="Permalink to this headline">¶</a></h2>
...
a <a class="reference external" href="http://cdash.org/">CDash</a> server. The command-line signature used to submit to <a class="reference external" href="http://cdash.org/">CDash</a> is:</p>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">--group</span> <span class="pre">&lt;group&gt;</span></code></dt>
<dd><p class="first">Specify what group you’d like to submit results to</p>
...
arbitrary.</p>
<p class="last">This replaces the deprecated option <code class="docutils literal notranslate"><span class="pre">--track</span></code>.
Despite the name change its behavior is unchanged.</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">-A</span> <span class="pre">&lt;file&gt;,</span> <span class="pre">--add-notes</span> <span class="pre">&lt;file&gt;</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">--tomorrow-tag</span></code></dt>
<dd><p class="first"><code class="docutils literal notranslate"><span class="pre">Nightly</span></code> or <code class="docutils literal notranslate"><span class="pre">Experimental</span></code> starts with next day tag.</p>
<p class="last">This is useful if the build will not finish in one day.</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">--extra-submit</span> <span class="pre">&lt;file&gt;[;&lt;file&gt;]</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">--http1.0</span></code></dt>
<dd><p class="first">Submit using <cite>HTTP 1.0</cite>.</p>
<p class="last">This option will force CTest to use <cite>HTTP 1.0</cite> to submit files to the
dashboard, instead of <cite>HTTP 1.1</cite>.</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">--no-compress-output</span></code></dt>
...
<h3><a class="toc-backref" href="#id20">Dashboard Client Steps</a><a class="headerlink" href="#dashboard-client-steps" title="Permalink to this headline">¶</a></h3>
...
<dt><code class="docutils literal notranslate"><span class="pre">Build</span></code></dt>
...
<dd>Test the software by loading a <code class="docutils literal notranslate"><span class="pre">CTestTestfile.cmake</span></code>
...
<dt><code class="docutils literal notranslate"><span class="pre">Coverage</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">MemCheck</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">Submit</span></code></dt>
...
<h3><a class="toc-backref" href="#id21">Dashboard Client Modes</a><a class="headerlink" href="#dashboard-client-modes" title="Permalink to this headline">¶</a></h3>
<p>CTest defines three modes of operation as a dashboard client:</p>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">Nightly</span></code></dt>
...
if the <code class="docutils literal notranslate"><span class="pre">Update</span></code> step reports no changes to the source tree.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Continuous</span></code></dt>
...
<code class="docutils literal notranslate"><span class="pre">Update</span></code> step if it reports no changes to the source tree.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Experimental</span></code></dt>
...
and <code class="docutils literal notranslate"><span class="pre">Submit</span></code> steps by default.</dd>
</dl>
</div>
<div class="section" id="dashboard-client-via-ctest-command-line">
<h3><a class="toc-backref" href="#id22">Dashboard Client via CTest Command-Line</a><a class="headerlink" href="#dashboard-client-via-ctest-command-line" title="Permalink to this headline">¶</a></h3>
...
<span id="ctest-script"></span><h3><a class="toc-backref" href="#id23">Dashboard Client via CTest Script</a><a class="headerlink" href="#dashboard-client-via-ctest-script" title="Permalink to this headline">¶</a></h3>
...
<h2><a class="toc-backref" href="#id24">Dashboard Client Configuration</a><a class="headerlink" href="#dashboard-client-configuration" title="Permalink to this headline">¶</a></h2>
...
<span id="id4"></span><h3><a class="toc-backref" href="#id25">CTest Start Step</a><a class="headerlink" href="#ctest-start-step" title="Permalink to this headline">¶</a></h3>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">BuildDirectory</span></code></dt>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">BZRCommand</span></code></dt>
<dd><p class="first"><code class="docutils literal notranslate"><span class="pre">bzr</span></code> command-line tool to use if source tree is managed by Bazaar.</p>
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-0-variable:CTEST_BZR_COMMAND"></span><a class="reference internal" href="../variable/CTEST_BZR_COMMAND.html#variable:CTEST_BZR_COMMAND" title="CTEST_BZR_COMMAND"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_BZR_COMMAND</span></code></a></li>
<li><span class="target" id="index-3-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: none</li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">BZRUpdateOptions</span></code></dt>
<dd><p class="first">Command-line options to the <code class="docutils literal notranslate"><span class="pre">BZRCommand</span></code> when updating the source.</p>
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-0-variable:CTEST_BZR_UPDATE_OPTIONS"></span><a class="reference internal" href="../variable/CTEST_BZR_UPDATE_OPTIONS.html#variable:CTEST_BZR_UPDATE_OPTIONS" title="CTEST_BZR_UPDATE_OPTIONS"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_BZR_UPDATE_OPTIONS</span></code></a></li>
<li><span class="target" id="index-4-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: none</li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">CVSCommand</span></code></dt>
<dd><p class="first"><code class="docutils literal notranslate"><span class="pre">cvs</span></code> command-line tool to use if source tree is managed by CVS.</p>
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-0-variable:CTEST_CVS_COMMAND"></span><a class="reference internal" href="../variable/CTEST_CVS_COMMAND.html#variable:CTEST_CVS_COMMAND" title="CTEST_CVS_COMMAND"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_CVS_COMMAND</span></code></a></li>
<li><span class="target" id="index-5-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">CVSCOMMAND</span></code></li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">CVSUpdateOptions</span></code></dt>
<dd><p class="first">Command-line options to the <code class="docutils literal notranslate"><span class="pre">CVSCommand</span></code> when updating the source.</p>
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-0-variable:CTEST_CVS_UPDATE_OPTIONS"></span><a class="reference internal" href="../variable/CTEST_CVS_UPDATE_OPTIONS.html#variable:CTEST_CVS_UPDATE_OPTIONS" title="CTEST_CVS_UPDATE_OPTIONS"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_CVS_UPDATE_OPTIONS</span></code></a></li>
<li><span class="target" id="index-6-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">CVS_UPDATE_OPTIONS</span></code></li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">GITCommand</span></code></dt>
<dd><p class="first"><code class="docutils literal notranslate"><span class="pre">git</span></code> command-line tool to use if source tree is managed by Git.</p>
<ul class="simple">
...
<li><span class="target" id="index-7-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">GITCOMMAND</span></code></li>
</ul>
<p class="last">The source tree is updated by <code class="docutils literal notranslate"><span class="pre">git</span> <span class="pre">fetch</span></code> followed by
...
<dt><code class="docutils literal notranslate"><span class="pre">GITInitSubmodules</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">GITUpdateCustom</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">HGCommand</span></code></dt>
<dd><p class="first"><code class="docutils literal notranslate"><span class="pre">hg</span></code> command-line tool to use if source tree is managed by Mercurial.</p>
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-0-variable:CTEST_HG_COMMAND"></span><a class="reference internal" href="../variable/CTEST_HG_COMMAND.html#variable:CTEST_HG_COMMAND" title="CTEST_HG_COMMAND"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_HG_COMMAND</span></code></a></li>
<li><span class="target" id="index-11-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: none</li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">HGUpdateOptions</span></code></dt>
<dd><p class="first">Command-line options to the <code class="docutils literal notranslate"><span class="pre">HGCommand</span></code> when updating the source.</p>
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-0-variable:CTEST_HG_UPDATE_OPTIONS"></span><a class="reference internal" href="../variable/CTEST_HG_UPDATE_OPTIONS.html#variable:CTEST_HG_UPDATE_OPTIONS" title="CTEST_HG_UPDATE_OPTIONS"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_HG_UPDATE_OPTIONS</span></code></a></li>
<li><span class="target" id="index-12-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: none</li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">P4Client</span></code></dt>
<dd><p class="first">Value of the <code class="docutils literal notranslate"><span class="pre">-c</span></code> option to the <code class="docutils literal notranslate"><span class="pre">P4Command</span></code>.</p>
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-0-variable:CTEST_P4_CLIENT"></span><a class="reference internal" href="../variable/CTEST_P4_CLIENT.html#variable:CTEST_P4_CLIENT" title="CTEST_P4_CLIENT"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_P4_CLIENT</span></code></a></li>
<li><span class="target" id="index-13-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">CTEST_P4_CLIENT</span></code></li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">P4Command</span></code></dt>
<dd><p class="first"><code class="docutils literal notranslate"><span class="pre">p4</span></code> command-line tool to use if source tree is managed by Perforce.</p>
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-0-variable:CTEST_P4_COMMAND"></span><a class="reference internal" href="../variable/CTEST_P4_COMMAND.html#variable:CTEST_P4_COMMAND" title="CTEST_P4_COMMAND"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_P4_COMMAND</span></code></a></li>
<li><span class="target" id="index-14-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">P4COMMAND</span></code></li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">P4Options</span></code></dt>
<dd><p class="first">Command-line options to the <code class="docutils literal notranslate"><span class="pre">P4Command</span></code> for all invocations.</p>
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-0-variable:CTEST_P4_OPTIONS"></span><a class="reference internal" href="../variable/CTEST_P4_OPTIONS.html#variable:CTEST_P4_OPTIONS" title="CTEST_P4_OPTIONS"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_P4_OPTIONS</span></code></a></li>
<li><span class="target" id="index-15-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">CTEST_P4_OPTIONS</span></code></li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">P4UpdateCustom</span></code></dt>
<dd><p class="first">Specify a custom command line (as a semicolon-separated list) to run
...
<li><span class="target" id="index-16-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">CTEST_P4_UPDATE_CUSTOM</span></code></li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">P4UpdateOptions</span></code></dt>
<dd><p class="first">Command-line options to the <code class="docutils literal notranslate"><span class="pre">P4Command</span></code> when updating the source.</p>
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-0-variable:CTEST_P4_UPDATE_OPTIONS"></span><a class="reference internal" href="../variable/CTEST_P4_UPDATE_OPTIONS.html#variable:CTEST_P4_UPDATE_OPTIONS" title="CTEST_P4_UPDATE_OPTIONS"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_P4_UPDATE_OPTIONS</span></code></a></li>
<li><span class="target" id="index-17-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">CTEST_P4_UPDATE_OPTIONS</span></code></li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">SVNCommand</span></code></dt>
<dd><p class="first"><code class="docutils literal notranslate"><span class="pre">svn</span></code> command-line tool to use if source tree is managed by Subversion.</p>
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-0-variable:CTEST_SVN_COMMAND"></span><a class="reference internal" href="../variable/CTEST_SVN_COMMAND.html#variable:CTEST_SVN_COMMAND" title="CTEST_SVN_COMMAND"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_SVN_COMMAND</span></code></a></li>
<li><span class="target" id="index-18-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">SVNCOMMAND</span></code></li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">SVNOptions</span></code></dt>
<dd><p class="first">Command-line options to the <code class="docutils literal notranslate"><span class="pre">SVNCommand</span></code> for all invocations.</p>
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-0-variable:CTEST_SVN_OPTIONS"></span><a class="reference internal" href="../variable/CTEST_SVN_OPTIONS.html#variable:CTEST_SVN_OPTIONS" title="CTEST_SVN_OPTIONS"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_SVN_OPTIONS</span></code></a></li>
<li><span class="target" id="index-19-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">CTEST_SVN_OPTIONS</span></code></li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">SVNUpdateOptions</span></code></dt>
<dd><p class="first">Command-line options to the <code class="docutils literal notranslate"><span class="pre">SVNCommand</span></code> when updating the source.</p>
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-0-variable:CTEST_SVN_UPDATE_OPTIONS"></span><a class="reference internal" href="../variable/CTEST_SVN_UPDATE_OPTIONS.html#variable:CTEST_SVN_UPDATE_OPTIONS" title="CTEST_SVN_UPDATE_OPTIONS"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_SVN_UPDATE_OPTIONS</span></code></a></li>
...
<dt><code class="docutils literal notranslate"><span class="pre">UpdateCommand</span></code></dt>
...
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-0-variable:CTEST_UPDATE_COMMAND"></span><a class="reference internal" href="../variable/CTEST_UPDATE_COMMAND.html#variable:CTEST_UPDATE_COMMAND" title="CTEST_UPDATE_COMMAND"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_UPDATE_COMMAND</span></code></a></li>
<li><span class="target" id="index-21-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">&lt;VCS&gt;COMMAND</span></code>
when <code class="docutils literal notranslate"><span class="pre">UPDATE_TYPE</span></code> is <code class="docutils literal notranslate"><span class="pre">&lt;vcs&gt;</span></code>, else <code class="docutils literal notranslate"><span class="pre">UPDATE_COMMAND</span></code></li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">UpdateOptions</span></code></dt>
<dd><p class="first">Command-line options to the <code class="docutils literal notranslate"><span class="pre">UpdateCommand</span></code>.</p>
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-0-variable:CTEST_UPDATE_OPTIONS"></span><a class="reference internal" href="../variable/CTEST_UPDATE_OPTIONS.html#variable:CTEST_UPDATE_OPTIONS" title="CTEST_UPDATE_OPTIONS"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_UPDATE_OPTIONS</span></code></a></li>
<li><span class="target" id="index-22-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">&lt;VCS&gt;_UPDATE_OPTIONS</span></code>
when <code class="docutils literal notranslate"><span class="pre">UPDATE_TYPE</span></code> is <code class="docutils literal notranslate"><span class="pre">&lt;vcs&gt;</span></code>, else <code class="docutils literal notranslate"><span class="pre">UPDATE_OPTIONS</span></code></li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">UpdateType</span></code></dt>
...
<li><span class="target" id="index-23-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">UPDATE_TYPE</span></code> if set,
else <code class="docutils literal notranslate"><span class="pre">CTEST_UPDATE_TYPE</span></code></li>
</ul>
</dd>
</dl>
<dl class="docutils" id="updateversiononly">
<dt><code class="docutils literal notranslate"><span class="pre">UpdateVersionOnly</span></code></dt>
<dd><p class="first">Specify that you want the version control update command to only
discover the current version that is checked out, and not to update
to a different version.</p>
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-0-variable:CTEST_UPDATE_VERSION_ONLY"></span><a class="reference internal" href="../variable/CTEST_UPDATE_VERSION_ONLY.html#variable:CTEST_UPDATE_VERSION_ONLY" title="CTEST_UPDATE_VERSION_ONLY"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_UPDATE_VERSION_ONLY</span></code></a></li>
</ul>
</dd>
</dl>
<dl class="docutils" id="updateversionoverride">
<dt><code class="docutils literal notranslate"><span class="pre">UpdateVersionOverride</span></code></dt>
<dd><p class="first">Specify the current version of your source tree.</p>
...
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-0-variable:CTEST_UPDATE_VERSION_OVERRIDE"></span><a class="reference internal" href="../variable/CTEST_UPDATE_VERSION_OVERRIDE.html#variable:CTEST_UPDATE_VERSION_OVERRIDE" title="CTEST_UPDATE_VERSION_OVERRIDE"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_UPDATE_VERSION_OVERRIDE</span></code></a></li>
</ul>
</dd>
</dl>
<p>Additional configuration settings include:</p>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">NightlyStartTime</span></code></dt>
<dd><p class="first">In the <code class="docutils literal notranslate"><span class="pre">Nightly</span></code> dashboard mode, specify the “nightly start time”.
...
else <code class="docutils literal notranslate"><span class="pre">CTEST_NIGHTLY_START_TIME</span></code></li>
</ul>
</dd>
</dl>
</div>
<div class="section" id="ctest-configure-step">
<span id="id6"></span><h3><a class="toc-backref" href="#id27">CTest Configure Step</a><a class="headerlink" href="#ctest-configure-step" title="Permalink to this headline">¶</a></h3>
...
<p>Configuration settings include:</p>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">ConfigureCommand</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">LabelsForSubprojects</span></code></dt>
<dd><p class="first">Specify a semicolon-separated list of labels that will be treated as
subprojects. This mapping will be passed on to CDash when configure, test or
build results are submitted.</p>
<ul class="simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-0-variable:CTEST_LABELS_FOR_SUBPROJECTS"></span><a class="reference internal" href="../variable/CTEST_LABELS_FOR_SUBPROJECTS.html#variable:CTEST_LABELS_FOR_SUBPROJECTS" title="CTEST_LABELS_FOR_SUBPROJECTS"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_LABELS_FOR_SUBPROJECTS</span></code></a></li>
<li><span class="target" id="index-26-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">CTEST_LABELS_FOR_SUBPROJECTS</span></code></li>
</ul>
<p class="last">See <a class="reference internal" href="#label-and-subproject-summary">Label and Subproject Summary</a>.</p>
</dd>
</dl>
...
<span id="id7"></span><h3><a class="toc-backref" href="#id28">CTest Build Step</a><a class="headerlink" href="#ctest-build-step" title="Permalink to this headline">¶</a></h3>
...
<p>Configuration settings include:</p>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">DefaultCTestConfigurationType</span></code></dt>
...
initialized by the <span class="target" id="index-0-command:build_command"></span><a class="reference internal" href="../command/build_command.html#command:build_command" title="build_command"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">build_command()</span></code></a> command</li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">UseLaunchers</span></code></dt>
...
<p>Configuration settings include:</p>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">ResourceSpecFile</span></code></dt>
<dd>Specify a
<a class="reference internal" href="#ctest-resource-specification-file"><span class="std std-ref">resource specification file</span></a>. See
<a class="reference internal" href="#ctest-resource-allocation"><span class="std std-ref">Resource Allocation</span></a> for more information.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">LabelsForSubprojects</span></code></dt>
<dd><p class="first">Specify a semicolon-separated list of labels that will be treated as
subprojects. This mapping will be passed on to CDash when configure, test or
build results are submitted.</p>
<ul class="simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-2-variable:CTEST_LABELS_FOR_SUBPROJECTS"></span><a class="reference internal" href="../variable/CTEST_LABELS_FOR_SUBPROJECTS.html#variable:CTEST_LABELS_FOR_SUBPROJECTS" title="CTEST_LABELS_FOR_SUBPROJECTS"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_LABELS_FOR_SUBPROJECTS</span></code></a></li>
<li><span class="target" id="index-32-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">CTEST_LABELS_FOR_SUBPROJECTS</span></code></li>
</ul>
<p class="last">See <a class="reference internal" href="#label-and-subproject-summary">Label and Subproject Summary</a>.</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">TestLoad</span></code></dt>
<dd><p class="first">While running tests in parallel (e.g. with <code class="docutils literal notranslate"><span class="pre">-j</span></code>), try not to start
tests when they may cause the CPU load to pass above a given threshold.</p>
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-0-variable:CTEST_TEST_LOAD"></span><a class="reference internal" href="../variable/CTEST_TEST_LOAD.html#variable:CTEST_TEST_LOAD" title="CTEST_TEST_LOAD"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_TEST_LOAD</span></code></a></li>
<li><span class="target" id="index-33-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">CTEST_TEST_LOAD</span></code></li>
</ul>
</dd>
...
<p>Configuration settings include:</p>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">CoverageCommand</span></code></dt>
<dd><p class="first">Command-line tool to perform software coverage analysis.
It will be executed in the location specified by the
<code class="docutils literal notranslate"><span class="pre">BuildDirectory</span></code> setting.</p>
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-0-variable:CTEST_COVERAGE_COMMAND"></span><a class="reference internal" href="../variable/CTEST_COVERAGE_COMMAND.html#variable:CTEST_COVERAGE_COMMAND" title="CTEST_COVERAGE_COMMAND"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_COVERAGE_COMMAND</span></code></a></li>
<li><span class="target" id="index-35-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">COVERAGE_COMMAND</span></code></li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">CoverageExtraFlags</span></code></dt>
<dd><p class="first">Specify command-line options to the <code class="docutils literal notranslate"><span class="pre">CoverageCommand</span></code> tool.</p>
<ul class="simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-0-variable:CTEST_COVERAGE_EXTRA_FLAGS"></span><a class="reference internal" href="../variable/CTEST_COVERAGE_EXTRA_FLAGS.html#variable:CTEST_COVERAGE_EXTRA_FLAGS" title="CTEST_COVERAGE_EXTRA_FLAGS"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_COVERAGE_EXTRA_FLAGS</span></code></a></li>
<li><span class="target" id="index-36-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">COVERAGE_EXTRA_FLAGS</span></code></li>
</ul>
<p class="last">These options are the first arguments passed to <code class="docutils literal notranslate"><span class="pre">CoverageCommand</span></code>.</p>
</dd>
</dl>
</div>
<div class="section" id="ctest-memcheck-step">
<span id="id10"></span><h3><a class="toc-backref" href="#id31">CTest MemCheck Step</a><a class="headerlink" href="#ctest-memcheck-step" title="Permalink to this headline">¶</a></h3>
...
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-0-variable:CTEST_MEMORYCHECK_SUPPRESSIONS_FILE"></span><a class="reference internal" href="../variable/CTEST_MEMORYCHECK_SUPPRESSIONS_FILE.html#variable:CTEST_MEMORYCHECK_SUPPRESSIONS_FILE" title="CTEST_MEMORYCHECK_SUPPRESSIONS_FILE"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_MEMORYCHECK_SUPPRESSIONS_FILE</span></code></a></li>
<li><span class="target" id="index-41-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">MEMORYCHECK_SUPPRESSIONS_FILE</span></code></li>
</ul>
</dd>
</dl>
<p>Additional configuration settings include:</p>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">BoundsCheckerCommand</span></code></dt>
<dd><p class="first">Specify a <code class="docutils literal notranslate"><span class="pre">MemoryCheckCommand</span></code> that is known to be command-line
compatible with Bounds Checker.</p>
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: none</li>
<li><span class="target" id="index-42-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: none</li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">PurifyCommand</span></code></dt>
<dd><p class="first">Specify a <code class="docutils literal notranslate"><span class="pre">MemoryCheckCommand</span></code> that is known to be command-line
compatible with Purify.</p>
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: none</li>
<li><span class="target" id="index-43-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">PURIFYCOMMAND</span></code></li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">ValgrindCommand</span></code></dt>
<dd><p class="first">Specify a <code class="docutils literal notranslate"><span class="pre">MemoryCheckCommand</span></code> that is known to be command-line
compatible with Valgrind.</p>
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: none</li>
<li><span class="target" id="index-44-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">VALGRIND_COMMAND</span></code></li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">ValgrindCommandOptions</span></code></dt>
<dd><p class="first">Specify command-line options to the <code class="docutils literal notranslate"><span class="pre">ValgrindCommand</span></code> tool.
They will be placed prior to the test command line.</p>
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: none</li>
<li><span class="target" id="index-45-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">VALGRIND_COMMAND_OPTIONS</span></code></li>
</ul>
</dd>
</dl>
</div>
<div class="section" id="ctest-submit-step">
<span id="id11"></span><h3><a class="toc-backref" href="#id32">CTest Submit Step</a><a class="headerlink" href="#ctest-submit-step" title="Permalink to this headline">¶</a></h3>
...
<p>Configuration settings include:</p>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">BuildName</span></code></dt>
<dd><p class="first">Describe the dashboard client platform with a short string.
(Operating system, compiler, etc.)</p>
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-0-variable:CTEST_BUILD_NAME"></span><a class="reference internal" href="../variable/CTEST_BUILD_NAME.html#variable:CTEST_BUILD_NAME" title="CTEST_BUILD_NAME"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_BUILD_NAME</span></code></a></li>
<li><span class="target" id="index-46-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">BUILDNAME</span></code></li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">CDashVersion</span></code></dt>
<dd><p class="first">Legacy option.  Not used.</p>
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: none, detected from server</li>
<li><span class="target" id="index-47-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">CTEST_CDASH_VERSION</span></code></li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">CTestSubmitRetryCount</span></code></dt>
...
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-0-variable:CTEST_CURL_OPTIONS"></span><a class="reference internal" href="../variable/CTEST_CURL_OPTIONS.html#variable:CTEST_CURL_OPTIONS" title="CTEST_CURL_OPTIONS"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_CURL_OPTIONS</span></code></a></li>
<li><span class="target" id="index-50-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">CTEST_CURL_OPTIONS</span></code></li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">DropLocation</span></code></dt>
<dd><p class="first">Legacy option.  When <code class="docutils literal notranslate"><span class="pre">SubmitURL</span></code> is not set, it is constructed from
...
else <code class="docutils literal notranslate"><span class="pre">CTEST_DROP_LOCATION</span></code></li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">DropMethod</span></code></dt>
<dd><p class="first">Legacy option.  When <code class="docutils literal notranslate"><span class="pre">SubmitURL</span></code> is not set, it is constructed from
<code class="docutils literal notranslate"><span class="pre">DropMethod</span></code>, <code class="docutils literal notranslate"><span class="pre">DropSiteUser</span></code>, <code class="docutils literal notranslate"><span class="pre">DropSitePassword</span></code>, <code class="docutils literal notranslate"><span class="pre">DropSite</span></code>, and
<code class="docutils literal notranslate"><span class="pre">DropLocation</span></code>.</p>
<ul class="last simple">
...
else <code class="docutils literal notranslate"><span class="pre">CTEST_DROP_SITE</span></code></li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">DropSitePassword</span></code></dt>
<dd><p class="first">Legacy option.  When <code class="docutils literal notranslate"><span class="pre">SubmitURL</span></code> is not set, it is constructed from
<code class="docutils literal notranslate"><span class="pre">DropMethod</span></code>, <code class="docutils literal notranslate"><span class="pre">DropSiteUser</span></code>, <code class="docutils literal notranslate"><span class="pre">DropSitePassword</span></code>, <code class="docutils literal notranslate"><span class="pre">DropSite</span></code>, and
<code class="docutils literal notranslate"><span class="pre">DropLocation</span></code>.</p>
<ul class="last simple">
...
<li><span class="target" id="index-54-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">DROP_SITE_PASSWORD</span></code> if set,
else <code class="docutils literal notranslate"><span class="pre">CTEST_DROP_SITE_PASWORD</span></code></li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">DropSiteUser</span></code></dt>
<dd><p class="first">Legacy option.  When <code class="docutils literal notranslate"><span class="pre">SubmitURL</span></code> is not set, it is constructed from
<code class="docutils literal notranslate"><span class="pre">DropMethod</span></code>, <code class="docutils literal notranslate"><span class="pre">DropSiteUser</span></code>, <code class="docutils literal notranslate"><span class="pre">DropSitePassword</span></code>, <code class="docutils literal notranslate"><span class="pre">DropSite</span></code>, and
<code class="docutils literal notranslate"><span class="pre">DropLocation</span></code>.</p>
<ul class="last simple">
...
<li><span class="target" id="index-55-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">DROP_SITE_USER</span></code> if set,
else <code class="docutils literal notranslate"><span class="pre">CTEST_DROP_SITE_USER</span></code></li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">IsCDash</span></code></dt>
<dd><p class="first">Legacy option.  Not used.</p>
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-0-variable:CTEST_DROP_SITE_CDASH"></span><a class="reference internal" href="../variable/CTEST_DROP_SITE_CDASH.html#variable:CTEST_DROP_SITE_CDASH" title="CTEST_DROP_SITE_CDASH"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_DROP_SITE_CDASH</span></code></a></li>
<li><span class="target" id="index-56-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">CTEST_DROP_SITE_CDASH</span></code></li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">ScpCommand</span></code></dt>
<dd><p class="first">Legacy option.  Not used.</p>
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-0-variable:CTEST_SCP_COMMAND"></span><a class="reference internal" href="../variable/CTEST_SCP_COMMAND.html#variable:CTEST_SCP_COMMAND" title="CTEST_SCP_COMMAND"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_SCP_COMMAND</span></code></a></li>
<li><span class="target" id="index-57-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">SCPCOMMAND</span></code></li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Site</span></code></dt>
<dd><p class="first">Describe the dashboard client host site with a short string.
(Hostname, domain, etc.)</p>
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-0-variable:CTEST_SITE"></span><a class="reference internal" href="../variable/CTEST_SITE.html#variable:CTEST_SITE" title="CTEST_SITE"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_SITE</span></code></a></li>
<li><span class="target" id="index-58-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">SITE</span></code>,
initialized by the <span class="target" id="index-0-command:site_name"></span><a class="reference internal" href="../command/site_name.html#command:site_name" title="site_name"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">site_name()</span></code></a> command</li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">SubmitURL</span></code></dt>
<dd><p class="first">The <code class="docutils literal notranslate"><span class="pre">http</span></code> or <code class="docutils literal notranslate"><span class="pre">https</span></code> URL of the dashboard server to send the submission
to.</p>
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-0-variable:CTEST_SUBMIT_URL"></span><a class="reference internal" href="../variable/CTEST_SUBMIT_URL.html#variable:CTEST_SUBMIT_URL" title="CTEST_SUBMIT_URL"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_SUBMIT_URL</span></code></a></li>
<li><span class="target" id="index-59-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">SUBMIT_URL</span></code> if set,
else <code class="docutils literal notranslate"><span class="pre">CTEST_SUBMIT_URL</span></code></li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">TriggerSite</span></code></dt>
<dd><p class="first">Legacy option.  Not used.</p>
<ul class="last simple">
<li><a class="reference internal" href="#ctest-script">CTest Script</a> variable: <span class="target" id="index-0-variable:CTEST_TRIGGER_SITE"></span><a class="reference internal" href="../variable/CTEST_TRIGGER_SITE.html#variable:CTEST_TRIGGER_SITE" title="CTEST_TRIGGER_SITE"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_TRIGGER_SITE</span></code></a></li>
<li><span class="target" id="index-60-module:CTest"></span><a class="reference internal" href="../module/CTest.html#module:CTest" title="CTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CTest</span></code></a> module variable: <code class="docutils literal notranslate"><span class="pre">TRIGGER_SITE</span></code> if set,
else <code class="docutils literal notranslate"><span class="pre">CTEST_TRIGGER_SITE</span></code></li>
</ul>
</dd>
</dl>
</div>
...
<span id="id12"></span><h2><a class="toc-backref" href="#id33">Show as JSON Object Model</a><a class="headerlink" href="#show-as-json-object-model" title="Permalink to this headline">¶</a></h2>
...
<dd>The string “ctestInfo”.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">version</span></code></dt>
<dd><p class="first">A JSON object specifying the version components.  Its members are</p>
<dl class="last docutils">
<dt><code class="docutils literal notranslate"><span class="pre">major</span></code></dt>
<dd>A non-negative integer specifying the major version component.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">minor</span></code></dt>
<dd>A non-negative integer specifying the minor version component.</dd>
</dl>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">backtraceGraph</span></code></dt>
<dd><p class="first">JSON object representing backtrace information with the
following members:</p>
<dl class="last docutils">
<dt><code class="docutils literal notranslate"><span class="pre">commands</span></code></dt>
...
<dd><p class="first">List of node JSON objects with members:</p>
<dl class="last docutils">
<dt><code class="docutils literal notranslate"><span class="pre">command</span></code></dt>
<dd>Index into the <code class="docutils literal notranslate"><span class="pre">commands</span></code> member of the <code class="docutils literal notranslate"><span class="pre">backtraceGraph</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">file</span></code></dt>
<dd>Index into the <code class="docutils literal notranslate"><span class="pre">files</span></code> member of the <code class="docutils literal notranslate"><span class="pre">backtraceGraph</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">line</span></code></dt>
<dd>Line number in the file where the backtrace was added.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">parent</span></code></dt>
<dd>Index into the <code class="docutils literal notranslate"><span class="pre">nodes</span></code> member of the <code class="docutils literal notranslate"><span class="pre">backtraceGraph</span></code>
representing the parent in the graph.</dd>
</dl>
</dd>
</dl>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">tests</span></code></dt>
<dd><p class="first">A JSON array listing information about each test.  Each entry
...
<dd>Configuration that the test can run on.
Empty string means any config.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">command</span></code></dt>
<dd>List where the first element is the test command and the
remaining elements are the command arguments.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">backtrace</span></code></dt>
<dd>Index into the <code class="docutils literal notranslate"><span class="pre">nodes</span></code> member of the <code class="docutils literal notranslate"><span class="pre">backtraceGraph</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">properties</span></code></dt>
<dd>Test properties.
Can contain keys for each of the supported test properties.</dd>
</dl>
</dd>
</dl>
</div>
<div class="section" id="resource-allocation">
<span id="ctest-resource-allocation"></span><h2><a class="toc-backref" href="#id34">Resource Allocation</a><a class="headerlink" href="#resource-allocation" title="Permalink to this headline">¶</a></h2>
...
<ul class="simple">
<li>The <a class="reference internal" href="#ctest-resource-specification-file"><span class="std std-ref">resource specification file</span></a>,
described below, which describes the resources available on the system.</li>
<li>The <span class="target" id="index-0-prop_test:RESOURCE_GROUPS"></span><a class="reference internal" href="../prop_test/RESOURCE_GROUPS.html#prop_test:RESOURCE_GROUPS" title="RESOURCE_GROUPS"><code class="xref cmake cmake-prop_test docutils literal notranslate"><span class="pre">RESOURCE_GROUPS</span></code></a> property of tests, which describes the
resources required by the test.</li>
</ul>
...
<span id="ctest-resource-specification-file"></span><h3><a class="toc-backref" href="#id35">Resource Specification File</a><a class="headerlink" href="#resource-specification-file" title="Permalink to this headline">¶</a></h3>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">version</span></code></dt>
<dd>An object containing a <code class="docutils literal notranslate"><span class="pre">major</span></code> integer field and a <code class="docutils literal notranslate"><span class="pre">minor</span></code> integer field.
...
<dt><code class="docutils literal notranslate"><span class="pre">local</span></code></dt>
<dd><p class="first">A JSON array of resource sets present on the system.  Currently, this array
...
<dd><p class="first">A string consisting of an identifier for the resource. Each character in
...
<dt><code class="docutils literal notranslate"><span class="pre">slots</span></code></dt>
<dd>An optional unsigned number specifying the number of slots available on the
...
specified, a default value of <code class="docutils literal notranslate"><span class="pre">1</span></code> is assumed.</dd>
</dl>
</dd>
</dl>
...
<h3><a class="toc-backref" href="#id36"><code class="docutils literal notranslate"><span class="pre">RESOURCE_GROUPS</span></code> Property</a><a class="headerlink" href="#resource-groups-property" title="Permalink to this headline">¶</a></h3>
...
<span id="ctest-resource-environment-variables"></span><h3><a class="toc-backref" href="#id37">Environment Variables</a><a class="headerlink" href="#environment-variables" title="Permalink to this headline">¶</a></h3>
...
<code class="descname">CTEST_RESOURCE_GROUP_COUNT</code><a class="headerlink" href="#envvar:CTEST_RESOURCE_GROUP_COUNT" title="Permalink to this definition">¶</a></dt>
...
<ul class="simple">
<li><code class="docutils literal notranslate"><span class="pre">CTEST_RESOURCE_GROUP_COUNT=3</span></code></li>
</ul>
...
<code class="descname">CTEST_RESOURCE_GROUP_&lt;num&gt;</code><a class="headerlink" href="#envvar:CTEST_RESOURCE_GROUP_<num>" title="Permalink to this definition">¶</a></dt>
...
<ul class="simple">
<li><code class="docutils literal notranslate"><span class="pre">CTEST_RESOURCE_GROUP_0=gpus</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">CTEST_RESOURCE_GROUP_1=gpus</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">CTEST_RESOURCE_GROUP_2=crypto_chips,gpus</span></code></li>
</ul>
</dd></dl>

<dl class="envvar">
<dt id="envvar:CTEST_RESOURCE_GROUP_&lt;num&gt;_&lt;resource-type&gt;">
<code class="descname">CTEST_RESOURCE_GROUP_&lt;num&gt;_&lt;resource-type&gt;</code><a class="headerlink" href="#envvar:CTEST_RESOURCE_GROUP_<num>_<resource-type>" title="Permalink to this definition">¶</a></dt>
...
<ul class="simple">
<li><code class="docutils literal notranslate"><span class="pre">CTEST_RESOURCE_GROUP_0_GPUS=id:0,slots:2</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">CTEST_RESOURCE_GROUP_1_GPUS=id:2,slots:2</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">CTEST_RESOURCE_GROUP_2_GPUS=id:1,slots:4;id:3,slots:1</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">CTEST_RESOURCE_GROUP_2_CRYPTO_CHIPS=id:card0,slots:2</span></code></li>
</ul>
...
<h2><a class="toc-backref" href="#id38">See Also</a><a class="headerlink" href="#see-also" title="Permalink to this headline">¶</a></h2>
...
<p class="last">Links to available documentation and community resources may be
found on this web page.</p>
</dd>
<dt>Discourse Forum</dt>
<dd><p class="first"><a class="reference external" href="https://discourse.cmake.org">https://discourse.cmake.org</a></p>
<p class="last">The Discourse Forum hosts discussion and questions about CMake.</p>
</dd>
</dl>
</div>
</div>
