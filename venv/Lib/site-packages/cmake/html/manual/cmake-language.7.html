...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>cmake-language(7) &mdash; CMake 3.16.1 Documentation</title>
...
<li><a class="reference internal" href="#environment-variables" id="id32">Environment Variables</a></li>
<li><a class="reference internal" href="#lists" id="id33">Lists</a></li>
</ul>
</li>
</ul>
</div>
...
<ul class="simple">
<li><a class="reference internal" href="#directories">Directories</a> (<code class="docutils literal notranslate"><span class="pre">CMakeLists.txt</span></code>),</li>
<li><a class="reference internal" href="#scripts">Scripts</a> (<code class="docutils literal notranslate"><span class="pre">&lt;script&gt;.cmake</span></code>), and</li>
<li><a class="reference internal" href="#modules">Modules</a> (<code class="docutils literal notranslate"><span class="pre">&lt;module&gt;.cmake</span></code>).</li>
</ul>
...
<div class="admonition note">
<p class="first admonition-title">Note</p>
<p class="last">CMake versions prior to 3.0 do not support continuation with <code class="docutils literal notranslate"><span class="pre">\</span></code>.
...
any nested calls within it, but not after the function returns.</dd>
...
<dl class="docutils">
<dt>Scope</dt>
<dd>Environment variables have global scope in a CMake process.
They are never cached.</dd>
<dt>References</dt>
<dd><a class="reference internal" href="#variable-references">Variable References</a> have the form <code class="docutils literal notranslate"><span class="pre">$ENV{&lt;variable&gt;}</span></code>.</dd>
<dt>Initialization</dt>
<dd>Initial values of the CMake environment variables are those of
the calling process.
...
and they are not seen by subsequent build or test processes.</dd>
</dl>
