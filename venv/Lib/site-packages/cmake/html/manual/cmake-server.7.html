...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>cmake-server(7) &mdash; CMake 3.16.1 Documentation</title>
...
<li><a class="reference internal" href="#type-ctestinfo" id="id23">Type “ctestInfo”</a></li>
<li><a class="reference internal" href="#type-cmakeinputs" id="id24">Type “cmakeInputs”</a></li>
<li><a class="reference internal" href="#type-cache" id="id25">Type “cache”</a></li>
<li><a class="reference internal" href="#type-filesystemwatchers" id="id26">Type “fileSystemWatchers”</a></li>
</ul>
</li>
</ul>
</li>
...
<p><span class="versionmodified">Deprecated since version 3.15: </span>This will be removed from a future version of CMake.
...
<dd>contains the minimum cmake version allowed for this project, null if the
project doesn’t specify one.</dd>
<dt>“hasInstallRule”</dt>
<dd>true if the project contains any install rules, false otherwise.</dd>
...
<dd>true if the target is auto-created by a generator, false otherwise</dd>
<dt>“hasInstallRule”</dt>
<dd>true if the target contains any install rules, false otherwise.</dd>
<dt>“installPaths”</dt>
<dd>full path to the destination directories defined by target install rules.</dd>
<dt>“artifacts”</dt>
...
<dd>contains the (sub-)projects name.</dd>
<dt>“ctestInfo”</dt>
<dd>contains a list of test objects.</dd>
</dl>
<p>Each test object can have the following keys:</p>
<dl class="docutils">
<dt>“ctestName”</dt>
<dd>contains the name of the test.</dd>
<dt>“ctestCommand”</dt>
<dd>contains the test command.</dd>
<dt>“properties”</dt>
<dd>contains a list of test property objects.</dd>
</dl>
<p>Each test property object can have the following keys:</p>
<dl class="docutils">
<dt>“key”</dt>
<dd>contains the test property key.</dd>
<dt>“value”</dt>
<dd>contains the test property value.</dd>
</dl>
</div>
