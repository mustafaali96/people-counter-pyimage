...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMAKE_FIND_PACKAGE_NO_PACKAGE_REGISTRY &mdash; CMake 3.16.1 Documentation</title>
...
<p><span class="versionmodified">Deprecated since version 3.16: </span>Use the <span class="target" id="index-0-variable:CMAKE_FIND_USE_PACKAGE_REGISTRY"></span><a class="reference internal" href="CMAKE_FIND_USE_PACKAGE_REGISTRY.html#variable:CMAKE_FIND_USE_PACKAGE_REGISTRY" title="CMAKE_FIND_USE_PACKAGE_REGISTRY"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_FIND_USE_PACKAGE_REGISTRY</span></code></a> variable instead.</p>
</div>
