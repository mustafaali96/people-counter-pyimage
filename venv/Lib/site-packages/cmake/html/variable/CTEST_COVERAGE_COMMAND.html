...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CTEST_COVERAGE_COMMAND &mdash; CMake 3.16.1 Documentation</title>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">--datafila</span></code></dt>
<dd>path to the merged <code class="docutils literal notranslate"><span class="pre">.ser</span></code> file</dd>
