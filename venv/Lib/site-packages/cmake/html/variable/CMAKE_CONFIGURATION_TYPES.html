...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMAKE_CONFIGURATION_TYPES &mdash; CMake 3.16.1 Documentation</title>
...
types.  See also <span class="target" id="index-0-variable:CMAKE_BUILD_TYPE"></span><a class="reference internal" href="CMAKE_BUILD_TYPE.html#variable:CMAKE_BUILD_TYPE" title="CMAKE_BUILD_TYPE"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_BUILD_TYPE</span></code></a> for details of managing
configuration data, and <span class="target" id="index-0-variable:CMAKE_CFG_INTDIR"></span><a class="reference internal" href="CMAKE_CFG_INTDIR.html#variable:CMAKE_CFG_INTDIR" title="CMAKE_CFG_INTDIR"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_CFG_INTDIR</span></code></a>.</p>
</div>
