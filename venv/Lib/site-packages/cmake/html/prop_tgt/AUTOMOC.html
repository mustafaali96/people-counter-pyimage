...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>AUTOMOC &mdash; CMake 3.16.1 Documentation</title>
...
<ul>
<li><p class="first">All header files in the target’s sources are added to the scan list.</p>
</li>
<li><p class="first">For all C++ source files <code class="docutils literal notranslate"><span class="pre">&lt;source_base&gt;.&lt;source_extension&gt;</span></code> in the
target’s sources, CMake searches for</p>
<ul class="simple">
<li>a regular header with the same base name
(<code class="docutils literal notranslate"><span class="pre">&lt;source_base&gt;.&lt;header_extention&gt;</span></code>) and</li>
<li>a private header with the same base name and a <code class="docutils literal notranslate"><span class="pre">_p</span></code> suffix
(<code class="docutils literal notranslate"><span class="pre">&lt;source_base&gt;_p.&lt;header_extention&gt;</span></code>)</li>
</ul>
...
<ul class="simple">
<li>a Qt macro from <span class="target" id="index-0-prop_tgt:AUTOMOC_MACRO_NAMES"></span><a class="reference internal" href="AUTOMOC_MACRO_NAMES.html#prop_tgt:AUTOMOC_MACRO_NAMES" title="AUTOMOC_MACRO_NAMES"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">AUTOMOC_MACRO_NAMES</span></code></a>,</li>
<li>additional file dependencies from the <code class="docutils literal notranslate"><span class="pre">FILE</span></code> argument of a
<code class="docutils literal notranslate"><span class="pre">Q_PLUGIN_METADATA</span></code> macro and</li>
<li>additional file dependencies detected by filters defined in
...
<ul class="simple">
<li>a Qt macro from <span class="target" id="index-1-prop_tgt:AUTOMOC_MACRO_NAMES"></span><a class="reference internal" href="AUTOMOC_MACRO_NAMES.html#prop_tgt:AUTOMOC_MACRO_NAMES" title="AUTOMOC_MACRO_NAMES"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">AUTOMOC_MACRO_NAMES</span></code></a>,</li>
<li>includes of header <code class="docutils literal notranslate"><span class="pre">moc</span></code> files
(see <a class="reference internal" href="#including-header-moc-files-in-sources">Including header moc files in sources</a>),</li>
<li>additional file dependencies from the <code class="docutils literal notranslate"><span class="pre">FILE</span></code> argument of a
<code class="docutils literal notranslate"><span class="pre">Q_PLUGIN_METADATA</span></code> macro and</li>
<li>additional file dependencies detected by filters defined in
...
<ul class="simple">
<li><code class="docutils literal notranslate"><span class="pre">&lt;AUTOGEN_BUILD_DIR&gt;/include</span></code>
for single configuration generators or in</li>
<li><code class="docutils literal notranslate"><span class="pre">&lt;AUTOGEN_BUILD_DIR&gt;/include_&lt;CONFIG&gt;</span></code>
for <span class="target" id="index-0-prop_gbl:GENERATOR_IS_MULTI_CONFIG"></span><a class="reference internal" href="../prop_gbl/GENERATOR_IS_MULTI_CONFIG.html#prop_gbl:GENERATOR_IS_MULTI_CONFIG" title="GENERATOR_IS_MULTI_CONFIG"><code class="xref cmake cmake-prop_gbl docutils literal notranslate"><span class="pre">multi</span> <span class="pre">configuration</span></code></a> generators.</li>
</ul>
...
in</p>
<ul class="simple">
<li><code class="docutils literal notranslate"><span class="pre">&lt;AUTOGEN_BUILD_DIR&gt;/&lt;SOURCE_DIR_CHECKSUM&gt;</span></code>
for single configuration generators or in,</li>
<li><code class="docutils literal notranslate"><span class="pre">&lt;AUTOGEN_BUILD_DIR&gt;/include_&lt;CONFIG&gt;/&lt;SOURCE_DIR_CHECKSUM&gt;</span></code>
...
<ul class="simple">
<li><code class="docutils literal notranslate"><span class="pre">&lt;AUTOGEN_BUILD_DIR&gt;/mocs_compilation.cpp</span></code>,</li>
</ul>
...
<ul class="simple">
<li><code class="docutils literal notranslate"><span class="pre">Qt5Core_VERSION_MAJOR</span></code> and <code class="docutils literal notranslate"><span class="pre">Qt5Core_VERSION_MINOR</span></code> variables
(usually set by <code class="docutils literal notranslate"><span class="pre">find_package(Qt5...)</span></code>)</li>
<li><code class="docutils literal notranslate"><span class="pre">Qt5Core_VERSION_MAJOR</span></code> and <code class="docutils literal notranslate"><span class="pre">Qt5Core_VERSION_MINOR</span></code> directory properties</li>
<li><code class="docutils literal notranslate"><span class="pre">QT_VERSION_MAJOR</span></code> and <code class="docutils literal notranslate"><span class="pre">QT_VERSION_MINOR</span></code>  variables
(usually set by <code class="docutils literal notranslate"><span class="pre">find_package(Qt4...)</span></code>)</li>
<li><code class="docutils literal notranslate"><span class="pre">QT_VERSION_MAJOR</span></code> and <code class="docutils literal notranslate"><span class="pre">QT_VERSION_MINOR</span></code>  directory properties</li>
</ul>
