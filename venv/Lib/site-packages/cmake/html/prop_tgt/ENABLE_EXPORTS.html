...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>ENABLE_EXPORTS &mdash; CMake 3.16.1 Documentation</title>
...
<ul class="simple">
<li>On Windows-based systems (including Cygwin) an “import library” is
created along with the executable to list the exported symbols.
Loadable modules link to the import library to get the symbols.</li>
<li>On macOS, loadable modules link to the executable itself using the
<code class="docutils literal notranslate"><span class="pre">-bundle_loader</span></code> flag.</li>
<li>On AIX, a linker “import file” is created along with the executable
to list the exported symbols for import when linking other targets.
Loadable modules link to the import file to get the symbols.</li>
<li>On other platforms, loadable modules are simply linked without
referencing the executable since the dynamic loader will
automatically bind symbols when the module is loaded.</li>
</ul>
