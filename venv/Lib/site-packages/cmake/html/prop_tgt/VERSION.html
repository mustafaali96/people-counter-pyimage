...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>VERSION &mdash; CMake 3.16.1 Documentation</title>
...
the <span class="target" id="index-1-prop_tgt:SOVERSION"></span><a class="reference internal" href="SOVERSION.html#prop_tgt:SOVERSION" title="SOVERSION"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">SOVERSION</span></code></a> property correspond to <em>compatibility version</em> and
<code class="docutils literal notranslate"><span class="pre">VERSION</span></code> to <em>current version</em>.  See the <span class="target" id="index-0-prop_tgt:FRAMEWORK"></span><a class="reference internal" href="FRAMEWORK.html#prop_tgt:FRAMEWORK" title="FRAMEWORK"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">FRAMEWORK</span></code></a> target
property for an example.  Versions of Mach-O binaries may be checked with the
<code class="docutils literal notranslate"><span class="pre">otool</span> <span class="pre">-L</span> <span class="pre">&lt;binary&gt;</span></code> command.</p>
</div>
</div>
