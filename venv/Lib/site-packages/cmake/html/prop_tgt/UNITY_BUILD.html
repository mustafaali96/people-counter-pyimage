...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>UNITY_BUILD &mdash; CMake 3.16.1 Documentation</title>
...
3.16.1 supports combining <code class="docutils literal notranslate"><span class="pre">C</span></code> and <code class="docutils literal notranslate"><span class="pre">CXX</span></code> source files.  For targets that
...
<p class="last">Projects should not directly set the <code class="docutils literal notranslate"><span class="pre">UNITY_BUILD</span></code> property or its
...
<ul class="simple">
<li>Any source file that has a non-empty <span class="target" id="index-0-prop_sf:COMPILE_OPTIONS"></span><a class="reference internal" href="../prop_sf/COMPILE_OPTIONS.html#prop_sf:COMPILE_OPTIONS" title="COMPILE_OPTIONS"><code class="xref cmake cmake-prop_sf docutils literal notranslate"><span class="pre">COMPILE_OPTIONS</span></code></a>,
...
into a unity source.</li>
<li>Projects can prevent an individual source file from being combined into
...
<code class="docutils literal notranslate"><span class="pre">#include</span></code> statement.</li>
<li>The order of source files added to the target via commands like
...
the <span class="target" id="index-1-prop_tgt:UNITY_BUILD_BATCH_SIZE"></span><a class="reference internal" href="UNITY_BUILD_BATCH_SIZE.html#prop_tgt:UNITY_BUILD_BATCH_SIZE" title="UNITY_BUILD_BATCH_SIZE"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">UNITY_BUILD_BATCH_SIZE</span></code></a> target property.</li>
</ul>
</div>
</div>
