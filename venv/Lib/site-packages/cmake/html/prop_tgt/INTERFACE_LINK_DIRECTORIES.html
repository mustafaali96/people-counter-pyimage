...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>INTERFACE_LINK_DIRECTORIES &mdash; CMake 3.16.1 Documentation</title>
...
required to compile against the headers for the target.  The <span class="target" id="index-1-command:target_link_directories"></span><a class="reference internal" href="../command/target_link_directories.html#command:target_link_directories" title="target_link_directories"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">target_link_directories()</span></code></a>
