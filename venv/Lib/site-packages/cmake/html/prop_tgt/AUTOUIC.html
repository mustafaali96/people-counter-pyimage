...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>AUTOUIC &mdash; CMake 3.16.1 Documentation</title>
...
<ul class="simple">
<li>in the vicinity of the file and</li>
<li>in the <span class="target" id="index-0-prop_tgt:AUTOUIC_SEARCH_PATHS"></span><a class="reference internal" href="AUTOUIC_SEARCH_PATHS.html#prop_tgt:AUTOUIC_SEARCH_PATHS" title="AUTOUIC_SEARCH_PATHS"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">AUTOUIC_SEARCH_PATHS</span></code></a> of the target.</li>
</ul>
...
<ul class="simple">
<li><code class="docutils literal notranslate"><span class="pre">&lt;AUTOGEN_BUILD_DIR&gt;/include</span></code> for single configuration generators or in</li>
<li><code class="docutils literal notranslate"><span class="pre">&lt;AUTOGEN_BUILD_DIR&gt;/include_&lt;CONFIG&gt;</span></code> for
...
<p><span class="target" id="index-0-prop_sf:AUTOUIC_OPTIONS"></span><a class="reference internal" href="../prop_sf/AUTOUIC_OPTIONS.html#prop_sf:AUTOUIC_OPTIONS" title="AUTOUIC_OPTIONS"><code class="xref cmake cmake-prop_sf docutils literal notranslate"><span class="pre">AUTOUIC_OPTIONS</span></code></a>: Additional command line options for <code class="docutils literal notranslate"><span class="pre">uic</span></code> can
be set via this source file property on a <code class="docutils literal notranslate"><span class="pre">&lt;base_name&gt;.ui</span></code> file.</p>
