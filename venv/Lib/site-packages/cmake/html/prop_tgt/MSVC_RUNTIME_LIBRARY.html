...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>MSVC_RUNTIME_LIBRARY &mdash; CMake 3.16.1 Documentation</title>
...
<p class="last">This property has effect only when policy <span class="target" id="index-0-policy:CMP0091"></span><a class="reference internal" href="../policy/CMP0091.html#policy:CMP0091" title="CMP0091"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0091</span></code></a> is set to <code class="docutils literal notranslate"><span class="pre">NEW</span></code>
