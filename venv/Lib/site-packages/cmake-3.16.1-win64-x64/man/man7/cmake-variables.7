...
.
.TH "CMAKE-VARIABLES" "7" "Dec 10, 2019" "3.16.1" "CMake"
.SH NAME
...
.sp
See also the \fBCMAKE_PROJECT_<PROJECT\-NAME>_INCLUDE\fP and
...
.sp
See also the \fBCMAKE_PROJECT_INCLUDE\fP and
\fBCMAKE_PROJECT_INCLUDE_BEFORE\fP variables.
...
.sp
When \fBCMAKE_GLOBAL_AUTORCC_TARGET\fP is enabled, a custom target
...
target platform compiles as WinRT by default (compiles with \fB/ZW\fP).
.sp
This variable is meant to be set by a
