...
.
.TH "CPACK-GENERATORS" "7" "Dec 10, 2019" "3.16.1" "CMake"
.SH NAME
...
.TP
.B Default
\fB<CPACK_PACKAGE_FILE_NAME>[\-<component>].<extension>\fP with
spaces replaced by ‘\-‘
.UNINDENT
.UNINDENT
.UNINDENT
...
.sp
See \fBCPackIFW\fP for details on the CPackIFW module.
.SS Overview
.sp
...
.SS Hints
.sp
Generally, the CPack \fBIFW\fP generator automatically finds \fI\%QtIFW\fP tools,
but if you don’t use a default path for installation of the \fI\%QtIFW\fP tools,
the path may be specified in either a CMake or an environment variable:
.INDENT 0.0
.TP
.B CPACK_IFW_ROOT
An CMake variable which specifies the location of the \fI\%QtIFW\fP tool suite.
.sp
...
.TP
.B QTIFWDIR
An environment variable which specifies the location of the \fI\%QtIFW\fP tool
suite.
.UNINDENT
.sp
\fBNOTE:\fP
...
.sp
Installers created by \fI\%QtIFW\fP tools have built\-in support for
...
.sp
You also can use command \fBcpack_ifw_add_repository()\fP and
