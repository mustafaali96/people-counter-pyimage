...
.
.TH "CMAKE-POLICIES" "7" "Dec 10, 2019" "3.16.1" "CMake"
.SH NAME
...
Unlike most policies, CMake version 3.16.1 does \fInot\fP warn
...
version 3.16.1 does \fInot\fP warn when this policy is not set and simply uses
...
.sp
This policy was introduced in CMake version 3.16. CMake version 3.16.1 warns
...
\fBcmake_policy()\fP command to set it to \fBOLD\fP or \fBNEW\fP explicitly.
Unlike many policies, CMake version 3.16.1 does \fInot\fP warn
...
3.16.1 warns when the policy is not set and uses \fBOLD\fP behavior.
...
CMake version 3.16.1 does \fInot\fP warn by default when this policy
...
3.16.1 warns when the policy is not set and uses \fBOLD\fP behavior.  Use
...
CMake version 3.16.1 does \fInot\fP warn when this policy is not set and
...
.sp
This policy was introduced in CMake version 3.3.
CMake version 3.16.1 warns when it sees unknown dependencies in
...
explicitly.  Unlike most policies, CMake version 3.16.1 does \fInot\fP warn
by default when this policy is not set and simply uses \fBOLD\fP behavior.
See documentation of the
