...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FindGnuTLS &mdash; CMake 3.16.1 Documentation</title>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">GNUTLS_FOUND</span></code></dt>
<dd>System has gnutls</dd>
<dt><code class="docutils literal notranslate"><span class="pre">GNUTLS_INCLUDE_DIR</span></code></dt>
<dd>The gnutls include directory</dd>
<dt><code class="docutils literal notranslate"><span class="pre">GNUTLS_LIBRARIES</span></code></dt>
<dd>The libraries needed to use gnutls</dd>
<dt><code class="docutils literal notranslate"><span class="pre">GNUTLS_DEFINITIONS</span></code></dt>
<dd>Compiler switches required for using gnutls</dd>
<dt><code class="docutils literal notranslate"><span class="pre">GNUTLS_VERSION</span></code></dt>
<dd>version of gnutls.</dd>
</dl>
</div>
</div>
