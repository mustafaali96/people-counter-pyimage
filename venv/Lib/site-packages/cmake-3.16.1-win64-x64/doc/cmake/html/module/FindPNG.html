...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FindPNG &mdash; CMake 3.16.1 Documentation</title>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">PNG::PNG</span></code></dt>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">PNG_INCLUDE_DIRS</span></code></dt>
<dd>where to find png.h, etc.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">PNG_LIBRARIES</span></code></dt>
<dd>the libraries to link against to use PNG.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">PNG_DEFINITIONS</span></code></dt>
<dd>You should add_definitions(${PNG_DEFINITIONS}) before compiling code
that includes png library files.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">PNG_FOUND</span></code></dt>
<dd>If false, do not try to use PNG.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">PNG_VERSION_STRING</span></code></dt>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">PNG_LIBRARY</span></code></dt>
<dd>where to find the PNG library.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">PNG_INCLUDE_DIR</span></code></dt>
