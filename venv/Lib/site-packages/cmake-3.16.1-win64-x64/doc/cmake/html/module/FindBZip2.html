...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FindBZip2 &mdash; CMake 3.16.1 Documentation</title>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">BZIP2_FOUND</span></code></dt>
<dd>system has BZip2</dd>
<dt><code class="docutils literal notranslate"><span class="pre">BZIP2_INCLUDE_DIRS</span></code></dt>
<dd>the BZip2 include directories</dd>
<dt><code class="docutils literal notranslate"><span class="pre">BZIP2_LIBRARIES</span></code></dt>
<dd>Link these to use BZip2</dd>
<dt><code class="docutils literal notranslate"><span class="pre">BZIP2_NEED_PREFIX</span></code></dt>
<dd>this is set if the functions are prefixed with <code class="docutils literal notranslate"><span class="pre">BZ2_</span></code></dd>
<dt><code class="docutils literal notranslate"><span class="pre">BZIP2_VERSION_STRING</span></code></dt>
<dd>the version of BZip2 found</dd>
</dl>
</div>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">BZIP2_INCLUDE_DIR</span></code></dt>
<dd>the BZip2 include directory</dd>
</dl>
</div>
</div>
