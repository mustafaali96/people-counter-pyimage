...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FindCups &mdash; CMake 3.16.1 Documentation</title>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">CUPS_FOUND</span></code></dt>
<dd>true if CUPS headers and libraries were found</dd>
<dt><code class="docutils literal notranslate"><span class="pre">CUPS_INCLUDE_DIRS</span></code></dt>
<dd>the directory containing the Cups headers</dd>
<dt><code class="docutils literal notranslate"><span class="pre">CUPS_LIBRARIES</span></code></dt>
<dd>the libraries to link against to use CUPS.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">CUPS_VERSION_STRING</span></code></dt>
<dd>the version of CUPS found (since CMake 2.8.8)</dd>
</dl>
</div>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">CUPS_INCLUDE_DIR</span></code></dt>
<dd>the directory containing the Cups headers</dd>
</dl>
</div>
</div>
