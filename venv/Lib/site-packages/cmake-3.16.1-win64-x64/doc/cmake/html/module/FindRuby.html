...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FindRuby &mdash; CMake 3.16.1 Documentation</title>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">RUBY_EXECUTABLE</span></code></dt>
<dd>full path to the ruby binary</dd>
<dt><code class="docutils literal notranslate"><span class="pre">RUBY_INCLUDE_DIRS</span></code></dt>
<dd>include dirs to be used when using the ruby library</dd>
<dt><code class="docutils literal notranslate"><span class="pre">RUBY_LIBRARY</span></code></dt>
<dd>full path to the ruby library</dd>
<dt><code class="docutils literal notranslate"><span class="pre">RUBY_VERSION</span></code></dt>
<dd>the version of ruby which was found, e.g. “1.8.7”</dd>
<dt><code class="docutils literal notranslate"><span class="pre">RUBY_FOUND</span></code></dt>
<dd>set to true if ruby ws found successfully</dd>
</dl>
<p>Also:</p>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">RUBY_INCLUDE_PATH</span></code></dt>
