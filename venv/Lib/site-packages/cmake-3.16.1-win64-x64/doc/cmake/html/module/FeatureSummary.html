...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FeatureSummary &mdash; CMake 3.16.1 Documentation</title>
...
<code class="descname">FeatureSummary_&lt;TYPE&gt;_DESCRIPTION</code><a class="headerlink" href="#variable:FeatureSummary_<TYPE>_DESCRIPTION" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>
...
<dt><code class="docutils literal notranslate"><span class="pre">ENABLED_FEATURES</span></code></dt>
<dd>the list of all features which are enabled</dd>
<dt><code class="docutils literal notranslate"><span class="pre">DISABLED_FEATURES</span></code></dt>
<dd>the list of all features which are disabled</dd>
<dt><code class="docutils literal notranslate"><span class="pre">PACKAGES_FOUND</span></code></dt>
<dd>the list of all packages which have been found</dd>
<dt><code class="docutils literal notranslate"><span class="pre">PACKAGES_NOT_FOUND</span></code></dt>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">&lt;TYPE&gt;_PACKAGES_FOUND</span></code></dt>
<dd>only those packages which have been found which have the type &lt;TYPE&gt;</dd>
<dt><code class="docutils literal notranslate"><span class="pre">&lt;TYPE&gt;_PACKAGES_NOT_FOUND</span></code></dt>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">URL</span> <span class="pre">&lt;url&gt;</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">DESCRIPTION</span> <span class="pre">&lt;description&gt;</span></code></dt>
<dd>A short description what that package is, at most one sentence.
Ideally this is set already directly in the Find-module.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">TYPE</span> <span class="pre">&lt;type&gt;</span></code></dt>
...
<span class="target" id="index-3-variable:FeatureSummary_PKG_TYPES"></span><a class="reference internal" href="#variable:FeatureSummary_PKG_TYPES" title="FeatureSummary_PKG_TYPES"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">FeatureSummary_PKG_TYPES</span></code></a> global property.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">PURPOSE</span> <span class="pre">&lt;purpose&gt;</span></code></dt>
