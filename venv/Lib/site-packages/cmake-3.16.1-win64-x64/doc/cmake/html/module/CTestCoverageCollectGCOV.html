...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CTestCoverageCollectGCOV &mdash; CMake 3.16.1 Documentation</title>
...
<li><em>Labels.json</em> indicates any <span class="target" id="index-0-prop_sf:LABELS"></span><a class="reference internal" href="../prop_sf/LABELS.html#prop_sf:LABELS" title="LABELS"><code class="xref cmake cmake-prop_sf docutils literal notranslate"><span class="pre">LABELS</span></code></a> that have been set on the
source files.</li>
<li>The <em>uncovered</em> directory holds any uncovered files found by
<span class="target" id="index-0-variable:CTEST_EXTRA_COVERAGE_GLOB"></span><a class="reference internal" href="../variable/CTEST_EXTRA_COVERAGE_GLOB.html#variable:CTEST_EXTRA_COVERAGE_GLOB" title="CTEST_EXTRA_COVERAGE_GLOB"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_EXTRA_COVERAGE_GLOB</span></code></a>.</li>
</ul>
...
<code class="descname">ctest_coverage_collect_gcov</code><a class="headerlink" href="#command:ctest_coverage_collect_gcov" title="Permalink to this definition">¶</a></dt>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">TARBALL</span> <span class="pre">&lt;tarfile&gt;</span></code></dt>
<dd>Specify the location of the <code class="docutils literal notranslate"><span class="pre">.tar</span></code> file to be created for later
upload to CDash.  Relative paths will be interpreted with respect
to the top-level build directory.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">SOURCE</span> <span class="pre">&lt;source_dir&gt;</span></code></dt>
<dd>Specify the top-level source directory for the build.
Default is the value of <span class="target" id="index-0-variable:CTEST_SOURCE_DIRECTORY"></span><a class="reference internal" href="../variable/CTEST_SOURCE_DIRECTORY.html#variable:CTEST_SOURCE_DIRECTORY" title="CTEST_SOURCE_DIRECTORY"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_SOURCE_DIRECTORY</span></code></a>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">BUILD</span> <span class="pre">&lt;build_dir&gt;</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">GCOV_COMMAND</span> <span class="pre">&lt;gcov_command&gt;</span></code></dt>
<dd>Specify the full path to the <code class="docutils literal notranslate"><span class="pre">gcov</span></code> command on the machine.
Default is the value of <span class="target" id="index-0-variable:CTEST_COVERAGE_COMMAND"></span><a class="reference internal" href="../variable/CTEST_COVERAGE_COMMAND.html#variable:CTEST_COVERAGE_COMMAND" title="CTEST_COVERAGE_COMMAND"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_COVERAGE_COMMAND</span></code></a>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">GCOV_OPTIONS</span> <span class="pre">&lt;options&gt;...</span></code></dt>
<dd>Specify options to be passed to gcov.  The <code class="docutils literal notranslate"><span class="pre">gcov</span></code> command
...
If not specified, the default option is just <code class="docutils literal notranslate"><span class="pre">-b</span> <span class="pre">-x</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">GLOB</span></code></dt>
