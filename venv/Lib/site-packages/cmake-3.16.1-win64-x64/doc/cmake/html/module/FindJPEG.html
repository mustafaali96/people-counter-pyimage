...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FindJPEG &mdash; CMake 3.16.1 Documentation</title>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">JPEG::JPEG</span></code></dt>
<dd>The JPEG library, if found.</dd>
</dl>
</div>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">JPEG_FOUND</span></code></dt>
<dd>If false, do not try to use JPEG.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">JPEG_INCLUDE_DIRS</span></code></dt>
<dd>where to find jpeglib.h, etc.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">JPEG_LIBRARIES</span></code></dt>
<dd>the libraries needed to use JPEG.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">JPEG_VERSION</span></code></dt>
<dd>the version of the JPEG library found</dd>
</dl>
</div>
...
<dt><code class="docutils literal notranslate"><span class="pre">JPEG_INCLUDE_DIRS</span></code></dt>
<dd>where to find jpeglib.h, etc.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">JPEG_LIBRARY_RELEASE</span></code></dt>
<dd>where to find the JPEG library (optimized).</dd>
<dt><code class="docutils literal notranslate"><span class="pre">JPEG_LIBRARY_DEBUG</span></code></dt>
<dd>where to find the JPEG library (debug).</dd>
</dl>
</div>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">JPEG_INCLUDE_DIR</span></code></dt>
<dd>where to find jpeglib.h, etc. (same as JPEG_INCLUDE_DIRS)</dd>
<dt><code class="docutils literal notranslate"><span class="pre">JPEG_LIBRARY</span></code></dt>
<dd>where to find the JPEG library.</dd>
</dl>
</div>
</div>
