...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CheckFortranSourceCompiles &mdash; CMake 3.16.1 Documentation</title>
...
<code class="descname">check_fortran_source_compiles</code><a class="headerlink" href="#command:check_fortran_source_compiles" title="Permalink to this definition">¶</a></dt>
...
command before the contents of <code class="docutils literal notranslate"><span class="pre">CMAKE_REQUIRED_FLAGS</span></code>.</dd>
...
<code class="docutils literal notranslate"><span class="pre">&lt;resultVar&gt;</span></code> will also be added automatically.</dd>
...
<dd>A <a class="reference internal" href="../manual/cmake-language.7.html#cmake-language-lists"><span class="std std-ref">;-list</span></a> of options to add to the link
command (see <span class="target" id="index-1-command:try_compile"></span><a class="reference internal" href="../command/try_compile.html#command:try_compile" title="try_compile"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">try_compile()</span></code></a> for further details).</dd>
