...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FindLTTngUST &mdash; CMake 3.16.1 Documentation</title>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">LTTng::UST</span></code></dt>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">LTTNGUST_FOUND</span></code></dt>
<dd><code class="docutils literal notranslate"><span class="pre">TRUE</span></code> if system has LTTng-UST</dd>
<dt><code class="docutils literal notranslate"><span class="pre">LTTNGUST_INCLUDE_DIRS</span></code></dt>
<dd>The LTTng-UST include directories</dd>
<dt><code class="docutils literal notranslate"><span class="pre">LTTNGUST_LIBRARIES</span></code></dt>
<dd>The libraries needed to use LTTng-UST</dd>
<dt><code class="docutils literal notranslate"><span class="pre">LTTNGUST_VERSION_STRING</span></code></dt>
<dd>The LTTng-UST version</dd>
<dt><code class="docutils literal notranslate"><span class="pre">LTTNGUST_HAS_TRACEF</span></code></dt>
<dd><code class="docutils literal notranslate"><span class="pre">TRUE</span></code> if the <code class="docutils literal notranslate"><span class="pre">tracef()</span></code> API is available in the system’s LTTng-UST</dd>
<dt><code class="docutils literal notranslate"><span class="pre">LTTNGUST_HAS_TRACELOG</span></code></dt>
<dd><code class="docutils literal notranslate"><span class="pre">TRUE</span></code> if the <code class="docutils literal notranslate"><span class="pre">tracelog()</span></code> API is available in the system’s LTTng-UST</dd>
</dl>
</div>
</div>
