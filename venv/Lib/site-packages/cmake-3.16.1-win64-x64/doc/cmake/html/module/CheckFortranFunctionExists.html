...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CheckFortranFunctionExists &mdash; CMake 3.16.1 Documentation</title>
...
<code class="descname">CHECK_FORTRAN_FUNCTION_EXISTS</code><a class="headerlink" href="#command:check_fortran_function_exists" title="Permalink to this definition">¶</a></dt>
...
<p>where</p>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">&lt;function&gt;</span></code></dt>
<dd>the name of the Fortran function</dd>
<dt><code class="docutils literal notranslate"><span class="pre">&lt;result&gt;</span></code></dt>
<dd>variable to store the result; will be created as an internal cache variable.</dd>
</dl>
</dd></dl>
...
command (see <span class="target" id="index-0-command:try_compile"></span><a class="reference internal" href="../command/try_compile.html#command:try_compile" title="try_compile"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">try_compile()</span></code></a> for further details).</dd>
