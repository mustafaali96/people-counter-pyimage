...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FindCUDA &mdash; CMake 3.16.1 Documentation</title>
...
<p><span class="versionmodified">Deprecated since version 3.10: </span>Superseded by first-class support for the CUDA language in CMake.</p>
</div>
...
Instead, list <code class="docutils literal notranslate"><span class="pre">CUDA</span></code> among the languages named in the top-level
call to the <span class="target" id="index-0-command:project"></span><a class="reference internal" href="../command/project.html#command:project" title="project"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">project()</span></code></a> command, or call the
