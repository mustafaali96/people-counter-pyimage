...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>FindALSA &mdash; CMake 3.16.1 Documentation</title>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">ALSA_FOUND</span></code></dt>
<dd>True if ALSA_INCLUDE_DIR &amp; ALSA_LIBRARY are found</dd>
<dt><code class="docutils literal notranslate"><span class="pre">ALSA_LIBRARIES</span></code></dt>
<dd>List of libraries when using ALSA.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">ALSA_INCLUDE_DIRS</span></code></dt>
<dd>Where to find the ALSA headers.</dd>
</dl>
</div>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">ALSA_INCLUDE_DIR</span></code></dt>
<dd>the ALSA include directory</dd>
<dt><code class="docutils literal notranslate"><span class="pre">ALSA_LIBRARY</span></code></dt>
<dd>the absolute path of the asound library</dd>
</dl>
</div>
</div>
