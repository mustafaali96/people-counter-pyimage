...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CPackIFW &mdash; CMake 3.16.1 Documentation</title>
...
CPack <code class="docutils literal notranslate"><span class="pre">IFW</span></code> generator.</p>
...
<dt><code class="docutils literal notranslate"><span class="pre">ESSENTIAL</span></code></dt>
<dd>if set, then the package manager stays disabled until that
component is updated.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">VIRTUAL</span></code></dt>
...
<span class="target" id="index-1-command:cpack_add_component"></span><a class="reference internal" href="CPackComponent.html#command:cpack_add_component" title="cpack_add_component"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">cpack_add_component()</span></code></a> command.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">FORCED_INSTALLATION</span></code></dt>
<dd>if set, then the component must always be installed.
It is a equivalent of the <code class="docutils literal notranslate"><span class="pre">REQUARED</span></code> option from the
<span class="target" id="index-2-command:cpack_add_component"></span><a class="reference internal" href="CPackComponent.html#command:cpack_add_component" title="cpack_add_component"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">cpack_add_component()</span></code></a> command.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">REQUIRES_ADMIN_RIGHTS</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">DISPLAY_NAME</span></code></dt>
<dd>set to rewrite original name configured by
<span class="target" id="index-3-command:cpack_add_component"></span><a class="reference internal" href="CPackComponent.html#command:cpack_add_component" title="cpack_add_component"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">cpack_add_component()</span></code></a> command.</dd>
...
<span class="target" id="index-4-command:cpack_add_component"></span><a class="reference internal" href="CPackComponent.html#command:cpack_add_component" title="cpack_add_component"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">cpack_add_component()</span></code></a> command.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">UPDATE_TEXT</span></code></dt>
...
By default used <span class="target" id="index-0-variable:CPACK_PACKAGE_VERSION"></span><a class="reference internal" href="CPack.html#variable:CPACK_PACKAGE_VERSION" title="CPACK_PACKAGE_VERSION"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_PACKAGE_VERSION</span></code></a>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">RELEASE_DATE</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">PRIORITY</span></code> | <code class="docutils literal notranslate"><span class="pre">SORTING_PRIORITY</span></code></dt>
<dd>is priority of the component in the tree.
The <code class="docutils literal notranslate"><span class="pre">PRIORITY</span></code> option is deprecated and will be removed in a future
version of CMake. Please use <code class="docutils literal notranslate"><span class="pre">SORTING_PRIORITY</span></code> option instead.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">DEPENDS</span></code> | <code class="docutils literal notranslate"><span class="pre">DEPENDENCIES</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">AUTO_DEPEND_ON</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">LICENSES</span></code></dt>
...
as a value of the <code class="docutils literal notranslate"><span class="pre">SCRIPT</span></code> option).</dd>
<dt><code class="docutils literal notranslate"><span class="pre">USER_INTERFACES</span></code></dt>
<dd>is a list of &lt;file_path&gt; (‘.ui’ files) representing pages to load.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">TRANSLATIONS</span></code></dt>
<dd>is a list of &lt;file_path&gt; (‘.qm’ files) representing translations to load.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">REPLACES</span></code></dt>
<dd>list of identifiers of component or component group to replace.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">CHECKABLE</span></code></dt>
<dd>Possible values are: TRUE, FALSE.
...
By default used <span class="target" id="index-1-variable:CPACK_PACKAGE_VERSION"></span><a class="reference internal" href="CPack.html#variable:CPACK_PACKAGE_VERSION" title="CPACK_PACKAGE_VERSION"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_PACKAGE_VERSION</span></code></a>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">RELEASE_DATE</span></code></dt>
<dd>keep empty to auto generate.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">SCRIPT</span></code></dt>
<dd>is a relative or absolute path to operations script
...
the script as a value of the <code class="docutils literal notranslate"><span class="pre">SCRIPT</span></code> option).</dd>
<dt><code class="docutils literal notranslate"><span class="pre">USER_INTERFACES</span></code></dt>
<dd>is a list of &lt;file_path&gt; (‘.ui’ files) representing pages to load.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">TRANSLATIONS</span></code></dt>
<dd>is a list of &lt;file_path&gt; (‘.qm’ files) representing translations to load.</dd>
...
<dt><code class="docutils literal notranslate"><span class="pre">URL</span></code></dt>
<dd>is points to a list of available components.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">OLD_URL</span></code></dt>
<dd>is points to a list that will replaced.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">NEW_URL</span></code></dt>
