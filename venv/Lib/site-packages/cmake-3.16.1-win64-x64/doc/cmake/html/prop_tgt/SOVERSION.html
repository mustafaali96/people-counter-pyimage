...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>SOVERSION &mdash; CMake 3.16.1 Documentation</title>
...
the <code class="docutils literal notranslate"><span class="pre">SOVERSION</span></code> property corresponds to <em>compatibility version</em> and
<span class="target" id="index-2-prop_tgt:VERSION"></span><a class="reference internal" href="VERSION.html#prop_tgt:VERSION" title="VERSION"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">VERSION</span></code></a> to <em>current version</em>.  See the <span class="target" id="index-0-prop_tgt:FRAMEWORK"></span><a class="reference internal" href="FRAMEWORK.html#prop_tgt:FRAMEWORK" title="FRAMEWORK"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">FRAMEWORK</span></code></a> target
