...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>AUTORCC &mdash; CMake 3.16.1 Documentation</title>
...
<p><span class="target" id="index-0-prop_sf:AUTORCC_OPTIONS"></span><a class="reference internal" href="../prop_sf/AUTORCC_OPTIONS.html#prop_sf:AUTORCC_OPTIONS" title="AUTORCC_OPTIONS"><code class="xref cmake cmake-prop_sf docutils literal notranslate"><span class="pre">AUTORCC_OPTIONS</span></code></a>:
Additional command line options for <code class="docutils literal notranslate"><span class="pre">rcc</span></code> can be set via this <code class="docutils literal notranslate"><span class="pre">.qrc</span></code>
