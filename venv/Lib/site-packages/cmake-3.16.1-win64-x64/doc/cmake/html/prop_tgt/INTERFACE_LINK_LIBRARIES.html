...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>INTERFACE_LINK_LIBRARIES &mdash; CMake 3.16.1 Documentation</title>
...
<p class="last">A call to <span class="target" id="index-1-command:target_link_libraries"></span><a class="reference internal" href="../command/target_link_libraries.html#command:target_link_libraries" title="target_link_libraries"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">target_link_libraries(&lt;target&gt;</span> <span class="pre">...)</span></code></a> may update this
...
directory as the call then <span class="target" id="index-2-command:target_link_libraries"></span><a class="reference internal" href="../command/target_link_libraries.html#command:target_link_libraries" title="target_link_libraries"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">target_link_libraries()</span></code></a> will add a
suffix of the form <code class="docutils literal notranslate"><span class="pre">::&#64;&lt;directory-id&gt;</span></code> to each entry, where the
<code class="docutils literal notranslate"><span class="pre">::&#64;</span></code> is a separator and the <code class="docutils literal notranslate"><span class="pre">&lt;directory-id&gt;</span></code> is unspecified.
