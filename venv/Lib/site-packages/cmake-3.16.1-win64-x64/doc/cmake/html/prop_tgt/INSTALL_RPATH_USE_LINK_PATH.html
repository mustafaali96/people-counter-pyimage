...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>INSTALL_RPATH_USE_LINK_PATH &mdash; CMake 3.16.1 Documentation</title>
...
<p><code class="docutils literal notranslate"><span class="pre">INSTALL_RPATH_USE_LINK_PATH</span></code> is a boolean that if set to <code class="docutils literal notranslate"><span class="pre">True</span></code> will
append directories in the linker search path and outside the project
to the <span class="target" id="index-0-prop_tgt:INSTALL_RPATH"></span><a class="reference internal" href="INSTALL_RPATH.html#prop_tgt:INSTALL_RPATH" title="INSTALL_RPATH"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">INSTALL_RPATH</span></code></a>.  This property is initialized by the value of
the variable <code class="docutils literal notranslate"><span class="pre">CMAKE_INSTALL_RPATH_USE_LINK_PATH</span></code> if it is set when a
target is created.</p>
</div>
