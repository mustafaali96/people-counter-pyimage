...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMake 3.15 Release Notes &mdash; CMake 3.16.1 Documentation</title>
...
<ul class="simple">
<li><a class="reference internal" href="#cmake-3-15-release-notes" id="id5">CMake 3.15 Release Notes</a><ul>
<li><a class="reference internal" href="#new-features" id="id6">New Features</a><ul>
<li><a class="reference internal" href="#generators" id="id7">Generators</a></li>
<li><a class="reference internal" href="#languages" id="id8">Languages</a></li>
<li><a class="reference internal" href="#compilers" id="id9">Compilers</a></li>
<li><a class="reference internal" href="#command-line" id="id10">Command-Line</a></li>
<li><a class="reference internal" href="#commands" id="id11">Commands</a></li>
<li><a class="reference internal" href="#variables" id="id12">Variables</a></li>
<li><a class="reference internal" href="#properties" id="id13">Properties</a></li>
<li><a class="reference internal" href="#modules" id="id14">Modules</a></li>
<li><a class="reference internal" href="#generator-expressions" id="id15">Generator Expressions</a></li>
<li><a class="reference internal" href="#ctest" id="id16">CTest</a></li>
<li><a class="reference internal" href="#cpack" id="id17">CPack</a></li>
</ul>
</li>
<li><a class="reference internal" href="#deprecated-and-removed-features" id="id18">Deprecated and Removed Features</a></li>
<li><a class="reference internal" href="#other-changes" id="id19">Other Changes</a></li>
<li><a class="reference internal" href="#updates" id="id20">Updates</a><ul>
<li><a class="reference internal" href="#id1" id="id21">3.15.1</a></li>
<li><a class="reference internal" href="#id2" id="id22">3.15.2</a></li>
<li><a class="reference internal" href="#id3" id="id23">3.15.3</a></li>
<li><a class="reference internal" href="#id4" id="id24">3.15.4</a></li>
</ul>
</li>
</ul>
</li>
...
<ul class="simple">
<li>The <span class="target" id="index-0-generator:Xcode"></span><a class="reference internal" href="../generator/Xcode.html#generator:Xcode" title="Xcode"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Xcode</span></code></a> generator now supports per-target schemes.
...
<span class="target" id="index-0-prop_tgt:XCODE_GENERATE_SCHEME"></span><a class="reference internal" href="../prop_tgt/XCODE_GENERATE_SCHEME.html#prop_tgt:XCODE_GENERATE_SCHEME" title="XCODE_GENERATE_SCHEME"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">XCODE_GENERATE_SCHEME</span></code></a> target property.</li>
<li>The <span class="target" id="index-0-generator:Green Hills MULTI"></span><a class="reference internal" href="../generator/Green Hills MULTI.html#generator:Green Hills MULTI" title="Green Hills MULTI"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Green</span> <span class="pre">Hills</span> <span class="pre">MULTI</span></code></a> generator has been updated:<ul>
<li>It now supports the <span class="target" id="index-0-command:add_custom_command"></span><a class="reference internal" href="../command/add_custom_command.html#command:add_custom_command" title="add_custom_command"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">add_custom_command()</span></code></a> and
<span class="target" id="index-0-command:add_custom_target"></span><a class="reference internal" href="../command/add_custom_target.html#command:add_custom_target" title="add_custom_target"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">add_custom_target()</span></code></a> commands.</li>
<li>It is now available on Linux.</li>
</ul>
</li>
</ul>
</div>
...
<ul>
<li><p class="first">Preliminary support for the <code class="docutils literal notranslate"><span class="pre">Swift</span></code> language was added to the
...
<ul class="simple">
<li>Use the <span class="target" id="index-0-envvar:SWIFTC"></span><a class="reference internal" href="../envvar/SWIFTC.html#envvar:SWIFTC" title="SWIFTC"><code class="xref cmake cmake-envvar docutils literal notranslate"><span class="pre">SWIFTC</span></code></a> environment variable to specify a compiler.</li>
<li>The <span class="target" id="index-0-prop_tgt:Swift_DEPENDENCIES_FILE"></span><a class="reference internal" href="../prop_tgt/Swift_DEPENDENCIES_FILE.html#prop_tgt:Swift_DEPENDENCIES_FILE" title="Swift_DEPENDENCIES_FILE"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">Swift_DEPENDENCIES_FILE</span></code></a> target property and
...
to customize dependency files.</li>
<li>The <span class="target" id="index-0-prop_tgt:Swift_MODULE_NAME"></span><a class="reference internal" href="../prop_tgt/Swift_MODULE_NAME.html#prop_tgt:Swift_MODULE_NAME" title="Swift_MODULE_NAME"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">Swift_MODULE_NAME</span></code></a> target property was added to
customize the Swift module name.</li>
<li>The <span class="target" id="index-0-prop_sf:Swift_DIAGNOSTICS_FILE"></span><a class="reference internal" href="../prop_sf/Swift_DIAGNOSTICS_FILE.html#prop_sf:Swift_DIAGNOSTICS_FILE" title="Swift_DIAGNOSTICS_FILE"><code class="xref cmake cmake-prop_sf docutils literal notranslate"><span class="pre">Swift_DIAGNOSTICS_FILE</span></code></a> source property was added to
indicate where to write the serialised Swift diagnostics.</li>
</ul>
...
<ul class="simple">
<li>The <code class="docutils literal notranslate"><span class="pre">Clang</span></code> compiler variant on Windows that targets the MSVC ABI
but has a GNU-like command line is now supported.</li>
<li>Support for the Clang-based ARM compiler was added with compiler id
<code class="docutils literal notranslate"><span class="pre">ARMClang</span></code>.</li>
<li>Support was added for the IAR compiler architectures Renesas RX,
RL78, RH850 and Texas Instruments MSP430.</li>
<li>Support was added for the IAR compilers built for Linux (IAR BuildLx).</li>
</ul>
</div>
...
<ul class="simple">
<li>The <span class="target" id="index-0-envvar:CMAKE_GENERATOR"></span><a class="reference internal" href="../envvar/CMAKE_GENERATOR.html#envvar:CMAKE_GENERATOR" title="CMAKE_GENERATOR"><code class="xref cmake cmake-envvar docutils literal notranslate"><span class="pre">CMAKE_GENERATOR</span></code></a> environment variable was added
...
<code class="docutils literal notranslate"><span class="pre">cmake</span> <span class="pre">--build</span> <span class="pre">.</span> <span class="pre">-t</span> <span class="pre">Library1</span> <span class="pre">Library2</span></code>.</li>
...
using the generated build system or the native build tool.</li>
<li>The <span class="target" id="index-3-manual:cmake(1)"></span><a class="reference internal" href="../manual/cmake.1.html#manual:cmake(1)" title="cmake(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake(1)</span></code></a> command learned a new CLI option <code class="docutils literal notranslate"><span class="pre">--loglevel</span></code>.</li>
...
to support removing multiple directories.</li>
<li>The <span class="target" id="index-5-manual:cmake(1)"></span><a class="reference internal" href="../manual/cmake.1.html#manual:cmake(1)" title="cmake(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake(1)</span></code></a> <code class="docutils literal notranslate"><span class="pre">-E</span> <span class="pre">tar</span></code> tool has been improved:<ul>
<li>It now continues adding files to an archive even if some of the files
are not readable.  This behavior is more consistent with the
classic <code class="docutils literal notranslate"><span class="pre">tar</span></code> tool.</li>
<li>It now parses all flags, and if an invalid flag was provided, a
warning is issued.</li>
<li>It now displays an error if no action flag was specified, along with a
list of possible actions: <code class="docutils literal notranslate"><span class="pre">t</span></code> (list), <code class="docutils literal notranslate"><span class="pre">c</span></code> (create) or <code class="docutils literal notranslate"><span class="pre">x</span></code> (extract).</li>
<li>It now supports extracting (<code class="docutils literal notranslate"><span class="pre">-x</span></code>) or listing (<code class="docutils literal notranslate"><span class="pre">-t</span></code>) only specific
files or directories.</li>
<li>It now supports Zstandard compression with a <code class="docutils literal notranslate"><span class="pre">--zstd</span></code> option.
Zstandard was designed to give a compression ratio comparable to that
of the DEFLATE (zip) algorithm, but faster, especially for decompression.</li>
</ul>
</li>
</ul>
</div>
...
generator to set the pool variable on the build statement.</li>
...
import libraries of the <code class="docutils literal notranslate"><span class="pre">UNKNOWN</span></code> type.</li>
...
keyword arguments that were given by the caller with no values.</li>
...
to enable echoing of the command-line string before execution.</li>
<li>The <span class="target" id="index-0-command:file"></span><a class="reference internal" href="../command/file.html#command:file" title="file"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">file(INSTALL)</span></code></a> command learned a new argument,
...
install symlinks.</li>
<li><span class="target" id="index-0-command:list"></span><a class="reference internal" href="../command/list.html#command:list" title="list"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">list()</span></code></a> learned new sub-commands:
<code class="docutils literal notranslate"><span class="pre">PREPEND</span></code>, <code class="docutils literal notranslate"><span class="pre">POP_FRONT</span></code> and <code class="docutils literal notranslate"><span class="pre">POP_BACK</span></code>.</li>
<li>The <span class="target" id="index-0-command:message"></span><a class="reference internal" href="../command/message.html#command:message" title="message"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">message()</span></code></a> command learned new types:
<code class="docutils literal notranslate"><span class="pre">NOTICE</span></code>, <code class="docutils literal notranslate"><span class="pre">VERBOSE</span></code>, <code class="docutils literal notranslate"><span class="pre">DEBUG</span></code> and <code class="docutils literal notranslate"><span class="pre">TRACE</span></code>.</li>
<li>The <span class="target" id="index-0-command:string"></span><a class="reference internal" href="../command/string.html#command:string" title="string"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">string()</span></code></a> learned a new sub-command <code class="docutils literal notranslate"><span class="pre">REPEAT</span></code>.</li>
</ul>
</div>
...
file first even if a find module is available.</li>
<li>The <span class="target" id="index-0-variable:CMAKE_FRAMEWORK"></span><a class="reference internal" href="../variable/CMAKE_FRAMEWORK.html#variable:CMAKE_FRAMEWORK" title="CMAKE_FRAMEWORK"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_FRAMEWORK</span></code></a> variable was added to initialize the
<span class="target" id="index-0-prop_tgt:FRAMEWORK"></span><a class="reference internal" href="../prop_tgt/FRAMEWORK.html#prop_tgt:FRAMEWORK" title="FRAMEWORK"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">FRAMEWORK</span></code></a> property on all targets.</li>
<li>The <span class="target" id="index-0-variable:CMAKE_VS_JUST_MY_CODE_DEBUGGING"></span><a class="reference internal" href="../variable/CMAKE_VS_JUST_MY_CODE_DEBUGGING.html#variable:CMAKE_VS_JUST_MY_CODE_DEBUGGING" title="CMAKE_VS_JUST_MY_CODE_DEBUGGING"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_VS_JUST_MY_CODE_DEBUGGING</span></code></a> variable and
...
compiling with MSVC cl 19.05 and higher.</li>
...
See policy <span class="target" id="index-0-policy:CMP0091"></span><a class="reference internal" href="../policy/CMP0091.html#policy:CMP0091" title="CMP0091"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0091</span></code></a>.</li>
...
without knowing the project name a priori.</li>
</ul>
</div>
...
passing the <code class="docutils literal notranslate"><span class="pre">PUBLIC_HEADER</span></code> and <code class="docutils literal notranslate"><span class="pre">PRIVATE_HEADER</span></code> arguments respectively.</li>
...
packages.</li>
<li>The <span class="target" id="index-0-prop_tgt:VS_PROJECT_IMPORT"></span><a class="reference internal" href="../prop_tgt/VS_PROJECT_IMPORT.html#prop_tgt:VS_PROJECT_IMPORT" title="VS_PROJECT_IMPORT"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">VS_PROJECT_IMPORT</span></code></a> target property was added to allow
managed Visual Studio project files to import external <code class="docutils literal notranslate"><span class="pre">.props</span></code> files.</li>
<li>The <span class="target" id="index-0-prop_tgt:VS_NO_SOLUTION_DEPLOY"></span><a class="reference internal" href="../prop_tgt/VS_NO_SOLUTION_DEPLOY.html#prop_tgt:VS_NO_SOLUTION_DEPLOY" title="VS_NO_SOLUTION_DEPLOY"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">VS_NO_SOLUTION_DEPLOY</span></code></a> target property was added to
...
to the WinCE or Windows Phone target device.</li>
</ul>
</div>
<div class="section" id="modules">
<h3><a class="toc-backref" href="#id14">Modules</a><a class="headerlink" href="#modules" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
<li>The <span class="target" id="index-0-module:FindBoost"></span><a class="reference internal" href="../module/FindBoost.html#module:FindBoost" title="FindBoost"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindBoost</span></code></a> module was reworked to expose a more consistent
user experience between its “Config” and “Module” modes and with other
find modules in general.<ul>
<li>A new imported target <code class="docutils literal notranslate"><span class="pre">Boost::headers</span></code> is now defined (same
as <code class="docutils literal notranslate"><span class="pre">Boost::boost</span></code>).</li>
<li>New output variables <code class="docutils literal notranslate"><span class="pre">Boost_VERSION_MACRO</span></code>,
...
were added.</li>
<li>The <code class="docutils literal notranslate"><span class="pre">QUIET</span></code> argument passed to <span class="target" id="index-1-command:find_package"></span><a class="reference internal" href="../command/find_package.html#command:find_package" title="find_package"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">find_package()</span></code></a> is no
...
<span class="target" id="index-2-command:find_package"></span><a class="reference internal" href="../command/find_package.html#command:find_package" title="find_package"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">find_package()</span></code></a>.  This is fixed in the next Boost release.</li>
<li>The input switch <code class="docutils literal notranslate"><span class="pre">Boost_DETAILED_FAILURE_MSG</span></code> was removed.</li>
<li><code class="docutils literal notranslate"><span class="pre">Boost_VERSION</span></code> now reports the version in <code class="docutils literal notranslate"><span class="pre">x.y.z</span></code>
format in module mode.  See policy <span class="target" id="index-0-policy:CMP0093"></span><a class="reference internal" href="../policy/CMP0093.html#policy:CMP0093" title="CMP0093"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0093</span></code></a>.</li>
</ul>
</li>
<li>The <span class="target" id="index-0-module:FindCups"></span><a class="reference internal" href="../module/FindCups.html#module:FindCups" title="FindCups"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindCups</span></code></a> module now provides imported targets.</li>
<li>The <span class="target" id="index-0-module:FindEnvModules"></span><a class="reference internal" href="../module/FindEnvModules.html#module:FindEnvModules" title="FindEnvModules"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindEnvModules</span></code></a> module was added to use Lua- and TCL-based
environment modules in <a class="reference internal" href="../manual/ctest.1.html#ctest-script"><span class="std std-ref">CTest Scripts</span></a>.</li>
<li>The <span class="target" id="index-0-module:FindGLEW"></span><a class="reference internal" href="../module/FindGLEW.html#module:FindGLEW" title="FindGLEW"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindGLEW</span></code></a> module now provides an interface more consistent
with what upstream GLEW provides in its own CMake package files.</li>
...
and <code class="docutils literal notranslate"><span class="pre">Python3::Module</span></code>) which can be used to develop Python modules.</li>
<li>Modules <span class="target" id="index-2-module:FindPython3"></span><a class="reference internal" href="../module/FindPython3.html#module:FindPython3" title="FindPython3"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindPython3</span></code></a>, <span class="target" id="index-2-module:FindPython2"></span><a class="reference internal" href="../module/FindPython2.html#module:FindPython2" title="FindPython2"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindPython2</span></code></a> and <span class="target" id="index-2-module:FindPython"></span><a class="reference internal" href="../module/FindPython.html#module:FindPython" title="FindPython"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindPython</span></code></a>
gain capability to control how virtual environments are handled.</li>
<li>The <span class="target" id="index-0-module:UseSWIG"></span><a class="reference internal" href="../module/UseSWIG.html#module:UseSWIG" title="UseSWIG"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">UseSWIG</span></code></a> module learned to manage alternate library names
...
list.</li>
<li>The <code class="docutils literal notranslate"><span class="pre">$&lt;CUDA_COMPILER_ID:...&gt;</span></code> and <code class="docutils literal notranslate"><span class="pre">$&lt;CUDA_COMPILER_VERSION:...&gt;</span></code>
<span class="target" id="index-1-manual:cmake-generator-expressions(7)"></span><a class="reference internal" href="../manual/cmake-generator-expressions.7.html#manual:cmake-generator-expressions(7)" title="cmake-generator-expressions(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">generator</span> <span class="pre">expressions</span></code></a> were added.</li>
<li>The <code class="docutils literal notranslate"><span class="pre">$&lt;COMPILE_LANG_AND_ID:...&gt;</span></code> generator expression was introduced to
...
each source file.</li>
<li>A <code class="docutils literal notranslate"><span class="pre">$&lt;FILTER:list,INCLUDE|EXCLUDE,regex&gt;</span></code>
<span class="target" id="index-2-manual:cmake-generator-expressions(7)"></span><a class="reference internal" href="../manual/cmake-generator-expressions.7.html#manual:cmake-generator-expressions(7)" title="cmake-generator-expressions(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">generator</span> <span class="pre">expression</span></code></a>
has been added.</li>
<li>A <code class="docutils literal notranslate"><span class="pre">$&lt;REMOVE_DUPLICATES:list&gt;</span></code>
<span class="target" id="index-3-manual:cmake-generator-expressions(7)"></span><a class="reference internal" href="../manual/cmake-generator-expressions.7.html#manual:cmake-generator-expressions(7)" title="cmake-generator-expressions(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">generator</span> <span class="pre">expression</span></code></a>
has been added.</li>
<li>The <code class="docutils literal notranslate"><span class="pre">$&lt;SHELL_PATH:...&gt;</span></code> <span class="target" id="index-4-manual:cmake-generator-expressions(7)"></span><a class="reference internal" href="../manual/cmake-generator-expressions.7.html#manual:cmake-generator-expressions(7)" title="cmake-generator-expressions(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">generator</span> <span class="pre">expression</span></code></a> gained support for a list of paths.</li>
<li>New <code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_FILE*&gt;</span></code> <span class="target" id="index-5-manual:cmake-generator-expressions(7)"></span><a class="reference internal" href="../manual/cmake-generator-expressions.7.html#manual:cmake-generator-expressions(7)" title="cmake-generator-expressions(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">generator</span> <span class="pre">expressions</span></code></a> were added to retrieve the prefix, base
name, and suffix of the file names of various artifacts:<ul>
<li><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_FILE_PREFIX:...&gt;</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_FILE_BASE_NAME:...&gt;</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_FILE_SUFFIX:...&gt;</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_LINKER_FILE_PREFIX:...&gt;</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_LINKER_FILE_BASE_NAME:...&gt;</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_LINKER_FILE_SUFFIX:...&gt;</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_PDB_FILE_BASE_NAME:...&gt;</span></code></li>
</ul>
</li>
<li>The <code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_OBJECTS:...&gt;</span></code> <span class="target" id="index-6-manual:cmake-generator-expressions(7)"></span><a class="reference internal" href="../manual/cmake-generator-expressions.7.html#manual:cmake-generator-expressions(7)" title="cmake-generator-expressions(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">generator</span> <span class="pre">expression</span></code></a> is now supported on <code class="docutils literal notranslate"><span class="pre">SHARED</span></code>,
<code class="docutils literal notranslate"><span class="pre">STATIC</span></code>, <code class="docutils literal notranslate"><span class="pre">MODULE</span></code> libraries and executables.</li>
</ul>
</div>
...
command to discover the current version that is checked out.</li>
</ul>
</div>
...
the <span class="target" id="index-0-manual:cmake-file-api(7)"></span><a class="reference internal" href="../manual/cmake-file-api.7.html#manual:cmake-file-api(7)" title="cmake-file-api(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake-file-api(7)</span></code></a> instead.</li>
...
instead.</li>
<li>The variable <span class="target" id="index-0-variable:CMAKE_AUTOMOC_RELAXED_MODE"></span><a class="reference internal" href="../variable/CMAKE_AUTOMOC_RELAXED_MODE.html#variable:CMAKE_AUTOMOC_RELAXED_MODE" title="CMAKE_AUTOMOC_RELAXED_MODE"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_AUTOMOC_RELAXED_MODE</span></code></a> is considered
deprecated.  Support still exists but will be removed in future versions.</li>
<li>The <span class="target" id="index-0-command:export"></span><a class="reference internal" href="../command/export.html#command:export" title="export"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">export(PACKAGE)</span></code></a> command now does nothing unless
...
See policy <span class="target" id="index-0-policy:CMP0090"></span><a class="reference internal" href="../policy/CMP0090.html#policy:CMP0090" title="CMP0090"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0090</span></code></a>.</li>
<li>The <span class="target" id="index-1-generator:Xcode"></span><a class="reference internal" href="../generator/Xcode.html#generator:Xcode" title="Xcode"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Xcode</span></code></a> generator now requires at least Xcode 5.</li>
<li>An explicit deprecation diagnostic was added for policy <code class="docutils literal notranslate"><span class="pre">CMP0066</span></code>
...
<ul class="simple">
<li>CMake learned how to compile C++14 with the IBM AIX XL compiler
and the SunPro compiler and to compile C++20 with the AppleClang compiler.</li>
<li>With MSVC-like compilers the value of <span class="target" id="index-0-variable:CMAKE_&lt;LANG&gt;_FLAGS"></span><a class="reference internal" href="../variable/CMAKE_LANG_FLAGS.html#variable:CMAKE_&lt;LANG&gt;_FLAGS" title="CMAKE_&lt;LANG&gt;_FLAGS"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_&lt;LANG&gt;_FLAGS</span></code></a>
no longer contains warning flags like <code class="docutils literal notranslate"><span class="pre">/W3</span></code> by default.
See policy <span class="target" id="index-0-policy:CMP0092"></span><a class="reference internal" href="../policy/CMP0092.html#policy:CMP0092" title="CMP0092"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0092</span></code></a>.</li>
<li>IBM Clang-based XL compilers that define <code class="docutils literal notranslate"><span class="pre">__ibmxl__</span></code> now use the
compiler id <code class="docutils literal notranslate"><span class="pre">XLClang</span></code> instead of <code class="docutils literal notranslate"><span class="pre">XL</span></code>.  See policy <span class="target" id="index-0-policy:CMP0089"></span><a class="reference internal" href="../policy/CMP0089.html#policy:CMP0089" title="CMP0089"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0089</span></code></a>.</li>
...
them as a relative path and removing the contents of the current directory.</li>
</ul>
</div>
...
<ul class="simple">
<li>In CMake 3.15.0 support for the GNU-like <code class="docutils literal notranslate"><span class="pre">Clang</span></code> compiler targeting the
...
This has been fixed.
The bug also existed in 3.14.0 through 3.14.6 and is fixed in 3.14.7.</li>
</ul>
</div>
</div>
</div>
