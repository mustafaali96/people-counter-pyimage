...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMake 3.9 Release Notes &mdash; CMake 3.16.1 Documentation</title>
...
<ul class="simple">
<li><a class="reference internal" href="#cmake-3-9-release-notes" id="id3">CMake 3.9 Release Notes</a><ul>
<li><a class="reference internal" href="#new-features" id="id4">New Features</a><ul>
<li><a class="reference internal" href="#languages" id="id5">Languages</a></li>
<li><a class="reference internal" href="#generators" id="id6">Generators</a></li>
...
<li><a class="reference internal" href="#modules" id="id10">Modules</a></li>
<li><a class="reference internal" href="#ctest" id="id11">CTest</a></li>
<li><a class="reference internal" href="#cpack" id="id12">CPack</a></li>
<li><a class="reference internal" href="#other" id="id13">Other</a></li>
</ul>
</li>
<li><a class="reference internal" href="#deprecated-and-removed-features" id="id14">Deprecated and Removed Features</a></li>
<li><a class="reference internal" href="#other-changes" id="id15">Other Changes</a></li>
<li><a class="reference internal" href="#updates" id="id16">Updates</a><ul>
<li><a class="reference internal" href="#id1" id="id17">3.9.1</a></li>
<li><a class="reference internal" href="#id2" id="id18">3.9.2</a></li>
</ul>
</li>
</ul>
</li>
...
<ul class="simple">
<li><code class="docutils literal notranslate"><span class="pre">CUDA</span></code> is now supported by the <a class="reference internal" href="../manual/cmake-generators.7.html#visual-studio-generators"><span class="std std-ref">Visual Studio Generators</span></a>
...
integration by earlier versions.</li>
<li>CMake is now aware of the <span class="target" id="index-0-prop_tgt:CXX_STANDARD"></span><a class="reference internal" href="../prop_tgt/CXX_STANDARD.html#prop_tgt:CXX_STANDARD" title="CXX_STANDARD"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">C++</span> <span class="pre">standards</span></code></a> and
...
<code class="docutils literal notranslate"><span class="pre">PGI</span></code>, and <code class="docutils literal notranslate"><span class="pre">XL</span></code>.</li>
</ul>
</div>
...
<ul class="simple">
<li><a class="reference internal" href="../manual/cmake-generators.7.html#visual-studio-generators"><span class="std std-ref">Visual Studio Generators</span></a> for VS 2010 and above learned to support
the <code class="docutils literal notranslate"><span class="pre">ASM_NASM</span></code> language when <code class="docutils literal notranslate"><span class="pre">nasm</span></code> is installed.</li>
<li>The <span class="target" id="index-0-generator:Xcode"></span><a class="reference internal" href="../generator/Xcode.html#generator:Xcode" title="Xcode"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Xcode</span></code></a> generator learned to create Xcode schema files.
...
<a class="reference internal" href="../manual/cmake-buildsystem.7.html#object-libraries"><span class="std std-ref">Object Libraries</span></a>.</li>
...
to map current configurations to the external configurations.</li>
...
specify where to install <a class="reference internal" href="../manual/cmake-buildsystem.7.html#object-libraries"><span class="std std-ref">Object Libraries</span></a>.</li>
<li>The <span class="target" id="index-1-command:install"></span><a class="reference internal" href="../command/install.html#command:install" title="install"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">install(EXPORT)</span></code></a> command learned how to export
<a class="reference internal" href="../manual/cmake-buildsystem.7.html#object-libraries"><span class="std std-ref">Object Libraries</span></a>.</li>
...
that performs argument separation depending on the host operating system.</li>
</ul>
</div>
...
places than the vicinity of the file including <code class="docutils literal notranslate"><span class="pre">ui_foo.h</span></code>.</li>
<li>A <span class="target" id="index-0-variable:CMAKE_FIND_LIBRARY_CUSTOM_LIB_SUFFIX"></span><a class="reference internal" href="../variable/CMAKE_FIND_LIBRARY_CUSTOM_LIB_SUFFIX.html#variable:CMAKE_FIND_LIBRARY_CUSTOM_LIB_SUFFIX" title="CMAKE_FIND_LIBRARY_CUSTOM_LIB_SUFFIX"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_FIND_LIBRARY_CUSTOM_LIB_SUFFIX</span></code></a> variable was added to
...
directory before each <code class="docutils literal notranslate"><span class="pre">lib</span></code> directory that would normally be searched.</li>
<li>A <span class="target" id="index-0-variable:CMAKE_INTERPROCEDURAL_OPTIMIZATION"></span><a class="reference internal" href="../variable/CMAKE_INTERPROCEDURAL_OPTIMIZATION.html#variable:CMAKE_INTERPROCEDURAL_OPTIMIZATION" title="CMAKE_INTERPROCEDURAL_OPTIMIZATION"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_INTERPROCEDURAL_OPTIMIZATION</span></code></a> variable was added to
...
targets.</li>
<li>A <span class="target" id="index-0-variable:CMAKE_&lt;LANG&gt;_COMPILER_AR"></span><a class="reference internal" href="../variable/CMAKE_LANG_COMPILER_AR.html#variable:CMAKE_&lt;LANG&gt;_COMPILER_AR" title="CMAKE_&lt;LANG&gt;_COMPILER_AR"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_&lt;LANG&gt;_COMPILER_AR</span></code></a> variable was added to hold
the path to the GCC/Clang wrapper of <code class="docutils literal notranslate"><span class="pre">ar</span></code>.</li>
<li>A <span class="target" id="index-0-variable:CMAKE_&lt;LANG&gt;_COMPILER_RANLIB"></span><a class="reference internal" href="../variable/CMAKE_LANG_COMPILER_RANLIB.html#variable:CMAKE_&lt;LANG&gt;_COMPILER_RANLIB" title="CMAKE_&lt;LANG&gt;_COMPILER_RANLIB"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_&lt;LANG&gt;_COMPILER_RANLIB</span></code></a> variable was added to hold
the path to the GCC/Clang wrapper of <code class="docutils literal notranslate"><span class="pre">ranlib</span></code>.</li>
...
variables were added to use separate sysroots for compiling and linking.</li>
</ul>
</div>
...
<ul class="simple">
<li>A new <span class="target" id="index-0-prop_tgt:AUTOGEN_BUILD_DIR"></span><a class="reference internal" href="../prop_tgt/AUTOGEN_BUILD_DIR.html#prop_tgt:AUTOGEN_BUILD_DIR" title="AUTOGEN_BUILD_DIR"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">AUTOGEN_BUILD_DIR</span></code></a> target property was introduced to set
...
and <span class="target" id="index-0-prop_tgt:AUTORCC"></span><a class="reference internal" href="../prop_tgt/AUTORCC.html#prop_tgt:AUTORCC" title="AUTORCC"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">AUTORCC</span></code></a>.</li>
<li>A new <span class="target" id="index-0-prop_tgt:AUTOMOC_DEPEND_FILTERS"></span><a class="reference internal" href="../prop_tgt/AUTOMOC_DEPEND_FILTERS.html#prop_tgt:AUTOMOC_DEPEND_FILTERS" title="AUTOMOC_DEPEND_FILTERS"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">AUTOMOC_DEPEND_FILTERS</span></code></a> target property was introduced to
...
for <code class="docutils literal notranslate"><span class="pre">moc</span></code> from the contents of source files.</li>
<li>A new <span class="target" id="index-0-prop_tgt:AUTOUIC_SEARCH_PATHS"></span><a class="reference internal" href="../prop_tgt/AUTOUIC_SEARCH_PATHS.html#prop_tgt:AUTOUIC_SEARCH_PATHS" title="AUTOUIC_SEARCH_PATHS"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">AUTOUIC_SEARCH_PATHS</span></code></a> target property was introduced to
...
places than the vicinity of the file including <code class="docutils literal notranslate"><span class="pre">ui_foo.h</span></code>.</li>
<li>Global properties <span class="target" id="index-0-prop_gbl:AUTOGEN_SOURCE_GROUP"></span><a class="reference internal" href="../prop_gbl/AUTOGEN_SOURCE_GROUP.html#prop_gbl:AUTOGEN_SOURCE_GROUP" title="AUTOGEN_SOURCE_GROUP"><code class="xref cmake cmake-prop_gbl docutils literal notranslate"><span class="pre">AUTOGEN_SOURCE_GROUP</span></code></a>,
...
support before enabling the target property.  See policy <span class="target" id="index-0-policy:CMP0069"></span><a class="reference internal" href="../policy/CMP0069.html#policy:CMP0069" title="CMP0069"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0069</span></code></a>.</li>
...
(e.g. <code class="docutils literal notranslate"><span class="pre">msvcrt.lib</span></code>).</li>
</ul>
</div>
<div class="section" id="modules">
<h3><a class="toc-backref" href="#id10">Modules</a><a class="headerlink" href="#modules" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
<li>A <span class="target" id="index-1-module:CheckIPOSupported"></span><a class="reference internal" href="../module/CheckIPOSupported.html#module:CheckIPOSupported" title="CheckIPOSupported"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CheckIPOSupported</span></code></a> module was added to help projects
check whether interprocedural optimization (IPO) is supported by
the current toolchain and CMake version.</li>
...
title for the selected package type.</li>
<li>The <span class="target" id="index-1-module:FeatureSummary"></span><a class="reference internal" href="../module/FeatureSummary.html#module:FeatureSummary" title="FeatureSummary"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FeatureSummary</span></code></a> module gained a new
...
whenever the package type is used in an output string by the module.</li>
<li>The <span class="target" id="index-0-module:FindDoxygen"></span><a class="reference internal" href="../module/FindDoxygen.html#module:FindDoxygen" title="FindDoxygen"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindDoxygen</span></code></a> module learned to control Doxygen behavior using
...
<code class="docutils literal notranslate"><span class="pre">mscgen</span></code> and <code class="docutils literal notranslate"><span class="pre">dia</span></code>.</li>
<li>The <span class="target" id="index-0-module:FindMPI"></span><a class="reference internal" href="../module/FindMPI.html#module:FindMPI" title="FindMPI"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindMPI</span></code></a> module now provides imported targets.</li>
...
a DLL export markup macro.</li>
<li>The <span class="target" id="index-1-module:FindProtobuf"></span><a class="reference internal" href="../module/FindProtobuf.html#module:FindProtobuf" title="FindProtobuf"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindProtobuf</span></code></a> module now supports usage of static libraries
for Unix via a new <code class="docutils literal notranslate"><span class="pre">Protobuf_USE_STATIC_LIBS</span></code> input variable.</li>
<li>The <span class="target" id="index-2-module:FindProtobuf"></span><a class="reference internal" href="../module/FindProtobuf.html#module:FindProtobuf" title="FindProtobuf"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindProtobuf</span></code></a> module now provides imported targets
when the libraries are found.</li>
<li>A new <span class="target" id="index-0-module:GoogleTest"></span><a class="reference internal" href="../module/GoogleTest.html#module:GoogleTest" title="GoogleTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">GoogleTest</span></code></a> module was added to provide the
...
discovered test cases to be returned to the caller.</li>
</ul>
</div>
...
to specify custom headers to send during submission.</li>
<li>The <span class="target" id="index-0-manual:ctest(1)"></span><a class="reference internal" href="../manual/ctest.1.html#manual:ctest(1)" title="ctest(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">ctest(1)</span></code></a> executable gained new options which allow the
...
fixtures.</li>
<li>A <span class="target" id="index-0-prop_test:DISABLED"></span><a class="reference internal" href="../prop_test/DISABLED.html#prop_test:DISABLED" title="DISABLED"><code class="xref cmake cmake-prop_test docutils literal notranslate"><span class="pre">DISABLED</span></code></a> test property was added to mark tests that
are configured but explicitly disabled so they do not run.</li>
</ul>
</div>
...
<span class="target" id="index-0-module:CPackProductBuild"></span><a class="reference internal" href="../module/CPackProductBuild.html#module:CPackProductBuild" title="CPackProductBuild"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">productbuild</span></code></a> generator.</li>
...
<code class="docutils literal notranslate"><span class="pre">ProgramFilesFolder</span></code> / <code class="docutils literal notranslate"><span class="pre">ProgramFiles64Folder</span></code>.</li>
</ul>
</div>
<div class="section" id="other">
<h3><a class="toc-backref" href="#id13">Other</a><a class="headerlink" href="#other" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
<li>Interprocedural optimization (IPO) is now supported for GNU and Clang
...
<span class="target" id="index-2-module:CheckIPOSupported"></span><a class="reference internal" href="../module/CheckIPOSupported.html#module:CheckIPOSupported" title="CheckIPOSupported"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CheckIPOSupported</span></code></a> module.</li>
<li>The <code class="docutils literal notranslate"><span class="pre">TARGET_OBJECTS</span></code>
...
<span class="target" id="index-0-command:file"></span><a class="reference internal" href="../command/file.html#command:file" title="file"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">file(GENERATE)</span></code></a> commands.</li>
<li>Two new informational generator expressions to retrieve Apple Bundle
...
the different Bundle types and layouts on macOS and iOS.</li>
</ul>
</div>
</div>
...
<ul class="simple">
<li>An explicit deprecation diagnostic was added for policies <code class="docutils literal notranslate"><span class="pre">CMP0036</span></code>
...
always port to the NEW behaviors as soon as possible.</li>
...
and will be removed in a future version of CMake.</li>
...
<li>The <span class="target" id="index-2-generator:Xcode"></span><a class="reference internal" href="../generator/Xcode.html#generator:Xcode" title="Xcode"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Xcode</span></code></a> generator dropped support for Xcode versions
older than 3.</li>
<li>The <span class="target" id="index-1-module:FindDoxygen"></span><a class="reference internal" href="../module/FindDoxygen.html#module:FindDoxygen" title="FindDoxygen"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindDoxygen</span></code></a> module has deprecated several variables.</li>
<li>The version of curl bundled with CMake no longer accepts URLs of the form
...
the form <code class="docutils literal notranslate"><span class="pre">file:///c:/...</span></code> instead to work on all versions.</li>
</ul>
</div>
...
<ul class="simple">
<li>When using <span class="target" id="index-3-prop_tgt:AUTOMOC"></span><a class="reference internal" href="../prop_tgt/AUTOMOC.html#prop_tgt:AUTOMOC" title="AUTOMOC"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">AUTOMOC</span></code></a>, CMake now scans for the presence of the
...
macro’s <code class="docutils literal notranslate"><span class="pre">FILE</span></code> argument changes.</li>
<li>When <span class="target" id="index-4-prop_tgt:AUTOMOC"></span><a class="reference internal" href="../prop_tgt/AUTOMOC.html#prop_tgt:AUTOMOC" title="AUTOMOC"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">AUTOMOC</span></code></a> detects an include statement of the form
...
failure when all tests are either skipped or pass.</li>
<li>The <span class="target" id="index-1-generator:Ninja"></span><a class="reference internal" href="../generator/Ninja.html#generator:Ninja" title="Ninja"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Ninja</span></code></a> generator has loosened the dependencies of object
...
dependencies to link.</li>
<li>On macOS, <code class="docutils literal notranslate"><span class="pre">RPATH</span></code> settings such as <span class="target" id="index-1-prop_tgt:BUILD_WITH_INSTALL_RPATH"></span><a class="reference internal" href="../prop_tgt/BUILD_WITH_INSTALL_RPATH.html#prop_tgt:BUILD_WITH_INSTALL_RPATH" title="BUILD_WITH_INSTALL_RPATH"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">BUILD_WITH_INSTALL_RPATH</span></code></a>
no longer affect the <code class="docutils literal notranslate"><span class="pre">install_name</span></code> field.  See policy <span class="target" id="index-0-policy:CMP0068"></span><a class="reference internal" href="../policy/CMP0068.html#policy:CMP0068" title="CMP0068"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0068</span></code></a>.</li>
...
linker setting that produces the <code class="docutils literal notranslate"><span class="pre">-DEBUG</span></code> linker flag variants.</li>
</ul>
</div>
...
<ul class="simple">
<li>The <code class="docutils literal notranslate"><span class="pre">find_</span></code> command <code class="docutils literal notranslate"><span class="pre">PACKAGE_ROOT</span></code> search path group added by
...
may be re-introduced in the future in a more-compatible way.</li>
</ul>
</div>
<div class="section" id="id2">
<h3><a class="toc-backref" href="#id18">3.9.2</a><a class="headerlink" href="#id2" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
<li>On macOS, the default application bundle <code class="docutils literal notranslate"><span class="pre">Info.plist</span></code> file no longer
enables Hi-DPI support as it did in 3.9.0 and 3.9.1.  The change had
to be reverted because it broke iOS applications.</li>
<li>The Xcode generator no longer adds “outputPaths” to custom script
...
rebuilds for both the old and new Xcode build systems.</li>
</ul>
</div>
</div>
</div>
