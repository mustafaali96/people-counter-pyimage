...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMake 3.6 Release Notes &mdash; CMake 3.16.1 Documentation</title>
...
<ul class="simple">
<li>The <span class="target" id="index-0-generator:Ninja"></span><a class="reference internal" href="../generator/Ninja.html#generator:Ninja" title="Ninja"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Ninja</span></code></a> generator learned to produce phony targets
...
<li>The <span class="target" id="index-1-generator:Ninja"></span><a class="reference internal" href="../generator/Ninja.html#generator:Ninja" title="Ninja"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Ninja</span></code></a> generator now includes system header files in build
...
<code class="docutils literal notranslate"><span class="pre">build.ninja</span></code> file for use as a <code class="docutils literal notranslate"><span class="pre">subninja</span></code>.</li>
...
<code class="docutils literal notranslate"><span class="pre">clang-tidy</span></code> along with the compiler for <code class="docutils literal notranslate"><span class="pre">C</span></code> and <code class="docutils literal notranslate"><span class="pre">CXX</span></code> languages.</li>
...
project for generated solutions (<code class="docutils literal notranslate"><span class="pre">.sln</span></code> files).</li>
</ul>
</div>
...
self-extracting shell installers or <code class="docutils literal notranslate"><span class="pre">.msi</span></code> files).</li>
...
<li>The <span class="target" id="index-0-module:FindCUDA"></span><a class="reference internal" href="../module/FindCUDA.html#module:FindCUDA" title="FindCUDA"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindCUDA</span></code></a> module learned to find the <code class="docutils literal notranslate"><span class="pre">cublas_device</span></code> library.</li>
...
<li>The <span class="target" id="index-0-module:FindLTTngUST"></span><a class="reference internal" href="../module/FindLTTngUST.html#module:FindLTTngUST" title="FindLTTngUST"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindLTTngUST</span></code></a> module was introduced to find the LTTng-UST
library.</li>
...
<li>Support was added for the Bruce C Compiler with compiler id <code class="docutils literal notranslate"><span class="pre">Bruce</span></code>.</li>
</ul>
</div>
...
<ul class="simple">
<li>The <span class="target" id="index-0-command:ctest_update"></span><a class="reference internal" href="../command/ctest_update.html#command:ctest_update" title="ctest_update"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">ctest_update()</span></code></a> command now looks at the
...
<li>The <span class="target" id="index-1-command:ctest_update"></span><a class="reference internal" href="../command/ctest_update.html#command:ctest_update" title="ctest_update"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">ctest_update()</span></code></a> command will now synchronize submodules on an
...
<li><p class="first">The <span class="target" id="index-1-cpack_gen:CPack DEB Generator"></span><a class="reference internal" href="../cpack_gen/deb.html#cpack_gen:CPack DEB Generator" title="CPack DEB Generator"><code class="xref cmake cmake-cpack_gen docutils literal notranslate"><span class="pre">CPack</span> <span class="pre">DEB</span> <span class="pre">Generator</span></code></a> learned how to generate
<code class="docutils literal notranslate"><span class="pre">DEBIAN/shlibs</span></code> contorl file when package contains shared libraries.</p>
</li>
<li><p class="first">The <span class="target" id="index-2-cpack_gen:CPack DEB Generator"></span><a class="reference internal" href="../cpack_gen/deb.html#cpack_gen:CPack DEB Generator" title="CPack DEB Generator"><code class="xref cmake cmake-cpack_gen docutils literal notranslate"><span class="pre">CPack</span> <span class="pre">DEB</span> <span class="pre">Generator</span></code></a> learned how to generate
...
libraries in ldconfig-controlled locations (e.g. <code class="docutils literal notranslate"><span class="pre">/lib/</span></code>, <code class="docutils literal notranslate"><span class="pre">/usr/lib/</span></code>).</p>
</li>
<li><p class="first">The <span class="target" id="index-3-cpack_gen:CPack DEB Generator"></span><a class="reference internal" href="../cpack_gen/deb.html#cpack_gen:CPack DEB Generator" title="CPack DEB Generator"><code class="xref cmake cmake-cpack_gen docutils literal notranslate"><span class="pre">CPack</span> <span class="pre">DEB</span> <span class="pre">Generator</span></code></a> learned how to generate dependencies
...
<li><p class="first">The <span class="target" id="index-5-cpack_gen:CPack DEB Generator"></span><a class="reference internal" href="../cpack_gen/deb.html#cpack_gen:CPack DEB Generator" title="CPack DEB Generator"><code class="xref cmake cmake-cpack_gen docutils literal notranslate"><span class="pre">CPack</span> <span class="pre">DEB</span> <span class="pre">Generator</span></code></a> learned how to set the package
...
See <span class="target" id="index-0-variable:CPACK_DEBIAN_PACKAGE_RELEASE"></span><a class="reference internal" href="../cpack_gen/deb.html#variable:CPACK_DEBIAN_PACKAGE_RELEASE" title="CPACK_DEBIAN_PACKAGE_RELEASE"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_DEBIAN_PACKAGE_RELEASE</span></code></a>.</p>
</li>
<li><p class="first">The <span class="target" id="index-6-cpack_gen:CPack DEB Generator"></span><a class="reference internal" href="../cpack_gen/deb.html#cpack_gen:CPack DEB Generator" title="CPack DEB Generator"><code class="xref cmake cmake-cpack_gen docutils literal notranslate"><span class="pre">CPack</span> <span class="pre">DEB</span> <span class="pre">Generator</span></code></a> learned how to set the package
...
<li><p class="first">The <span class="target" id="index-0-module:CPackIFW"></span><a class="reference internal" href="../module/CPackIFW.html#module:CPackIFW" title="CPackIFW"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CPackIFW</span></code></a> module gained a new
...
<li><p class="first">The <span class="target" id="index-1-cpack_gen:CPack RPM Generator"></span><a class="reference internal" href="../cpack_gen/rpm.html#cpack_gen:CPack RPM Generator" title="CPack RPM Generator"><code class="xref cmake cmake-cpack_gen docutils literal notranslate"><span class="pre">CPack</span> <span class="pre">RPM</span> <span class="pre">Generator</span></code></a> learned how to set default values
...
<li><p class="first">The <span class="target" id="index-2-cpack_gen:CPack RPM Generator"></span><a class="reference internal" href="../cpack_gen/rpm.html#cpack_gen:CPack RPM Generator" title="CPack RPM Generator"><code class="xref cmake cmake-cpack_gen docutils literal notranslate"><span class="pre">CPack</span> <span class="pre">RPM</span> <span class="pre">Generator</span></code></a> learned how to set user defined
...
<ul class="simple">
<li>The precompiled OS X binary provided on <code class="docutils literal notranslate"><span class="pre">cmake.org</span></code> now requires
...
last one.</li>
<li><span class="target" id="index-0-prop_tgt:AUTOMOC"></span><a class="reference internal" href="../prop_tgt/AUTOMOC.html#prop_tgt:AUTOMOC" title="AUTOMOC"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">AUTOMOC</span></code></a> now diagnoses name collisions when multiple source
...
same name (because the generated <code class="docutils literal notranslate"><span class="pre">moc_foo.cpp</span></code> files would collide).</li>
