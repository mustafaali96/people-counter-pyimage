...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMake 3.16 Release Notes &mdash; CMake 3.16.1 Documentation</title>
...
<h1><a class="toc-backref" href="#id1">CMake 3.16 Release Notes</a><a class="headerlink" href="#cmake-3-16-release-notes" title="Permalink to this headline">¶</a></h1>
<div class="contents topic" id="contents">
<p class="topic-title first">Contents</p>
<ul class="simple">
<li><a class="reference internal" href="#cmake-3-16-release-notes" id="id1">CMake 3.16 Release Notes</a><ul>
...
<li><a class="reference internal" href="#compilers" id="id4">Compilers</a></li>
<li><a class="reference internal" href="#platforms" id="id5">Platforms</a></li>
<li><a class="reference internal" href="#command-line" id="id6">Command-Line</a></li>
...
<li><a class="reference internal" href="#autogen" id="id11">Autogen</a></li>
<li><a class="reference internal" href="#ctest" id="id12">CTest</a></li>
<li><a class="reference internal" href="#cpack" id="id13">CPack</a></li>
</ul>
</li>
...
<ul class="simple">
<li>CMake learned to support the Objective C (<code class="docutils literal notranslate"><span class="pre">OBJC</span></code>) and Objective C++
...
as plain C++ sources as they were before.</li>
</ul>
</div>
<div class="section" id="compilers">
<h3><a class="toc-backref" href="#id4">Compilers</a><a class="headerlink" href="#compilers" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
<li>The <code class="docutils literal notranslate"><span class="pre">Clang</span></code> compiler is now supported on <code class="docutils literal notranslate"><span class="pre">Solaris</span></code>.</li>
</ul>
</div>
...
<ul class="simple">
<li>On AIX, executables using the <span class="target" id="index-0-prop_tgt:ENABLE_EXPORTS"></span><a class="reference internal" href="../prop_tgt/ENABLE_EXPORTS.html#prop_tgt:ENABLE_EXPORTS" title="ENABLE_EXPORTS"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">ENABLE_EXPORTS</span></code></a> target property
...
an <code class="docutils literal notranslate"><span class="pre">ARCHIVE</span></code> artifact.</li>
<li>On AIX, runtime linking is no longer enabled by default.  CMake provides
...
of <code class="docutils literal notranslate"><span class="pre">stderr</span></code>.</li>
...
preserve backward compatibility.</li>
</ul>
</div>
...
lists created by generator expressions.</li>
<li>The <span class="target" id="index-0-command:file"></span><a class="reference internal" href="../command/file.html#command:file" title="file"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">file()</span></code></a> command learned a new sub-command,
...
a replacement for <span class="target" id="index-0-module:GetPrerequisites"></span><a class="reference internal" href="../module/GetPrerequisites.html#module:GetPrerequisites" title="GetPrerequisites"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">GetPrerequisites</span></code></a>.</li>
...
search locations:<ul>
<li><span class="target" id="index-0-variable:CMAKE_FIND_USE_PACKAGE_ROOT_PATH"></span><a class="reference internal" href="../variable/CMAKE_FIND_USE_PACKAGE_ROOT_PATH.html#variable:CMAKE_FIND_USE_PACKAGE_ROOT_PATH" title="CMAKE_FIND_USE_PACKAGE_ROOT_PATH"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_FIND_USE_PACKAGE_ROOT_PATH</span></code></a> - Controls the default
behavior of searching the <span class="target" id="index-0-variable:&lt;PackageName&gt;_ROOT"></span><a class="reference internal" href="../variable/PackageName_ROOT.html#variable:&lt;PackageName&gt;_ROOT" title="&lt;PackageName&gt;_ROOT"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">&lt;PackageName&gt;_ROOT</span></code></a> variables.</li>
<li><span class="target" id="index-0-variable:CMAKE_FIND_USE_CMAKE_ENVIRONMENT_PATH"></span><a class="reference internal" href="../variable/CMAKE_FIND_USE_CMAKE_ENVIRONMENT_PATH.html#variable:CMAKE_FIND_USE_CMAKE_ENVIRONMENT_PATH" title="CMAKE_FIND_USE_CMAKE_ENVIRONMENT_PATH"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_FIND_USE_CMAKE_ENVIRONMENT_PATH</span></code></a> - Controls the default
behavior of searching the CMake-specific environment variables.</li>
<li><span class="target" id="index-0-variable:CMAKE_FIND_USE_SYSTEM_ENVIRONMENT_PATH"></span><a class="reference internal" href="../variable/CMAKE_FIND_USE_SYSTEM_ENVIRONMENT_PATH.html#variable:CMAKE_FIND_USE_SYSTEM_ENVIRONMENT_PATH" title="CMAKE_FIND_USE_SYSTEM_ENVIRONMENT_PATH"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_FIND_USE_SYSTEM_ENVIRONMENT_PATH</span></code></a> - Controls the default
behavior of searching the standard system environment variables.</li>
<li><span class="target" id="index-0-variable:CMAKE_FIND_USE_CMAKE_PATH"></span><a class="reference internal" href="../variable/CMAKE_FIND_USE_CMAKE_PATH.html#variable:CMAKE_FIND_USE_CMAKE_PATH" title="CMAKE_FIND_USE_CMAKE_PATH"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_FIND_USE_CMAKE_PATH</span></code></a> - Controls the default behavior of
searching the CMake-specific cache variables.</li>
<li><span class="target" id="index-0-variable:CMAKE_FIND_USE_CMAKE_SYSTEM_PATH"></span><a class="reference internal" href="../variable/CMAKE_FIND_USE_CMAKE_SYSTEM_PATH.html#variable:CMAKE_FIND_USE_CMAKE_SYSTEM_PATH" title="CMAKE_FIND_USE_CMAKE_SYSTEM_PATH"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_FIND_USE_CMAKE_SYSTEM_PATH</span></code></a> - Controls the default
behavior of searching the platform-specific CMake variables.</li>
</ul>
</li>
<li>The <span class="target" id="index-1-command:find_package"></span><a class="reference internal" href="../command/find_package.html#command:find_package" title="find_package"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">find_package()</span></code></a> command has learned to check the
...
the default behavior of searching the CMake system package registry.</li>
<li>The <span class="target" id="index-0-command:message"></span><a class="reference internal" href="../command/message.html#command:message" title="message"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">message()</span></code></a> command learned indentation control with the new
...
a list of headers to precompile for faster compilation times.</li>
</ul>
</div>
...
<ul class="simple">
<li>The <span class="target" id="index-0-variable:CMAKE_CUDA_RESOLVE_DEVICE_SYMBOLS"></span><a class="reference internal" href="../variable/CMAKE_CUDA_RESOLVE_DEVICE_SYMBOLS.html#variable:CMAKE_CUDA_RESOLVE_DEVICE_SYMBOLS" title="CMAKE_CUDA_RESOLVE_DEVICE_SYMBOLS"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_CUDA_RESOLVE_DEVICE_SYMBOLS</span></code></a> variable has been
introduced to optionally initialize the
<span class="target" id="index-0-prop_tgt:CUDA_RESOLVE_DEVICE_SYMBOLS"></span><a class="reference internal" href="../prop_tgt/CUDA_RESOLVE_DEVICE_SYMBOLS.html#prop_tgt:CUDA_RESOLVE_DEVICE_SYMBOLS" title="CUDA_RESOLVE_DEVICE_SYMBOLS"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">CUDA_RESOLVE_DEVICE_SYMBOLS</span></code></a> target property.</li>
<li>The <span class="target" id="index-0-variable:CMAKE_ECLIPSE_RESOURCE_ENCODING"></span><a class="reference internal" href="../variable/CMAKE_ECLIPSE_RESOURCE_ENCODING.html#variable:CMAKE_ECLIPSE_RESOURCE_ENCODING" title="CMAKE_ECLIPSE_RESOURCE_ENCODING"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_ECLIPSE_RESOURCE_ENCODING</span></code></a> variable was added to
...
include source files for faster compilation times.</li>
</ul>
</div>
...
<li>The <span class="target" id="index-0-prop_tgt:INSTALL_REMOVE_ENVIRONMENT_RPATH"></span><a class="reference internal" href="../prop_tgt/INSTALL_REMOVE_ENVIRONMENT_RPATH.html#prop_tgt:INSTALL_REMOVE_ENVIRONMENT_RPATH" title="INSTALL_REMOVE_ENVIRONMENT_RPATH"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">INSTALL_REMOVE_ENVIRONMENT_RPATH</span></code></a> target property was
...
<span class="target" id="index-0-variable:CMAKE_INSTALL_REMOVE_ENVIRONMENT_RPATH"></span><a class="reference internal" href="../variable/CMAKE_INSTALL_REMOVE_ENVIRONMENT_RPATH.html#variable:CMAKE_INSTALL_REMOVE_ENVIRONMENT_RPATH" title="CMAKE_INSTALL_REMOVE_ENVIRONMENT_RPATH"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_INSTALL_REMOVE_ENVIRONMENT_RPATH</span></code></a> variable.</li>
<li>The <span class="target" id="index-0-prop_tgt:PRECOMPILE_HEADERS"></span><a class="reference internal" href="../prop_tgt/PRECOMPILE_HEADERS.html#prop_tgt:PRECOMPILE_HEADERS" title="PRECOMPILE_HEADERS"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">PRECOMPILE_HEADERS</span></code></a> target property was added to specify
a list of headers to precompile for faster compilation times.
Set it using the <span class="target" id="index-1-command:target_precompile_headers"></span><a class="reference internal" href="../command/target_precompile_headers.html#command:target_precompile_headers" title="target_precompile_headers"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">target_precompile_headers()</span></code></a> command.</li>
<li>The <span class="target" id="index-1-prop_tgt:UNITY_BUILD"></span><a class="reference internal" href="../prop_tgt/UNITY_BUILD.html#prop_tgt:UNITY_BUILD" title="UNITY_BUILD"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">UNITY_BUILD</span></code></a> target property was added to tell
generators to batch include source files for faster compilation
times.</li>
<li>The <span class="target" id="index-0-prop_tgt:VS_CONFIGURATION_TYPE"></span><a class="reference internal" href="../prop_tgt/VS_CONFIGURATION_TYPE.html#prop_tgt:VS_CONFIGURATION_TYPE" title="VS_CONFIGURATION_TYPE"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">VS_CONFIGURATION_TYPE</span></code></a> target property now supports
<span class="target" id="index-1-manual:cmake-generator-expressions(7)"></span><a class="reference internal" href="../manual/cmake-generator-expressions.7.html#manual:cmake-generator-expressions(7)" title="cmake-generator-expressions(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">generator</span> <span class="pre">expressions</span></code></a>.</li>
<li>The <span class="target" id="index-0-prop_tgt:VS_DPI_AWARE"></span><a class="reference internal" href="../prop_tgt/VS_DPI_AWARE.html#prop_tgt:VS_DPI_AWARE" title="VS_DPI_AWARE"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">VS_DPI_AWARE</span></code></a> target property was added to tell
...
property in <code class="docutils literal notranslate"><span class="pre">.vcxproj</span></code> files.</li>
...
<code class="docutils literal notranslate"><span class="pre">Allow</span> <span class="pre">debugging</span> <span class="pre">when</span> <span class="pre">using</span> <span class="pre">document</span> <span class="pre">Versions</span> <span class="pre">Browser</span></code> schema option.</li>
</ul>
</div>
...
any of the source files have changed since the last successful run.</li>
<li>The <span class="target" id="index-0-module:FindGnuTLS"></span><a class="reference internal" href="../module/FindGnuTLS.html#module:FindGnuTLS" title="FindGnuTLS"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindGnuTLS</span></code></a> module now provides an imported target.</li>
...
giving the reason for the failure.</li>
...
<ul>
<li><p class="first">When using <span class="target" id="index-0-prop_tgt:AUTOMOC"></span><a class="reference internal" href="../prop_tgt/AUTOMOC.html#prop_tgt:AUTOMOC" title="AUTOMOC"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">AUTOMOC</span></code></a>, CMake now generates the <code class="docutils literal notranslate"><span class="pre">-p</span></code> path prefix
...
source and/or build directory is a symbolic link.</p>
<p>The <code class="docutils literal notranslate"><span class="pre">moc</span></code> path prefix generation behavior can be configured by setting
the new <span class="target" id="index-0-variable:CMAKE_AUTOMOC_PATH_PREFIX"></span><a class="reference internal" href="../variable/CMAKE_AUTOMOC_PATH_PREFIX.html#variable:CMAKE_AUTOMOC_PATH_PREFIX" title="CMAKE_AUTOMOC_PATH_PREFIX"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_AUTOMOC_PATH_PREFIX</span></code></a> variable and/or
<span class="target" id="index-0-prop_tgt:AUTOMOC_PATH_PREFIX"></span><a class="reference internal" href="../prop_tgt/AUTOMOC_PATH_PREFIX.html#prop_tgt:AUTOMOC_PATH_PREFIX" title="AUTOMOC_PATH_PREFIX"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">AUTOMOC_PATH_PREFIX</span></code></a> target property.</p>
</li>
</ul>
</div>
...
<ul class="simple">
<li><span class="target" id="index-0-manual:ctest(1)"></span><a class="reference internal" href="../manual/ctest.1.html#manual:ctest(1)" title="ctest(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">ctest(1)</span></code></a> now has the ability to schedule tests based on resource
...
details.</li>
<li>A new test property, <span class="target" id="index-0-prop_test:SKIP_REGULAR_EXPRESSION"></span><a class="reference internal" href="../prop_test/SKIP_REGULAR_EXPRESSION.html#prop_test:SKIP_REGULAR_EXPRESSION" title="SKIP_REGULAR_EXPRESSION"><code class="xref cmake cmake-prop_test docutils literal notranslate"><span class="pre">SKIP_REGULAR_EXPRESSION</span></code></a>, has been added.
...
packages with Zstandard compression.</li>
</ul>
</div>
</div>
...
<ul class="simple">
<li>An explicit deprecation diagnostic was added for policy <code class="docutils literal notranslate"><span class="pre">CMP0067</span></code>
...
instead.</li>
<li>The <span class="target" id="index-1-module:GetPrerequisites"></span><a class="reference internal" href="../module/GetPrerequisites.html#module:GetPrerequisites" title="GetPrerequisites"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">GetPrerequisites</span></code></a> module has been deprecated, as it has been
superceded by <span class="target" id="index-1-command:file"></span><a class="reference internal" href="../command/file.html#command:file" title="file"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">file(GET_RUNTIME_DEPENDENCIES)</span></code></a>.</li>
<li>The <code class="docutils literal notranslate"><span class="pre">CPACK_INSTALL_SCRIPT</span></code> variable has been deprecated in favor of the
new, more accurately named <span class="target" id="index-0-variable:CPACK_INSTALL_SCRIPTS"></span><a class="reference internal" href="../module/CPack.html#variable:CPACK_INSTALL_SCRIPTS" title="CPACK_INSTALL_SCRIPTS"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_INSTALL_SCRIPTS</span></code></a> variable.</li>
</ul>
</div>
...
the symlink.  It no longer removes content of the linked directory.</li>
...
See policy <span class="target" id="index-0-policy:CMP0097"></span><a class="reference internal" href="../policy/CMP0097.html#policy:CMP0097" title="CMP0097"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0097</span></code></a>.</li>
<li>The <span class="target" id="index-0-module:FindGTest"></span><a class="reference internal" href="../module/FindGTest.html#module:FindGTest" title="FindGTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindGTest</span></code></a> module has been updated to recognize
MSVC build trees generated by GTest 1.8.1.</li>
<li>The <span class="target" id="index-1-command:project"></span><a class="reference internal" href="../command/project.html#command:project" title="project"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">project()</span></code></a> command no longer strips leading zeros in version
components.  See policy <span class="target" id="index-0-policy:CMP0096"></span><a class="reference internal" href="../policy/CMP0096.html#policy:CMP0096" title="CMP0096"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0096</span></code></a>.</li>
<li>The Qt Compressed Help file is now named <code class="docutils literal notranslate"><span class="pre">CMake.qch</span></code>, which no longer
...
file at a fixed location that remains valid across CMake upgrades.</li>
<li><code class="docutils literal notranslate"><span class="pre">RPATH</span></code> entries are properly escaped in the generated CMake scripts
used for installation.  See policy <span class="target" id="index-0-policy:CMP0095"></span><a class="reference internal" href="../policy/CMP0095.html#policy:CMP0095" title="CMP0095"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0095</span></code></a>.</li>
<li>When using <span class="target" id="index-0-variable:CMAKE_WINDOWS_EXPORT_ALL_SYMBOLS"></span><a class="reference internal" href="../variable/CMAKE_WINDOWS_EXPORT_ALL_SYMBOLS.html#variable:CMAKE_WINDOWS_EXPORT_ALL_SYMBOLS" title="CMAKE_WINDOWS_EXPORT_ALL_SYMBOLS"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_WINDOWS_EXPORT_ALL_SYMBOLS</span></code></a> on Windows the
auto-generated exports are now updated only when the object files
providing the symbols are updated.</li>
</ul>
</div>
</div>
