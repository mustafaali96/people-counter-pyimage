...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMake 3.12 Release Notes &mdash; CMake 3.16.1 Documentation</title>
...
<ul class="simple">
<li><a class="reference internal" href="#cmake-3-12-release-notes" id="id1">CMake 3.12 Release Notes</a><ul>
...
<li><a class="reference internal" href="#generator-expressions" id="id9">Generator Expressions</a></li>
<li><a class="reference internal" href="#ctest" id="id10">CTest</a></li>
<li><a class="reference internal" href="#cpack" id="id11">CPack</a></li>
<li><a class="reference internal" href="#other" id="id12">Other</a></li>
</ul>
</li>
...
<ul class="simple">
<li>The <a class="reference internal" href="../manual/cmake-generators.7.html#visual-studio-generators"><span class="std std-ref">Visual Studio Generators</span></a> for VS 2017 learned to support a
...
build level.  They map to corresponding options of the native build tool.</li>
</ul>
</div>
...
for which they have been updated and avoid explicit policy settings.</li>
...
build system dependency on globbed directory’s contents.</li>
...
See policy <span class="target" id="index-0-policy:CMP0074"></span><a class="reference internal" href="../policy/CMP0074.html#policy:CMP0074" title="CMP0074"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0074</span></code></a>.</li>
...
to concatenate list’s elements separated by a glue string.</li>
...
to get a sublist of the list.</li>
<li>The <span class="target" id="index-2-command:list"></span><a class="reference internal" href="../command/list.html#command:list" title="list"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">list()</span></code></a> command learned a <code class="docutils literal notranslate"><span class="pre">TRANSFORM</span></code> sub-command
to apply various string transformation to list’s elements.</li>
...
options using shell-like quoting.</li>
...
files in direct dependents and also propagates usage requirements.</li>
</ul>
</div>
...
<span class="target" id="index-0-prop_tgt:FOLDER"></span><a class="reference internal" href="../prop_tgt/FOLDER.html#prop_tgt:FOLDER" title="FOLDER"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">FOLDER</span></code></a> property on all targets.</li>
...
<span class="target" id="index-0-prop_tgt:DOTNET_TARGET_FRAMEWORK_VERSION"></span><a class="reference internal" href="../prop_tgt/DOTNET_TARGET_FRAMEWORK_VERSION.html#prop_tgt:DOTNET_TARGET_FRAMEWORK_VERSION" title="DOTNET_TARGET_FRAMEWORK_VERSION"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">DOTNET_TARGET_FRAMEWORK_VERSION</span></code></a> target properties.</li>
<li><code class="docutils literal notranslate"><span class="pre">CMAKE_PROJECT_VERSION*</span></code> variables have been introduced:<ul>
<li><span class="target" id="index-0-variable:CMAKE_PROJECT_VERSION"></span><a class="reference internal" href="../variable/CMAKE_PROJECT_VERSION.html#variable:CMAKE_PROJECT_VERSION" title="CMAKE_PROJECT_VERSION"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_PROJECT_VERSION</span></code></a></li>
<li><span class="target" id="index-0-variable:CMAKE_PROJECT_VERSION_MAJOR"></span><a class="reference internal" href="../variable/CMAKE_PROJECT_VERSION_MAJOR.html#variable:CMAKE_PROJECT_VERSION_MAJOR" title="CMAKE_PROJECT_VERSION_MAJOR"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_PROJECT_VERSION_MAJOR</span></code></a></li>
<li><span class="target" id="index-0-variable:CMAKE_PROJECT_VERSION_MINOR"></span><a class="reference internal" href="../variable/CMAKE_PROJECT_VERSION_MINOR.html#variable:CMAKE_PROJECT_VERSION_MINOR" title="CMAKE_PROJECT_VERSION_MINOR"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_PROJECT_VERSION_MINOR</span></code></a></li>
<li><span class="target" id="index-0-variable:CMAKE_PROJECT_VERSION_PATCH"></span><a class="reference internal" href="../variable/CMAKE_PROJECT_VERSION_PATCH.html#variable:CMAKE_PROJECT_VERSION_PATCH" title="CMAKE_PROJECT_VERSION_PATCH"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_PROJECT_VERSION_PATCH</span></code></a></li>
<li><span class="target" id="index-0-variable:CMAKE_PROJECT_VERSION_TWEAK"></span><a class="reference internal" href="../variable/CMAKE_PROJECT_VERSION_TWEAK.html#variable:CMAKE_PROJECT_VERSION_TWEAK" title="CMAKE_PROJECT_VERSION_TWEAK"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_PROJECT_VERSION_TWEAK</span></code></a></li>
</ul>
</li>
<li>The <span class="target" id="index-0-variable:CMAKE_SUPPRESS_REGENERATION"></span><a class="reference internal" href="../variable/CMAKE_SUPPRESS_REGENERATION.html#variable:CMAKE_SUPPRESS_REGENERATION" title="CMAKE_SUPPRESS_REGENERATION"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_SUPPRESS_REGENERATION</span></code></a> variable was extended to
...
It is also now documented.</li>
<li><code class="docutils literal notranslate"><span class="pre">CMAKE_VS_SDK_*_DIRECTORIES</span></code> variables were defined to tell
...
variables are:<ul>
<li><span class="target" id="index-0-variable:CMAKE_VS_SDK_EXCLUDE_DIRECTORIES"></span><a class="reference internal" href="../variable/CMAKE_VS_SDK_EXCLUDE_DIRECTORIES.html#variable:CMAKE_VS_SDK_EXCLUDE_DIRECTORIES" title="CMAKE_VS_SDK_EXCLUDE_DIRECTORIES"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_VS_SDK_EXCLUDE_DIRECTORIES</span></code></a></li>
<li><span class="target" id="index-0-variable:CMAKE_VS_SDK_EXECUTABLE_DIRECTORIES"></span><a class="reference internal" href="../variable/CMAKE_VS_SDK_EXECUTABLE_DIRECTORIES.html#variable:CMAKE_VS_SDK_EXECUTABLE_DIRECTORIES" title="CMAKE_VS_SDK_EXECUTABLE_DIRECTORIES"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_VS_SDK_EXECUTABLE_DIRECTORIES</span></code></a></li>
<li><span class="target" id="index-0-variable:CMAKE_VS_SDK_INCLUDE_DIRECTORIES"></span><a class="reference internal" href="../variable/CMAKE_VS_SDK_INCLUDE_DIRECTORIES.html#variable:CMAKE_VS_SDK_INCLUDE_DIRECTORIES" title="CMAKE_VS_SDK_INCLUDE_DIRECTORIES"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_VS_SDK_INCLUDE_DIRECTORIES</span></code></a></li>
<li><span class="target" id="index-0-variable:CMAKE_VS_SDK_LIBRARY_DIRECTORIES"></span><a class="reference internal" href="../variable/CMAKE_VS_SDK_LIBRARY_DIRECTORIES.html#variable:CMAKE_VS_SDK_LIBRARY_DIRECTORIES" title="CMAKE_VS_SDK_LIBRARY_DIRECTORIES"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_VS_SDK_LIBRARY_DIRECTORIES</span></code></a></li>
<li><span class="target" id="index-0-variable:CMAKE_VS_SDK_LIBRARY_WINRT_DIRECTORIES"></span><a class="reference internal" href="../variable/CMAKE_VS_SDK_LIBRARY_WINRT_DIRECTORIES.html#variable:CMAKE_VS_SDK_LIBRARY_WINRT_DIRECTORIES" title="CMAKE_VS_SDK_LIBRARY_WINRT_DIRECTORIES"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_VS_SDK_LIBRARY_WINRT_DIRECTORIES</span></code></a></li>
<li><span class="target" id="index-0-variable:CMAKE_VS_SDK_REFERENCE_DIRECTORIES"></span><a class="reference internal" href="../variable/CMAKE_VS_SDK_REFERENCE_DIRECTORIES.html#variable:CMAKE_VS_SDK_REFERENCE_DIRECTORIES" title="CMAKE_VS_SDK_REFERENCE_DIRECTORIES"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_VS_SDK_REFERENCE_DIRECTORIES</span></code></a></li>
<li><span class="target" id="index-0-variable:CMAKE_VS_SDK_SOURCE_DIRECTORIES"></span><a class="reference internal" href="../variable/CMAKE_VS_SDK_SOURCE_DIRECTORIES.html#variable:CMAKE_VS_SDK_SOURCE_DIRECTORIES" title="CMAKE_VS_SDK_SOURCE_DIRECTORIES"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_VS_SDK_SOURCE_DIRECTORIES</span></code></a></li>
</ul>
</li>
<li>A <span class="target" id="index-0-variable:MSVC_TOOLSET_VERSION"></span><a class="reference internal" href="../variable/MSVC_TOOLSET_VERSION.html#variable:MSVC_TOOLSET_VERSION" title="MSVC_TOOLSET_VERSION"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">MSVC_TOOLSET_VERSION</span></code></a> variable was added to provide the
MSVC toolset version associated with the current MSVC compiler version
in <span class="target" id="index-0-variable:MSVC_VERSION"></span><a class="reference internal" href="../variable/MSVC_VERSION.html#variable:MSVC_VERSION" title="MSVC_VERSION"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">MSVC_VERSION</span></code></a>.</li>
</ul>
</div>
...
<ul class="simple">
<li>The <span class="target" id="index-0-prop_tgt:COMMON_LANGUAGE_RUNTIME"></span><a class="reference internal" href="../prop_tgt/COMMON_LANGUAGE_RUNTIME.html#prop_tgt:COMMON_LANGUAGE_RUNTIME" title="COMMON_LANGUAGE_RUNTIME"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">COMMON_LANGUAGE_RUNTIME</span></code></a> target property was introduced
...
property was added to support <code class="docutils literal notranslate"><span class="pre">C++/CLI</span></code> for imported targets.</li>
...
<li>A <span class="target" id="index-0-prop_dir:TESTS"></span><a class="reference internal" href="../prop_dir/TESTS.html#prop_dir:TESTS" title="TESTS"><code class="xref cmake cmake-prop_dir docutils literal notranslate"><span class="pre">TESTS</span></code></a> directory property was added to hold the list of
tests defined by the <span class="target" id="index-0-command:add_test"></span><a class="reference internal" href="../command/add_test.html#command:add_test" title="add_test"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">add_test()</span></code></a> command.</li>
<li>A <span class="target" id="index-0-prop_tgt:VS_DEBUGGER_COMMAND"></span><a class="reference internal" href="../prop_tgt/VS_DEBUGGER_COMMAND.html#prop_tgt:VS_DEBUGGER_COMMAND" title="VS_DEBUGGER_COMMAND"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">VS_DEBUGGER_COMMAND</span></code></a> target property was created to set the
...
and above.</li>
<li>HLSL source file properties <span class="target" id="index-0-prop_sf:VS_SHADER_DISABLE_OPTIMIZATIONS"></span><a class="reference internal" href="../prop_sf/VS_SHADER_DISABLE_OPTIMIZATIONS.html#prop_sf:VS_SHADER_DISABLE_OPTIMIZATIONS" title="VS_SHADER_DISABLE_OPTIMIZATIONS"><code class="xref cmake cmake-prop_sf docutils literal notranslate"><span class="pre">VS_SHADER_DISABLE_OPTIMIZATIONS</span></code></a>
...
expressions.</li>
<li>HLSL source file property <span class="target" id="index-0-prop_sf:VS_SHADER_OBJECT_FILE_NAME"></span><a class="reference internal" href="../prop_sf/VS_SHADER_OBJECT_FILE_NAME.html#prop_sf:VS_SHADER_OBJECT_FILE_NAME" title="VS_SHADER_OBJECT_FILE_NAME"><code class="xref cmake cmake-prop_sf docutils literal notranslate"><span class="pre">VS_SHADER_OBJECT_FILE_NAME</span></code></a> has been
...
The property specifies the file name of the compiled shader object.</li>
</ul>
</div>
<div class="section" id="modules">
<h3><a class="toc-backref" href="#id8">Modules</a><a class="headerlink" href="#modules" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
<li>The <span class="target" id="index-0-module:FindALSA"></span><a class="reference internal" href="../module/FindALSA.html#module:FindALSA" title="FindALSA"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindALSA</span></code></a> module now provides imported targets.</li>
<li>The <span class="target" id="index-0-module:FindCURL"></span><a class="reference internal" href="../module/FindCURL.html#module:FindCURL" title="FindCURL"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindCURL</span></code></a> module now provides imported targets.</li>
<li>The <span class="target" id="index-0-module:FindJPEG"></span><a class="reference internal" href="../module/FindJPEG.html#module:FindJPEG" title="FindJPEG"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindJPEG</span></code></a> module now provides imported targets.</li>
<li>The <span class="target" id="index-0-module:FindLibXml2"></span><a class="reference internal" href="../module/FindLibXml2.html#module:FindLibXml2" title="FindLibXml2"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindLibXml2</span></code></a> module now provides imported targets.</li>
<li>The <span class="target" id="index-0-module:FindMatlab"></span><a class="reference internal" href="../module/FindMatlab.html#module:FindMatlab" title="FindMatlab"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindMatlab</span></code></a> module now supports the Matlab Runtime
Compiler (MCR) for compiling and linking matlab extensions.</li>
<li>A <span class="target" id="index-0-module:FindODBC"></span><a class="reference internal" href="../module/FindODBC.html#module:FindODBC" title="FindODBC"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindODBC</span></code></a> module was added to find an Open Database Connectivity
(ODBC) library.</li>
...
to locate python environments.</li>
<li>The <span class="target" id="index-0-module:UseSWIG"></span><a class="reference internal" href="../module/UseSWIG.html#module:UseSWIG" title="UseSWIG"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">UseSWIG</span></code></a> module gained a whole refresh and is now more
consistent with standard CMake commands to generate libraries and is
fully configurable through properties.</li>
<li>The <span class="target" id="index-1-module:UseSWIG"></span><a class="reference internal" href="../module/UseSWIG.html#module:UseSWIG" title="UseSWIG"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">UseSWIG</span></code></a> module learned to manage multiple behaviors through
...
robust handling of <code class="docutils literal notranslate"><span class="pre">SWIG</span></code> advanced features (like <code class="docutils literal notranslate"><span class="pre">%template</span></code>).</li>
<li>The <span class="target" id="index-2-module:UseSWIG"></span><a class="reference internal" href="../module/UseSWIG.html#module:UseSWIG" title="UseSWIG"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">UseSWIG</span></code></a> module learned to support CSHARP variant
wrapper files.</li>
...
<ul class="simple">
<li>A new <code class="docutils literal notranslate"><span class="pre">$&lt;GENEX_EVAL:...&gt;</span></code> and <code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_GENEX_EVAL:target,...&gt;</span></code>
...
evaluation results itself in generator expressions.</li>
<li>A new <code class="docutils literal notranslate"><span class="pre">$&lt;IN_LIST:...&gt;</span></code>
<span class="target" id="index-2-manual:cmake-generator-expressions(7)"></span><a class="reference internal" href="../manual/cmake-generator-expressions.7.html#manual:cmake-generator-expressions(7)" title="cmake-generator-expressions(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">generator</span> <span class="pre">expression</span></code></a>
has been added.</li>
<li>A new <code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_EXISTS:...&gt;</span></code>
<span class="target" id="index-3-manual:cmake-generator-expressions(7)"></span><a class="reference internal" href="../manual/cmake-generator-expressions.7.html#manual:cmake-generator-expressions(7)" title="cmake-generator-expressions(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">generator</span> <span class="pre">expression</span></code></a>
has been added.</li>
<li>A new <code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_NAME_IF_EXISTS:...&gt;</span></code>
...
<ul class="simple">
<li>The <span class="target" id="index-0-command:ctest_start"></span><a class="reference internal" href="../command/ctest_start.html#command:ctest_start" title="ctest_start"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">ctest_start()</span></code></a> command has been reworked so that you can simply
...
the arguments is less significant.</li>
<li>A <span class="target" id="index-0-prop_test:PROCESSOR_AFFINITY"></span><a class="reference internal" href="../prop_test/PROCESSOR_AFFINITY.html#prop_test:PROCESSOR_AFFINITY" title="PROCESSOR_AFFINITY"><code class="xref cmake cmake-prop_test docutils literal notranslate"><span class="pre">PROCESSOR_AFFINITY</span></code></a> test property was added to request
that CTest run a test with CPU affinity for a set of processors
disjoint from other concurrently running tests with the property set.</li>
</ul>
</div>
...
<ul class="simple">
<li>The <span class="target" id="index-0-module:CPack"></span><a class="reference internal" href="../module/CPack.html#module:CPack" title="CPack"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CPack</span></code></a> module now uses variables
...
to initialize corresponding CPack variables.</li>
<li>A <span class="target" id="index-0-cpack_gen:CPack NuGet Generator"></span><a class="reference internal" href="../cpack_gen/nuget.html#cpack_gen:CPack NuGet Generator" title="CPack NuGet Generator"><code class="xref cmake cmake-cpack_gen docutils literal notranslate"><span class="pre">CPack</span> <span class="pre">NuGet</span> <span class="pre">Generator</span></code></a> was was added with basic
support for <a class="reference external" href="https://docs.microsoft.com/en-us/nuget/what-is-nuget">NuGet</a>.</li>
</ul>
</div>
...
the <code class="docutils literal notranslate"><span class="pre">cxx_std_20</span></code> meta-feature.</li>
<li>The <span class="target" id="index-1-manual:cmake-compile-features(7)"></span><a class="reference internal" href="../manual/cmake-compile-features.7.html#manual:cmake-compile-features(7)" title="cmake-compile-features(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">Compile</span> <span class="pre">Features</span></code></a> functionality
is now aware of the availability of C features in MSVC since VS 2010.</li>
<li>The <span class="target" id="index-2-manual:cmake-compile-features(7)"></span><a class="reference internal" href="../manual/cmake-compile-features.7.html#manual:cmake-compile-features(7)" title="cmake-compile-features(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">Compile</span> <span class="pre">Features</span></code></a> functionality
...
<li>CMake no longer produces <code class="docutils literal notranslate"><span class="pre">&lt;tgt&gt;_LIB_DEPENDS</span></code> cache entries
for library targets.  See policy <span class="target" id="index-0-policy:CMP0073"></span><a class="reference internal" href="../policy/CMP0073.html#policy:CMP0073" title="CMP0073"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0073</span></code></a>.</li>
</ul>
</div>
...
<ul class="simple">
<li>Include flags for directories marked as <code class="docutils literal notranslate"><span class="pre">SYSTEM</span></code> are now moved after
...
compilers that do not have any <code class="docutils literal notranslate"><span class="pre">-isystem</span></code> flag.</li>
<li>Fortran dependency scanning now supports dependencies implied by
<a class="reference external" href="http://fortranwiki.org/fortran/show/Submodules">Fortran Submodules</a>.</li>
<li>The existence and functionality of the file
...
advantage of CPack-style component installs.</li>
...
See policy <span class="target" id="index-0-policy:CMP0075"></span><a class="reference internal" href="../policy/CMP0075.html#policy:CMP0075" title="CMP0075"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0075</span></code></a>.</li>
...
learned to honor the <code class="docutils literal notranslate"><span class="pre">CMAKE_REQUIRED_LIBRARIES</span></code> variable.
See policy <span class="target" id="index-1-policy:CMP0075"></span><a class="reference internal" href="../policy/CMP0075.html#policy:CMP0075" title="CMP0075"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0075</span></code></a>.</li>
<li>The <span class="target" id="index-0-module:CheckIncludeFiles"></span><a class="reference internal" href="../module/CheckIncludeFiles.html#module:CheckIncludeFiles" title="CheckIncludeFiles"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CheckIncludeFiles</span></code></a> module <code class="docutils literal notranslate"><span class="pre">check_include_files</span></code> macro
learned to honor the <code class="docutils literal notranslate"><span class="pre">CMAKE_REQUIRED_LIBRARIES</span></code> variable.
See policy <span class="target" id="index-2-policy:CMP0075"></span><a class="reference internal" href="../policy/CMP0075.html#policy:CMP0075" title="CMP0075"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0075</span></code></a>.</li>
...
Java modules to <code class="docutils literal notranslate"><span class="pre">&quot;&quot;</span></code> for MINGW, MSYS, and CYGWIN environments.</li>
</ul>
</div>
</div>
