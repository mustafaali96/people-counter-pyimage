...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMake 3.2 Release Notes &mdash; CMake 3.16.1 Documentation</title>
...
<li>A new <span class="target" id="index-0-command:continue"></span><a class="reference internal" href="../command/continue.html#command:continue" title="continue"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">continue()</span></code></a> command was added that can be called inside loop
contexts to end the current iteration and start the next one at the top of
the loop block.</li>
<li>The <span class="target" id="index-0-command:file"></span><a class="reference internal" href="../command/file.html#command:file" title="file"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">file(LOCK)</span></code></a> subcommand was created to allow CMake
processes to synchronize through file and directory locks.</li>
<li>The <span class="target" id="index-1-command:file"></span><a class="reference internal" href="../command/file.html#command:file" title="file"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">file(STRINGS)</span></code></a> now supports UTF-16LE, UTF-16BE,
UTF-32LE, UTF-32BE as <code class="docutils literal notranslate"><span class="pre">ENCODING</span></code> options.</li>
<li>The <span class="target" id="index-0-command:install"></span><a class="reference internal" href="../command/install.html#command:install" title="install"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">install(EXPORT)</span></code></a> command now works with an absolute
...
test project.  See policy <span class="target" id="index-0-policy:CMP0056"></span><a class="reference internal" href="../policy/CMP0056.html#policy:CMP0056" title="CMP0056"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0056</span></code></a>.</li>
...
option just as <span class="target" id="index-1-command:try_compile"></span><a class="reference internal" href="../command/try_compile.html#command:try_compile" title="try_compile"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">try_compile()</span></code></a> already does.</li>
<li>The <span class="target" id="index-2-command:file"></span><a class="reference internal" href="../command/file.html#command:file" title="file"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">file(GENERATE)</span></code></a> command now generates the output file with
the same permissions as the input file if set.</li>
<li>The <span class="target" id="index-3-command:file"></span><a class="reference internal" href="../command/file.html#command:file" title="file"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">file(GENERATE)</span></code></a> command can now generate files which are
...
<ul class="simple">
<li>The <span class="target" id="index-0-module:ExternalData"></span><a class="reference internal" href="../module/ExternalData.html#module:ExternalData" title="ExternalData"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">ExternalData</span></code></a> module learned to support
...
<li>A <span class="target" id="index-0-module:FindGSL"></span><a class="reference internal" href="../module/FindGSL.html#module:FindGSL" title="FindGSL"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindGSL</span></code></a> module was introduced to find the
GNU Scientific Library.</li>
<li>A <span class="target" id="index-0-module:FindIntl"></span><a class="reference internal" href="../module/FindIntl.html#module:FindIntl" title="FindIntl"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindIntl</span></code></a> module was introduced to find the
Gettext <code class="docutils literal notranslate"><span class="pre">libintl</span></code> library.</li>
<li>The <span class="target" id="index-0-module:FindLATEX"></span><a class="reference internal" href="../module/FindLATEX.html#module:FindLATEX" title="FindLATEX"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindLATEX</span></code></a> module learned to support components.</li>
<li>The <span class="target" id="index-0-module:FindMPI"></span><a class="reference internal" href="../module/FindMPI.html#module:FindMPI" title="FindMPI"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindMPI</span></code></a> module learned to find MS-MPI on Windows.</li>
...
<code class="docutils literal notranslate"><span class="pre">gcov</span></code> results for submission to CDash.</li>
</ul>
</div>
...
<li>The <span class="target" id="index-4-cpack_gen:CPack RPM Generator"></span><a class="reference internal" href="../cpack_gen/rpm.html#cpack_gen:CPack RPM Generator" title="CPack RPM Generator"><code class="xref cmake cmake-cpack_gen docutils literal notranslate"><span class="pre">CPack</span> <span class="pre">RPM</span> <span class="pre">Generator</span></code></a> learned a new
...
<code class="docutils literal notranslate"><span class="pre">.xz</span></code>-compressed archives with the <code class="docutils literal notranslate"><span class="pre">J</span></code> flag.</li>
...
<li>Apple Clang (<code class="docutils literal notranslate"><span class="pre">AppleClang</span></code>) for Xcode versions 4.4 though 6.1.</li>
<li>GNU compiler versions 4.4 through 5.0 on UNIX and Apple (<code class="docutils literal notranslate"><span class="pre">GNU</span></code>).</li>
<li>Microsoft Visual Studio (<code class="docutils literal notranslate"><span class="pre">MSVC</span></code>) for versions 2010 through 2015.</li>
<li>Oracle SolarisStudio (<code class="docutils literal notranslate"><span class="pre">SunPro</span></code>) version 12.4.</li>
</ul>
</li>
<li>The <a class="reference internal" href="../manual/cmake-qt.7.html#qt-autorcc"><span class="std std-ref">AUTORCC</span></a> feature now tracks files listed in <code class="docutils literal notranslate"><span class="pre">.qrc</span></code> files
...
<ul class="simple">
<li>The <span class="target" id="index-0-command:break"></span><a class="reference internal" href="../command/break.html#command:break" title="break"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">break()</span></code></a> command now rejects calls outside of a loop
context or that pass arguments to the command.
See policy <span class="target" id="index-0-policy:CMP0055"></span><a class="reference internal" href="../policy/CMP0055.html#policy:CMP0055" title="CMP0055"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0055</span></code></a>.</li>
</ul>
</div>
...
<li>The <span class="target" id="index-0-module:FindOpenGL"></span><a class="reference internal" href="../module/FindOpenGL.html#module:FindOpenGL" title="FindOpenGL"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindOpenGL</span></code></a> module no longer explicitly searches
...
<code class="docutils literal notranslate"><span class="pre">xcode-select</span></code> switches to a different Xcode installation.</p>
</li>
...
<li><p class="first">The <span class="target" id="index-0-generator:Xcode"></span><a class="reference internal" href="../generator/Xcode.html#generator:Xcode" title="Xcode"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Xcode</span></code></a> generator no longer requires a value for
...
It now locates <code class="docutils literal notranslate"><span class="pre">xcodebuild</span></code> when needed at build time.</p>
</li>
<li><p class="first">When building CMake itself using SolarisStudio 12, the default <code class="docutils literal notranslate"><span class="pre">libCStd</span></code>
