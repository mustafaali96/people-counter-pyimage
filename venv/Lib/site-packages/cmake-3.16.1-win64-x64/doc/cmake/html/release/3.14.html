...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMake 3.14 Release Notes &mdash; CMake 3.16.1 Documentation</title>
...
<ul class="simple">
<li><a class="reference internal" href="#cmake-3-14-release-notes" id="id7">CMake 3.14 Release Notes</a><ul>
<li><a class="reference internal" href="#new-features" id="id8">New Features</a><ul>
<li><a class="reference internal" href="#generators" id="id9">Generators</a></li>
<li><a class="reference internal" href="#file-based-api" id="id10">File-Based API</a></li>
<li><a class="reference internal" href="#platforms" id="id11">Platforms</a></li>
<li><a class="reference internal" href="#command-line" id="id12">Command-Line</a></li>
<li><a class="reference internal" href="#commands" id="id13">Commands</a></li>
<li><a class="reference internal" href="#variables" id="id14">Variables</a></li>
<li><a class="reference internal" href="#properties" id="id15">Properties</a></li>
<li><a class="reference internal" href="#modules" id="id16">Modules</a></li>
<li><a class="reference internal" href="#generator-expressions" id="id17">Generator Expressions</a></li>
<li><a class="reference internal" href="#autogen" id="id18">Autogen</a></li>
<li><a class="reference internal" href="#ctest" id="id19">CTest</a></li>
</ul>
</li>
<li><a class="reference internal" href="#deprecated-and-removed-features" id="id20">Deprecated and Removed Features</a></li>
<li><a class="reference internal" href="#other-changes" id="id21">Other Changes</a></li>
<li><a class="reference internal" href="#updates" id="id22">Updates</a><ul>
<li><a class="reference internal" href="#id1" id="id23">3.14.1</a></li>
<li><a class="reference internal" href="#id2" id="id24">3.14.3</a></li>
<li><a class="reference internal" href="#id3" id="id25">3.14.4</a></li>
<li><a class="reference internal" href="#id4" id="id26">3.14.5</a></li>
<li><a class="reference internal" href="#id5" id="id27">3.14.6</a></li>
<li><a class="reference internal" href="#id6" id="id28">3.14.7</a></li>
</ul>
</li>
</ul>
</li>
...
<ul>
<li><p class="first">The <span class="target" id="index-0-generator:Visual Studio 16 2019"></span><a class="reference internal" href="../generator/Visual Studio 16 2019.html#generator:Visual Studio 16 2019" title="Visual Studio 16 2019"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Visual</span> <span class="pre">Studio</span> <span class="pre">16</span> <span class="pre">2019</span></code></a> generator was added.  This is
...
<ul class="simple">
<li>Now supports <a class="reference internal" href="../manual/cmake-buildsystem.7.html#object-libraries"><span class="std std-ref">Object Libraries</span></a>.</li>
<li>Now warns on unsupported project types such as shared libraries.</li>
<li>Now generates a top-level <code class="docutils literal notranslate"><span class="pre">&lt;PROJECT-NAME&gt;.top.gpj</span></code> for each directory
...
<code class="docutils literal notranslate"><span class="pre">default.gpj</span></code> is no longer created.</li>
<li>Now honors target renaming and destination output control properties
...
<span class="target" id="index-0-command:install"></span><a class="reference internal" href="../command/install.html#command:install" title="install"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">install()</span></code></a>.</li>
<li>Now honors source file properties <span class="target" id="index-0-prop_sf:INCLUDE_DIRECTORIES"></span><a class="reference internal" href="../prop_sf/INCLUDE_DIRECTORIES.html#prop_sf:INCLUDE_DIRECTORIES" title="INCLUDE_DIRECTORIES"><code class="xref cmake cmake-prop_sf docutils literal notranslate"><span class="pre">INCLUDE_DIRECTORIES</span></code></a>,
<span class="target" id="index-0-prop_sf:COMPILE_DEFINITIONS"></span><a class="reference internal" href="../prop_sf/COMPILE_DEFINITIONS.html#prop_sf:COMPILE_DEFINITIONS" title="COMPILE_DEFINITIONS"><code class="xref cmake cmake-prop_sf docutils literal notranslate"><span class="pre">COMPILE_DEFINITIONS</span></code></a>, and <span class="target" id="index-0-prop_sf:COMPILE_OPTIONS"></span><a class="reference internal" href="../prop_sf/COMPILE_OPTIONS.html#prop_sf:COMPILE_OPTIONS" title="COMPILE_OPTIONS"><code class="xref cmake cmake-prop_sf docutils literal notranslate"><span class="pre">COMPILE_OPTIONS</span></code></a>.</li>
<li>Now supports Dynamic Download Integrity Applications which did not include
...
link flag of <code class="docutils literal notranslate"><span class="pre">-dynamic</span></code>.</li>
<li>The contents of project files now sorts sources groups and files by name.
...
variable to enable this for all targets.</li>
</ul>
</li>
</ul>
</div>
...
<ul class="simple">
<li>A file-based api for clients to get semantic buildsystem information
...
<ul class="simple">
<li>CMake now supports <a class="reference internal" href="../manual/cmake-toolchains.7.html#cross-compiling-for-ios-tvos-or-watchos"><span class="std std-ref">Cross Compiling for iOS, tvOS, or watchOS</span></a>
using simple toolchain files.</li>
</ul>
</div>
...
support this option currently.</li>
...
(e.g. LF vs CRLF) should be ignored when comparing files.</li>
...
explicitly specify source and build directories.</li>
</ul>
</div>
...
which can be used to create hard or symbolic links.</li>
...
which can be used to determine the path that a symlink points to.</li>
...
extension after the last <code class="docutils literal notranslate"><span class="pre">.</span></code> in the name.</li>
<li>The <span class="target" id="index-0-command:if"></span><a class="reference internal" href="../command/if.html#command:if" title="if"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">if()</span></code></a> command gained support for checking if cache variables
are defined with the  <code class="docutils literal notranslate"><span class="pre">DEFINED</span> <span class="pre">CACHE{VAR}</span></code> syntax.</li>
...
learned to support generator expressions.  See policy <span class="target" id="index-0-policy:CMP0087"></span><a class="reference internal" href="../policy/CMP0087.html#policy:CMP0087" title="CMP0087"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0087</span></code></a>.</li>
<li>The <span class="target" id="index-3-command:install"></span><a class="reference internal" href="../command/install.html#command:install" title="install"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">install(TARGETS)</span></code></a> command learned how to install to an
...
in lieu of a <code class="docutils literal notranslate"><span class="pre">DESTINATION</span></code> argument.</li>
...
<code class="docutils literal notranslate"><span class="pre">DESTINATION</span></code> argument.</li>
...
as the list since these operations on empty lists is also the empty list.</li>
<li>The <span class="target" id="index-1-command:list"></span><a class="reference internal" href="../command/list.html#command:list" title="list"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">list()</span></code></a> operation <code class="docutils literal notranslate"><span class="pre">REMOVE_AT</span></code> now indicates that the given
indices are invalid for a non-existent variable or empty list.</li>
<li>The <span class="target" id="index-0-command:try_compile"></span><a class="reference internal" href="../command/try_compile.html#command:try_compile" title="try_compile"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">try_compile()</span></code></a> and <span class="target" id="index-0-command:try_run"></span><a class="reference internal" href="../command/try_run.html#command:try_run" title="try_run"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">try_run()</span></code></a> commands gained a new
<code class="docutils literal notranslate"><span class="pre">LINK_OPTIONS</span></code> option.</li>
</ul>
</div>
...
<ul class="simple">
<li>A <span class="target" id="index-0-prop_gbl:CMAKE_ROLE"></span><a class="reference internal" href="../prop_gbl/CMAKE_ROLE.html#prop_gbl:CMAKE_ROLE" title="CMAKE_ROLE"><code class="xref cmake cmake-prop_gbl docutils literal notranslate"><span class="pre">CMAKE_ROLE</span></code></a> global property was added to allow scripts to
determine whether they’re running in project mode, script mode,
find-package mode, CTest, or CPack.</li>
...
only honored on static libraries.</li>
<li>The <span class="target" id="index-0-prop_tgt:EXCLUDE_FROM_ALL"></span><a class="reference internal" href="../prop_tgt/EXCLUDE_FROM_ALL.html#prop_tgt:EXCLUDE_FROM_ALL" title="EXCLUDE_FROM_ALL"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">EXCLUDE_FROM_ALL</span></code></a> target property was created to override
...
<li><p class="first">A <span class="target" id="index-0-module:CheckFortranSourceRuns"></span><a class="reference internal" href="../module/CheckFortranSourceRuns.html#module:CheckFortranSourceRuns" title="CheckFortranSourceRuns"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CheckFortranSourceRuns</span></code></a> module was added to provide a
...
source snippet compiles and runs.</p>
</li>
<li><p class="first">The <span class="target" id="index-0-module:CMakePackageConfigHelpers"></span><a class="reference internal" href="../module/CMakePackageConfigHelpers.html#module:CMakePackageConfigHelpers" title="CMakePackageConfigHelpers"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CMakePackageConfigHelpers</span></code></a> module’s
...
<li><p class="first">The <span class="target" id="index-0-module:FetchContent"></span><a class="reference internal" href="../module/FetchContent.html#module:FetchContent" title="FetchContent"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FetchContent</span></code></a> module gained a new
...
significantly reduces the amount of boilerplate needed in a project.</p>
</li>
<li><p class="first">The <span class="target" id="index-0-module:FindBISON"></span><a class="reference internal" href="../module/FindBISON.html#module:FindBISON" title="FindBISON"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindBISON</span></code></a> module’s <code class="docutils literal notranslate"><span class="pre">BISON_TARGET</span></code> command now runs <code class="docutils literal notranslate"><span class="pre">bison</span></code>
...
See policy <span class="target" id="index-0-policy:CMP0088"></span><a class="reference internal" href="../policy/CMP0088.html#policy:CMP0088" title="CMP0088"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0088</span></code></a>.</p>
</li>
<li><p class="first">The <span class="target" id="index-0-module:FindCURL"></span><a class="reference internal" href="../module/FindCURL.html#module:FindCURL" title="FindCURL"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindCURL</span></code></a> module gained support for requesting
protocols as package components.</p>
</li>
<li><p class="first">The <span class="target" id="index-0-module:FindFontconfig"></span><a class="reference internal" href="../module/FindFontconfig.html#module:FindFontconfig" title="FindFontconfig"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindFontconfig</span></code></a> module was added to find <a class="reference external" href="https://www.freedesktop.org/wiki/Software/fontconfig/">fontconfig</a>.</p>
</li>
<li><p class="first">The <span class="target" id="index-0-module:FindGDAL"></span><a class="reference internal" href="../module/FindGDAL.html#module:FindGDAL" title="FindGDAL"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindGDAL</span></code></a> module now provides imported targets.</p>
</li>
<li><p class="first">The <span class="target" id="index-0-module:FindGIF"></span><a class="reference internal" href="../module/FindGIF.html#module:FindGIF" title="FindGIF"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindGIF</span></code></a> module now provides imported targets.</p>
</li>
<li><p class="first">The <span class="target" id="index-0-module:FindGit"></span><a class="reference internal" href="../module/FindGit.html#module:FindGit" title="FindGit"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindGit</span></code></a> module now provides an imported target for the
Git executable.</p>
</li>
<li><p class="first">The <span class="target" id="index-0-module:FindIce"></span><a class="reference internal" href="../module/FindIce.html#module:FindIce" title="FindIce"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindIce</span></code></a> module learned to find <code class="docutils literal notranslate"><span class="pre">slice2confluence</span></code>
and <code class="docutils literal notranslate"><span class="pre">slice2matlab</span></code>.</p>
</li>
<li><p class="first">The <span class="target" id="index-0-module:FindLibinput"></span><a class="reference internal" href="../module/FindLibinput.html#module:FindLibinput" title="FindLibinput"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindLibinput</span></code></a> module was added to find <a class="reference external" href="https://www.freedesktop.org/wiki/Software/libinput/">libinput</a>.</p>
</li>
<li><p class="first">The <span class="target" id="index-0-module:FindLibLZMA"></span><a class="reference internal" href="../module/FindLibLZMA.html#module:FindLibLZMA" title="FindLibLZMA"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindLibLZMA</span></code></a> module now provides imported targets.</p>
</li>
<li><p class="first">The <span class="target" id="index-0-module:FindMatlab"></span><a class="reference internal" href="../module/FindMatlab.html#module:FindMatlab" title="FindMatlab"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindMatlab</span></code></a> module gained new options <code class="docutils literal notranslate"><span class="pre">R2017b</span></code> and
...
The option <code class="docutils literal notranslate"><span class="pre">MX_LIBRARY</span></code> is no longer needed.</p>
</li>
<li><p class="first">The <span class="target" id="index-0-module:FindPostgreSQL"></span><a class="reference internal" href="../module/FindPostgreSQL.html#module:FindPostgreSQL" title="FindPostgreSQL"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindPostgreSQL</span></code></a> module now provides imported targets.</p>
</li>
<li><p class="first">The <span class="target" id="index-0-module:FindPython"></span><a class="reference internal" href="../module/FindPython.html#module:FindPython" title="FindPython"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindPython</span></code></a>, <span class="target" id="index-0-module:FindPython2"></span><a class="reference internal" href="../module/FindPython2.html#module:FindPython2" title="FindPython2"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindPython2</span></code></a>, and <span class="target" id="index-0-module:FindPython3"></span><a class="reference internal" href="../module/FindPython3.html#module:FindPython3" title="FindPython3"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindPython3</span></code></a>
modules gained support for <code class="docutils literal notranslate"><span class="pre">NumPy</span></code> component.</p>
</li>
<li><p class="first">The <span class="target" id="index-1-module:FindPython2"></span><a class="reference internal" href="../module/FindPython2.html#module:FindPython2" title="FindPython2"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindPython2</span></code></a>, <span class="target" id="index-1-module:FindPython3"></span><a class="reference internal" href="../module/FindPython3.html#module:FindPython3" title="FindPython3"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindPython3</span></code></a>, and <span class="target" id="index-1-module:FindPython"></span><a class="reference internal" href="../module/FindPython.html#module:FindPython" title="FindPython"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindPython</span></code></a>
modules now support running in script mode by skipping the creation of
imported targets and helper functions.</p>
</li>
<li><p class="first">The <span class="target" id="index-0-module:FindSQLite3"></span><a class="reference internal" href="../module/FindSQLite3.html#module:FindSQLite3" title="FindSQLite3"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindSQLite3</span></code></a> module was added to find the SQLite v3.x library.</p>
</li>
<li><p class="first">The <span class="target" id="index-0-module:FindX11"></span><a class="reference internal" href="../module/FindX11.html#module:FindX11" title="FindX11"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindX11</span></code></a> had the following variables renamed in order to match
their library names rather than header names. The old variables are provided
for compatibility:</p>
<blockquote>
<div><ul class="simple">
<li><code class="docutils literal notranslate"><span class="pre">X11_Xxf86misc_INCLUDE_PATH</span></code> instead of <code class="docutils literal notranslate"><span class="pre">X11_xf86misc_INCLUDE_PATH</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">X11_Xxf86misc_LIB</span></code> instead of <code class="docutils literal notranslate"><span class="pre">X11_xf86misc_LIB</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">X11_Xxf86misc_FOUND</span></code> instead of <code class="docutils literal notranslate"><span class="pre">X11_xf86misc_FOUND</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">X11_Xxf86vm_INCLUDE_PATH</span></code> instead of <code class="docutils literal notranslate"><span class="pre">X11_xf86vmode_INCLUDE_PATH</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">X11_Xxf86vm_LIB</span></code> instead of <code class="docutils literal notranslate"><span class="pre">X11_xf86vmode_LIB</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">X11_Xxf86vm_FOUND</span></code> instead of <code class="docutils literal notranslate"><span class="pre">X11_xf86vmode_FOUND</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">X11_xkbfile_INCLUDE_PATH</span></code> instead of <code class="docutils literal notranslate"><span class="pre">X11_Xkbfile_INCLUDE_PATH</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">X11_xkbfile_LIB</span></code> instead of <code class="docutils literal notranslate"><span class="pre">X11_Xkbfile_LIB</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">X11_xkbfile_FOUND</span></code> instead of <code class="docutils literal notranslate"><span class="pre">X11_Xkbfile_FOUND</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">X11_Xtst_INCLUDE_PATH</span></code> instead of <code class="docutils literal notranslate"><span class="pre">X11_XTest_INCLUDE_PATH</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">X11_Xtst_LIB</span></code> instead of <code class="docutils literal notranslate"><span class="pre">X11_XTest_LIB</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">X11_Xtst_FOUND</span></code> instead of <code class="docutils literal notranslate"><span class="pre">X11_XTest_FOUND</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">X11_Xss_INCLUDE_PATH</span></code> instead of <code class="docutils literal notranslate"><span class="pre">X11_Xscreensaver_INCLUDE_PATH</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">X11_Xss_LIB</span></code> instead of <code class="docutils literal notranslate"><span class="pre">X11_Xscreensaver_LIB</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">X11_Xss_FOUND</span></code> instead of <code class="docutils literal notranslate"><span class="pre">X11_Xscreensaver_FOUND</span></code></li>
</ul>
</div></blockquote>
...
<blockquote>
<div><ul class="simple">
<li><code class="docutils literal notranslate"><span class="pre">X11_Xinput_INCLUDE_PATH</span></code> (use <code class="docutils literal notranslate"><span class="pre">X11_Xi_INCLUDE_PATH</span></code>)</li>
<li><code class="docutils literal notranslate"><span class="pre">X11_Xinput_LIB</span></code> (use <code class="docutils literal notranslate"><span class="pre">X11_Xi_LIB</span></code>)</li>
<li><code class="docutils literal notranslate"><span class="pre">X11_Xinput_FOUND</span></code> (use <code class="docutils literal notranslate"><span class="pre">X11_Xi_FOUND</span></code>)</li>
</ul>
</div></blockquote>
</li>
<li><p class="first">The <span class="target" id="index-1-module:FindX11"></span><a class="reference internal" href="../module/FindX11.html#module:FindX11" title="FindX11"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindX11</span></code></a> now provides <code class="docutils literal notranslate"><span class="pre">X11_Xext_INCLUDE_PATH</span></code>.</p>
</li>
<li><p class="first">The <span class="target" id="index-2-module:FindX11"></span><a class="reference internal" href="../module/FindX11.html#module:FindX11" title="FindX11"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindX11</span></code></a> now provides imported targets.</p>
</li>
<li><p class="first">The <span class="target" id="index-0-module:UseSWIG"></span><a class="reference internal" href="../module/UseSWIG.html#module:UseSWIG" title="UseSWIG"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">UseSWIG</span></code></a> module learned to pass <code class="docutils literal notranslate"><span class="pre">-module</span> <span class="pre">&lt;module_name&gt;</span></code> to
...
See policy <span class="target" id="index-0-policy:CMP0086"></span><a class="reference internal" href="../policy/CMP0086.html#policy:CMP0086" title="CMP0086"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0086</span></code></a>.</p>
</li>
<li><p class="first">The <span class="target" id="index-1-module:UseSWIG"></span><a class="reference internal" href="../module/UseSWIG.html#module:UseSWIG" title="UseSWIG"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">UseSWIG</span></code></a> module gained an option to specify
<code class="docutils literal notranslate"><span class="pre">SWIG</span></code> source file extensions.</p>
</li>
</ul>
</div>
...
<ul class="simple">
<li>The <code class="docutils literal notranslate"><span class="pre">$&lt;Fortran_COMPILER_ID:...&gt;</span></code> and <code class="docutils literal notranslate"><span class="pre">$&lt;Fortran_COMPILER_VERSION:...&gt;</span></code>
<span class="target" id="index-1-manual:cmake-generator-expressions(7)"></span><a class="reference internal" href="../manual/cmake-generator-expressions.7.html#manual:cmake-generator-expressions(7)" title="cmake-generator-expressions(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">generator</span> <span class="pre">expressions</span></code></a> were added.</li>
<li>The <code class="docutils literal notranslate"><span class="pre">$&lt;IN_LIST:...&gt;</span></code> generator expression now correctly handles an
empty argument. See <span class="target" id="index-0-policy:CMP0085"></span><a class="reference internal" href="../policy/CMP0085.html#policy:CMP0085" title="CMP0085"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0085</span></code></a> for details.</li>
</ul>
</div>
...
<li><p class="first">The new variables <span class="target" id="index-0-variable:CMAKE_GLOBAL_AUTOGEN_TARGET"></span><a class="reference internal" href="../variable/CMAKE_GLOBAL_AUTOGEN_TARGET.html#variable:CMAKE_GLOBAL_AUTOGEN_TARGET" title="CMAKE_GLOBAL_AUTOGEN_TARGET"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_GLOBAL_AUTOGEN_TARGET</span></code></a>,
...
of global <code class="docutils literal notranslate"><span class="pre">autogen</span></code> and <code class="docutils literal notranslate"><span class="pre">autorcc</span></code> targets.</p>
</li>
<li><p class="first">A new <span class="target" id="index-0-variable:CMAKE_AUTOGEN_ORIGIN_DEPENDS"></span><a class="reference internal" href="../variable/CMAKE_AUTOGEN_ORIGIN_DEPENDS.html#variable:CMAKE_AUTOGEN_ORIGIN_DEPENDS" title="CMAKE_AUTOGEN_ORIGIN_DEPENDS"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_AUTOGEN_ORIGIN_DEPENDS</span></code></a> variable and
...
<ul class="simple">
<li><span class="target" id="index-0-manual:ctest(1)"></span><a class="reference internal" href="../manual/ctest.1.html#manual:ctest(1)" title="ctest(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">ctest(1)</span></code></a> gained a <code class="docutils literal notranslate"><span class="pre">--show-only=json-v1</span></code> option to show the
list of tests in a machine-readable JSON format.
See the <a class="reference internal" href="../manual/ctest.1.html#show-as-json-object-model"><span class="std std-ref">Show as JSON Object Model</span></a> section of the manual.</li>
<li>The <span class="target" id="index-0-command:ctest_submit"></span><a class="reference internal" href="../command/ctest_submit.html#command:ctest_submit" title="ctest_submit"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">ctest_submit()</span></code></a> command learned a new <code class="docutils literal notranslate"><span class="pre">Done</span></code> part that can be used
to inform CDash that a build is complete and that no more parts will be uploaded.</li>
<li>CTest learned to accept the dashboard server submission URL from a single
...
argument of the <span class="target" id="index-1-command:ctest_submit"></span><a class="reference internal" href="../command/ctest_submit.html#command:ctest_submit" title="ctest_submit"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">ctest_submit()</span></code></a> command.</li>
</ul>
</div>
</div>
...
<ul class="simple">
<li>An explicit deprecation diagnostic was added for policies <code class="docutils literal notranslate"><span class="pre">CMP0064</span></code>
...
Windows 7 or higher.</li>
<li>CTest no longer supports submissions via <code class="docutils literal notranslate"><span class="pre">ftp</span></code>, <code class="docutils literal notranslate"><span class="pre">scp</span></code>, <code class="docutils literal notranslate"><span class="pre">cp</span></code>, and
...
and it only supports submissions over <code class="docutils literal notranslate"><span class="pre">http</span></code> and <code class="docutils literal notranslate"><span class="pre">https</span></code>.</li>
</ul>
</div>
...
<ul class="simple">
<li>Object library linking has been fixed to propagate private link libraries
of object libraries to consuming targets.</li>
<li>Install rules under <span class="target" id="index-0-command:add_subdirectory"></span><a class="reference internal" href="../command/add_subdirectory.html#command:add_subdirectory" title="add_subdirectory"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">add_subdirectory()</span></code></a> now interleave with those in
the calling directory. See policy <span class="target" id="index-0-policy:CMP0082"></span><a class="reference internal" href="../policy/CMP0082.html#policy:CMP0082" title="CMP0082"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0082</span></code></a> for details.</li>
<li>CMake now imposes a maximum recursion limit to prevent a stack overflow on
scripts that recurse infinitely. The limit can be adjusted at runtime with
<span class="target" id="index-0-variable:CMAKE_MAXIMUM_RECURSION_DEPTH"></span><a class="reference internal" href="../variable/CMAKE_MAXIMUM_RECURSION_DEPTH.html#variable:CMAKE_MAXIMUM_RECURSION_DEPTH" title="CMAKE_MAXIMUM_RECURSION_DEPTH"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_MAXIMUM_RECURSION_DEPTH</span></code></a>.</li>
<li>When using cppcheck via the <span class="target" id="index-0-variable:CMAKE_&lt;LANG&gt;_CPPCHECK"></span><a class="reference internal" href="../variable/CMAKE_LANG_CPPCHECK.html#variable:CMAKE_&lt;LANG&gt;_CPPCHECK" title="CMAKE_&lt;LANG&gt;_CPPCHECK"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_&lt;LANG&gt;_CPPCHECK</span></code></a> variable
...
<code class="docutils literal notranslate"><span class="pre">cppcheck</span></code> returns non-zero as configured by its command-line options.</li>
<li>Required link options to manage Position Independent Executable are now
...
is controlled by policy <span class="target" id="index-0-policy:CMP0083"></span><a class="reference internal" href="../policy/CMP0083.html#policy:CMP0083" title="CMP0083"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0083</span></code></a>.</li>
<li><a class="reference internal" href="../manual/cmake-generators.7.html#visual-studio-generators"><span class="std std-ref">Visual Studio Generators</span></a> for VS 2010 and above learned
...
via <span class="target" id="index-0-command:add_custom_target"></span><a class="reference internal" href="../command/add_custom_target.html#command:add_custom_target" title="add_custom_target"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">add_custom_target()</span></code></a>.</li>
...
to <code class="docutils literal notranslate"><span class="pre">gnutar</span></code> and a deprecation message emitted.</li>
<li>CMake no longer issues a warning if a target listed in an
...
<ul class="simple">
<li>The <span class="target" id="index-1-module:FindFontconfig"></span><a class="reference internal" href="../module/FindFontconfig.html#module:FindFontconfig" title="FindFontconfig"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindFontconfig</span></code></a> module added by 3.14.0 accidentally
...
module is new in the 3.14 series usage should not yet be widespread.</li>
</ul>
</div>
...
The bug also existed in 3.13.0 through 3.13.4 and is fixed in 3.13.5.</li>
</ul>
</div>
<div class="section" id="id4">
<h3><a class="toc-backref" href="#id26">3.14.5</a><a class="headerlink" href="#id4" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
<li>Entries of the <code class="docutils literal notranslate"><span class="pre">CPATH</span></code> environment variable are no longer excluded
...
<ul class="simple">
<li>In CMake 3.14.0 through 3.14.5, the <span class="target" id="index-1-module:FindBISON"></span><a class="reference internal" href="../module/FindBISON.html#module:FindBISON" title="FindBISON"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindBISON</span></code></a> module
...
directory instead of the source tree directory.  This has been fixed.</li>
</ul>
</div>
<div class="section" id="id6">
<h3><a class="toc-backref" href="#id28">3.14.7</a><a class="headerlink" href="#id6" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
<li>In CMake 3.14.0 through 3.14.6, the <span class="target" id="index-1-prop_dir:EXCLUDE_FROM_ALL"></span><a class="reference internal" href="../prop_dir/EXCLUDE_FROM_ALL.html#prop_dir:EXCLUDE_FROM_ALL" title="EXCLUDE_FROM_ALL"><code class="xref cmake cmake-prop_dir docutils literal notranslate"><span class="pre">EXCLUDE_FROM_ALL</span></code></a>
