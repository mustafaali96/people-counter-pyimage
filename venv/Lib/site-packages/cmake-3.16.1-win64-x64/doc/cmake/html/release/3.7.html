...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMake 3.7 Release Notes &mdash; CMake 3.16.1 Documentation</title>
...
<ul class="simple">
<li>The <span class="target" id="index-0-generator:Ninja"></span><a class="reference internal" href="../generator/Ninja.html#generator:Ninja" title="Ninja"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Ninja</span></code></a> generator learned to conditionally support
...
<li>The <span class="target" id="index-1-generator:Ninja"></span><a class="reference internal" href="../generator/Ninja.html#generator:Ninja" title="Ninja"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Ninja</span></code></a> generator learned to produce phony targets
...
place <code class="docutils literal notranslate"><span class="pre">.natvis</span></code> source files into VS project files properly.</li>
<li>The <span class="target" id="index-0-generator:Xcode"></span><a class="reference internal" href="../generator/Xcode.html#generator:Xcode" title="Xcode"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Xcode</span></code></a> generator’s rudimentary Swift language support
...
<li>The <span class="target" id="index-0-generator:CodeLite"></span><a class="reference internal" href="../generator/CodeLite.html#generator:CodeLite" title="CodeLite"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">CodeLite</span></code></a> generator gained a new
...
variables inside a <span class="target" id="index-0-command:function"></span><a class="reference internal" href="../command/function.html#command:function" title="function"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">function()</span></code></a> body.</li>
...
<code class="docutils literal notranslate"><span class="pre">HTTPHEADER</span> <span class="pre">&lt;HTTP-header&gt;</span></code> and <code class="docutils literal notranslate"><span class="pre">USERPWD</span> <span class="pre">&lt;username&gt;:&lt;password&gt;</span></code> options.</li>
...
property.</li>
<li>The <span class="target" id="index-1-command:find_package"></span><a class="reference internal" href="../command/find_package.html#command:find_package" title="find_package"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">find_package()</span></code></a> command gained the possibility of
...
and <span class="target" id="index-0-variable:CMAKE_FIND_PACKAGE_SORT_DIRECTION"></span><a class="reference internal" href="../variable/CMAKE_FIND_PACKAGE_SORT_DIRECTION.html#variable:CMAKE_FIND_PACKAGE_SORT_DIRECTION" title="CMAKE_FIND_PACKAGE_SORT_DIRECTION"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_FIND_PACKAGE_SORT_DIRECTION</span></code></a>.</li>
<li>The <span class="target" id="index-0-command:if"></span><a class="reference internal" href="../command/if.html#command:if" title="if"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">if()</span></code></a> command gained new boolean comparison operations
...
<code class="docutils literal notranslate"><span class="pre">VERSION_LESS_EQUAL</span></code>, and <code class="docutils literal notranslate"><span class="pre">VERSION_GREATER_EQUAL</span></code>.</li>
...
<li>The <span class="target" id="index-0-command:try_compile"></span><a class="reference internal" href="../command/try_compile.html#command:try_compile" title="try_compile"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">try_compile()</span></code></a> command source file signature now honors
...
for the current toolchain were used.  See policy <span class="target" id="index-0-policy:CMP0066"></span><a class="reference internal" href="../policy/CMP0066.html#policy:CMP0066" title="CMP0066"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0066</span></code></a>.</li>
</ul>
</div>
...
the sorting mode of the <span class="target" id="index-2-command:find_package"></span><a class="reference internal" href="../command/find_package.html#command:find_package" title="find_package"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">find_package()</span></code></a> command.</li>
...
the sorting direction the <span class="target" id="index-3-command:find_package"></span><a class="reference internal" href="../command/find_package.html#command:find_package" title="find_package"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">find_package()</span></code></a> command.</li>
...
<li>A <span class="target" id="index-0-prop_dir:BINARY_DIR"></span><a class="reference internal" href="../prop_dir/BINARY_DIR.html#prop_dir:BINARY_DIR" title="BINARY_DIR"><code class="xref cmake cmake-prop_dir docutils literal notranslate"><span class="pre">BINARY_DIR</span></code></a> directory property was added to get the
...
needed by running <code class="docutils literal notranslate"><span class="pre">ldd</span> <span class="pre">-r</span> <span class="pre">-u</span></code>.</li>
<li>A <span class="target" id="index-0-prop_dir:SOURCE_DIR"></span><a class="reference internal" href="../prop_dir/SOURCE_DIR.html#prop_dir:SOURCE_DIR" title="SOURCE_DIR"><code class="xref cmake cmake-prop_dir docutils literal notranslate"><span class="pre">SOURCE_DIR</span></code></a> directory property was added to get the
absolute path to the source directory associated with a directory.</li>
<li>A <span class="target" id="index-0-prop_dir:SUBDIRECTORIES"></span><a class="reference internal" href="../prop_dir/SUBDIRECTORIES.html#prop_dir:SUBDIRECTORIES" title="SUBDIRECTORIES"><code class="xref cmake cmake-prop_dir docutils literal notranslate"><span class="pre">SUBDIRECTORIES</span></code></a> directory property was added to
...
<code class="docutils literal notranslate"><span class="pre">HTTP_PASSWORD</span></code> options to set http download credentials.</li>
...
<code class="docutils literal notranslate"><span class="pre">REPORT_FILE</span></code> option to specify the bison <code class="docutils literal notranslate"><span class="pre">--report-file=</span></code> option.</li>
<li>The <span class="target" id="index-0-module:FindBZip2"></span><a class="reference internal" href="../module/FindBZip2.html#module:FindBZip2" title="FindBZip2"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindBZip2</span></code></a> module now provides imported targets.</li>
<li>A <span class="target" id="index-0-module:FindICU"></span><a class="reference internal" href="../module/FindICU.html#module:FindICU" title="FindICU"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindICU</span></code></a> module was introduced to find the International
Components for Unicode (ICU) libraries and programs.</li>
<li>The <span class="target" id="index-0-module:FindMatlab"></span><a class="reference internal" href="../module/FindMatlab.html#module:FindMatlab" title="FindMatlab"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindMatlab</span></code></a> module learned to find the SIMULINK and MAT
components.</li>
...
<li>The <span class="target" id="index-0-module:FindOpenCL"></span><a class="reference internal" href="../module/FindOpenCL.html#module:FindOpenCL" title="FindOpenCL"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindOpenCL</span></code></a> module now provides imported targets.</li>
<li>The <span class="target" id="index-0-module:FindOpenMP"></span><a class="reference internal" href="../module/FindOpenMP.html#module:FindOpenMP" title="FindOpenMP"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindOpenMP</span></code></a> module learned to detect the OpenMP
version (specification date) from the compiler.</li>
<li>A <span class="target" id="index-0-module:FindVulkan"></span><a class="reference internal" href="../module/FindVulkan.html#module:FindVulkan" title="FindVulkan"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindVulkan</span></code></a> module was added.</li>
...
<li>The <span class="target" id="index-0-module:GNUInstallDirs"></span><a class="reference internal" href="../module/GNUInstallDirs.html#module:GNUInstallDirs" title="GNUInstallDirs"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">GNUInstallDirs</span></code></a> module gained a new
<span class="target" id="index-0-command:gnuinstalldirs_get_absolute_install_dir"></span><a class="reference internal" href="../module/GNUInstallDirs.html#command:gnuinstalldirs_get_absolute_install_dir" title="gnuinstalldirs_get_absolute_install_dir"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">GNUInstallDirs_get_absolute_install_dir()</span></code></a> command.</li>
<li>The <span class="target" id="index-0-module:UseJava"></span><a class="reference internal" href="../module/UseJava.html#module:UseJava" title="UseJava"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">UseJava</span></code></a> module gained APIs to “export” jar targets
...
and <code class="docutils literal notranslate"><span class="pre">export_jars</span></code> functions.</li>
</ul>
</div>
...
code of the <span class="target" id="index-0-manual:ctest(1)"></span><a class="reference internal" href="../manual/ctest.1.html#manual:ctest(1)" title="ctest(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">ctest(1)</span></code></a> process.</li>
</ul>
</div>
...
<ul class="simple">
<li>CPack gained a <span class="target" id="index-0-cpack_gen:CPack productbuild Generator"></span><a class="reference internal" href="../cpack_gen/productbuild.html#cpack_gen:CPack productbuild Generator" title="CPack productbuild Generator"><code class="xref cmake cmake-cpack_gen docutils literal notranslate"><span class="pre">CPack</span> <span class="pre">productbuild</span> <span class="pre">Generator</span></code></a> on OS X.</li>
...
See <span class="target" id="index-0-variable:CPACK_DEBIAN_ARCHIVE_TYPE"></span><a class="reference internal" href="../cpack_gen/deb.html#variable:CPACK_DEBIAN_ARCHIVE_TYPE" title="CPACK_DEBIAN_ARCHIVE_TYPE"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_DEBIAN_ARCHIVE_TYPE</span></code></a></li>
<li>The <span class="target" id="index-0-module:CPackIFW"></span><a class="reference internal" href="../module/CPackIFW.html#module:CPackIFW" title="CPackIFW"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CPackIFW</span></code></a> module gained a new
...
<li>The <span class="target" id="index-1-cpack_gen:CPack RPM Generator"></span><a class="reference internal" href="../cpack_gen/rpm.html#cpack_gen:CPack RPM Generator" title="CPack RPM Generator"><code class="xref cmake cmake-cpack_gen docutils literal notranslate"><span class="pre">CPack</span> <span class="pre">RPM</span> <span class="pre">Generator</span></code></a> learned to generate source rpm
...
<li>The <span class="target" id="index-2-cpack_gen:CPack WIX Generator"></span><a class="reference internal" href="../cpack_gen/wix.html#cpack_gen:CPack WIX Generator" title="CPack WIX Generator"><code class="xref cmake cmake-cpack_gen docutils literal notranslate"><span class="pre">CPack</span> <span class="pre">WIX</span> <span class="pre">Generator</span></code></a> now supports
<span class="target" id="index-0-variable:CPACK_WIX_PATCH_FILE"></span><a class="reference internal" href="../cpack_gen/wix.html#variable:CPACK_WIX_PATCH_FILE" title="CPACK_WIX_PATCH_FILE"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_WIX_PATCH_FILE</span></code></a> fragments for Feature elements.</li>
<li>The <span class="target" id="index-3-cpack_gen:CPack WIX Generator"></span><a class="reference internal" href="../cpack_gen/wix.html#cpack_gen:CPack WIX Generator" title="CPack WIX Generator"><code class="xref cmake cmake-cpack_gen docutils literal notranslate"><span class="pre">CPack</span> <span class="pre">WIX</span> <span class="pre">Generator</span></code></a> now supports
...
to change.</li>
<li>The <span class="target" id="index-1-manual:cmake(1)"></span><a class="reference internal" href="../manual/cmake.1.html#manual:cmake(1)" title="cmake(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake(1)</span></code></a> command learned a <code class="docutils literal notranslate"><span class="pre">--trace-source=&lt;file&gt;</span></code> option.</li>
<li><span class="target" id="index-0-manual:ccmake(1)"></span><a class="reference internal" href="../manual/ccmake.1.html#manual:ccmake(1)" title="ccmake(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">ccmake(1)</span></code></a> learned to support vim-like navigation bindings.</li>
...
<ul>
<li><p class="first">We no longer provide Linux i386 binaries for download from <code class="docutils literal notranslate"><span class="pre">cmake.org</span></code>
for new versions of CMake.</p>
</li>
<li><p class="first">Vim support files <code class="docutils literal notranslate"><span class="pre">cmake-indent.vim</span></code>, <code class="docutils literal notranslate"><span class="pre">cmake-syntax.vim</span></code>, and
...
<li>Vim support files <code class="docutils literal notranslate"><span class="pre">indent/cmake.vim</span></code> and <code class="docutils literal notranslate"><span class="pre">syntax/cmake.vim</span></code>
