...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMake 3.13 Release Notes &mdash; CMake 3.16.1 Documentation</title>
...
<ul class="simple">
<li><a class="reference internal" href="#cmake-3-13-release-notes" id="id5">CMake 3.13 Release Notes</a><ul>
...
<li><a class="reference internal" href="#command-line" id="id8">Command-Line</a></li>
...
<li><a class="reference internal" href="#deprecated-and-removed-features" id="id15">Deprecated and Removed Features</a></li>
<li><a class="reference internal" href="#other-changes" id="id16">Other Changes</a></li>
<li><a class="reference internal" href="#updates" id="id17">Updates</a><ul>
<li><a class="reference internal" href="#id1" id="id18">3.13.2</a></li>
<li><a class="reference internal" href="#id2" id="id19">3.13.3</a></li>
<li><a class="reference internal" href="#id3" id="id20">3.13.4</a></li>
<li><a class="reference internal" href="#id4" id="id21">3.13.5</a></li>
</ul>
</li>
</ul>
</li>
...
<ul class="simple">
<li>The <a class="reference internal" href="../manual/cmake-generators.7.html#visual-studio-generators"><span class="std std-ref">Visual Studio Generators</span></a> for VS 2010 and above learned to
...
and supporting <span class="target" id="index-0-module:CheckIPOSupported"></span><a class="reference internal" href="../module/CheckIPOSupported.html#module:CheckIPOSupported" title="CheckIPOSupported"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CheckIPOSupported</span></code></a> module.</li>
<li>The <span class="target" id="index-0-generator:Xcode"></span><a class="reference internal" href="../generator/Xcode.html#generator:Xcode" title="Xcode"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Xcode</span></code></a> generator learned to configure more Xcode Scheme
fields.  See the <span class="target" id="index-0-variable:CMAKE_XCODE_GENERATE_SCHEME"></span><a class="reference internal" href="../variable/CMAKE_XCODE_GENERATE_SCHEME.html#variable:CMAKE_XCODE_GENERATE_SCHEME" title="CMAKE_XCODE_GENERATE_SCHEME"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_XCODE_GENERATE_SCHEME</span></code></a> variable.</li>
...
<li>Added support for architecture selection through
...
e.g. <code class="docutils literal notranslate"><span class="pre">arm</span></code>, <code class="docutils literal notranslate"><span class="pre">ppc</span></code>, and <code class="docutils literal notranslate"><span class="pre">86</span></code>.</li>
<li>Added support for toolset selection through
...
e.g. <code class="docutils literal notranslate"><span class="pre">comp_201205</span></code>, <code class="docutils literal notranslate"><span class="pre">comp_201510</span></code>, <code class="docutils literal notranslate"><span class="pre">comp_201722_beta</span></code>.</li>
<li>Added support for platform selection through <code class="docutils literal notranslate"><span class="pre">GHS_TARGET_PLATFORM</span></code>,
e.g. <code class="docutils literal notranslate"><span class="pre">integrity</span></code>, <code class="docutils literal notranslate"><span class="pre">linux</span></code>, <code class="docutils literal notranslate"><span class="pre">standalone</span></code>, etc.</li>
<li>No longer checks that <code class="docutils literal notranslate"><span class="pre">arm</span></code> based compilers are installed but ensures
that the correct <code class="docutils literal notranslate"><span class="pre">gbuild.exe</span></code> exists.</li>
<li>No longer hard-codes ARM files, BSP, toolset, or OS locations.</li>
</ul>
</li>
</ul>
</div>
...
This option can be used independently of <code class="docutils literal notranslate"><span class="pre">-B</span></code>.</li>
...
This option can be used independently of <code class="docutils literal notranslate"><span class="pre">-S</span></code>.</li>
...
learned to support generator expressions in <code class="docutils literal notranslate"><span class="pre">WORKING_DIRECTORY</span></code> options.</li>
<li>The <span class="target" id="index-0-command:add_link_options"></span><a class="reference internal" href="../command/add_link_options.html#command:add_link_options" title="add_link_options"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">add_link_options()</span></code></a> command was created to add link
options in the current directory.</li>
<li>The <span class="target" id="index-0-command:install"></span><a class="reference internal" href="../command/install.html#command:install" title="install"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">install(TARGETS)</span></code></a> command learned to install targets
created outside the current directory.</li>
...
insertion position.</li>
<li>The <span class="target" id="index-0-command:list"></span><a class="reference internal" href="../command/list.html#command:list" title="list"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">list(SORT)</span></code></a> command gained options to control the
comparison operation used to order the entries.</li>
<li>The <span class="target" id="index-0-command:math"></span><a class="reference internal" href="../command/math.html#command:math" title="math"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">math()</span></code></a> command gained options for hexadecimal.</li>
...
specify link directories for targets and their dependents.</li>
...
specify link options for targets and their dependents.</li>
...
See policy <span class="target" id="index-0-policy:CMP0079"></span><a class="reference internal" href="../policy/CMP0079.html#policy:CMP0079" title="CMP0079"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0079</span></code></a>.</li>
</ul>
</div>
...
<ul class="simple">
<li>A <span class="target" id="index-0-variable:CMAKE_AUTOGEN_VERBOSE"></span><a class="reference internal" href="../variable/CMAKE_AUTOGEN_VERBOSE.html#variable:CMAKE_AUTOGEN_VERBOSE" title="CMAKE_AUTOGEN_VERBOSE"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_AUTOGEN_VERBOSE</span></code></a> variable was added to optionally
...
and <span class="target" id="index-0-prop_tgt:AUTORCC"></span><a class="reference internal" href="../prop_tgt/AUTORCC.html#prop_tgt:AUTORCC" title="AUTORCC"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">AUTORCC</span></code></a> from within CMake project code.</li>
<li>A <span class="target" id="index-0-variable:CMAKE_VS_GLOBALS"></span><a class="reference internal" href="../variable/CMAKE_VS_GLOBALS.html#variable:CMAKE_VS_GLOBALS" title="CMAKE_VS_GLOBALS"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_VS_GLOBALS</span></code></a> variable was added to initialize
...
<ul class="simple">
<li>The <span class="target" id="index-0-prop_tgt:DEPLOYMENT_ADDITIONAL_FILES"></span><a class="reference internal" href="../prop_tgt/DEPLOYMENT_ADDITIONAL_FILES.html#prop_tgt:DEPLOYMENT_ADDITIONAL_FILES" title="DEPLOYMENT_ADDITIONAL_FILES"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">DEPLOYMENT_ADDITIONAL_FILES</span></code></a> target property was
...
to specify transitive link dependencies on files.</li>
<li>The <span class="target" id="index-0-prop_tgt:LINK_DEPENDS"></span><a class="reference internal" href="../prop_tgt/LINK_DEPENDS.html#prop_tgt:LINK_DEPENDS" title="LINK_DEPENDS"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">LINK_DEPENDS</span></code></a> target property learned to support
...
now support generator expressions.</li>
</ul>
</div>
...
to specify a Boost architecture-specific library filename fragment.</li>
<li>The <span class="target" id="index-0-module:FindCURL"></span><a class="reference internal" href="../module/FindCURL.html#module:FindCURL" title="FindCURL"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindCURL</span></code></a> module learned to find debug and release variants
separately.</li>
<li>The <span class="target" id="index-0-module:FindMatlab"></span><a class="reference internal" href="../module/FindMatlab.html#module:FindMatlab" title="FindMatlab"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindMatlab</span></code></a> module gained new components <code class="docutils literal notranslate"><span class="pre">ENGINE_LIBRARY</span></code> and
...
component to request finding the Matlab Compiler add-on.</li>
...
targets in global scope.</li>
<li>The <span class="target" id="index-1-module:FindPkgConfig"></span><a class="reference internal" href="../module/FindPkgConfig.html#module:FindPkgConfig" title="FindPkgConfig"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindPkgConfig</span></code></a> module gained support for <code class="docutils literal notranslate"><span class="pre">&lt;</span></code> and <code class="docutils literal notranslate"><span class="pre">&gt;</span></code>
operators for version checks in addition to the already supported
operators <code class="docutils literal notranslate"><span class="pre">&gt;=</span></code>, <code class="docutils literal notranslate"><span class="pre">&lt;=</span></code>, and <code class="docutils literal notranslate"><span class="pre">=</span></code>.</li>
...
Windows (Registry).</li>
<li>The <span class="target" id="index-0-module:FindSubversion"></span><a class="reference internal" href="../module/FindSubversion.html#module:FindSubversion" title="FindSubversion"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindSubversion</span></code></a> module <code class="docutils literal notranslate"><span class="pre">Subversion_WC_INFO</span></code> command
...
e.g. when the source tree is not under Subversion control.</li>
<li>The <span class="target" id="index-0-module:UseSWIG"></span><a class="reference internal" href="../module/UseSWIG.html#module:UseSWIG" title="UseSWIG"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">UseSWIG</span></code></a> module learned to manage target property
<span class="target" id="index-0-prop_tgt:INCLUDE_DIRECTORIES"></span><a class="reference internal" href="../prop_tgt/INCLUDE_DIRECTORIES.html#prop_tgt:INCLUDE_DIRECTORIES" title="INCLUDE_DIRECTORIES"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">INCLUDE_DIRECTORIES</span></code></a> for <code class="docutils literal notranslate"><span class="pre">SWIG</span></code> compilation.</li>
</ul>
</div>
...
test progress summary when output goes to a terminal.</li>
</ul>
</div>
...
the entire packaging process.</li>
</ul>
</div>
</div>
...
<ul class="simple">
<li>An explicit deprecation diagnostic was added for policies <code class="docutils literal notranslate"><span class="pre">CMP0055</span></code>
...
<ul class="simple">
<li>The precompiled binaries provided on <code class="docutils literal notranslate"><span class="pre">cmake.org</span></code> now include
qthelp-format documentation.</li>
<li>The <span class="target" id="index-0-command:option"></span><a class="reference internal" href="../command/option.html#command:option" title="option"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">option()</span></code></a> command now honors an existing normal variable
...
See policy <span class="target" id="index-0-policy:CMP0077"></span><a class="reference internal" href="../policy/CMP0077.html#policy:CMP0077" title="CMP0077"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0077</span></code></a>.</li>
<li>The <a class="reference internal" href="../manual/cmake-generators.7.html#makefile-generators"><span class="std std-ref">Makefile Generators</span></a> learned to remove custom command and
custom target byproducts during <code class="docutils literal notranslate"><span class="pre">make</span> <span class="pre">clean</span></code>.</li>
...
the old behavior where required.</li>
...
time. This was always a bug anyway. See policy <span class="target" id="index-0-policy:CMP0080"></span><a class="reference internal" href="../policy/CMP0080.html#policy:CMP0080" title="CMP0080"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0080</span></code></a>.</li>
<li>The <span class="target" id="index-1-module:UseSWIG"></span><a class="reference internal" href="../module/UseSWIG.html#module:UseSWIG" title="UseSWIG"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">UseSWIG</span></code></a> module has changed strategy for target naming.
See policy <span class="target" id="index-0-policy:CMP0078"></span><a class="reference internal" href="../policy/CMP0078.html#policy:CMP0078" title="CMP0078"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0078</span></code></a>.</li>
<li>The <span class="target" id="index-1-prop_tgt:LINK_DIRECTORIES"></span><a class="reference internal" href="../prop_tgt/LINK_DIRECTORIES.html#prop_tgt:LINK_DIRECTORIES" title="LINK_DIRECTORIES"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">LINK_DIRECTORIES</span></code></a> target property now expects absolute paths.
See policy <span class="target" id="index-0-policy:CMP0081"></span><a class="reference internal" href="../policy/CMP0081.html#policy:CMP0081" title="CMP0081"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0081</span></code></a>.</li>
<li>The CPack generators have been moved into their own separate section
...
they should never have been available in the first place.</li>
</ul>
</div>
...
<ul class="simple">
<li>CMake 3.13.0 included a change to pass compiler implicit include
...
further investigation before being re-introduced in a later release.</li>
</ul>
</div>
...
when VS 2019 is installed.</li>
<li>CMake now checks that at least one of the source or binary directory
...
working directory as the source and build tree.</li>
</ul>
</div>
<div class="section" id="id3">
<h3><a class="toc-backref" href="#id20">3.13.4</a><a class="headerlink" href="#id3" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
<li>The error added by 3.13.3 in cases that neither a source or binary
...
dependents that link the static library.  This has been fixed.</li>
</ul>
</div>
</div>
</div>
