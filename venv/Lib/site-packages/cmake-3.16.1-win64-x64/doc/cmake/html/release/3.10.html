...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMake 3.10 Release Notes &mdash; CMake 3.16.1 Documentation</title>
...
<ul class="simple">
<li><a class="reference internal" href="#cmake-3-10-release-notes" id="id3">CMake 3.10 Release Notes</a><ul>
...
<li><a class="reference internal" href="#other" id="id14">Other</a></li>
</ul>
</li>
...
<li><a class="reference internal" href="#id1" id="id18">3.10.1</a></li>
<li><a class="reference internal" href="#release-notes-3-10-3" id="id19">3.10.3</a></li>
</ul>
</li>
</ul>
</li>
...
<ul class="simple">
<li>The <a class="reference external" href="https://github.com/flang-compiler/flang">flang</a> Fortran compiler is now supported, with compiler id <code class="docutils literal notranslate"><span class="pre">Flang</span></code>.</li>
<li>A new minimal platform file for <code class="docutils literal notranslate"><span class="pre">Midipix</span></code> was added.</li>
<li>Support for the MSVC ARM64 architecture was added.
Visual Studio 2017 Update 4 and above offer an ARM64 toolchain.</li>
<li>Support for the IAR ARM Compiler was improved.</li>
</ul>
</div>
...
are now understood and preserved in the output.</li>
...
check.</li>
<li>The <span class="target" id="index-0-command:string"></span><a class="reference internal" href="../command/string.html#command:string" title="string"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">string()</span></code></a> command learned a new <code class="docutils literal notranslate"><span class="pre">PREPEND</span></code> subcommand.</li>
...
for full weekday name and <code class="docutils literal notranslate"><span class="pre">%B</span></code> for full month name.</li>
</ul>
</div>
...
<ul class="simple">
<li>A <span class="target" id="index-0-variable:CMAKE_DIRECTORY_LABELS"></span><a class="reference internal" href="../variable/CMAKE_DIRECTORY_LABELS.html#variable:CMAKE_DIRECTORY_LABELS" title="CMAKE_DIRECTORY_LABELS"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_DIRECTORY_LABELS</span></code></a> variable was added to specify
labels for all tests in a directory.</li>
</ul>
</div>
...
<ul class="simple">
<li>A <span class="target" id="index-0-prop_tgt:&lt;LANG&gt;_CPPCHECK"></span><a class="reference internal" href="../prop_tgt/LANG_CPPCHECK.html#prop_tgt:&lt;LANG&gt;_CPPCHECK" title="&lt;LANG&gt;_CPPCHECK"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">&lt;LANG&gt;_CPPCHECK</span></code></a> target property and supporting
...
run <code class="docutils literal notranslate"><span class="pre">cppcheck</span></code> with the compiler for <code class="docutils literal notranslate"><span class="pre">C</span></code> and <code class="docutils literal notranslate"><span class="pre">CXX</span></code> languages.</li>
<li>A <span class="target" id="index-0-prop_dir:LABELS"></span><a class="reference internal" href="../prop_dir/LABELS.html#prop_dir:LABELS" title="LABELS"><code class="xref cmake cmake-prop_dir docutils literal notranslate"><span class="pre">LABELS</span></code></a> directory property was added to specify labels
for all targets and tests in a directory.</li>
<li>A <span class="target" id="index-0-prop_dir:TEST_INCLUDE_FILES"></span><a class="reference internal" href="../prop_dir/TEST_INCLUDE_FILES.html#prop_dir:TEST_INCLUDE_FILES" title="TEST_INCLUDE_FILES"><code class="xref cmake cmake-prop_dir docutils literal notranslate"><span class="pre">TEST_INCLUDE_FILES</span></code></a> directory property was added to
...
<ul class="simple">
<li>The <span class="target" id="index-0-module:FindCurses"></span><a class="reference internal" href="../module/FindCurses.html#module:FindCurses" title="FindCurses"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindCurses</span></code></a> module gained a <code class="docutils literal notranslate"><span class="pre">CURSES_NEED_WIDE</span></code> option
to request the wide-character variant.</li>
<li>The <span class="target" id="index-0-module:FindEXPAT"></span><a class="reference internal" href="../module/FindEXPAT.html#module:FindEXPAT" title="FindEXPAT"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindEXPAT</span></code></a> module now provides imported targets.</li>
<li>The <span class="target" id="index-0-module:FindFreetype"></span><a class="reference internal" href="../module/FindFreetype.html#module:FindFreetype" title="FindFreetype"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindFreetype</span></code></a> module now provides imported targets.</li>
<li><span class="target" id="index-0-module:FindMPI"></span><a class="reference internal" href="../module/FindMPI.html#module:FindMPI" title="FindMPI"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindMPI</span></code></a> gained a number of new features, including:<ul>
<li>Language-specific components have been added to the module.</li>
<li>Many more MPI environments are now supported.</li>
<li>The environmental support for Fortran has been improved.</li>
<li>A user now has fine-grained control over the MPI selection process,
including passing custom parameters to the MPI compiler.</li>
<li>The version of the implemented MPI standard is now being exposed.</li>
<li>MPI-2 C++ bindings can now be detected and also suppressed if so desired.</li>
<li>The available Fortran bindings are now being detected and verified.</li>
<li>Various MPI-3 information can be requested, including the library version
and Fortran capabilities of the individual bindings.</li>
<li>Statically linked MPI implementations are supported.</li>
</ul>
</li>
<li>A <span class="target" id="index-0-module:FindOpenACC"></span><a class="reference internal" href="../module/FindOpenACC.html#module:FindOpenACC" title="FindOpenACC"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindOpenACC</span></code></a> module was added to detect compiler support
for OpenACC.  Currently only supports PGI, GNU and Cray compilers.</li>
<li>The <span class="target" id="index-0-module:FindOpenGL"></span><a class="reference internal" href="../module/FindOpenGL.html#module:FindOpenGL" title="FindOpenGL"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindOpenGL</span></code></a> module gained support for GLVND on Linux.</li>
<li>The <span class="target" id="index-0-module:FindOpenMP"></span><a class="reference internal" href="../module/FindOpenMP.html#module:FindOpenMP" title="FindOpenMP"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindOpenMP</span></code></a> module gained support for
language-specific components.</li>
<li>A <span class="target" id="index-0-module:FindPatch"></span><a class="reference internal" href="../module/FindPatch.html#module:FindPatch" title="FindPatch"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">FindPatch</span></code></a> module was added to find the <code class="docutils literal notranslate"><span class="pre">patch</span></code>
...
gained a <code class="docutils literal notranslate"><span class="pre">DESCRIPTORS</span></code> option to generate descriptor files.</li>
<li>The <span class="target" id="index-0-module:GoogleTest"></span><a class="reference internal" href="../module/GoogleTest.html#module:GoogleTest" title="GoogleTest"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">GoogleTest</span></code></a> module gained a new command
...
an ambiguity of the <code class="docutils literal notranslate"><span class="pre">TIMEOUT</span></code> keyword (see <a class="reference internal" href="#release-notes-3-10-3"><span class="std std-ref">3.10.3</span></a>).</li>
...
for installing Intel compiler runtimes.</li>
</ul>
</div>
...
<code class="docutils literal notranslate"><span class="pre">&lt;AUTOGEN_BUILD_DIR&gt;/include</span></code>.</li>
...
in earlier releases.
See policy <span class="target" id="index-0-policy:CMP0071"></span><a class="reference internal" href="../policy/CMP0071.html#policy:CMP0071" title="CMP0071"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0071</span></code></a>.</li>
<li>When using <span class="target" id="index-3-prop_tgt:AUTOMOC"></span><a class="reference internal" href="../prop_tgt/AUTOMOC.html#prop_tgt:AUTOMOC" title="AUTOMOC"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">AUTOMOC</span></code></a>, CMake searches for the strings <code class="docutils literal notranslate"><span class="pre">Q_OBJECT</span></code>,
...
to register additional strings (macro names) to search for.</li>
<li>When using <span class="target" id="index-4-prop_tgt:AUTOMOC"></span><a class="reference internal" href="../prop_tgt/AUTOMOC.html#prop_tgt:AUTOMOC" title="AUTOMOC"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">AUTOMOC</span></code></a>, the new
...
<code class="docutils literal notranslate"><span class="pre">moc_predefs.h</span></code>.</li>
</ul>
</div>
...
set it in the <code class="docutils literal notranslate"><span class="pre">CTestConfig.cmake</span></code> config file.</li>
</ul>
</div>
...
building basic cross-platform Debian packages.</li>
...
See the <span class="target" id="index-0-variable:CPACK_DEBIAN_PACKAGE_RELEASE"></span><a class="reference internal" href="../cpack_gen/deb.html#variable:CPACK_DEBIAN_PACKAGE_RELEASE" title="CPACK_DEBIAN_PACKAGE_RELEASE"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_DEBIAN_PACKAGE_RELEASE</span></code></a> variable.</li>
<li>The <span class="target" id="index-2-cpack_gen:CPack DEB Generator"></span><a class="reference internal" href="../cpack_gen/deb.html#cpack_gen:CPack DEB Generator" title="CPack DEB Generator"><code class="xref cmake cmake-cpack_gen docutils literal notranslate"><span class="pre">CPack</span> <span class="pre">DEB</span> <span class="pre">Generator</span></code></a> learned more strict package
version checking that complies with Debian rules.</li>
...
<code class="docutils literal notranslate"><span class="pre">REPLACES</span></code> and <code class="docutils literal notranslate"><span class="pre">CHECKABLE</span></code> options.</li>
...
target binary format.</li>
<li>The <span class="target" id="index-1-cpack_gen:CPack IFW Generator"></span><a class="reference internal" href="../cpack_gen/ifw.html#cpack_gen:CPack IFW Generator" title="CPack IFW Generator"><code class="xref cmake cmake-cpack_gen docutils literal notranslate"><span class="pre">CPack</span> <span class="pre">IFW</span> <span class="pre">Generator</span></code></a> gained new
...
<li>The graphviz output now distinguishes among the different dependency types
...
graph as solid, dashed and dotted edges.</li>
</ul>
</div>
</div>
...
<ul class="simple">
<li>Support for building CMake itself with C++98 compilers was dropped.
CMake is now implemented using C++11.</li>
<li>Support for building CMake on HP-UX has been dropped pending better
...
Use CMake 3.9 or lower instead for HP-UX support.</li>
</ul>
</div>
...
<ul class="simple">
<li>On FreeBSD the C++ compiler named <code class="docutils literal notranslate"><span class="pre">c++</span></code> is now the preferred default.</li>
<li>The <span class="target" id="index-0-command:file"></span><a class="reference internal" href="../command/file.html#command:file" title="file"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">file(GENERATE)</span></code></a> command now interprets relative paths
...
See policy <span class="target" id="index-0-policy:CMP0070"></span><a class="reference internal" href="../policy/CMP0070.html#policy:CMP0070" title="CMP0070"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0070</span></code></a>.</li>
...
Another approach will be needed to provide backtrace information.</li>
</ul>
</div>
...
<ul class="simple">
<li>CMake 3.10.1 added a <code class="docutils literal notranslate"><span class="pre">TIMEOUT</span></code> option to <span class="target" id="index-1-command:gtest_discover_tests"></span><a class="reference internal" href="../module/GoogleTest.html#command:gtest_discover_tests" title="gtest_discover_tests"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">gtest_discover_tests()</span></code></a>
...
<code class="docutils literal notranslate"><span class="pre">TIMEOUT</span></code> keyword in 3.10.1 and 3.10.2 has not been preserved.</li>
</ul>
</div>
</div>
</div>
