...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMAKE_C_KNOWN_FEATURES &mdash; CMake 3.16.1 Documentation</title>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">c_std_90</span></code></dt>
<dd>Compiler mode is at least C 90.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">c_std_99</span></code></dt>
<dd>Compiler mode is at least C 99.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">c_std_11</span></code></dt>
<dd>Compiler mode is at least C 11.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">c_function_prototypes</span></code></dt>
<dd>Function prototypes, as defined in <code class="docutils literal notranslate"><span class="pre">ISO/IEC</span> <span class="pre">9899:1990</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">c_restrict</span></code></dt>
<dd><code class="docutils literal notranslate"><span class="pre">restrict</span></code> keyword, as defined in <code class="docutils literal notranslate"><span class="pre">ISO/IEC</span> <span class="pre">9899:1999</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">c_static_assert</span></code></dt>
<dd>Static assert, as defined in <code class="docutils literal notranslate"><span class="pre">ISO/IEC</span> <span class="pre">9899:2011</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">c_variadic_macros</span></code></dt>
<dd>Variadic macros, as defined in <code class="docutils literal notranslate"><span class="pre">ISO/IEC</span> <span class="pre">9899:1999</span></code>.</dd>
</dl>
</div>
