...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMAKE_CXX_KNOWN_FEATURES &mdash; CMake 3.16.1 Documentation</title>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">cxx_std_98</span></code></dt>
<dd>Compiler mode is at least C++ 98.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">cxx_std_11</span></code></dt>
<dd>Compiler mode is at least C++ 11.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">cxx_std_14</span></code></dt>
<dd>Compiler mode is at least C++ 14.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">cxx_std_17</span></code></dt>
<dd>Compiler mode is at least C++ 17.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">cxx_std_20</span></code></dt>
<dd>Compiler mode is at least C++ 20.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">cxx_aggregate_default_initializers</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_alias_templates</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_alignas</span></code></dt>
<dd>Alignment control <code class="docutils literal notranslate"><span class="pre">alignas</span></code>, as defined in <a class="reference external" href="http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2007/n2341.pdf">N2341</a>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">cxx_alignof</span></code></dt>
<dd>Alignment control <code class="docutils literal notranslate"><span class="pre">alignof</span></code>, as defined in <a class="reference external" href="http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2007/n2341.pdf">N2341</a>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">cxx_attributes</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_attribute_deprecated</span></code></dt>
<dd><code class="docutils literal notranslate"><span class="pre">[[deprecated]]</span></code> attribute, as defined in <a class="reference external" href="http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2013/n3760.html">N3760</a>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">cxx_auto_type</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_binary_literals</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_constexpr</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_contextual_conversions</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_decltype_incomplete_return_types</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_decltype</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_decltype_auto</span></code></dt>
<dd><code class="docutils literal notranslate"><span class="pre">decltype(auto)</span></code> semantics, as defined in <a class="reference external" href="http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2013/n3638.html">N3638</a>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">cxx_default_function_template_args</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_defaulted_functions</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_defaulted_move_initializers</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_delegating_constructors</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_deleted_functions</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_digit_separators</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_enum_forward_declarations</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_explicit_conversions</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_extended_friend_declarations</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_extern_templates</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_final</span></code></dt>
<dd>Override control <code class="docutils literal notranslate"><span class="pre">final</span></code> keyword, as defined in <a class="reference external" href="http://www.open-std.org/JTC1/SC22/WG21/docs/papers/2009/n2928.htm">N2928</a>, <a class="reference external" href="http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2010/n3206.htm">N3206</a> and <a class="reference external" href="http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2011/n3272.htm">N3272</a>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">cxx_func_identifier</span></code></dt>
<dd>Predefined <code class="docutils literal notranslate"><span class="pre">__func__</span></code> identifier, as defined in <a class="reference external" href="http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2007/n2340.htm">N2340</a>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">cxx_generalized_initializers</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_generic_lambdas</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_inheriting_constructors</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_inline_namespaces</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_lambdas</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_lambda_init_captures</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_local_type_template_args</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_long_long_type</span></code></dt>
<dd><code class="docutils literal notranslate"><span class="pre">long</span> <span class="pre">long</span></code> type, as defined in <a class="reference external" href="http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2005/n1811.pdf">N1811</a>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">cxx_noexcept</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_nonstatic_member_init</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_nullptr</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_override</span></code></dt>
<dd>Override control <code class="docutils literal notranslate"><span class="pre">override</span></code> keyword, as defined in <a class="reference external" href="http://www.open-std.org/JTC1/SC22/WG21/docs/papers/2009/n2928.htm">N2928</a>, <a class="reference external" href="http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2010/n3206.htm">N3206</a>
and <a class="reference external" href="http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2011/n3272.htm">N3272</a>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">cxx_range_for</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_raw_string_literals</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_reference_qualified_functions</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_relaxed_constexpr</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_return_type_deduction</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_right_angle_brackets</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_rvalue_references</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_sizeof_member</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_static_assert</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_strong_enums</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_thread_local</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_trailing_return_types</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_unicode_literals</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_uniform_initialization</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_unrestricted_unions</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_user_literals</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_variable_templates</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_variadic_macros</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_variadic_templates</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">cxx_template_template_parameters</span></code></dt>
<dd>Template template parameters, as defined in <code class="docutils literal notranslate"><span class="pre">ISO/IEC</span> <span class="pre">14882:1998</span></code>.</dd>
</dl>
</div>
