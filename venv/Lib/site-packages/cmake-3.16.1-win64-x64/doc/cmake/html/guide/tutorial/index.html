...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMake Tutorial &mdash; CMake 3.16.1 Documentation</title>
...
<ul class="simple">
<li><a class="reference internal" href="#cmake-tutorial" id="id1">CMake Tutorial</a><ul>
<li><a class="reference internal" href="#a-basic-starting-point-step-1" id="id2">A Basic Starting Point (Step 1)</a><ul>
<li><a class="reference internal" href="#adding-a-version-number-and-configured-header-file" id="id3">Adding a Version Number and Configured Header File</a></li>
<li><a class="reference internal" href="#specify-the-c-standard" id="id4">Specify the C++ Standard</a></li>
<li><a class="reference internal" href="#build-and-test" id="id5">Build and Test</a></li>
</ul>
</li>
<li><a class="reference internal" href="#adding-a-library-step-2" id="id6">Adding a Library (Step 2)</a></li>
<li><a class="reference internal" href="#adding-usage-requirements-for-library-step-3" id="id7">Adding Usage Requirements for Library (Step 3)</a></li>
<li><a class="reference internal" href="#installing-and-testing-step-4" id="id8">Installing and Testing (Step 4)</a><ul>
<li><a class="reference internal" href="#install-rules" id="id9">Install Rules</a></li>
<li><a class="reference internal" href="#testing-support" id="id10">Testing Support</a></li>
</ul>
</li>
<li><a class="reference internal" href="#adding-system-introspection-step-5" id="id11">Adding System Introspection (Step 5)</a><ul>
<li><a class="reference internal" href="#specify-compile-definition" id="id12">Specify Compile Definition</a></li>
</ul>
</li>
<li><a class="reference internal" href="#adding-a-custom-command-and-generated-file-step-6" id="id13">Adding a Custom Command and Generated File (Step 6)</a></li>
<li><a class="reference internal" href="#building-an-installer-step-7" id="id14">Building an Installer (Step 7)</a></li>
<li><a class="reference internal" href="#adding-support-for-a-dashboard-step-8" id="id15">Adding Support for a Dashboard (Step 8)</a></li>
<li><a class="reference internal" href="#mixing-static-and-shared-step-9" id="id16">Mixing Static and Shared (Step 9)</a></li>
<li><a class="reference internal" href="#adding-generator-expressions-step-10" id="id17">Adding Generator Expressions (Step 10)</a></li>
<li><a class="reference internal" href="#adding-export-configuration-step-11" id="id18">Adding Export Configuration (Step 11)</a></li>
<li><a class="reference internal" href="#import-a-cmake-project-consumer" id="id19">Import a CMake Project (Consumer)</a></li>
<li><a class="reference internal" href="#packaging-debug-and-release-multipackage" id="id20">Packaging Debug and Release (MultiPackage)</a></li>
</ul>
</li>
</ul>
</div>
...
<blockquote>
<div><ul class="simple">
<li><code class="docutils literal notranslate"><span class="pre">target_compile_definitions</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">target_compile_options</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">target_include_directories</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">target_link_libraries</span></code></li>
</ul>
</div></blockquote>
...
<li>Always include <code class="docutils literal notranslate"><span class="pre">MathFunctions.h</span></code></li>
<li>Always use <code class="docutils literal notranslate"><span class="pre">mathfunctions::sqrt</span></code></li>
