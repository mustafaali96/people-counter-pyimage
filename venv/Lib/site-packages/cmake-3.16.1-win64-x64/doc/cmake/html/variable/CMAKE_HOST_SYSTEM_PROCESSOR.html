...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMAKE_HOST_SYSTEM_PROCESSOR &mdash; CMake 3.16.1 Documentation</title>
...
<p>On systems that support <code class="docutils literal notranslate"><span class="pre">uname</span></code>, this variable is set to the output of
<code class="docutils literal notranslate"><span class="pre">uname</span> <span class="pre">-p</span></code>.  On Windows it is set to the value of the environment variable
