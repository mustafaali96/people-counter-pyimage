...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMAKE_FIND_PACKAGE_SORT_ORDER &mdash; CMake 3.16.1 Documentation</title>
...
<dt><code class="docutils literal notranslate"><span class="pre">NATURAL</span></code></dt>
<dd>Sort packages using natural order (see <code class="docutils literal notranslate"><span class="pre">strverscmp(3)</span></code> manual),
