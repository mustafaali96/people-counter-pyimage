...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMAKE_FIND_PACKAGE_SORT_DIRECTION &mdash; CMake 3.16.1 Documentation</title>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">DEC</span></code></dt>
<dd>Default.  Ordering is done in descending mode.
The highest folder found will be tested first.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">ASC</span></code></dt>
