...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMAKE_MSVC_RUNTIME_LIBRARY &mdash; CMake 3.16.1 Documentation</title>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">MultiThreaded</span></code></dt>
<dd>Compile with <code class="docutils literal notranslate"><span class="pre">-MT</span></code> or equivalent flag(s) to use a multi-threaded
statically-linked runtime library.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">MultiThreadedDLL</span></code></dt>
<dd>Compile with <code class="docutils literal notranslate"><span class="pre">-MD</span></code> or equivalent flag(s) to use a multi-threaded
dynamically-linked runtime library.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">MultiThreadedDebug</span></code></dt>
<dd>Compile with <code class="docutils literal notranslate"><span class="pre">-MTd</span></code> or equivalent flag(s) to use a multi-threaded
statically-linked runtime library.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">MultiThreadedDebugDLL</span></code></dt>
<dd>Compile with <code class="docutils literal notranslate"><span class="pre">-MDd</span></code> or equivalent flag(s) to use a multi-threaded
dynamically-linked runtime library.</dd>
</dl>
...
<p class="last">This variable has effect only when policy <span class="target" id="index-0-policy:CMP0091"></span><a class="reference internal" href="../policy/CMP0091.html#policy:CMP0091" title="CMP0091"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0091</span></code></a> is set to <code class="docutils literal notranslate"><span class="pre">NEW</span></code>
