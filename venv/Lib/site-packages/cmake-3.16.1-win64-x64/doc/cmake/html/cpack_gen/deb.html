...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CPack DEB Generator &mdash; CMake 3.16.1 Documentation</title>
...
<blockquote>
<div><ul class="simple">
<li><a class="reference external" href="https://gitlab.kitware.com/cmake/community/wikis/doc/cpack/Configuration">https://gitlab.kitware.com/cmake/community/wikis/doc/cpack/Configuration</a></li>
<li><a class="reference external" href="https://gitlab.kitware.com/cmake/community/wikis/doc/cpack/PackageGenerators#deb-unix-only">https://gitlab.kitware.com/cmake/community/wikis/doc/cpack/PackageGenerators#deb-unix-only</a></li>
</ul>
</div></blockquote>
...
<li>Mandatory : YES</li>
<li>Default   :<ul>
<li><span class="target" id="index-0-variable:CPACK_PACKAGE_NAME"></span><a class="reference internal" href="../module/CPack.html#variable:CPACK_PACKAGE_NAME" title="CPACK_PACKAGE_NAME"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_PACKAGE_NAME</span></code></a> for non-component based
installations</li>
...
<ul class="simple">
<li>Mandatory : YES</li>
<li>Default   : <code class="docutils literal notranslate"><span class="pre">&lt;CPACK_PACKAGE_FILE_NAME&gt;[-&lt;component&gt;].deb</span></code></li>
</ul>
...
<p class="last">Preferred setting of this variable is <code class="docutils literal notranslate"><span class="pre">DEB-DEFAULT</span></code> but for backward
...
<code class="descname">CPACK_DEBIAN_PACKAGE_EPOCH</code><a class="headerlink" href="#variable:CPACK_DEBIAN_PACKAGE_EPOCH" title="Permalink to this definition">¶</a></dt>
<dd><p>The Debian package epoch</p>
<ul class="simple">
<li>Mandatory : No</li>
<li>Default   : -</li>
</ul>
...
<div class="admonition note">
<p class="first admonition-title">Note</p>
<p class="last">For backward compatibility with CMake 3.9 and lower a failed test of this
...
<ul class="simple">
<li>Mandatory : YES</li>
<li>Default   : Output of <code class="docutils literal notranslate"><span class="pre">dpkg</span> <span class="pre">--print-architecture</span></code> (or <code class="docutils literal notranslate"><span class="pre">i386</span></code>
if <code class="docutils literal notranslate"><span class="pre">dpkg</span></code> is not found)</li>
</ul>
</dd></dl>
...
<ul class="simple">
<li>Mandatory : YES</li>
<li>Default   : <code class="docutils literal notranslate"><span class="pre">CPACK_PACKAGE_CONTACT</span></code></li>
</ul>
</dd></dl>
...
<code class="descname">CPACK_DEBIAN_&lt;COMPONENT&gt;_DESCRIPTION</code><a class="headerlink" href="#variable:CPACK_DEBIAN_<COMPONENT>_DESCRIPTION" title="Permalink to this definition">¶</a></dt>
<dd><p>The Debian package description</p>
<ul class="simple">
<li>Mandatory : YES</li>
<li>Default   :<ul>
<li><span class="target" id="index-0-variable:CPACK_DEBIAN_&lt;COMPONENT&gt;_DESCRIPTION"></span><a class="reference internal" href="#variable:CPACK_DEBIAN_&lt;COMPONENT&gt;_DESCRIPTION" title="CPACK_DEBIAN_&lt;COMPONENT&gt;_DESCRIPTION"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_DEBIAN_&lt;COMPONENT&gt;_DESCRIPTION</span></code></a> (component
based installers only) if set, or <span class="target" id="index-0-variable:CPACK_DEBIAN_PACKAGE_DESCRIPTION"></span><a class="reference internal" href="#variable:CPACK_DEBIAN_PACKAGE_DESCRIPTION" title="CPACK_DEBIAN_PACKAGE_DESCRIPTION"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_DEBIAN_PACKAGE_DESCRIPTION</span></code></a> if set, or</li>
...
based installers only) if set, or <span class="target" id="index-0-variable:CPACK_PACKAGE_DESCRIPTION"></span><a class="reference internal" href="../module/CPack.html#variable:CPACK_PACKAGE_DESCRIPTION" title="CPACK_PACKAGE_DESCRIPTION"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_PACKAGE_DESCRIPTION</span></code></a> if set, or</li>
<li>content of the file specified in <span class="target" id="index-0-variable:CPACK_PACKAGE_DESCRIPTION_FILE"></span><a class="reference internal" href="../module/CPack.html#variable:CPACK_PACKAGE_DESCRIPTION_FILE" title="CPACK_PACKAGE_DESCRIPTION_FILE"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_PACKAGE_DESCRIPTION_FILE</span></code></a> if set</li>
</ul>
</li>
</ul>
...
<div class="admonition note">
<p class="first admonition-title">Note</p>
<p class="last">This variable previously defaulted to the <code class="docutils literal notranslate"><span class="pre">paxr</span></code> value, but <code class="docutils literal notranslate"><span class="pre">dpkg</span></code>
...
<ul class="simple">
<li>Mandatory : NO</li>
<li>Default   : <span class="target" id="index-0-variable:CMAKE_PROJECT_HOMEPAGE_URL"></span><a class="reference internal" href="../variable/CMAKE_PROJECT_HOMEPAGE_URL.html#variable:CMAKE_PROJECT_HOMEPAGE_URL" title="CMAKE_PROJECT_HOMEPAGE_URL"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_PROJECT_HOMEPAGE_URL</span></code></a></li>
</ul>
<div class="admonition note">
<p class="first admonition-title">Note</p>
...
<dd><p>Sets the <code class="docutils literal notranslate"><span class="pre">Source</span></code> field of the binary Debian package.
...
<code class="descname">CPACK_DEBIAN_DEBUGINFO_PACKAGE</code><a class="headerlink" href="#variable:CPACK_DEBIAN_DEBUGINFO_PACKAGE" title="Permalink to this definition">¶</a></dt>
<dt id="variable:CPACK_DEBIAN_&lt;component&gt;_DEBUGINFO_PACKAGE">
<code class="descname">CPACK_DEBIAN_&lt;component&gt;_DEBUGINFO_PACKAGE</code><a class="headerlink" href="#variable:CPACK_DEBIAN_<component>_DEBUGINFO_PACKAGE" title="Permalink to this definition">¶</a></dt>
...
<div class="admonition note">
<p class="first admonition-title">Note</p>
<p class="last">Binaries must contain debug symbols before packaging so use either <code class="docutils literal notranslate"><span class="pre">Debug</span></code>
