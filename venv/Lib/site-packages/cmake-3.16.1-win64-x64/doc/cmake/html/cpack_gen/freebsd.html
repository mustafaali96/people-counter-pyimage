...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CPack FreeBSD Generator &mdash; CMake 3.16.1 Documentation</title>
...
<code class="descname">CPACK_FREEBSD_PACKAGE_NAME</code><a class="headerlink" href="#variable:CPACK_FREEBSD_PACKAGE_NAME" title="Permalink to this definition">¶</a></dt>
...
based on CMAKE_PROJECT_NAME).</li>
</ul>
</li>
</ul>
</dd></dl>
...
<code class="descname">CPACK_FREEBSD_PACKAGE_COMMENT</code><a class="headerlink" href="#variable:CPACK_FREEBSD_PACKAGE_COMMENT" title="Permalink to this definition">¶</a></dt>
<dd><p>Sets the package comment. This is the short description displayed by
pkg(8) in standard “pkg info” output.</p>
<ul class="simple">
<li>Mandatory: YES</li>
<li>Default:<ul>
<li><span class="target" id="index-0-variable:CPACK_PACKAGE_DESCRIPTION_SUMMARY"></span><a class="reference internal" href="../module/CPack.html#variable:CPACK_PACKAGE_DESCRIPTION_SUMMARY" title="CPACK_PACKAGE_DESCRIPTION_SUMMARY"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_PACKAGE_DESCRIPTION_SUMMARY</span></code></a> (this is always set
by CPack itself, if nothing else sets it explicitly).</li>
...
parameter for <span class="target" id="index-0-command:project"></span><a class="reference internal" href="../command/project.html#command:project" title="project"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">project()</span></code></a>).</li>
</ul>
</li>
</ul>
</dd></dl>
...
<code class="descname">CPACK_FREEBSD_PACKAGE_DESCRIPTION</code><a class="headerlink" href="#variable:CPACK_FREEBSD_PACKAGE_DESCRIPTION" title="Permalink to this definition">¶</a></dt>
...
for Debian packaging, so we may as well re-use it).</li>
</ul>
</li>
</ul>
</dd></dl>
...
<code class="descname">CPACK_FREEBSD_PACKAGE_WWW</code><a class="headerlink" href="#variable:CPACK_FREEBSD_PACKAGE_WWW" title="Permalink to this definition">¶</a></dt>
...
<blockquote>
<div><ul class="simple">
<li><span class="target" id="index-0-variable:CMAKE_PROJECT_HOMEPAGE_URL"></span><a class="reference internal" href="../variable/CMAKE_PROJECT_HOMEPAGE_URL.html#variable:CMAKE_PROJECT_HOMEPAGE_URL" title="CMAKE_PROJECT_HOMEPAGE_URL"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_PROJECT_HOMEPAGE_URL</span></code></a>, or if that is not set,
...
<code class="descname">CPACK_FREEBSD_PACKAGE_LICENSE</code><a class="headerlink" href="#variable:CPACK_FREEBSD_PACKAGE_LICENSE" title="Permalink to this definition">¶</a></dt>
...
<li>Mandatory: YES</li>
<li>Default:<ul>
<li><span class="target" id="index-0-variable:CPACK_RPM_PACKAGE_LICENSE"></span><a class="reference internal" href="rpm.html#variable:CPACK_RPM_PACKAGE_LICENSE" title="CPACK_RPM_PACKAGE_LICENSE"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_RPM_PACKAGE_LICENSE</span></code></a></li>
</ul>
</li>
</ul>
</dd></dl>
...
<code class="descname">CPACK_FREEBSD_PACKAGE_LICENSE_LOGIC</code><a class="headerlink" href="#variable:CPACK_FREEBSD_PACKAGE_LICENSE_LOGIC" title="Permalink to this definition">¶</a></dt>
...
<ul class="simple">
<li>Mandatory: NO</li>
<li>Default: single</li>
</ul>
</dd></dl>

<dl class="variable">
<dt id="variable:CPACK_FREEBSD_PACKAGE_MAINTAINER">
<code class="descname">CPACK_FREEBSD_PACKAGE_MAINTAINER</code><a class="headerlink" href="#variable:CPACK_FREEBSD_PACKAGE_MAINTAINER" title="Permalink to this definition">¶</a></dt>
...
<code class="descname">CPACK_FREEBSD_PACKAGE_ORIGIN</code><a class="headerlink" href="#variable:CPACK_FREEBSD_PACKAGE_ORIGIN" title="Permalink to this definition">¶</a></dt>
...
<ul class="simple">
<li>Mandatory: YES</li>
<li>Default: misc/&lt;package name&gt;</li>
</ul>
</dd></dl>

<dl class="variable">
<dt id="variable:CPACK_FREEBSD_PACKAGE_CATEGORIES">
<code class="descname">CPACK_FREEBSD_PACKAGE_CATEGORIES</code><a class="headerlink" href="#variable:CPACK_FREEBSD_PACKAGE_CATEGORIES" title="Permalink to this definition">¶</a></dt>
...
<ul class="simple">
<li>Mandatory: YES</li>
<li>Default: derived from ORIGIN</li>
</ul>
</dd></dl>

<dl class="variable">
<dt id="variable:CPACK_FREEBSD_PACKAGE_DEPS">
<code class="descname">CPACK_FREEBSD_PACKAGE_DEPS</code><a class="headerlink" href="#variable:CPACK_FREEBSD_PACKAGE_DEPS" title="Permalink to this definition">¶</a></dt>
