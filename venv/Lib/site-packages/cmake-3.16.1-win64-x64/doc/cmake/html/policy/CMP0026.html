...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMP0026 &mdash; CMake 3.16.1 Documentation</title>
...
generate-time.  At generate time, the <code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_FILE&gt;</span></code> generator
...
use the <code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_FILE&gt;</span></code> generator expression together with the
...
3.16.1 warns when the policy is not set and uses <code class="docutils literal notranslate"><span class="pre">OLD</span></code> behavior.  Use
