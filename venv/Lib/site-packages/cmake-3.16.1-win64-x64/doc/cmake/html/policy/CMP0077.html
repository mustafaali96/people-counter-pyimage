...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMP0077 &mdash; CMake 3.16.1 Documentation</title>
...
<ul class="simple">
<li>a cache entry of the specified name does not exist at all, or</li>
<li>a cache entry of the specified name exists but has not been given
a type (e.g. via <code class="docutils literal notranslate"><span class="pre">-D&lt;name&gt;=ON</span></code> on the command line).</li>
</ul>
...
name:</p>
<ul class="simple">
<li>The <code class="docutils literal notranslate"><span class="pre">OLD</span></code> behavior for this policy is to proceed even when a normal
...
normal variable is removed.</li>
<li>The <code class="docutils literal notranslate"><span class="pre">NEW</span></code> behavior for this policy is to do nothing when a normal
variable of the same name exists.  The normal variable is not removed.
The cache entry is not created or updated and is ignored if it exists.</li>
</ul>
