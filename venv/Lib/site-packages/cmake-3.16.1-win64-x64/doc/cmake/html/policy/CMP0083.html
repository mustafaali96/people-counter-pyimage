...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>CMP0083 &mdash; CMake 3.16.1 Documentation</title>
...
is set:</p>
<ul class="simple">
<li>Set to <code class="docutils literal notranslate"><span class="pre">TRUE</span></code>: flags to produce a position independent executable are
passed to the linker step. For example <code class="docutils literal notranslate"><span class="pre">-pie</span></code> for <code class="docutils literal notranslate"><span class="pre">GCC</span></code>.</li>
<li>Set to <code class="docutils literal notranslate"><span class="pre">FALSE</span></code>: flags not to produce a position independent executable are
passed to the linker step. For example <code class="docutils literal notranslate"><span class="pre">-no-pie</span></code> for <code class="docutils literal notranslate"><span class="pre">GCC</span></code>.</li>
<li>Not set: no flags are passed to the linker step.</li>
</ul>
...
Unlike most policies, CMake version 3.16.1 does not warn when this policy is
not set and simply uses <code class="docutils literal notranslate"><span class="pre">OLD</span></code> behavior.</p>
<div class="admonition note">
<p class="first admonition-title">Note</p>
<p class="last">Android platform has a special handling of <code class="docutils literal notranslate"><span class="pre">PIE</span></code> so it is not required
