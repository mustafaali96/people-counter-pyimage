...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>target_precompile_headers &mdash; CMake 3.16.1 Documentation</title>
...
only one language (e.g. <code class="docutils literal notranslate"><span class="pre">CXX</span></code> and not <code class="docutils literal notranslate"><span class="pre">C</span></code>).  For example:</p>
...
<span class="w">    </span><span class="s">&quot;$&lt;$&lt;COMPILE_LANGUAGE:CXX&gt;:cxx_only.h&gt;&quot;</span><span class="w"></span>
...
<p>When specifying angle brackets inside a <span class="target" id="index-1-manual:cmake-generator-expressions(7)"></span><a class="reference internal" href="../manual/cmake-generator-expressions.7.html#manual:cmake-generator-expressions(7)" title="cmake-generator-expressions(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">generator</span> <span class="pre">expression</span></code></a>, be sure to encode the closing <code class="docutils literal notranslate"><span class="pre">&gt;</span></code>
as <code class="docutils literal notranslate"><span class="pre">$&lt;ANGLE-R&gt;</span></code>.  For example:</p>
...
<p class="last">The <code class="docutils literal notranslate"><span class="pre">REUSE_FROM</span></code> form requires the same set of compiler options,
