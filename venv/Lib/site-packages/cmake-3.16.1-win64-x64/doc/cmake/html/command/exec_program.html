...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>exec_program &mdash; CMake 3.16.1 Documentation</title>
...
<p><span class="versionmodified">Deprecated since version 3.0: </span>Use the <span class="target" id="index-0-command:execute_process"></span><a class="reference internal" href="execute_process.html#command:execute_process" title="execute_process"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">execute_process()</span></code></a> command instead.</p>
</div>
