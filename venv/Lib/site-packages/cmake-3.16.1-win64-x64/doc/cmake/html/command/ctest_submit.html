...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>ctest_submit &mdash; CMake 3.16.1 Documentation</title>
...
<dt><code class="docutils literal notranslate"><span class="pre">SUBMIT_URL</span> <span class="pre">&lt;url&gt;</span></code></dt>
<dd>The <code class="docutils literal notranslate"><span class="pre">http</span></code> or <code class="docutils literal notranslate"><span class="pre">https</span></code> URL of the dashboard server to send the submission
to.  If not given, the <span class="target" id="index-0-variable:CTEST_SUBMIT_URL"></span><a class="reference internal" href="../variable/CTEST_SUBMIT_URL.html#variable:CTEST_SUBMIT_URL" title="CTEST_SUBMIT_URL"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CTEST_SUBMIT_URL</span></code></a> variable is used.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">BUILD_ID</span> <span class="pre">&lt;result-var&gt;</span></code></dt>
<dd>Store in the <code class="docutils literal notranslate"><span class="pre">&lt;result-var&gt;</span></code> variable the ID assigned to this build by
CDash.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">HTTPHEADER</span> <span class="pre">&lt;HTTP-header&gt;</span></code></dt>
<dd><p class="first">Specify HTTP header to be included in the request to CDash during submission.
...
<p class="last">This suboption can be repeated several times for multiple headers.</p>
</dd>
...
<p>This signature accepts the <code class="docutils literal notranslate"><span class="pre">SUBMIT_URL</span></code>, <code class="docutils literal notranslate"><span class="pre">BUILD_ID</span></code>, <code class="docutils literal notranslate"><span class="pre">HTTPHEADER</span></code>,
<code class="docutils literal notranslate"><span class="pre">RETRY_COUNT</span></code>, <code class="docutils literal notranslate"><span class="pre">RETRY_DELAY</span></code>, <code class="docutils literal notranslate"><span class="pre">RETURN_VALUE</span></code> and <code class="docutils literal notranslate"><span class="pre">QUIET</span></code> options
