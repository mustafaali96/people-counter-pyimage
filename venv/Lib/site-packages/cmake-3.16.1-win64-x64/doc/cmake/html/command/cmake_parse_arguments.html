...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>cmake_parse_arguments &mdash; CMake 3.16.1 Documentation</title>
...
the <code class="docutils literal notranslate"><span class="pre">&lt;N&gt;</span></code>-th argument, where <code class="docutils literal notranslate"><span class="pre">&lt;N&gt;</span></code> is an unsigned integer.  This allows for
the values to have special characters like <code class="docutils literal notranslate"><span class="pre">;</span></code> in them.</p>
...
<p><code class="docutils literal notranslate"><span class="pre">&lt;one_value_keywords&gt;</span></code> and <code class="docutils literal notranslate"><span class="pre">&lt;multi_value_keywords&gt;</span></code> that were given no
values at all are collected in a variable <code class="docutils literal notranslate"><span class="pre">&lt;prefix&gt;_KEYWORDS_MISSING_VALUES</span></code>
that will be undefined if all keywords received values. This can be checked
to see if there were keywords without any values given.</p>
