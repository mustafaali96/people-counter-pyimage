...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>set &mdash; CMake 3.16.1 Documentation</title>
...
<dd>Boolean <code class="docutils literal notranslate"><span class="pre">ON/OFF</span></code> value.  <span class="target" id="index-0-manual:cmake-gui(1)"></span><a class="reference internal" href="../manual/cmake-gui.1.html#manual:cmake-gui(1)" title="cmake-gui(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake-gui(1)</span></code></a> offers a checkbox.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">FILEPATH</span></code></dt>
<dd>Path to a file on disk.  <span class="target" id="index-1-manual:cmake-gui(1)"></span><a class="reference internal" href="../manual/cmake-gui.1.html#manual:cmake-gui(1)" title="cmake-gui(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake-gui(1)</span></code></a> offers a file dialog.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">PATH</span></code></dt>
<dd>Path to a directory on disk.  <span class="target" id="index-2-manual:cmake-gui(1)"></span><a class="reference internal" href="../manual/cmake-gui.1.html#manual:cmake-gui(1)" title="cmake-gui(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake-gui(1)</span></code></a> offers a file dialog.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">STRING</span></code></dt>
<dd>A line of text.  <span class="target" id="index-3-manual:cmake-gui(1)"></span><a class="reference internal" href="../manual/cmake-gui.1.html#manual:cmake-gui(1)" title="cmake-gui(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake-gui(1)</span></code></a> offers a text field or a
...
<dd>A line of text.  <span class="target" id="index-4-manual:cmake-gui(1)"></span><a class="reference internal" href="../manual/cmake-gui.1.html#manual:cmake-gui(1)" title="cmake-gui(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake-gui(1)</span></code></a> does not show internal entries.
They may be used to store variables persistently across runs.
Use of this type implies <code class="docutils literal notranslate"><span class="pre">FORCE</span></code>.</dd>
</dl>
