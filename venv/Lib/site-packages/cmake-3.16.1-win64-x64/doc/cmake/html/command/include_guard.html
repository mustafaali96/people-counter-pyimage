...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>include_guard &mdash; CMake 3.16.1 Documentation</title>
...
<dd>The include guard applies within the current directory and below. The file
...
<span class="target" id="index-0-command:include"></span><a class="reference internal" href="include.html#command:include" title="include"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">include()</span></code></a> from the current file or its children).</dd>
<dt><code class="docutils literal notranslate"><span class="pre">GLOBAL</span></code></dt>
<dd>The include guard applies globally to the whole build. The current file
will only be included once regardless of the scope.</dd>
</dl>
