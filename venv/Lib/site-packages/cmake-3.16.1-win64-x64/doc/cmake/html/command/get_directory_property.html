...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>get_directory_property &mdash; CMake 3.16.1 Documentation</title>
...
<p>Stores a property of directory scope in the named <code class="docutils literal notranslate"><span class="pre">&lt;variable&gt;</span></code>.
The <code class="docutils literal notranslate"><span class="pre">DIRECTORY</span></code> argument specifies another directory from which
to retrieve the property value instead of the current directory.
The specified directory must have already been traversed by CMake.</p>
