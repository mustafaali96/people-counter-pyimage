...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>set_property &mdash; CMake 3.16.1 Documentation</title>
...
<span class="w">              </span><span class="no">SOURCE</span><span class="w">    </span><span class="p">[</span><span class="nv">&lt;src1&gt;</span><span class="w"> </span><span class="p">...]</span><span class="w">      </span><span class="p">|</span><span class="w"></span>
...
<span class="w">             </span><span class="no">PROPERTY</span><span class="w"> </span><span class="nv">&lt;name&gt;</span><span class="w"> </span><span class="p">[</span><span class="nb">value1</span><span class="w"> </span><span class="p">...]</span><span class="nf">)</span><span class="w"></span>
</pre></div>
</div>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">GLOBAL</span></code></dt>
...
directory (<code class="docutils literal notranslate"><span class="pre">CMakeLists.txt</span></code>).
See also the <span class="target" id="index-0-command:set_source_files_properties"></span><a class="reference internal" href="set_source_files_properties.html#command:set_source_files_properties" title="set_source_files_properties"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">set_source_files_properties()</span></code></a> command.</dd>
...
property value.  If the <code class="docutils literal notranslate"><span class="pre">APPEND_STRING</span></code> option is given the string is
