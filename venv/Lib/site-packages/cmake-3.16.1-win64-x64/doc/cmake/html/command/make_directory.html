...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>make_directory &mdash; CMake 3.16.1 Documentation</title>
...
<p><span class="versionmodified">Deprecated since version 3.0: </span>Use the <span class="target" id="index-0-command:file"></span><a class="reference internal" href="file.html#command:file" title="file"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">file(MAKE_DIRECTORY)</span></code></a> command instead.</p>
</div>
