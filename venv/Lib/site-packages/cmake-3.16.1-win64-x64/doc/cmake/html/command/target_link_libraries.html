...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>target_link_libraries &mdash; CMake 3.16.1 Documentation</title>
...
<li><a class="reference internal" href="#linking-object-libraries" id="id7">Linking Object Libraries</a></li>
<li><a class="reference internal" href="#cyclic-dependencies-of-static-libraries" id="id8">Cyclic Dependencies of Static Libraries</a></li>
<li><a class="reference internal" href="#creating-relocatable-packages" id="id9">Creating Relocatable Packages</a></li>
</ul>
</li>
</ul>
</div>
...
<li><p class="first"><strong>A link flag</strong>: Item names starting with <code class="docutils literal notranslate"><span class="pre">-</span></code>, but not <code class="docutils literal notranslate"><span class="pre">-l</span></code> or
...
<li><p class="first">A <code class="docutils literal notranslate"><span class="pre">debug</span></code>, <code class="docutils literal notranslate"><span class="pre">optimized</span></code>, or <code class="docutils literal notranslate"><span class="pre">general</span></code> keyword immediately followed
...
have no special meaning when produced by a generator expression.</p>
</li>
</ul>
