...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>ctest_coverage &mdash; CMake 3.16.1 Documentation</title>
...
<dd>Mark <code class="docutils literal notranslate"><span class="pre">Coverage.xml</span></code> for append to results previously submitted to a
...
<dt><code class="docutils literal notranslate"><span class="pre">LABELS</span></code></dt>
...
<dd>Store in the <code class="docutils literal notranslate"><span class="pre">&lt;result-var&gt;</span></code> variable <code class="docutils literal notranslate"><span class="pre">0</span></code> if coverage tools
