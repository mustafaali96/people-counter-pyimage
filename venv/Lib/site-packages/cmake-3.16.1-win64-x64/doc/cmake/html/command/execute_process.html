...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>execute_process &mdash; CMake 3.16.1 Documentation</title>
...
<span class="w">                </span><span class="p">[</span><span class="no">ENCODING</span><span class="w"> </span><span class="nv">&lt;name&gt;</span><span class="p">]</span><span class="nf">)</span><span class="w"></span>
</pre></div>
</div>
...
<dd>After the specified number of seconds (fractions allowed), all unfinished
...
set to a string mentioning the “timeout”.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">RESULT_VARIABLE</span></code></dt>
<dd>The variable will be set to contain the result of last child process.
This will be an integer return code from the last child or a string
describing an error condition.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">RESULTS_VARIABLE</span> <span class="pre">&lt;variable&gt;</span></code></dt>
<dd>The variable will be set to contain the result of all processes as a
...
from the corresponding child or a string describing an error condition.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">OUTPUT_VARIABLE</span></code>, <code class="docutils literal notranslate"><span class="pre">ERROR_VARIABLE</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">INPUT_FILE,</span> <span class="pre">OUTPUT_FILE</span></code>, <code class="docutils literal notranslate"><span class="pre">ERROR_FILE</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">OUTPUT_QUIET</span></code>, <code class="docutils literal notranslate"><span class="pre">ERROR_QUIET</span></code></dt>
<dd>The standard output or standard error results will be quietly ignored.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">COMMAND_ECHO</span> <span class="pre">&lt;where&gt;</span></code></dt>
<dd>The command being run will be echo’ed to <code class="docutils literal notranslate"><span class="pre">&lt;where&gt;</span></code> with <code class="docutils literal notranslate"><span class="pre">&lt;where&gt;</span></code>
...
to control the default behavior when this option is not present.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">ENCODING</span> <span class="pre">&lt;name&gt;</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">ANSI</span></code></dt>
<dd>Use the ANSI codepage.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">OEM</span></code></dt>
<dd>Use the original equipment manufacturer (OEM) code page.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">UTF8</span></code> or <code class="docutils literal notranslate"><span class="pre">UTF-8</span></code></dt>
<dd>Use the UTF-8 codepage. Prior to CMake 3.11.0, only <code class="docutils literal notranslate"><span class="pre">UTF8</span></code> was accepted
for this encoding. In CMake 3.11.0, <code class="docutils literal notranslate"><span class="pre">UTF-8</span></code> was added for consistency with
the <a class="reference external" href="https://www.ietf.org/rfc/rfc3629">UTF-8 RFC</a> naming convention.</dd>
</dl>
</dd>
</dl>
