...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>install &mdash; CMake 3.16.1 Documentation</title>
...
<dd><p class="first">Specify a list of build configurations for which the install rule
...
<p class="last">Note that <code class="docutils literal notranslate"><span class="pre">CONFIGURATIONS</span></code> appears BEFORE <code class="docutils literal notranslate"><span class="pre">RUNTIME</span> <span class="pre">DESTINATION</span></code>.</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">COMPONENT</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">EXCLUDE_FROM_ALL</span></code></dt>
...
<p>Many of the <code class="docutils literal notranslate"><span class="pre">install()</span></code> variants implicitly create the directories
...
project.  There are several kinds of target files that may be installed:</p>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">ARCHIVE</span></code></dt>
<dd>Static libraries are treated as <code class="docutils literal notranslate"><span class="pre">ARCHIVE</span></code> targets, except those
marked with the <code class="docutils literal notranslate"><span class="pre">FRAMEWORK</span></code> property on macOS (see <code class="docutils literal notranslate"><span class="pre">FRAMEWORK</span></code>
below.) For DLL platforms (all Windows-based systems including
Cygwin), the DLL import library is treated as an <code class="docutils literal notranslate"><span class="pre">ARCHIVE</span></code> target.
On AIX, the linker import file created for executables with
<span class="target" id="index-0-prop_tgt:ENABLE_EXPORTS"></span><a class="reference internal" href="../prop_tgt/ENABLE_EXPORTS.html#prop_tgt:ENABLE_EXPORTS" title="ENABLE_EXPORTS"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">ENABLE_EXPORTS</span></code></a> is treated as an <code class="docutils literal notranslate"><span class="pre">ARCHIVE</span></code> target.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">LIBRARY</span></code></dt>
<dd>Module libraries are always treated as <code class="docutils literal notranslate"><span class="pre">LIBRARY</span></code> targets. For non-
DLL platforms shared libraries are treated as <code class="docutils literal notranslate"><span class="pre">LIBRARY</span></code> targets,
except those marked with the <code class="docutils literal notranslate"><span class="pre">FRAMEWORK</span></code> property on macOS (see
<code class="docutils literal notranslate"><span class="pre">FRAMEWORK</span></code> below.)</dd>
<dt><code class="docutils literal notranslate"><span class="pre">RUNTIME</span></code></dt>
<dd>Executables are treated as <code class="docutils literal notranslate"><span class="pre">RUNTIME</span></code> objects, except those marked
with the <code class="docutils literal notranslate"><span class="pre">MACOSX_BUNDLE</span></code> property on macOS (see <code class="docutils literal notranslate"><span class="pre">BUNDLE</span></code> below.)
For DLL platforms (all Windows-based systems including Cygwin), the
DLL part of a shared library is treated as a <code class="docutils literal notranslate"><span class="pre">RUNTIME</span></code> target.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">OBJECTS</span></code></dt>
<dd>Object libraries (a simple group of object files) are always treated
as <code class="docutils literal notranslate"><span class="pre">OBJECTS</span></code> targets.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">FRAMEWORK</span></code></dt>
<dd>Both static and shared libraries marked with the <code class="docutils literal notranslate"><span class="pre">FRAMEWORK</span></code>
property are treated as <code class="docutils literal notranslate"><span class="pre">FRAMEWORK</span></code> targets on macOS.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">BUNDLE</span></code></dt>
<dd>Executables marked with the <span class="target" id="index-0-prop_tgt:MACOSX_BUNDLE"></span><a class="reference internal" href="../prop_tgt/MACOSX_BUNDLE.html#prop_tgt:MACOSX_BUNDLE" title="MACOSX_BUNDLE"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">MACOSX_BUNDLE</span></code></a> property are treated as
<code class="docutils literal notranslate"><span class="pre">BUNDLE</span></code> targets on macOS.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">PUBLIC_HEADER</span></code></dt>
<dd>Any <span class="target" id="index-0-prop_tgt:PUBLIC_HEADER"></span><a class="reference internal" href="../prop_tgt/PUBLIC_HEADER.html#prop_tgt:PUBLIC_HEADER" title="PUBLIC_HEADER"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">PUBLIC_HEADER</span></code></a> files associated with a library are installed in
...
<span class="target" id="index-1-prop_tgt:PUBLIC_HEADER"></span><a class="reference internal" href="../prop_tgt/PUBLIC_HEADER.html#prop_tgt:PUBLIC_HEADER" title="PUBLIC_HEADER"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">PUBLIC_HEADER</span></code></a> for details.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">PRIVATE_HEADER</span></code></dt>
<dd>Similar to <code class="docutils literal notranslate"><span class="pre">PUBLIC_HEADER</span></code>, but for <code class="docutils literal notranslate"><span class="pre">PRIVATE_HEADER</span></code> files. See
<span class="target" id="index-0-prop_tgt:PRIVATE_HEADER"></span><a class="reference internal" href="../prop_tgt/PRIVATE_HEADER.html#prop_tgt:PRIVATE_HEADER" title="PRIVATE_HEADER"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">PRIVATE_HEADER</span></code></a> for details.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">RESOURCE</span></code></dt>
<dd>Similar to <code class="docutils literal notranslate"><span class="pre">PUBLIC_HEADER</span></code> and <code class="docutils literal notranslate"><span class="pre">PRIVATE_HEADER</span></code>, but for
<code class="docutils literal notranslate"><span class="pre">RESOURCE</span></code> files. See <span class="target" id="index-0-prop_tgt:RESOURCE"></span><a class="reference internal" href="../prop_tgt/RESOURCE.html#prop_tgt:RESOURCE" title="RESOURCE"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">RESOURCE</span></code></a> for details.</dd>
</dl>
...
<thead valign="bottom">
<tr class="row-odd"><th class="head">Target Type</th>
<th class="head">GNUInstallDirs Variable</th>
<th class="head">Built-In Default</th>
</tr>
</thead>
<tbody valign="top">
<tr class="row-even"><td><code class="docutils literal notranslate"><span class="pre">RUNTIME</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">${CMAKE_INSTALL_BINDIR}</span></code></td>
...
<td><code class="docutils literal notranslate"><span class="pre">${CMAKE_INSTALL_LIBDIR}</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">lib</span></code></td>
</tr>
<tr class="row-even"><td><code class="docutils literal notranslate"><span class="pre">ARCHIVE</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">${CMAKE_INSTALL_LIBDIR}</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">lib</span></code></td>
</tr>
<tr class="row-odd"><td><code class="docutils literal notranslate"><span class="pre">PRIVATE_HEADER</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">${CMAKE_INSTALL_INCLUDEDIR}</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">include</span></code></td>
</tr>
<tr class="row-even"><td><code class="docutils literal notranslate"><span class="pre">PUBLIC_HEADER</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">${CMAKE_INSTALL_INCLUDEDIR}</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">include</span></code></td>
</tr>
</tbody>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">NAMELINK_COMPONENT</span></code></dt>
<dd><p class="first">On some platforms a versioned shared library has a symbolic link such
as:</p>
...
<code class="docutils literal notranslate"><span class="pre">LIBRARY</span></code> block.</p>
<p class="last">When <code class="docutils literal notranslate"><span class="pre">NAMELINK_ONLY</span></code> is given, either <code class="docutils literal notranslate"><span class="pre">NAMELINK_COMPONENT</span></code> or
...
<dt><code class="docutils literal notranslate"><span class="pre">NAMELINK_SKIP</span></code></dt>
<dd><p class="first">Similar to <code class="docutils literal notranslate"><span class="pre">NAMELINK_ONLY</span></code>, but it has the opposite effect: it causes the
...
<code class="docutils literal notranslate"><span class="pre">LIBRARY</span></code> block.</p>
<p class="last">If <code class="docutils literal notranslate"><span class="pre">NAMELINK_SKIP</span></code> is specified, <code class="docutils literal notranslate"><span class="pre">NAMELINK_COMPONENT</span></code> has no effect. It
...
<dd>This option associates the installed target files with an export called
...
the name of the exported target.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">INCLUDES</span> <span class="pre">DESTINATION</span></code></dt>
<dd>This option specifies a list of directories which will be added to the
...
<code class="docutils literal notranslate"><span class="pre">$&lt;INSTALL_PREFIX&gt;</span></code>.</dd>
</dl>
...
<p><a class="reference internal" href="#install-targets">install(TARGETS)</a> can install targets that were created in
...
<p>An install destination given as a <code class="docutils literal notranslate"><span class="pre">DESTINATION</span></code> argument may
...
<thead valign="bottom">
<tr class="row-odd"><th class="head"><code class="docutils literal notranslate"><span class="pre">TYPE</span></code> Argument</th>
<th class="head">GNUInstallDirs Variable</th>
<th class="head">Built-In Default</th>
</tr>
</thead>
<tbody valign="top">
<tr class="row-even"><td><code class="docutils literal notranslate"><span class="pre">BIN</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">${CMAKE_INSTALL_BINDIR}</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">bin</span></code></td>
</tr>
<tr class="row-odd"><td><code class="docutils literal notranslate"><span class="pre">SBIN</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">${CMAKE_INSTALL_SBINDIR}</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">sbin</span></code></td>
</tr>
<tr class="row-even"><td><code class="docutils literal notranslate"><span class="pre">LIB</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">${CMAKE_INSTALL_LIBDIR}</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">lib</span></code></td>
</tr>
<tr class="row-odd"><td><code class="docutils literal notranslate"><span class="pre">INCLUDE</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">${CMAKE_INSTALL_INCLUDEDIR}</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">include</span></code></td>
</tr>
<tr class="row-even"><td><code class="docutils literal notranslate"><span class="pre">SYSCONF</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">${CMAKE_INSTALL_SYSCONFDIR}</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">etc</span></code></td>
</tr>
<tr class="row-odd"><td><code class="docutils literal notranslate"><span class="pre">SHAREDSTATE</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">${CMAKE_INSTALL_SHARESTATEDIR}</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">com</span></code></td>
</tr>
<tr class="row-even"><td><code class="docutils literal notranslate"><span class="pre">LOCALSTATE</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">${CMAKE_INSTALL_LOCALSTATEDIR}</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">var</span></code></td>
</tr>
<tr class="row-odd"><td><code class="docutils literal notranslate"><span class="pre">RUNSTATE</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">${CMAKE_INSTALL_RUNSTATEDIR}</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">&lt;LOCALSTATE</span> <span class="pre">dir&gt;/run</span></code></td>
</tr>
<tr class="row-even"><td><code class="docutils literal notranslate"><span class="pre">DATA</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">${CMAKE_INSTALL_DATADIR}</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">&lt;DATAROOT</span> <span class="pre">dir&gt;</span></code></td>
</tr>
<tr class="row-odd"><td><code class="docutils literal notranslate"><span class="pre">INFO</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">${CMAKE_INSTALL_INFODIR}</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">&lt;DATAROOT</span> <span class="pre">dir&gt;/info</span></code></td>
</tr>
<tr class="row-even"><td><code class="docutils literal notranslate"><span class="pre">LOCALE</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">${CMAKE_INSTALL_LOCALEDIR}</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">&lt;DATAROOT</span> <span class="pre">dir&gt;/locale</span></code></td>
</tr>
<tr class="row-odd"><td><code class="docutils literal notranslate"><span class="pre">MAN</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">${CMAKE_INSTALL_MANDIR}</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">&lt;DATAROOT</span> <span class="pre">dir&gt;/man</span></code></td>
</tr>
<tr class="row-even"><td><code class="docutils literal notranslate"><span class="pre">DOC</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">${CMAKE_INSTALL_DOCDIR}</span></code></td>
<td><code class="docutils literal notranslate"><span class="pre">&lt;DATAROOT</span> <span class="pre">dir&gt;/doc</span></code></td>
</tr>
</tbody>
</table>
<p>Projects wishing to follow the common practice of installing headers into a
...
<p>The <code class="docutils literal notranslate"><span class="pre">MESSAGE_NEVER</span></code> option disables file installation status output.</p>
...
<p>Some options may follow a <code class="docutils literal notranslate"><span class="pre">PATTERN</span></code> or <code class="docutils literal notranslate"><span class="pre">REGEX</span></code> expression and are applied
...
<p>The list of <code class="docutils literal notranslate"><span class="pre">dirs...</span></code> given to <code class="docutils literal notranslate"><span class="pre">DIRECTORY</span></code> and an install destination
given as a <code class="docutils literal notranslate"><span class="pre">DESTINATION</span></code> argument may use “generator expressions”
with the syntax <code class="docutils literal notranslate"><span class="pre">$&lt;...&gt;</span></code>.  See the <span class="target" id="index-3-manual:cmake-generator-expressions(7)"></span><a class="reference internal" href="../manual/cmake-generator-expressions.7.html#manual:cmake-generator-expressions(7)" title="cmake-generator-expressions(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake-generator-expressions(7)</span></code></a>
...
<p><code class="docutils literal notranslate"><span class="pre">&lt;file&gt;</span></code> or <code class="docutils literal notranslate"><span class="pre">&lt;code&gt;</span></code> may use “generator expressions” with the syntax
...
<p>In addition to cmake language files, the <code class="docutils literal notranslate"><span class="pre">EXPORT_ANDROID_MK</span></code> mode maybe
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">COMPONENT</span></code></dt>
<dd>Set this variable to install only a single CPack component as opposed to all
...
component, run <code class="docutils literal notranslate"><span class="pre">cmake</span> <span class="pre">-DCOMPONENT=Development</span> <span class="pre">-P</span> <span class="pre">cmake_install.cmake</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">BUILD_TYPE</span></code></dt>
<dd>Set this variable to change the build type if you are using a multi-config
...
<code class="docutils literal notranslate"><span class="pre">cmake</span> <span class="pre">-DBUILD_TYPE=Debug</span> <span class="pre">-P</span> <span class="pre">cmake_install.cmake</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">DESTDIR</span></code></dt>
<dd>This is an environment variable rather than a CMake variable. It allows you
