...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>string &mdash; CMake 3.16.1 Documentation</title>
...
<a class="reference internal" href="#regular-expressions">Regular Expressions</a>
...
<dd>Matches at beginning of input</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$</span></code></dt>
<dd>Matches at end of input</dd>
<dt><code class="docutils literal notranslate"><span class="pre">.</span></code></dt>
<dd>Matches any single character</dd>
<dt><code class="docutils literal notranslate"><span class="pre">\&lt;char&gt;</span></code></dt>
<dd>Matches the single character specified by <code class="docutils literal notranslate"><span class="pre">&lt;char&gt;</span></code>.  Use this to
...
character is unnecessary but allowed, e.g. <code class="docutils literal notranslate"><span class="pre">\a</span></code> matches <code class="docutils literal notranslate"><span class="pre">a</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">[</span> <span class="pre">]</span></code></dt>
<dd>Matches any character(s) inside the brackets</dd>
<dt><code class="docutils literal notranslate"><span class="pre">[^</span> <span class="pre">]</span></code></dt>
<dd>Matches any character(s) not inside the brackets</dd>
<dt><code class="docutils literal notranslate"><span class="pre">-</span></code></dt>
<dd>Inside brackets, specifies an inclusive range between
...
mathematical operators.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">*</span></code></dt>
<dd>Matches preceding pattern zero or more times</dd>
<dt><code class="docutils literal notranslate"><span class="pre">+</span></code></dt>
<dd>Matches preceding pattern one or more times</dd>
<dt><code class="docutils literal notranslate"><span class="pre">?</span></code></dt>
<dd>Matches preceding pattern zero or once only</dd>
<dt><code class="docutils literal notranslate"><span class="pre">|</span></code></dt>
<dd>Matches a pattern on either side of the <code class="docutils literal notranslate"><span class="pre">|</span></code></dd>
<dt><code class="docutils literal notranslate"><span class="pre">()</span></code></dt>
<dd>Saves a matched subexpression, which can be referenced
in the <code class="docutils literal notranslate"><span class="pre">REGEX</span> <span class="pre">REPLACE</span></code> operation. Additionally it is saved
by all regular expression-related commands, including
e.g. <span class="target" id="index-0-command:if"></span><a class="reference internal" href="if.html#command:if" title="if"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">if(MATCHES)</span></code></a>, in the variables
<span class="target" id="index-0-variable:CMAKE_MATCH_&lt;n&gt;"></span><a class="reference internal" href="../variable/CMAKE_MATCH_n.html#variable:CMAKE_MATCH_&lt;n&gt;" title="CMAKE_MATCH_&lt;n&gt;"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_MATCH_&lt;n&gt;</span></code></a> for <code class="docutils literal notranslate"><span class="pre">&lt;n&gt;</span></code> 0..9.</dd>
</dl>
...
<ul class="simple">
<li>The quoted argument <code class="docutils literal notranslate"><span class="pre">&quot;[</span> <span class="pre">\t\r\n]&quot;</span></code> specifies a regex that matches
any single whitespace character.</li>
<li>The quoted argument <code class="docutils literal notranslate"><span class="pre">&quot;[/\\]&quot;</span></code> specifies a regex that matches
a single forward slash <code class="docutils literal notranslate"><span class="pre">/</span></code> or backslash <code class="docutils literal notranslate"><span class="pre">\</span></code>.</li>
<li>The quoted argument <code class="docutils literal notranslate"><span class="pre">&quot;[A-Za-z0-9_]&quot;</span></code> specifies a regex that matches
any single “word” character in the C locale.</li>
<li>The quoted argument <code class="docutils literal notranslate"><span class="pre">&quot;\\(\\a\\+b\\)&quot;</span></code> specifies a regex that matches
...
having to escape the backslashes, e.g. <code class="docutils literal notranslate"><span class="pre">[[\(\a\+\b\)]]</span></code>.</li>
</ul>
</div>
</div>
...
will be returned.  If <code class="docutils literal notranslate"><span class="pre">&lt;string&gt;</span></code> is shorter than <code class="docutils literal notranslate"><span class="pre">&lt;length&gt;</span></code> then the
end of the string is used instead.</p>
...
<p class="last">CMake 3.1 and below reported an error if <code class="docutils literal notranslate"><span class="pre">&lt;length&gt;</span></code> pointed past
the end of <code class="docutils literal notranslate"><span class="pre">&lt;string&gt;</span></code>.</p>
</div>
...
<dd>US Secure Hash Algorithms, RFC 4634.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">SHA3_224</span></code></dt>
<dd>Keccak SHA-3.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">SHA3_256</span></code></dt>
<dd>Keccak SHA-3.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">SHA3_384</span></code></dt>
<dd>Keccak SHA-3.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">SHA3_512</span></code></dt>
<dd>Keccak SHA-3.</dd>
</dl>
</div>
...
<div class="admonition note">
<p class="first admonition-title">Note</p>
<p class="last">If the <code class="docutils literal notranslate"><span class="pre">SOURCE_DATE_EPOCH</span></code> environment variable is set,
