...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>cmake-generator-expressions(7) &mdash; CMake 3.16.1 Documentation</title>
...
<h1><a class="toc-backref" href="#id3">cmake-generator-expressions(7)</a><a class="headerlink" href="#cmake-generator-expressions-7" title="Permalink to this headline">¶</a></h1>
<div class="contents topic" id="contents">
<p class="topic-title first">Contents</p>
<ul class="simple">
<li><a class="reference internal" href="#cmake-generator-expressions-7" id="id3">cmake-generator-expressions(7)</a><ul>
<li><a class="reference internal" href="#introduction" id="id4">Introduction</a></li>
<li><a class="reference internal" href="#boolean-generator-expressions" id="id5">Boolean Generator Expressions</a><ul>
<li><a class="reference internal" href="#logical-operators" id="id6">Logical Operators</a></li>
<li><a class="reference internal" href="#string-comparisons" id="id7">String Comparisons</a></li>
<li><a class="reference internal" href="#variable-queries" id="id8">Variable Queries</a></li>
</ul>
</li>
<li><a class="reference internal" href="#string-valued-generator-expressions" id="id9">String-Valued Generator Expressions</a><ul>
<li><a class="reference internal" href="#escaped-characters" id="id10">Escaped Characters</a></li>
<li><a class="reference internal" href="#conditional-expressions" id="id11">Conditional Expressions</a></li>
<li><a class="reference internal" href="#string-transformations" id="id12">String Transformations</a></li>
<li><a class="reference internal" href="#id2" id="id13">Variable Queries</a></li>
<li><a class="reference internal" href="#target-dependent-queries" id="id14">Target-Dependent Queries</a></li>
<li><a class="reference internal" href="#output-related-expressions" id="id15">Output-Related Expressions</a></li>
</ul>
</li>
<li><a class="reference internal" href="#debugging" id="id16">Debugging</a></li>
</ul>
</li>
</ul>
</div>
...
<span id="id1"></span><h2><a class="toc-backref" href="#id5">Boolean Generator Expressions</a><a class="headerlink" href="#boolean-generator-expressions" title="Permalink to this headline">¶</a></h2>
...
<h3><a class="toc-backref" href="#id6">Logical Operators</a><a class="headerlink" href="#logical-operators" title="Permalink to this headline">¶</a></h3>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;BOOL:string&gt;</span></code></dt>
<dd><p class="first">Converts <code class="docutils literal notranslate"><span class="pre">string</span></code> to <code class="docutils literal notranslate"><span class="pre">0</span></code> or <code class="docutils literal notranslate"><span class="pre">1</span></code>. Evaluates to <code class="docutils literal notranslate"><span class="pre">0</span></code> if any of the
following is true:</p>
<ul class="simple">
<li><code class="docutils literal notranslate"><span class="pre">string</span></code> is empty,</li>
<li><code class="docutils literal notranslate"><span class="pre">string</span></code> is a case-insensitive equal of
<code class="docutils literal notranslate"><span class="pre">0</span></code>, <code class="docutils literal notranslate"><span class="pre">FALSE</span></code>, <code class="docutils literal notranslate"><span class="pre">OFF</span></code>, <code class="docutils literal notranslate"><span class="pre">N</span></code>, <code class="docutils literal notranslate"><span class="pre">NO</span></code>, <code class="docutils literal notranslate"><span class="pre">IGNORE</span></code>, or <code class="docutils literal notranslate"><span class="pre">NOTFOUND</span></code>, or</li>
<li><code class="docutils literal notranslate"><span class="pre">string</span></code> ends in the suffix <code class="docutils literal notranslate"><span class="pre">-NOTFOUND</span></code> (case-sensitive).</li>
</ul>
<p class="last">Otherwise evaluates to <code class="docutils literal notranslate"><span class="pre">1</span></code>.</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;AND:conditions&gt;</span></code></dt>
<dd>where <code class="docutils literal notranslate"><span class="pre">conditions</span></code> is a comma-separated list of boolean expressions.
...
Otherwise evaluates to <code class="docutils literal notranslate"><span class="pre">0</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;OR:conditions&gt;</span></code></dt>
<dd>where <code class="docutils literal notranslate"><span class="pre">conditions</span></code> is a comma-separated list of boolean expressions.
...
Otherwise evaluates to <code class="docutils literal notranslate"><span class="pre">0</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;NOT:condition&gt;</span></code></dt>
<dd><code class="docutils literal notranslate"><span class="pre">0</span></code> if <code class="docutils literal notranslate"><span class="pre">condition</span></code> is <code class="docutils literal notranslate"><span class="pre">1</span></code>, else <code class="docutils literal notranslate"><span class="pre">1</span></code>.</dd>
</dl>
</div>
<div class="section" id="string-comparisons">
<h3><a class="toc-backref" href="#id7">String Comparisons</a><a class="headerlink" href="#string-comparisons" title="Permalink to this headline">¶</a></h3>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;STREQUAL:string1,string2&gt;</span></code></dt>
<dd><p class="first"><code class="docutils literal notranslate"><span class="pre">1</span></code> if <code class="docutils literal notranslate"><span class="pre">string1</span></code> and <code class="docutils literal notranslate"><span class="pre">string2</span></code> are equal, else <code class="docutils literal notranslate"><span class="pre">0</span></code>.
...
<div class="last highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="o">$&lt;</span><span class="no">STREQUAL</span><span class="o">:$&lt;</span><span class="no">UPPER_CASE</span><span class="o">:${</span><span class="nt">foo</span><span class="o">}&gt;</span><span class="p">,</span><span class="s">&quot;BAR&quot;</span><span class="o">&gt;</span><span class="w"> </span><span class="c"># &quot;1&quot; if ${foo} is any of &quot;BAR&quot;, &quot;Bar&quot;, &quot;bar&quot;, ...</span>
</pre></div>
</div>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;EQUAL:value1,value2&gt;</span></code></dt>
<dd><code class="docutils literal notranslate"><span class="pre">1</span></code> if <code class="docutils literal notranslate"><span class="pre">value1</span></code> and <code class="docutils literal notranslate"><span class="pre">value2</span></code> are numerically equal, else <code class="docutils literal notranslate"><span class="pre">0</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;IN_LIST:string,list&gt;</span></code></dt>
<dd><code class="docutils literal notranslate"><span class="pre">1</span></code> if <code class="docutils literal notranslate"><span class="pre">string</span></code> is member of the semicolon-separated <code class="docutils literal notranslate"><span class="pre">list</span></code>, else <code class="docutils literal notranslate"><span class="pre">0</span></code>.
Uses case-sensitive comparisons.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;VERSION_LESS:v1,v2&gt;</span></code></dt>
<dd><code class="docutils literal notranslate"><span class="pre">1</span></code> if <code class="docutils literal notranslate"><span class="pre">v1</span></code> is a version less than <code class="docutils literal notranslate"><span class="pre">v2</span></code>, else <code class="docutils literal notranslate"><span class="pre">0</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;VERSION_GREATER:v1,v2&gt;</span></code></dt>
<dd><code class="docutils literal notranslate"><span class="pre">1</span></code> if <code class="docutils literal notranslate"><span class="pre">v1</span></code> is a version greater than <code class="docutils literal notranslate"><span class="pre">v2</span></code>, else <code class="docutils literal notranslate"><span class="pre">0</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;VERSION_EQUAL:v1,v2&gt;</span></code></dt>
<dd><code class="docutils literal notranslate"><span class="pre">1</span></code> if <code class="docutils literal notranslate"><span class="pre">v1</span></code> is the same version as <code class="docutils literal notranslate"><span class="pre">v2</span></code>, else <code class="docutils literal notranslate"><span class="pre">0</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;VERSION_LESS_EQUAL:v1,v2&gt;</span></code></dt>
<dd><code class="docutils literal notranslate"><span class="pre">1</span></code> if <code class="docutils literal notranslate"><span class="pre">v1</span></code> is a version less than or equal to <code class="docutils literal notranslate"><span class="pre">v2</span></code>, else <code class="docutils literal notranslate"><span class="pre">0</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;VERSION_GREATER_EQUAL:v1,v2&gt;</span></code></dt>
<dd><code class="docutils literal notranslate"><span class="pre">1</span></code> if <code class="docutils literal notranslate"><span class="pre">v1</span></code> is a version greater than or equal to <code class="docutils literal notranslate"><span class="pre">v2</span></code>, else <code class="docutils literal notranslate"><span class="pre">0</span></code>.</dd>
</dl>
</div>
<div class="section" id="variable-queries">
<h3><a class="toc-backref" href="#id8">Variable Queries</a><a class="headerlink" href="#variable-queries" title="Permalink to this headline">¶</a></h3>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_EXISTS:target&gt;</span></code></dt>
<dd><code class="docutils literal notranslate"><span class="pre">1</span></code> if <code class="docutils literal notranslate"><span class="pre">target</span></code> exists, else <code class="docutils literal notranslate"><span class="pre">0</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;CONFIG:cfg&gt;</span></code></dt>
<dd><code class="docutils literal notranslate"><span class="pre">1</span></code> if config is <code class="docutils literal notranslate"><span class="pre">cfg</span></code>, else <code class="docutils literal notranslate"><span class="pre">0</span></code>. This is a case-insensitive comparison.
...
this expression when it is evaluated on a property on an <span class="target" id="index-0-prop_tgt:IMPORTED"></span><a class="reference internal" href="../prop_tgt/IMPORTED.html#prop_tgt:IMPORTED" title="IMPORTED"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">IMPORTED</span></code></a>
target.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;PLATFORM_ID:platform_ids&gt;</span></code></dt>
<dd>where <code class="docutils literal notranslate"><span class="pre">platform_ids</span></code> is a comma-separated list.
...
See also the <span class="target" id="index-0-variable:CMAKE_SYSTEM_NAME"></span><a class="reference internal" href="../variable/CMAKE_SYSTEM_NAME.html#variable:CMAKE_SYSTEM_NAME" title="CMAKE_SYSTEM_NAME"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_SYSTEM_NAME</span></code></a> variable.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;C_COMPILER_ID:compiler_ids&gt;</span></code></dt>
<dd>where <code class="docutils literal notranslate"><span class="pre">compiler_ids</span></code> is a comma-separated list.
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;CXX_COMPILER_ID:compiler_ids&gt;</span></code></dt>
<dd>where <code class="docutils literal notranslate"><span class="pre">compiler_ids</span></code> is a comma-separated list.
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;CUDA_COMPILER_ID:compiler_ids&gt;</span></code></dt>
<dd>where <code class="docutils literal notranslate"><span class="pre">compiler_ids</span></code> is a comma-separated list.
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;OBJC_COMPILER_ID:compiler_ids&gt;</span></code></dt>
<dd>where <code class="docutils literal notranslate"><span class="pre">compiler_ids</span></code> is a comma-separated list.
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;OBJCXX_COMPILER_ID:compiler_ids&gt;</span></code></dt>
<dd>where <code class="docutils literal notranslate"><span class="pre">compiler_ids</span></code> is a comma-separated list.
<code class="docutils literal notranslate"><span class="pre">1</span></code> if the CMake’s compiler id of the Objective-C++ compiler matches any one
of the entries in <code class="docutils literal notranslate"><span class="pre">compiler_ids</span></code>, otherwise <code class="docutils literal notranslate"><span class="pre">0</span></code>.
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;Fortran_COMPILER_ID:compiler_ids&gt;</span></code></dt>
<dd>where <code class="docutils literal notranslate"><span class="pre">compiler_ids</span></code> is a comma-separated list.
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;C_COMPILER_VERSION:version&gt;</span></code></dt>
<dd><code class="docutils literal notranslate"><span class="pre">1</span></code> if the version of the C compiler matches <code class="docutils literal notranslate"><span class="pre">version</span></code>, otherwise <code class="docutils literal notranslate"><span class="pre">0</span></code>.
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;CXX_COMPILER_VERSION:version&gt;</span></code></dt>
<dd><code class="docutils literal notranslate"><span class="pre">1</span></code> if the version of the CXX compiler matches <code class="docutils literal notranslate"><span class="pre">version</span></code>, otherwise <code class="docutils literal notranslate"><span class="pre">0</span></code>.
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;CUDA_COMPILER_VERSION:version&gt;</span></code></dt>
<dd><code class="docutils literal notranslate"><span class="pre">1</span></code> if the version of the CXX compiler matches <code class="docutils literal notranslate"><span class="pre">version</span></code>, otherwise <code class="docutils literal notranslate"><span class="pre">0</span></code>.
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;OBJC_COMPILER_VERSION:version&gt;</span></code></dt>
<dd><code class="docutils literal notranslate"><span class="pre">1</span></code> if the version of the OBJC compiler matches <code class="docutils literal notranslate"><span class="pre">version</span></code>, otherwise <code class="docutils literal notranslate"><span class="pre">0</span></code>.
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;OBJCXX_COMPILER_VERSION:version&gt;</span></code></dt>
<dd><code class="docutils literal notranslate"><span class="pre">1</span></code> if the version of the OBJCXX compiler matches <code class="docutils literal notranslate"><span class="pre">version</span></code>, otherwise <code class="docutils literal notranslate"><span class="pre">0</span></code>.
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;Fortran_COMPILER_VERSION:version&gt;</span></code></dt>
<dd><code class="docutils literal notranslate"><span class="pre">1</span></code> if the version of the Fortran compiler matches <code class="docutils literal notranslate"><span class="pre">version</span></code>, otherwise <code class="docutils literal notranslate"><span class="pre">0</span></code>.
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_POLICY:policy&gt;</span></code></dt>
<dd><code class="docutils literal notranslate"><span class="pre">1</span></code> if the <code class="docutils literal notranslate"><span class="pre">policy</span></code> was NEW when the ‘head’ target was created,
...
policies.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;COMPILE_FEATURES:features&gt;</span></code></dt>
<dd>where <code class="docutils literal notranslate"><span class="pre">features</span></code> is a comma-spearated list.
...
<dl class="docutils" id="boolean-compile-language-generator-expression">
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;COMPILE_LANG_AND_ID:language,compiler_ids&gt;</span></code></dt>
<dd><p class="first"><code class="docutils literal notranslate"><span class="pre">1</span></code> when the language used for compilation unit matches <code class="docutils literal notranslate"><span class="pre">language</span></code> and
...
<div class="last highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">target_compile_definitions(</span><span class="nb">myapp</span><span class="w"></span>
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;COMPILE_LANGUAGE:languages&gt;</span></code></dt>
<dd><p class="first"><code class="docutils literal notranslate"><span class="pre">1</span></code> when the language used for compilation unit matches any of the entries
...
instead:</p>
<div class="last highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">add_library(</span><span class="nb">myapp_c</span><span class="w"> </span><span class="nb">foo.c</span><span class="nf">)</span><span class="w"></span>
...
<h2><a class="toc-backref" href="#id9">String-Valued Generator Expressions</a><a class="headerlink" href="#string-valued-generator-expressions" title="Permalink to this headline">¶</a></h2>
...
<h3><a class="toc-backref" href="#id10">Escaped Characters</a><a class="headerlink" href="#escaped-characters" title="Permalink to this headline">¶</a></h3>
<p>String literals to escape the special meaning a character would otherwise have:</p>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;ANGLE-R&gt;</span></code></dt>
<dd>A literal <code class="docutils literal notranslate"><span class="pre">&gt;</span></code>. Used for example to compare strings that contain a <code class="docutils literal notranslate"><span class="pre">&gt;</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;COMMA&gt;</span></code></dt>
<dd>A literal <code class="docutils literal notranslate"><span class="pre">,</span></code>. Used for example to compare strings which contain a <code class="docutils literal notranslate"><span class="pre">,</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;SEMICOLON&gt;</span></code></dt>
<dd>A literal <code class="docutils literal notranslate"><span class="pre">;</span></code>. Used to prevent list expansion on an argument with <code class="docutils literal notranslate"><span class="pre">;</span></code>.</dd>
</dl>
</div>
<div class="section" id="conditional-expressions">
<span id="conditional-generator-expressions"></span><h3><a class="toc-backref" href="#id11">Conditional Expressions</a><a class="headerlink" href="#conditional-expressions" title="Permalink to this headline">¶</a></h3>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;condition:true_string&gt;</span></code></dt>
<dd>Evaluates to <code class="docutils literal notranslate"><span class="pre">true_string</span></code> if <code class="docutils literal notranslate"><span class="pre">condition</span></code> is <code class="docutils literal notranslate"><span class="pre">1</span></code>.
Otherwise evaluates to the empty string.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;IF:condition,true_string,false_string&gt;</span></code></dt>
<dd>Evaluates to <code class="docutils literal notranslate"><span class="pre">true_string</span></code> if <code class="docutils literal notranslate"><span class="pre">condition</span></code> is <code class="docutils literal notranslate"><span class="pre">1</span></code>.
Otherwise evaluates to <code class="docutils literal notranslate"><span class="pre">false_string</span></code>.</dd>
</dl>
...
<span id="string-transforming-generator-expressions"></span><h3><a class="toc-backref" href="#id12">String Transformations</a><a class="headerlink" href="#string-transformations" title="Permalink to this headline">¶</a></h3>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;JOIN:list,string&gt;</span></code></dt>
<dd>Joins the list with the content of <code class="docutils literal notranslate"><span class="pre">string</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;REMOVE_DUPLICATES:list&gt;</span></code></dt>
<dd>Removes duplicated items in the given <code class="docutils literal notranslate"><span class="pre">list</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;FILTER:list,INCLUDE|EXCLUDE,regex&gt;</span></code></dt>
<dd>Includes or removes items from <code class="docutils literal notranslate"><span class="pre">list</span></code> that match the regular expression <code class="docutils literal notranslate"><span class="pre">regex</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;LOWER_CASE:string&gt;</span></code></dt>
<dd>Content of <code class="docutils literal notranslate"><span class="pre">string</span></code> converted to lower case.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;UPPER_CASE:string&gt;</span></code></dt>
<dd>Content of <code class="docutils literal notranslate"><span class="pre">string</span></code> converted to upper case.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;GENEX_EVAL:expr&gt;</span></code></dt>
<dd>Content of <code class="docutils literal notranslate"><span class="pre">expr</span></code> evaluated as a generator expression in the current
context. This enables consumption of generator expressions whose
evaluation results itself in generator expressions.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_GENEX_EVAL:tgt,expr&gt;</span></code></dt>
<dd><p class="first">Content of <code class="docutils literal notranslate"><span class="pre">expr</span></code> evaluated as a generator expression in the context of
...
<div class="last highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">add_custom_target(</span><span class="nb">printFooKeys</span><span class="w"></span>
...
<h3><a class="toc-backref" href="#id13">Variable Queries</a><a class="headerlink" href="#id2" title="Permalink to this headline">¶</a></h3>
<dl class="docutils">
...
<dd>Configuration name. Deprecated since CMake 3.0. Use <code class="docutils literal notranslate"><span class="pre">CONFIG</span></code> instead.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;PLATFORM_ID&gt;</span></code></dt>
<dd>The current system’s CMake platform id.
See also the <span class="target" id="index-1-variable:CMAKE_SYSTEM_NAME"></span><a class="reference internal" href="../variable/CMAKE_SYSTEM_NAME.html#variable:CMAKE_SYSTEM_NAME" title="CMAKE_SYSTEM_NAME"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_SYSTEM_NAME</span></code></a> variable.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;C_COMPILER_ID&gt;</span></code></dt>
<dd>The CMake’s compiler id of the C compiler used.
See also the <span class="target" id="index-6-variable:CMAKE_&lt;LANG&gt;_COMPILER_ID"></span><a class="reference internal" href="../variable/CMAKE_LANG_COMPILER_ID.html#variable:CMAKE_&lt;LANG&gt;_COMPILER_ID" title="CMAKE_&lt;LANG&gt;_COMPILER_ID"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_&lt;LANG&gt;_COMPILER_ID</span></code></a> variable.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;CXX_COMPILER_ID&gt;</span></code></dt>
<dd>The CMake’s compiler id of the CXX compiler used.
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;CUDA_COMPILER_ID&gt;</span></code></dt>
<dd>The CMake’s compiler id of the CUDA compiler used.
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;OBJC_COMPILER_ID&gt;</span></code></dt>
<dd>The CMake’s compiler id of the OBJC compiler used.
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;OBJCXX_COMPILER_ID&gt;</span></code></dt>
<dd>The CMake’s compiler id of the OBJCXX compiler used.
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;Fortran_COMPILER_ID&gt;</span></code></dt>
<dd>The CMake’s compiler id of the Fortran compiler used.
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;C_COMPILER_VERSION&gt;</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;CXX_COMPILER_VERSION&gt;</span></code></dt>
<dd>The version of the CXX compiler used.
See also the <span class="target" id="index-8-variable:CMAKE_&lt;LANG&gt;_COMPILER_VERSION"></span><a class="reference internal" href="../variable/CMAKE_LANG_COMPILER_VERSION.html#variable:CMAKE_&lt;LANG&gt;_COMPILER_VERSION" title="CMAKE_&lt;LANG&gt;_COMPILER_VERSION"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_&lt;LANG&gt;_COMPILER_VERSION</span></code></a> variable.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;CUDA_COMPILER_VERSION&gt;</span></code></dt>
<dd>The version of the CUDA compiler used.
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;OBJC_COMPILER_VERSION&gt;</span></code></dt>
<dd>The version of the OBJC compiler used.
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;OBJCXX_COMPILER_VERSION&gt;</span></code></dt>
<dd>The version of the OBJCXX compiler used.
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;Fortran_COMPILER_VERSION&gt;</span></code></dt>
<dd>The version of the Fortran compiler used.
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;COMPILE_LANGUAGE&gt;</span></code></dt>
<dd>The compile language of source files when evaluating compile options.
...
for notes about the portability of this generator expression.</dd>
</dl>
</div>
<div class="section" id="target-dependent-queries">
<h3><a class="toc-backref" href="#id14">Target-Dependent Queries</a><a class="headerlink" href="#target-dependent-queries" title="Permalink to this headline">¶</a></h3>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_NAME_IF_EXISTS:tgt&gt;</span></code></dt>
<dd>Expands to the <code class="docutils literal notranslate"><span class="pre">tgt</span></code> if the given target exists, an empty string
otherwise.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_FILE:tgt&gt;</span></code></dt>
<dd>Full path to main file (.exe, .so.1.2, .a) where <code class="docutils literal notranslate"><span class="pre">tgt</span></code> is the name of a
target.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_FILE_BASE_NAME:tgt&gt;</span></code></dt>
<dd><p class="first">Base name of main file where <code class="docutils literal notranslate"><span class="pre">tgt</span></code> is the name of a target.</p>
<p>The base name corresponds to the target file name (see
<code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_FILE_NAME:tgt&gt;</span></code>) without prefix and suffix. For example, if
target file name is <code class="docutils literal notranslate"><span class="pre">libbase.so</span></code>, the base name is <code class="docutils literal notranslate"><span class="pre">base</span></code>.</p>
...
<p class="last">Note that <code class="docutils literal notranslate"><span class="pre">tgt</span></code> is not added as a dependency of the target this
expression is evaluated on.</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_FILE_PREFIX:tgt&gt;</span></code></dt>
<dd><p class="first">Prefix of main file where <code class="docutils literal notranslate"><span class="pre">tgt</span></code> is the name of a target.</p>
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_FILE_SUFFIX:tgt&gt;</span></code></dt>
<dd><p class="first">Suffix of main file where <code class="docutils literal notranslate"><span class="pre">tgt</span></code> is the name of a target.</p>
<p>The suffix corresponds to the file extension (such as “.so” or “.exe”).</p>
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_FILE_NAME:tgt&gt;</span></code></dt>
<dd>Name of main file (.exe, .so.1.2, .a).</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_FILE_DIR:tgt&gt;</span></code></dt>
<dd>Directory of main file (.exe, .so.1.2, .a).</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_LINKER_FILE:tgt&gt;</span></code></dt>
<dd>File used to link (.a, .lib, .so) where <code class="docutils literal notranslate"><span class="pre">tgt</span></code> is the name of a target.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_LINKER_FILE_BASE_NAME:tgt&gt;</span></code></dt>
<dd><p class="first">Base name of file used to link where <code class="docutils literal notranslate"><span class="pre">tgt</span></code> is the name of a target.</p>
<p>The base name corresponds to the target linker file name (see
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_LINKER_FILE_PREFIX:tgt&gt;</span></code></dt>
<dd><p class="first">Prefix of file used to link where <code class="docutils literal notranslate"><span class="pre">tgt</span></code> is the name of a target.</p>
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_LINKER_FILE_SUFFIX:tgt&gt;</span></code></dt>
<dd><p class="first">Suffix of file used to link where <code class="docutils literal notranslate"><span class="pre">tgt</span></code> is the name of a target.</p>
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_LINKER_FILE_NAME:tgt&gt;</span></code></dt>
<dd>Name of file used to link (.a, .lib, .so).</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_LINKER_FILE_DIR:tgt&gt;</span></code></dt>
<dd>Directory of file used to link (.a, .lib, .so).</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_SONAME_FILE:tgt&gt;</span></code></dt>
<dd>File with soname (.so.3) where <code class="docutils literal notranslate"><span class="pre">tgt</span></code> is the name of a target.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_SONAME_FILE_NAME:tgt&gt;</span></code></dt>
<dd>Name of file with soname (.so.3).</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_SONAME_FILE_DIR:tgt&gt;</span></code></dt>
<dd>Directory of with soname (.so.3).</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_PDB_FILE:tgt&gt;</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_PDB_FILE_BASE_NAME:tgt&gt;</span></code></dt>
<dd><p class="first">Base name of the linker generated program database file (.pdb)
where <code class="docutils literal notranslate"><span class="pre">tgt</span></code> is the name of a target.</p>
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_PDB_FILE_NAME:tgt&gt;</span></code></dt>
<dd>Name of the linker generated program database file (.pdb).</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_PDB_FILE_DIR:tgt&gt;</span></code></dt>
<dd>Directory of the linker generated program database file (.pdb).</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_BUNDLE_DIR:tgt&gt;</span></code></dt>
<dd>Full path to the bundle directory (<code class="docutils literal notranslate"><span class="pre">my.app</span></code>, <code class="docutils literal notranslate"><span class="pre">my.framework</span></code>, or
<code class="docutils literal notranslate"><span class="pre">my.bundle</span></code>) where <code class="docutils literal notranslate"><span class="pre">tgt</span></code> is the name of a target.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_BUNDLE_CONTENT_DIR:tgt&gt;</span></code></dt>
<dd>Full path to the bundle content directory where <code class="docutils literal notranslate"><span class="pre">tgt</span></code> is the name of a
...
structure.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_PROPERTY:tgt,prop&gt;</span></code></dt>
<dd><p class="first">Value of the property <code class="docutils literal notranslate"><span class="pre">prop</span></code> on the target <code class="docutils literal notranslate"><span class="pre">tgt</span></code>.</p>
<p class="last">Note that <code class="docutils literal notranslate"><span class="pre">tgt</span></code> is not added as a dependency of the target this
expression is evaluated on.</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_PROPERTY:prop&gt;</span></code></dt>
<dd>Value of the property <code class="docutils literal notranslate"><span class="pre">prop</span></code> on the target on which the generator
expression is evaluated. Note that for generator expressions in
<a class="reference internal" href="cmake-buildsystem.7.html#target-usage-requirements"><span class="std std-ref">Transitive Usage Requirements</span></a> this is the value of the property
on the consuming target rather than the target specifying the
requirement.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;INSTALL_PREFIX&gt;</span></code></dt>
<dd>Content of the install prefix when the target is exported via
<span class="target" id="index-0-command:install"></span><a class="reference internal" href="../command/install.html#command:install" title="install"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">install(EXPORT)</span></code></a> and empty otherwise.</dd>
</dl>
</div>
<div class="section" id="output-related-expressions">
<h3><a class="toc-backref" href="#id15">Output-Related Expressions</a><a class="headerlink" href="#output-related-expressions" title="Permalink to this headline">¶</a></h3>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_NAME:...&gt;</span></code></dt>
<dd>Marks <code class="docutils literal notranslate"><span class="pre">...</span></code> as being the name of a target.  This is required if exporting
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;LINK_ONLY:...&gt;</span></code></dt>
<dd>Content of <code class="docutils literal notranslate"><span class="pre">...</span></code> except when evaluated in a link interface while
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;INSTALL_INTERFACE:...&gt;</span></code></dt>
<dd>Content of <code class="docutils literal notranslate"><span class="pre">...</span></code> when the property is exported using <span class="target" id="index-1-command:install"></span><a class="reference internal" href="../command/install.html#command:install" title="install"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">install(EXPORT)</span></code></a>,
and empty otherwise.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;BUILD_INTERFACE:...&gt;</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;MAKE_C_IDENTIFIER:...&gt;</span></code></dt>
<dd>Content of <code class="docutils literal notranslate"><span class="pre">...</span></code> converted to a C identifier.  The conversion follows the
same behavior as <span class="target" id="index-0-command:string"></span><a class="reference internal" href="../command/string.html#command:string" title="string"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">string(MAKE_C_IDENTIFIER)</span></code></a>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_OBJECTS:objLib&gt;</span></code></dt>
<dd>List of objects resulting from build of <code class="docutils literal notranslate"><span class="pre">objLib</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">$&lt;SHELL_PATH:...&gt;</span></code></dt>
<dd>Content of <code class="docutils literal notranslate"><span class="pre">...</span></code> converted to shell path style. For example, slashes are
converted to backslashes in Windows shells and drive letters are converted
to posix paths in MSYS shells. The <code class="docutils literal notranslate"><span class="pre">...</span></code> must be an absolute path.
The <code class="docutils literal notranslate"><span class="pre">...</span></code> may be a <a class="reference internal" href="cmake-language.7.html#cmake-language-lists"><span class="std std-ref">semicolon-separated list</span></a>
...
in double quotes in CMake source code so that <code class="docutils literal notranslate"><span class="pre">;</span></code> does not split arguments.</dd>
</dl>
</div>
</div>
<div class="section" id="debugging">
<h2><a class="toc-backref" href="#id16">Debugging</a><a class="headerlink" href="#debugging" title="Permalink to this headline">¶</a></h2>
