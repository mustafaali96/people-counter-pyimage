...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>cmake-developer(7) &mdash; CMake 3.16.1 Documentation</title>
...
<li><a class="reference internal" href="#find-modules" id="id4">Find Modules</a><ul>
<li><a class="reference internal" href="#standard-variable-names" id="id5">Standard Variable Names</a></li>
<li><a class="reference internal" href="#a-sample-find-module" id="id6">A Sample Find Module</a></li>
</ul>
</li>
</ul>
</li>
...
<p>A “find module” is a <code class="docutils literal notranslate"><span class="pre">Find&lt;PackageName&gt;.cmake</span></code> file to be loaded
...
exists on the system, set the <code class="docutils literal notranslate"><span class="pre">&lt;PackageName&gt;_FOUND</span></code> variable to reflect
...
<code class="docutils literal notranslate"><span class="pre">Xxx_</span></code> to make sure they do not interfere with other find modules; the
same consideration applies to macros, functions and imported targets.</p>
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">Xxx_INCLUDE_DIRS</span></code></dt>
<dd>The final set of include directories listed in one variable for use by
client code.  This should not be a cache entry.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Xxx_LIBRARIES</span></code></dt>
<dd>The libraries to link against to use Xxx. These should include full
paths.  This should not be a cache entry.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Xxx_DEFINITIONS</span></code></dt>
<dd>Definitions to use when compiling code that uses Xxx. This really
shouldn’t include options such as <code class="docutils literal notranslate"><span class="pre">-DHAS_JPEG</span></code> that a client
source-code file uses to decide whether to <code class="docutils literal notranslate"><span class="pre">#include</span> <span class="pre">&lt;jpeg.h&gt;</span></code></dd>
<dt><code class="docutils literal notranslate"><span class="pre">Xxx_EXECUTABLE</span></code></dt>
<dd>Where to find the Xxx tool.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Xxx_Yyy_EXECUTABLE</span></code></dt>
<dd>Where to find the Yyy tool that comes with Xxx.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Xxx_LIBRARY_DIRS</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">Xxx_ROOT_DIR</span></code></dt>
<dd>Where to find the base directory of Xxx.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Xxx_VERSION_Yy</span></code></dt>
<dd>Expect Version Yy if true. Make sure at most one of these is ever true.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Xxx_WRAP_Yy</span></code></dt>
<dd>If False, do not try to use the relevant CMake wrapping command.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Xxx_Yy_FOUND</span></code></dt>
<dd>If False, optional Yy part of Xxx system is not available.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Xxx_FOUND</span></code></dt>
<dd>Set to false, or undefined, if we haven’t found, or don’t want to use
Xxx.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Xxx_NOT_FOUND_MESSAGE</span></code></dt>
...
<span class="target" id="index-2-command:find_package"></span><a class="reference internal" href="../command/find_package.html#command:find_package" title="find_package"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">find_package()</span></code></a> command and by
<code class="docutils literal notranslate"><span class="pre">find_package_handle_standard_args()</span></code> to inform the user about the
problem.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Xxx_RUNTIME_LIBRARY_DIRS</span></code></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">Xxx_VERSION</span></code></dt>
<dd>The full version string of the package found, if any.  Note that many
existing modules provide <code class="docutils literal notranslate"><span class="pre">Xxx_VERSION_STRING</span></code> instead.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Xxx_VERSION_MAJOR</span></code></dt>
<dd>The major version of the package found, if any.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Xxx_VERSION_MINOR</span></code></dt>
<dd>The minor version of the package found, if any.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Xxx_VERSION_PATCH</span></code></dt>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">Xxx_LIBRARY</span></code></dt>
<dd>The path of the Xxx library (as used with <span class="target" id="index-0-command:find_library"></span><a class="reference internal" href="../command/find_library.html#command:find_library" title="find_library"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">find_library()</span></code></a>, for
example).</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Xxx_Yy_LIBRARY</span></code></dt>
<dd>The path of the Yy library that is part of the Xxx system. It may or
may not be required to use Xxx.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Xxx_INCLUDE_DIR</span></code></dt>
<dd>Where to find headers for using the Xxx library.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Xxx_Yy_INCLUDE_DIR</span></code></dt>
...
<code class="docutils literal notranslate"><span class="pre">Foo_LIBRARY_DEBUG</span></code>.</p>
...
<ul class="simple">
<li>An underlined heading specifying the module name.</li>
<li>A simple description of what the module finds.
More description may be required for some packages.  If there are
caveats or other details users of the module should be aware of,
specify them here.</li>
<li>A section listing imported targets provided by the module, if any.</li>
<li>A section listing result variables provided by the module.</li>
<li>Optionally a section listing cache variables used by the module, if any.</li>
</ul>
...
was passed to <span class="target" id="index-3-command:find_package"></span><a class="reference internal" href="../command/find_package.html#command:find_package" title="find_package"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">find_package()</span></code></a>, it will check the requested version
