...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>cpack(1) &mdash; CMake 3.16.1 Documentation</title>
...
<dl class="docutils">
<dt><code class="docutils literal notranslate"><span class="pre">-G</span> <span class="pre">&lt;generators&gt;</span></code></dt>
<dd><code class="docutils literal notranslate"><span class="pre">&lt;generators&gt;</span></code> is a <a class="reference internal" href="cmake-language.7.html#cmake-language-lists"><span class="std std-ref">semicolon-separated list</span></a>
...
generators that will be used.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">-C</span> <span class="pre">&lt;configs&gt;</span></code></dt>
<dd>Specify the project configuration(s) to be packaged (e.g. <code class="docutils literal notranslate"><span class="pre">Debug</span></code>,
...
have already been built before invoking <code class="docutils literal notranslate"><span class="pre">cpack</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">-D</span> <span class="pre">&lt;var&gt;=&lt;value&gt;</span></code></dt>
<dd>Set a CPack variable.  This will override any value set for <code class="docutils literal notranslate"><span class="pre">&lt;var&gt;</span></code> in the
input file read by <code class="docutils literal notranslate"><span class="pre">cpack</span></code>.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">--config</span> <span class="pre">&lt;configFile&gt;</span></code></dt>
<dd>Specify the configuration file read by <code class="docutils literal notranslate"><span class="pre">cpack</span></code> to provide the packaging
...
<dd>Run <code class="docutils literal notranslate"><span class="pre">cpack</span></code> with verbose output.  This can be used to show more details
from the package generation tools and is suitable for project developers.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">--debug</span></code></dt>
<dd>Run <code class="docutils literal notranslate"><span class="pre">cpack</span></code> with debug output.  This option is intended mainly for the
...
<dd>Put the underlying cmake scripts in trace mode.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">--trace-expand</span></code></dt>
<dd>Put the underlying cmake scripts in expanded trace mode.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">-P</span> <span class="pre">&lt;packageName&gt;</span></code></dt>
<dd>Override/define the value of the <span class="target" id="index-0-variable:CPACK_PACKAGE_NAME"></span><a class="reference internal" href="../module/CPack.html#variable:CPACK_PACKAGE_NAME" title="CPACK_PACKAGE_NAME"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_PACKAGE_NAME</span></code></a> variable used
...
file will then be ignored.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">-R</span> <span class="pre">&lt;packageVersion&gt;</span></code></dt>
<dd>Override/define the value of the <span class="target" id="index-0-variable:CPACK_PACKAGE_VERSION"></span><a class="reference internal" href="../module/CPack.html#variable:CPACK_PACKAGE_VERSION" title="CPACK_PACKAGE_VERSION"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_PACKAGE_VERSION</span></code></a>
...
use as a working area during package creation.</dd>
<dt><code class="docutils literal notranslate"><span class="pre">--vendor</span> <span class="pre">&lt;vendorName&gt;</span></code></dt>
<dd>Override/define <span class="target" id="index-0-variable:CPACK_PACKAGE_VENDOR"></span><a class="reference internal" href="../module/CPack.html#variable:CPACK_PACKAGE_VENDOR" title="CPACK_PACKAGE_VENDOR"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_PACKAGE_VENDOR</span></code></a>.</dd>
</dl>
<dl class="docutils">
