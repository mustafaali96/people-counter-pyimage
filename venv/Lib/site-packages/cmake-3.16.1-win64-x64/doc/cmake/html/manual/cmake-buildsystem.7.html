...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title>cmake-buildsystem(7) &mdash; CMake 3.16.1 Documentation</title>
...
may be used as source inputs to other targets:</p>
...
Because <code class="docutils literal notranslate"><span class="pre">exe2</span></code> links to both and they are in conflict, a diagnostic is
issued.</p>
...
contains a cycle.  <span class="target" id="index-3-manual:cmake(1)"></span><a class="reference internal" href="cmake.1.html#manual:cmake(1)" title="cmake(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake(1)</span></code></a> issues a diagnostic in this case.</p>
</div>
...
<ul class="simple">
<li>The executable file (e.g. <code class="docutils literal notranslate"><span class="pre">.exe</span></code>) of an executable target
created by the <span class="target" id="index-3-command:add_executable"></span><a class="reference internal" href="../command/add_executable.html#command:add_executable" title="add_executable"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">add_executable()</span></code></a> command.</li>
<li>On DLL platforms: the executable file (e.g. <code class="docutils literal notranslate"><span class="pre">.dll</span></code>) of a shared
...
with the <code class="docutils literal notranslate"><span class="pre">SHARED</span></code> option.</li>
</ul>
...
<ul class="simple">
<li>The loadable module file (e.g. <code class="docutils literal notranslate"><span class="pre">.dll</span></code> or <code class="docutils literal notranslate"><span class="pre">.so</span></code>) of a module
...
with the <code class="docutils literal notranslate"><span class="pre">MODULE</span></code> option.</li>
<li>On non-DLL platforms: the shared library file (e.g. <code class="docutils literal notranslate"><span class="pre">.so</span></code> or <code class="docutils literal notranslate"><span class="pre">.dylib</span></code>)
...
command with the <code class="docutils literal notranslate"><span class="pre">SHARED</span></code> option.</li>
</ul>
...
<ul class="simple">
<li>The static library file (e.g. <code class="docutils literal notranslate"><span class="pre">.lib</span></code> or <code class="docutils literal notranslate"><span class="pre">.a</span></code>) of a static
...
with the <code class="docutils literal notranslate"><span class="pre">STATIC</span></code> option.</li>
<li>On DLL platforms: the import library file (e.g. <code class="docutils literal notranslate"><span class="pre">.lib</span></code>) of a shared
...
<li>On DLL platforms: the import library file (e.g. <code class="docutils literal notranslate"><span class="pre">.lib</span></code>) of an
...
when its <span class="target" id="index-0-prop_tgt:ENABLE_EXPORTS"></span><a class="reference internal" href="../prop_tgt/ENABLE_EXPORTS.html#prop_tgt:ENABLE_EXPORTS" title="ENABLE_EXPORTS"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">ENABLE_EXPORTS</span></code></a> target property is set.</li>
<li>On AIX: the linker import file (e.g. <code class="docutils literal notranslate"><span class="pre">.imp</span></code>) of an executable target
...
<span class="target" id="index-1-prop_tgt:ENABLE_EXPORTS"></span><a class="reference internal" href="../prop_tgt/ENABLE_EXPORTS.html#prop_tgt:ENABLE_EXPORTS" title="ENABLE_EXPORTS"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">ENABLE_EXPORTS</span></code></a> target property is set.</li>
</ul>
...
<p>An <code class="docutils literal notranslate"><span class="pre">INTERFACE</span></code> target has no <span class="target" id="index-1-prop_tgt:LOCATION"></span><a class="reference internal" href="../prop_tgt/LOCATION.html#prop_tgt:LOCATION" title="LOCATION"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">LOCATION</span></code></a> and is mutable, but is
otherwise similar to an <span class="target" id="index-13-prop_tgt:IMPORTED"></span><a class="reference internal" href="../prop_tgt/IMPORTED.html#prop_tgt:IMPORTED" title="IMPORTED"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">IMPORTED</span></code></a> target.</p>
...
<div class="highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">add_library(</span><span class="nb">Eigen</span><span class="w"> </span><span class="no">INTERFACE</span><span class="nf">)</span><span class="w"></span>
...
<p>The properties permitted to be set on or read from an <code class="docutils literal notranslate"><span class="pre">INTERFACE</span></code> library
are:</p>
<ul class="simple">
<li>Properties matching <code class="docutils literal notranslate"><span class="pre">INTERFACE_*</span></code></li>
<li>Built-in properties matching <code class="docutils literal notranslate"><span class="pre">COMPATIBLE_INTERFACE_*</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">EXPORT_NAME</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">EXPORT_PROPERTIES</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">IMPORTED</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">MANUALLY_ADDED_DEPENDENCIES</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">NAME</span></code></li>
<li>Properties matching <code class="docutils literal notranslate"><span class="pre">IMPORTED_LIBNAME_*</span></code></li>
<li>Properties matching <code class="docutils literal notranslate"><span class="pre">MAP_IMPORTED_CONFIG_*</span></code></li>
</ul>
